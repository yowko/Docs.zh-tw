                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/fsharp/get-started/">開始使用</a></p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/visual-basic/walkthroughs">逐步解說</a></p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/spark/tutorials/">教學課程</a></p>
                                                <p><a href="/dotnet/spark/resources/">資源</a></p>
                                                <p><a href="/dotnet/api/?view=spark-dotnet">.NET for Apache Spark API 參考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>了解使用 Visual Studio 建置 ASP.NET Core MVC Web 應用程式的基礎概念。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>了解 Web Apps、WebJobs、雲端服務及 VM 等 Azure 服務。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 儲存體</h3>
                                                    <p>了解 Azure 儲存體，並了解如何使用 Azure Blob、表格、佇列及檔案建立應用程式。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>在 Azure 上使用 F#</h3>
                                                    <p>了解如何以 F# 使用各種 Azure 服務，例如 Azure 儲存體、雲端服務及 Azure Functions。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>WPF 提供開發人員以 XAML 為基礎的模型，可用於建置 Windows 上的傳統型應用程式。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>利用 MonoGame 程式庫文件中心的教學課程與設定指示，以 C# 建置遊戲。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>在您撰寫 .NET 程式碼的任何位置上處理資料批次、即時串流、機器學習和特定查詢。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft 平台和工具的容器化 Docker 應用程式生命週期</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Azure 雲端及 Windows 容器將現有 .NET 應用程式現代化</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 ASP.NET Core 和 Azure 架構現代化 Web 應用程式</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>無伺服器應用程式：架構、模式和 Azure 實作</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>預覽</strong> 建構適用於 Azure 的雲端原生 .NET 應用程式</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>預覽</strong> 適用於 ASP.NET Web Forms 開發人員的 Blazor</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>預覽</strong> 適用於 WCF 開發人員的 ASP.NET Core gRPC</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
