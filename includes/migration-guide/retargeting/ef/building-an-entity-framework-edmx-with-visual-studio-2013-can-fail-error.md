...
|建議|Entity Framework 的目標檔案已修正，從 .NET Framework 4.6 開始，可搭配新的 MSBuild 配置使用。 升級至該版 Framework 將會修正此問題。 或者，您也可以使用[此因應措施](https://stackoverflow.com/a/24249247/131944)來直接修補目標檔案。|
|範圍|主要|
|版本|4.5.1|
|類型|正在重定目標|
