...
---
### <a name="obsolete-antiforgery-cors-diagnostics-mvc-and-routing-apis-removed"></a><span data-ttu-id="0c9d8-101">已移除過時的 Antiforgery、CORS、診斷、MVC 和路由 Api</span><span class="sxs-lookup"><span data-stu-id="0c9d8-101">Obsolete Antiforgery, CORS, Diagnostics, MVC, and Routing APIs removed</span></span>

<span data-ttu-id="0c9d8-102">已移除 ASP.NET Core 2.2 中過時的成員和相容性參數。</span><span class="sxs-lookup"><span data-stu-id="0c9d8-102">Obsolete members and compatibility switches in ASP.NET Core 2.2 were removed.</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="0c9d8-103">引進的版本</span><span class="sxs-lookup"><span data-stu-id="0c9d8-103">Version introduced</span></span>

<span data-ttu-id="0c9d8-104">3.0</span><span class="sxs-lookup"><span data-stu-id="0c9d8-104">3.0</span></span>

#### <a name="reason-for-change"></a><span data-ttu-id="0c9d8-105">變更的原因</span><span class="sxs-lookup"><span data-stu-id="0c9d8-105">Reason for change</span></span>

<span data-ttu-id="0c9d8-106">API surface 一段時間的改善。</span><span class="sxs-lookup"><span data-stu-id="0c9d8-106">Improvement of API surface over time.</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="0c9d8-107">建議的動作</span><span class="sxs-lookup"><span data-stu-id="0c9d8-107">Recommended action</span></span>

<span data-ttu-id="0c9d8-108">以 .NET Core 2.2 為目標時，請遵循過時組建訊息中的指導方針，改為採用新的 Api。</span><span class="sxs-lookup"><span data-stu-id="0c9d8-108">While targeting .NET Core 2.2, follow the guidance in the obsolete build messages to adopt new APIs instead.</span></span>

#### <a name="category"></a><span data-ttu-id="0c9d8-109">類別</span><span class="sxs-lookup"><span data-stu-id="0c9d8-109">Category</span></span>

<span data-ttu-id="0c9d8-110">ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="0c9d8-110">ASP.NET Core</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="0c9d8-111">受影響的 API</span><span class="sxs-lookup"><span data-stu-id="0c9d8-111">Affected APIs</span></span>

<span data-ttu-id="0c9d8-112">下列類型和成員已標示為已過時，適用于 ASP.NET Core 2.1 和2.2：</span><span class="sxs-lookup"><span data-stu-id="0c9d8-112">The following types and members were marked as obsolete for ASP.NET Core 2.1 and 2.2:</span></span>

<span data-ttu-id="0c9d8-113">**型別**</span><span class="sxs-lookup"><span data-stu-id="0c9d8-113">**Types**</span></span>
...
<span data-ttu-id="0c9d8-114">**建構函式**</span><span class="sxs-lookup"><span data-stu-id="0c9d8-114">**Constructors**</span></span>
...
- [<span data-ttu-id="0c9d8-117">AspNetCore （） KnownRouteValueConstraint （）</span><span class="sxs-lookup"><span data-stu-id="0c9d8-117">Microsoft.AspNetCore.Mvc.Routing.KnownRouteValueConstraint()</span></span>](https://docs.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.routing.knownroutevalueconstraint.-ctor?view=aspnetcore-2.2#Microsoft_AspNetCore_Mvc_Routing_KnownRouteValueConstraint__ctor)
...
<span data-ttu-id="0c9d8-119">**屬性**</span><span class="sxs-lookup"><span data-stu-id="0c9d8-119">**Properties**</span></span>
...
<span data-ttu-id="0c9d8-120">**方法**</span><span class="sxs-lookup"><span data-stu-id="0c9d8-120">**Methods**</span></span>
