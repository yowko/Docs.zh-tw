...
---
### <a name="private-fields-added-to-built-in-struct-types"></a><span data-ttu-id="052b2-101">加入至內建結構類型的私用欄位</span><span class="sxs-lookup"><span data-stu-id="052b2-101">Private fields added to built-in struct types</span></span>

<span data-ttu-id="052b2-102">私用欄位已加入至[參考元件](../../../../docs/standard/assembly/reference-assemblies.md)中的[某些結構類型](#affected-apis)。</span><span class="sxs-lookup"><span data-stu-id="052b2-102">Private fields were added to [certain struct types](#affected-apis) in [reference assemblies](../../../../docs/standard/assembly/reference-assemblies.md).</span></span> <span data-ttu-id="052b2-103">因此，在 c # 中，這些結構類型一律必須使用 [new 運算子](../../../../docs/csharp/language-reference/operators/new-operator.md) 或 [default 常值](../../../../docs/csharp/language-reference/operators/default.md#default-literal)具現化。</span><span class="sxs-lookup"><span data-stu-id="052b2-103">As a result, in C#, those struct types must always be instantiated by using the [new operator](../../../../docs/csharp/language-reference/operators/new-operator.md) or [default literal](../../../../docs/csharp/language-reference/operators/default.md#default-literal).</span></span>

#### <a name="change-description"></a><span data-ttu-id="052b2-104">變更描述</span><span class="sxs-lookup"><span data-stu-id="052b2-104">Change description</span></span>

<span data-ttu-id="052b2-105">在 .NET Core 2.0 和舊版本中，某些提供的結構類型（例如）可以具現 <xref:System.ConsoleKeyInfo> 化，而不需要 `new` 在 c # 中使用運算子或 [預設常值](../../../../docs/csharp/language-reference/operators/default.md#default-literal) 。</span><span class="sxs-lookup"><span data-stu-id="052b2-105">In .NET Core 2.0 and previous versions, some provided struct types, for example, <xref:System.ConsoleKeyInfo>, could be instantiated without using the `new` operator or [default literal](../../../../docs/csharp/language-reference/operators/default.md#default-literal) in C#.</span></span> <span data-ttu-id="052b2-106">這是因為 c # 編譯器所使用的 [參考元件](../../../../docs/standard/assembly/reference-assemblies.md) 不包含結構的私用欄位。</span><span class="sxs-lookup"><span data-stu-id="052b2-106">This was because the [reference assemblies](../../../../docs/standard/assembly/reference-assemblies.md) used by the C# compiler didn't contain the private fields for the structs.</span></span> <span data-ttu-id="052b2-107">.NET 結構類型的所有私用欄位都會加入至 .NET Core 2.1 開始的參考元件中。</span><span class="sxs-lookup"><span data-stu-id="052b2-107">All private fields for .NET struct types are added to the reference assemblies starting in .NET Core 2.1.</span></span>

<span data-ttu-id="052b2-108">例如，下列 c # 程式碼會在 .NET Core 2.0 中編譯，但不會在 .NET Core 2.1 中進行編譯：</span><span class="sxs-lookup"><span data-stu-id="052b2-108">For example, the following C# code compiles in .NET Core 2.0, but not in .NET Core 2.1:</span></span>
...
<span data-ttu-id="052b2-109">在 .NET Core 2.1 中，先前的程式碼會導致下列編譯器錯誤： **CS0165-使用未指派的區域變數 ' key '**</span><span class="sxs-lookup"><span data-stu-id="052b2-109">In .NET Core 2.1, the previous code results in the following compiler error: **CS0165 - Use of unassigned local variable 'key'**</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="052b2-110">引進的版本</span><span class="sxs-lookup"><span data-stu-id="052b2-110">Version introduced</span></span>

<span data-ttu-id="052b2-111">2.1</span><span class="sxs-lookup"><span data-stu-id="052b2-111">2.1</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="052b2-112">建議的動作</span><span class="sxs-lookup"><span data-stu-id="052b2-112">Recommended action</span></span>

<span data-ttu-id="052b2-113">使用 `new` 運算子或 [預設常值](../../../../docs/csharp/language-reference/operators/default.md#default-literal)具現化結構類型。</span><span class="sxs-lookup"><span data-stu-id="052b2-113">Instantiate struct types by using the `new` operator or [default literal](../../../../docs/csharp/language-reference/operators/default.md#default-literal).</span></span>

<span data-ttu-id="052b2-114">例如：</span><span class="sxs-lookup"><span data-stu-id="052b2-114">For example:</span></span>
...
#### <a name="category"></a><span data-ttu-id="052b2-115">類別</span><span class="sxs-lookup"><span data-stu-id="052b2-115">Category</span></span>

<span data-ttu-id="052b2-116">Core .NET 程式庫</span><span class="sxs-lookup"><span data-stu-id="052b2-116">Core .NET libraries</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="052b2-117">受影響的 API</span><span class="sxs-lookup"><span data-stu-id="052b2-117">Affected APIs</span></span>
