...
歡迎使用 .NET API 瀏覽器 - 您可以在此一次購足來自 Microsoft 所有以 .NET 為基礎的 API。 在下面的方塊中輸入，便可開始搜尋 Managed API。 您可以在[我們的部落格文章中](https://aka.ms/apibrowser)進一步了解 API 瀏覽器。 如果有任何意見回饋，請使用[我們的 UserVoice 網站](https://aka.ms/apibrowserfeedback) \(英文\)。
