...
## <a name="simpleSelf"></a> <span data-ttu-id="490f4-162">沒有協力廠商相依性的自封式部署</span><span class="sxs-lookup"><span data-stu-id="490f4-162">Self-contained deployment without third-party dependencies</span></span>
