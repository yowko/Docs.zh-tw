...
## <a name="net-core-30-api-changes"></a>.NET 核心 3.0 API 更改
...
* [如何從牛頓軟.Json遷移到系統.Text.Json](../../standard/serialization/system-text-json-migrate-from-newtonsoft-how-to.md)
