---
title: ".NET Core 應用程式類型"
description: ".NET Core 應用程式類型"
...
# <a name="net-core-app-types"></a>.NET Core 應用程式類型

## <a name="content-moved"></a>內容已移至新位置！
本內容已合併並移至 [.NET Core Application Deployment](deploying/index.md) (.NET Core 應用程式部署) 主題。 
