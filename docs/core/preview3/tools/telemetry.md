...
# <a name="net-core-tools-telemetry-net-core-tools-rc4"></a>.NET Core 工具遙測 (.NET Core 工具 RC4)

> [!WARNING]
> 本主題適用於 .NET Core 工具 RC4。 .NET Core 工具 Preview 2 版本，請參閱 [.NET Core 工具遙測](../../tools/telemetry.md)主題。
