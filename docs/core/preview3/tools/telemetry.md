...
# <a name="net-core-tools-telemetry-tooling-preview-4"></a>.NET Core 工具遙測 (工具 Preview 4)

> [!WARNING]
> 此主題適用於 Visual Studio 2017 RC - .NET Core 工具 Preview 4。 .NET Core 工具 Preview 2 版本，請參閱 [.NET Core 工具遙測](../../tools/telemetry.md)主題。
