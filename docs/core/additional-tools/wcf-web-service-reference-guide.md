...
- [視覺化工作室 2017 版本 15.5](https://aka.ms/vsdownload?utm_source=mscom&utm_campaign=msdocs)或更高版本
...
- [開始使用 Windows 通信基礎應用程式](../../framework/wcf/getting-started-tutorial.md)
- [Visual Studio 中的 Windows 通信基礎服務和 WCF 資料服務](/visualstudio/data-tools/windows-communication-foundation-services-and-wcf-data-services-in-visual-studio)
- [WCF 支援 .NET 核心上的功能](https://github.com/dotnet/wcf/blob/master/release-notes/SupportedFeatures-v2.1.0.md)

## <a name="feedback--questions"></a>意見反應和問題

如果您有任何問題或回饋，請使用["報告問題"](/visualstudio/ide/how-to-report-a-problem-with-visual-studio)工具在[開發人員社區](https://developercommunity.visualstudio.com/)報告。
