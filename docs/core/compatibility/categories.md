...
---
# <a name="how-code-changes-can-affect-compatibility"></a>程式碼變更會如何影響相容性

*相容性*是指在實作之 .NET 版本上編譯或執行程式碼的能力，而該版本與原先開發程式碼時所使用的 .NET 版本不同。 [特定變更](index.md)可能會以六種不同的方式影響相容性：
