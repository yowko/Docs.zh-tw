...
---
# <a name="breaking-changes-for-migration-from-version-22-to-31"></a>從版本2.2 遷移至3.1 的重大變更

如果您要從2.2 版升級到 .NET Core 的3.1 版、ASP.NET Core 或 EF Core，本文所列的重大變更可能會影響您的應用程式。
