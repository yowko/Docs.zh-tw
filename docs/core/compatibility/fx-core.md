...
如需將 Windows Forms 應用程式從 .NET Framework 遷移至 .NET Core 3.0 或更新版本時的重大變更相關資訊，請參閱[Windows Forms （.NET Framework 至 .Net core）中的重大變更](../porting/winforms-breaking-changes.md)。
