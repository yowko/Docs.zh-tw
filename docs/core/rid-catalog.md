...
請務必注意，RID 是封閉的字串。 這表示它們必須完全相符，使用這些項目的作業才能正常運作。 舉例來說，讓我們來看看[基礎作業系統](https://elementary.io/)的案例，這個作業系統是 Ubuntu 14.04 的直接複製品。 雖然 .NET Core 和 CLI 可在該版本的 Ubuntu 上運作，但如果您不經任何修改就嘗試在基礎作業系統中加以使用，任何套件的還原作業將會失敗。 這是因為我們目前沒有任何 RID 指定將基礎作業系統做為平台。 
