...
1. 巡覽至 .NET Core 安裝資料夾。 根據預設，其位於 *%ProgramFiles%\dotnet\packs*。
   ...
   - 選擇要為其安裝 IntelliSense 的 SDK，然後巡覽至相關聯的路徑。 下列選項可供您選擇：
   ...
   - 巡覽至要為其安裝當地語系化 IntelliSense 的版本。 例如，*3.1.0*。
   - 開啟 *ref* 資料夾。
   - 開啟 Moniker 資料夾。 例如，*netcoreapp3.1*。
...
> [!IMPORTANT]
> 若要安裝、更新或修改 Visual Studio，您必須以具有系統管理權限的帳戶登入。 如需詳細資訊，請參閱[使用者權限和 Visual Studio](/visualstudio/ide/user-permissions-and-visual-studio)。
...
1. 在主功能表中，選取 [工具]   > [選項]  。 [選項] 對話方塊隨即開啟。

1. 在 [環境]  資料夾下方，選擇 [國際設定]  。
