...
---
# <a name="tutorial-publish-a-net-console-application-using-visual-studio-for-mac"></a>教學課程：使用 Visual Studio for Mac 發佈 .NET 主控台應用程式
...
1. 開啟您在 [使用 Visual Studio for Mac 建立 .net 主控台應用程式](with-visual-studio-mac.md)中建立的 HelloWorld 專案。
...
> [使用 Visual Studio for Mac 建立 .NET 程式庫](library-with-visual-studio-mac.md)
