...
| <span data-ttu-id="a29cd-212">:::no-loc(Blazor)::: 伺服器應用程式</span><span class="sxs-lookup"><span data-stu-id="a29cd-212">:::no-loc(Blazor)::: Server App</span></span>                            | [<span data-ttu-id="a29cd-213">blazorserver</span><span class="sxs-lookup"><span data-stu-id="a29cd-213">blazorserver</span></span>](#blazorserver)   | <span data-ttu-id="a29cd-214">[C#]</span><span class="sxs-lookup"><span data-stu-id="a29cd-214">[C#]</span></span>         | <span data-ttu-id="a29cd-215">Web:::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="a29cd-215">Web/:::no-loc(Blazor):::</span></span>                            | <span data-ttu-id="a29cd-216">3.0</span><span class="sxs-lookup"><span data-stu-id="a29cd-216">3.0</span></span>        |
| <span data-ttu-id="a29cd-217">:::no-loc(Blazor)::::::no-loc(WebAssembly):::應用程式</span><span class="sxs-lookup"><span data-stu-id="a29cd-217">:::no-loc(Blazor)::: :::no-loc(WebAssembly)::: App</span></span>                       | [<span data-ttu-id="a29cd-218">blazorwasm</span><span class="sxs-lookup"><span data-stu-id="a29cd-218">blazorwasm</span></span>](#blazorwasm)       | <span data-ttu-id="a29cd-219">[C#]</span><span class="sxs-lookup"><span data-stu-id="a29cd-219">[C#]</span></span>         | <span data-ttu-id="a29cd-220">Web:::no-loc(Blazor):::/:::no-loc(WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="a29cd-220">Web/:::no-loc(Blazor):::/:::no-loc(WebAssembly):::</span></span>                | <span data-ttu-id="a29cd-221">3.1.300</span><span class="sxs-lookup"><span data-stu-id="a29cd-221">3.1.300</span></span>    |
...
- **`-ho|--hosted`**
  ...
  <span data-ttu-id="a29cd-475">包含應用程式的 ASP.NET Core 主機 :::no-loc(Blazor)::: :::no-loc(WebAssembly)::: 。</span><span class="sxs-lookup"><span data-stu-id="a29cd-475">Includes an ASP.NET Core host for the :::no-loc(Blazor)::: :::no-loc(WebAssembly)::: app.</span></span>
