...
| <span data-ttu-id="9ae63-212">Blazor 伺服器應用程式</span><span class="sxs-lookup"><span data-stu-id="9ae63-212">Blazor Server App</span></span>                            | [<span data-ttu-id="9ae63-213">blazorserver</span><span class="sxs-lookup"><span data-stu-id="9ae63-213">blazorserver</span></span>](#blazorserver)   | <span data-ttu-id="9ae63-214">[C#]</span><span class="sxs-lookup"><span data-stu-id="9ae63-214">[C#]</span></span>         | <span data-ttu-id="9ae63-215">WebBlazor</span><span class="sxs-lookup"><span data-stu-id="9ae63-215">Web/Blazor</span></span>                            | <span data-ttu-id="9ae63-216">3.0</span><span class="sxs-lookup"><span data-stu-id="9ae63-216">3.0</span></span>        |
| <span data-ttu-id="9ae63-217">BlazorWebAssembly應用程式</span><span class="sxs-lookup"><span data-stu-id="9ae63-217">Blazor WebAssembly App</span></span>                       | [<span data-ttu-id="9ae63-218">blazorwasm</span><span class="sxs-lookup"><span data-stu-id="9ae63-218">blazorwasm</span></span>](#blazorwasm)       | <span data-ttu-id="9ae63-219">[C#]</span><span class="sxs-lookup"><span data-stu-id="9ae63-219">[C#]</span></span>         | <span data-ttu-id="9ae63-220">WebBlazor/WebAssembly</span><span class="sxs-lookup"><span data-stu-id="9ae63-220">Web/Blazor/WebAssembly</span></span>                | <span data-ttu-id="9ae63-221">3.1.300</span><span class="sxs-lookup"><span data-stu-id="9ae63-221">3.1.300</span></span>    |
...
- **`-ho|--hosted`**
  ...
  <span data-ttu-id="9ae63-477">包含應用程式的 ASP.NET Core 主機 Blazor WebAssembly 。</span><span class="sxs-lookup"><span data-stu-id="9ae63-477">Includes an ASP.NET Core host for the Blazor WebAssembly app.</span></span>
