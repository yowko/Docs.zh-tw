...
---
# <a name="use-generalized-additive-models-and-shape-functions-for-model-interpretability-in-mlnet"></a>使用通用添加劑模型和元件函數實現模型可解釋性ML.NET
...
有關如何訓練 GAM 模型並檢查和解釋結果的範例,請參閱[二進位分類培訓師範例](https://github.com/dotnet/machinelearning/blob/master/docs/samples/Microsoft.ML.Samples/Dynamic/Trainers/BinaryClassification/Gam.cs)。
