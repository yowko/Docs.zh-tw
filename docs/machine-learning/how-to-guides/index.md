...
* [從檔和 SQL 資料庫載入數據。](load-data-ml-net.md)

### <a name="prepare-the-data"></a>準備資料

* [使用正規器來預先處理定型資料，以用於資料處理。](prepare-data-ml-net.md)
...
* [載入經過培訓的機器學習模型。](save-load-machine-learning-models-ml-net.md)

* [使用經過訓練的模型進行預測。](machine-learning-model-predictions-ml-net.md)

## <a name="probabilistic-infernet"></a>概率 (Infer.NET)

* [創建遊戲匹配清單應用與Infer.NET和概率程式設計。](matchup-app-infer-net.md)
