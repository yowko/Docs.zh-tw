...
2. 請執行下列工作來壓縮已發佈的應用程式檔，讓您可以輕鬆地將它們上傳至您的 HDInsight 叢集。

   **在 Windows 上：**

   流覽至 *mySparkApp/bin/Release/netcoreapp 3.0/ubuntu. 16.04-x64*。 然後，在 [ **發行** 資料夾] 上按一下滑鼠右鍵，然後選取 [ **傳送至 > 壓縮 (壓縮) 資料夾**。 將新資料夾命名為 **publish.zip**。
