...
- [使用模式比對來避免 ' a ' 檢查，後面接著 cast (IDE0020) ](../fundamentals/code-analysis/style-rules/ide0020.md) -埠剩餘的 c # 程式碼樣式規則新增至新格式
...
- [使用聯合運算式 (IDE0029) ](../fundamentals/code-analysis/style-rules/ide0029.md) -重構一些程式碼樣式規則來分隔檔
...
- [使用複合指派 (IDE0054) ](../fundamentals/code-analysis/style-rules/ide0054.md) -重構一些程式碼樣式規則來分隔檔
