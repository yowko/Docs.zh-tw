...
- <span data-ttu-id="34c91-109">[使用資料](../architecture/blazor-for-web-forms-developers/data.md)  -  Blazor電子書-資料章節</span><span class="sxs-lookup"><span data-stu-id="34c91-109">[Work with data](../architecture/blazor-for-web-forms-developers/data.md) - Blazor eBook - Data chapter</span></span>
