...
* <span data-ttu-id="3345a-136">要將 UTC 轉換為的時區。</span><span class="sxs-lookup"><span data-stu-id="3345a-136">The time zone to convert the UTC to.</span></span>
