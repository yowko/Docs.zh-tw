...
在 .NET Framework 2.0 中首次引進，**泛型**基本上是「程式碼範本」，可讓開發人員定義[型別安全](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/hbzz1a9a(v=vs.100))資料結構，而不需要認可至實際資料類型。 <xref:System.Collections.Generic.List%601>例如，是一個[泛型集合](xref:System.Collections.Generic)，可以聲明和用於任何類型的 ，如`List<int>`。 `List<string>` `List<Person>`
