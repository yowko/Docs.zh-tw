---
title: "XML 文件和資料 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
-   <xref:System.Xml.XmlDocument?displayProperty=fullName> 類別實作 [W3C 文件物件模型 \(DOM\) 層級 1 核心](http://www.w3.org/TR/REC-DOM-Level-1/)和 [DOM 層級 2 核心](http://www.w3.org/TR/DOM-Level-2-Core/)建議事項。  
  
-   <xref:System.Xml.XmlReader?displayProperty=fullName> 和 <xref:System.Xml.XmlWriter?displayProperty=fullName> 類別支援 [W3C XML 1.0](http://www.w3.org/TR/2006/REC-xml-20060816/) 和 [XML 中的命名空間](http://www.w3.org/TR/REC-xml-names/)建議事項。  
  
-   <xref:System.Xml.Schema.XmlSchemaSet?displayProperty=fullName> 類別中的結構描述支援 [W3C XML 結構描述第 1 部分：結構](http://www.w3.org/TR/xmlschema-1/)和 [XML 結構描述第 2 部分：資料類型](http://www.w3.org/TR/xmlschema-2/)建議事項。  
...
-   **產能。** [LINQ to XML](../../../../ocs/visual-basic/programming-guide/concepts/linq/linq-to-xml.md) 可輕鬆地透過 XML 編寫程式，並提供類似於 SQL 的查詢體驗。  
...
## 在本節中  
 ...
 討論用來處理記憶體中 XML 資料的三個模型。  [LINQ to XML](../../../../ocs/visual-basic/programming-guide/concepts/linq/linq-to-xml.md)、<xref:System.Xml.XmlDocument> 類別 \(根據 W3C 文件物件模型\) 和 <xref:System.Xml.XPath.XPathDocument> 類別 \(根據 XPath 資料模型\)。  
