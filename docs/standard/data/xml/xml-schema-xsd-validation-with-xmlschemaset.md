...
> [!NOTE]
>  <xref:System.Xml.Schema> 命名空間包含的擴充方法可在使用 [LINQ to XML](https://msdn.microsoft.com/library/f0fe21e9-ee43-4a55-b91a-0800e5782c13) 時，輕鬆地針對 XSD 檔案驗證 XML 樹狀結構。 如需使用 LINQ to XML 驗證 XML 文件的詳細資訊，請參閱[如何：使用 XSD 進行驗證](https://msdn.microsoft.com/library/481a97fa-6e96-46f2-8c9a-415555fac33b)。  
