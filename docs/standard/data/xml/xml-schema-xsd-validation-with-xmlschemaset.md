...
> [!NOTE]
>  <xref:System.Xml.Schema>命名空間包含可簡化 XML 樹狀結構根據 XSD 檔案時使用的驗證延伸模組方法[LINQ to XML](http://msdn.microsoft.com/library/f0fe21e9-ee43-4a55-b91a-0800e5782c13)。 如需驗證 XML 文件與 LINQ to XML 的詳細資訊，請參閱[How to： 使用 XSD 驗證](http://msdn.microsoft.com/library/481a97fa-6e96-46f2-8c9a-415555fac33b)。  
