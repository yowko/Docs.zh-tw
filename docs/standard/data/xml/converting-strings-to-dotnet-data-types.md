---
title: "將字串轉換成 .NET Framework 資料型別 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
若要將一個字串轉換成 .NET Framework 資料型別，請使用符合應用程式需求的 **XmlConvert** 方法。  如需所有可用於 **XmlConvert** 類別的轉換方法清單，請參閱 [XmlConvert 成員](frlrfSystemXmlXmlConvertMembersTopic)。  
