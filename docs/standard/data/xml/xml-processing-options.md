...
|<xref:System.Xml.Xsl.XslCompiledTransform>|記憶體內|-   提供使用 XSL 轉換來轉換 XML 資料的選項。<br />-    [XSLT 編譯器 (xsltc.exe)](../../../../docs/standard/data/xml/xslt-compiler-xsltc-exe.md) 可讓您在應用程式中參考先行編譯的轉換。|  
