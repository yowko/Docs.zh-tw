---
title: "使用 XPathNavigator 存取 XML 資料 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
## 本章節內容  
 ...
 說明如何使用 <xref:System.Xml.XPath.XPathNavigator> 類別，在 <xref:System.Xml.XPath.XPathDocument> 或 <xref:System.Xml.XmlDocument> 物件中存取強型別 XML 資料。  
