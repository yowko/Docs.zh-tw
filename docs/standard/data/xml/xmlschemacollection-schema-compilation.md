---
title: "XmlSchemaCollection 結構描述編譯 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
---
# XmlSchemaCollection 結構描述編譯
**XmlSchemaCollection** 是一種快取區 \(Cache\) 或程式庫，您可在此儲存和驗證 XML 資料精簡 \(XDR\) 和 XML 結構描述定義語言 \(XSD\) 結構描述。  **XmlSchemaCollection** 會藉由在記憶體中快取結構描述，而不是從檔案或 URL 存取它們的方式來提升效能。  
