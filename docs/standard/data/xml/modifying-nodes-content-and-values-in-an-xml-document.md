---
title: "修改 XML 文件中的節點、內容和值 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
-   使用 <xref:System.Xml.XmlCharacterData.AppendData%2A>、<xref:System.Xml.XmlCharacterData.InsertData%2A> 或 <xref:System.Xml.XmlCharacterData.ReplaceData%2A> 方法，將其他字元加入繼承自 <xref:System.Xml.XmlCharacterData> 類別的節點。  
  
-   使用繼承自 <xref:System.Xml.XmlCharacterData> 之節點型別上的 <xref:System.Xml.XmlCharacterData.DeleteData%2A> 方法，藉由移除某範圍的字元來修改內容。  
