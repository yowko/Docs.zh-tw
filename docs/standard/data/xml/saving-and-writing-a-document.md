...
```  
 ...
 <xref:System.Xml.XmlDeclaration>針對<xref:System.Xml.XmlNode.OuterXml%2A>、 <xref:System.Xml.XmlDeclaration.WriteTo%2A>和<xref:System.Xml.XmlNode.InnerXml%2A>的成員，如果未設定<xref:System.Xml.XmlDeclaration.Encoding%2A>屬性，則不會寫出編碼。否則，在 XML 宣告中寫出的編碼與在<xref:System.Xml.XmlDeclaration.Encoding%2A>屬性中找到的編碼相同。  
