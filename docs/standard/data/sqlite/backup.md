...
目前，`BackupDatabase` 會儘快備份資料庫，並封鎖其他連接，使其無法寫入至資料庫。 問題[#13834](https://github.com/dotnet/efcore/issues/13834)會提供替代的 API，以在背景中備份資料庫，並允許其他連接中斷備份並寫入資料庫。 如果您有興趣，請提供有關問題的意見反應。
