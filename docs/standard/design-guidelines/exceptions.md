...
例外狀況處理有許多優於傳回值為基礎的錯誤報告。 良好的架構設計，可協助應用程式開發人員了解例外狀況的優點。 本節討論例外狀況的優點，並提供有效地使用這些指導方針。  
  
## <a name="in-this-section"></a>本節內容  
 [擲回例外狀況](../../../docs/standard/design-guidelines/exception-throwing.md)  
 [使用標準例外狀況類型](../../../docs/standard/design-guidelines/using-standard-exception-types.md)  
 [例外狀況和效能](../../../docs/standard/design-guidelines/exceptions-and-performance.md)  
