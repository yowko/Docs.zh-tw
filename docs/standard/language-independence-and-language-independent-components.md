...
|<xref:System.UInt64>|64 位元不帶正負號的整數|<xref:System.Int64> (可能會溢位)、<xref:System.Numerics.BigInteger> 或 <xref:System.Double>|  
