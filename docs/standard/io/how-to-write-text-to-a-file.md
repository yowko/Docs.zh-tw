...
---
# <a name="how-to-write-text-to-a-file"></a>如何：將文本寫入檔
...
## <a name="example-synchronously-write-text-with-streamwriter"></a>示例：使用流編寫器同步寫入文本
...
## <a name="example-asynchronously-write-text-with-streamwriter"></a>示例：使用流編寫器非同步寫入文本
...
## <a name="example-write-and-append-text-with-the-file-class"></a>示例：使用 File 類編寫和追加文本
