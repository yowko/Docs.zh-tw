...
![當執行緒觸發記憶體回收時](../../../docs/standard/garbage-collection/media/gc-triggered.png "GC_Triggered") 觸發記憶體回收的執行緒
...
![伺服器記憶體回收執行緒](../../../docs/standard/garbage-collection/media/gc-server.png "GC_Server") 伺服器記憶體回收
...
![並行記憶體回收執行緒](../../../docs/standard/garbage-collection/media/gc-concurrent.png "GC_Concurrent") 並行記憶體回收
