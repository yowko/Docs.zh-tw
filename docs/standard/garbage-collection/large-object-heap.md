...
![顯示添加效能計數器的螢幕截圖。](media/large-object-heap/add-performance-counter.png)
圖 4：層代 2 GC 之後的 LOH
...
僅當調用分配大小大於 8MB （0x80000）的[VirtualAlloc](/windows/desktop/api/memoryapi/nf-memoryapi-virtualalloc)時，此命令才會進入調試器並顯示呼叫堆疊。
