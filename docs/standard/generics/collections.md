...
## <a name="systemcollectionsobjectmodel"></a>{2&gt;System.Collections.ObjectModel&lt;2}
...
> [!NOTE]
> 在 C# 和 Visual Basic 中，不需要明確使用 <xref:System.Nullable%601>，因為語言已具有可為 Null 型別的語法。 請參閱[可為 nullC#的實數值型別（參考）](../../csharp/language-reference/builtin-types/nullable-value-types.md)和[可為 null 的實數值型別（Visual Basic）](../../visual-basic/programming-guide/language-features/data-types/nullable-value-types.md)
