...
<span data-ttu-id="5f0be-115">下表說明版本與文化特性屬性。</span><span class="sxs-lookup"><span data-stu-id="5f0be-115">The following table describes the version and culture attributes.</span></span>
