...
您可以使用 Visual Studio 或命令列工具強式命名組件。 有關詳細資訊，請參閱[：使用強式名稱](sign-strong-name.md)或[Sn.exe（強式名稱工具）](../../framework/tools/sn-exe-strong-name-tool.md)對程式集進行簽名。
...
當您參考強式名稱的組件時，您會希望取得某些優點，例如版本控制和命名保護。 在 .NET 框架中，強命名程式集可以安裝在全域組件快取中，這是啟用某些方案所必需的。
...
- 您希望通過應用發行者策略來集中應用的服務，這意味著程式集必須安裝在全域組件快取中。

如果您是開源開發人員，並且希望獲得強命名程式集的標識優勢，請考慮將與程式集關聯的私密金鑰簽入到原始程式碼管理系統。

## <a name="see-also"></a>另請參閱

- [全域組件快取](../../framework/app-domains/gac.md)
- [如何：使用強式名稱對程式集進行簽名](sign-strong-name.md)
