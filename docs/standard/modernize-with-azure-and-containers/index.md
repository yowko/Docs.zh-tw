...
| **雲端基礎結構就緒** <br /> *隨即轉移* | **雲端最佳化** <br /> *現代化* | **雲端原生** <br /> *現代化、 重建和重寫* |
|---|---|---|
| **應用程式的計算目標** |
...
- **容器化 Docker 應用程式生命週期，Microsoft 平台和工具**（可下載的電子書）： [*https://aka.ms/dockerlifecycleebook*](https://aka.ms/dockerlifecycleebook)
