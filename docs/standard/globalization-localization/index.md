...
ms.topic: "article"
helpviewer_keywords: 
  - "應用程式開發 [.NET Framework], 全球化"
  - "全域應用程式"
  - "全球化 [.NET Framework], 編碼"
  - "國際應用程式 [.NET Framework]"
  - "國際化"
  - "多語文應用程式開發"
  - "世界性的應用程式"
...
開發[世界通用的應用程式](http://msdn.microsoft.com/goglobal/bb978433.aspx) \(英文\)，包括可以當地語系化為一種或多種語言的應用程式，這項開發工作包含下列三個步驟：全球化、當地語系化能力檢閱及當地語系化。  
...
-   可產生更穩定且較少 Bug 的當地語系化應用程式。  
 ...
 如需詳細資訊，請參閱[全球化開發人員中心](http://go.microsoft.com/fwlink/?LinkId=235015) \(英文\)。  
...
## 在本節中  
 ...
 [開發世界性的應用程式的最佳作法](../../../docs/standard/globalization-localization/best-practices-for-developing-world-ready-apps.md)  
