...
ms.locfileid: "80523902"
---
# <a name="net-guide"></a>.NET 指南

.NET 指南提供有關 .NET 的資訊。 根據您的熟悉 .NET,您可能希望瀏覽本指南的不同部分和其他指南,如[.NET Core](../core/index.yml)或[.NET 框架](../framework/index.yml)。
...
## <a name="port-net-framework-code-to-net-standard-or-net-core"></a>連接埠 .NET 框架代碼到 .NET 標準或 .NET 核心

要將應用程式、服務、元件或 NuGet 包移植到 .NET 標準或 .NET 核心,請參閱[從 .NET 框架的埠到 .NET Core。](../core/porting/index.md) 共用 .NET 標準和 .NET Core 的工具,因此內容與移植到兩個框架相關。
