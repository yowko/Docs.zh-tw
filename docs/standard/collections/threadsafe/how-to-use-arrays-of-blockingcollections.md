...
下列範例示範如何搭配使用 [System.Collections.Concurrent.BlockingCollection&lt;T&gt;](https://docs.microsoft.com/dotnet/core/api/System.Collections.Concurrent.BlockingCollection-1) 物件的陣列與靜態方法 (例如 `TryAddToAny` 和 `TryTakeFromAny`)，來實作元件之間的快速且彈性資料傳輸。 
