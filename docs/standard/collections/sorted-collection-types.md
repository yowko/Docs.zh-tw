...
-   項目會依 <xref:System.Collections.IComparer?displayProperty=fullName> 實作排序 (非泛型 <xref:System.Collections.SortedList>) 或依 <xref:System.Collections.Generic.IComparer%601?displayProperty=fullName> 實作排序 (兩個泛型類別)。  
