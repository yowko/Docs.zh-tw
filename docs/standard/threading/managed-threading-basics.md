...
> [!NOTE]
> 在 .NET Framework 4 中，工作平行程式庫和 PLINQ 提供適用於多執行緒程式中工作和資料平行處理原則的 API。 有關詳細資訊，請參閱[並行程式設計](../../../docs/standard/parallel-programming/index.md)。  
...
## <a name="in-this-section"></a>本節內容
 ...
 [同步資料，實現多執行緒](../../../docs/standard/threading/synchronizing-data-for-multithreading.md)  
...
## <a name="related-sections"></a>相關章節
 ...
 [託管執行緒最佳實踐](../../../docs/standard/threading/managed-threading-best-practices.md)  
