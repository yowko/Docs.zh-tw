...
## <a name="how-to-create-and-start-a-new-thread"></a>作法：建立及啟動新的執行緒
...
## <a name="how-to-stop-a-thread"></a>作法：停止執行緒
...
## <a name="how-to-pause-or-interrupt-a-thread"></a>作法：暫停或插斷執行緒
