...
---
# <a name="how-to-serialize-using-datacontractserializer-linq-to-xml"></a>如何使用 DataContractSerializer (LINQ to XML) 進行序列化

本文顯示使用 <xref:System.Runtime.Serialization.DataContractSerializer> c # 和 Visual Basic 序列化和還原序列化的範例。

## <a name="example-create-objects-that-contain-xelement-objects-then-serialize-and-deserialize-them"></a>範例：建立包含物件的物件 `XElement` ，然後將它們序列化和還原序列化
