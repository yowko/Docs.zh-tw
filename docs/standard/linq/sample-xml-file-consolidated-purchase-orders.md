...
---
# <a name="sample-xml-file-consolidated-purchase-orders-linq-to-xml"></a>範例 XML 檔：合併的採購訂單 (LINQ to XML) 

下列 XML 檔案用於 LINQ to XML 檔的各種範例中。 此檔案是一組不同於多個公司之組織結構的採購訂單。 每個公司的採購訂單都位於個別的命名空間中。
