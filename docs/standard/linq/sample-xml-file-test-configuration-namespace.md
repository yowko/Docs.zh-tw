...
---
# <a name="sample-xml-file-test-configuration-in-a-namespace-linq-to-xml"></a>範例 XML 檔：命名空間中的測試設定 (LINQ to XML) 

下列 XML 檔案用於 LINQ to XML 檔的各種範例中。 這是測試組態檔案。 XML 位於命名空間中。
