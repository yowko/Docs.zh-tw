...
---
# <a name="sample-xml-file-multiple-purchase-orders-in-a-namespace-linq-to-xml"></a>範例 XML 檔：命名空間中的多個採購訂單 (LINQ to XML) 

下列 XML 檔案用於 LINQ to XML 檔的各種範例中。 這個檔案包含數個採購訂單。 XML 位於命名空間中。
