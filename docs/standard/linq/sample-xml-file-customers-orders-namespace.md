---
title: 範例 XML 檔：命名空間中的客戶和訂單-LINQ to XML
description: 這個 XML 檔案（用於範例中）在命名空間中有關于客戶和訂單的資料。
ms.date: 07/20/2015
...
ms.locfileid: "89552688"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a><span data-ttu-id="af605-103">範例 XML 檔：命名空間中的客戶和訂單 (LINQ to XML) </span><span class="sxs-lookup"><span data-stu-id="af605-103">Sample XML file: Customers and orders in a namespace (LINQ to XML)</span></span>

<span data-ttu-id="af605-104">下列 XML 檔案用於 LINQ to XML 檔的各種範例中。</span><span class="sxs-lookup"><span data-stu-id="af605-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="af605-105">這個檔案包含客戶和訂單。</span><span class="sxs-lookup"><span data-stu-id="af605-105">This file contains customers and orders.</span></span> <span data-ttu-id="af605-106">XML 位於命名空間中。</span><span class="sxs-lookup"><span data-stu-id="af605-106">The XML is in a namespace.</span></span>

## <a name="customersordersinnamespacexml"></a><span data-ttu-id="af605-107">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="af605-107">CustomersOrdersInNamespace.xml</span></span>
