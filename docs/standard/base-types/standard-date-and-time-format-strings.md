...
標準日期和時間格式字串會使用單一字元做為格式規範，以定義或值的文字表示 <xref:System.DateTime> <xref:System.DateTimeOffset> 。 任何包含一個以上字元（包括空白字元）的日期和時間格式字串都會被解釋為 [自訂日期和時間格式字串](custom-date-and-time-format-strings.md)。 標準或自訂格式字串有兩種使用方式：
...
> [!TIP]
> 您可以下載 **格式化公用** 程式，這是一個 .net Windows Forms 應用程式，可讓您將格式字串套用至數值或日期和時間值，並顯示結果字串。 提供 [C#](/samples/dotnet/samples/windowsforms-formatting-utility-cs) 和 [Visual Basic](/samples/dotnet/samples/windowsforms-formatting-utility-vb) 的原始程式碼。

[!INCLUDE[C# interactive-note](~/includes/csharp-interactive-with-utc-partial-note.md)]

## <a name="table-of-format-specifiers"></a>格式規範的表格

<a name="table"></a>下表描述標準日期和時間的格式規範。 除非特別註明，否則特定標準日期和時間格式規範會產生相同的字串表示，無論是與 <xref:System.DateTime> 或 <xref:System.DateTimeOffset> 值搭配使用。 如需使用標準日期和時間格式字串的詳細資訊，請參閱 [主控台設定](#control-panel-settings) 和 [DateTimeFormatInfo 屬性](#datetimeformatinfo-properties) 。
...
|"M"、"m"|月/日模式。<br /><br /> 詳細資訊： [月份 ( "m"、"m" ) 格式規範](#MonthDay)。|2009-06-15T13:45:30 -> June 15 (en-US)<br /><br /> 2009-06-15T13:45:30 -> 15 juni (da-DK)<br /><br /> 2009-06-15T13:45:30 -> 15 Juni (id-ID)|
...
|"s"|可排序日期/時間模式。<br /><br /> 詳細資訊：可 [排序的 ( "s" ) 格式規範](#Sortable)。|2009-06-15T13:45:30 (DateTimeKind.Local) -> 2009-06-15T13:45:30<br /><br /> 2009-06-15T13:45:30 (DateTimeKind.Utc) -> 2009-06-15T13:45:30|
...
|"T"|完整時間模式。<br /><br /> 詳細資訊： [long time ( "T" ) 格式規範](#LongTime)。|2009-06-15T13:45:30 -> 1:45:30 PM (en-US)<br /><br /> 2009-06-15T13:45:30 -> 13:45:30 (hr-HR)<br /><br /> 2009-06-15T13:45:30 -> 01:45:30 م (ar-EG)|
|"u"|國際可排序日期/時間模式。<br /><br /> 詳細資訊： [通用可排序 ( "u" ) 格式規範](#UniversalSortable)。|使用 <xref:System.DateTime> 值：2009-06-15T13:45:30 -> 2009-06-15 13:45:30Z<br /><br /> 使用 <xref:System.DateTimeOffset> 值：2009-06-15T13:45:30 -> 2009-06-15 20:45:30Z|
|"U"|國際完整日期/時間模式。<br /><br /> 詳細資訊： [通用 full ( "U" ) 格式規範](#UniversalFull)。|2009-06-15T13:45:30 -> Monday, June 15, 2009 8:45:30 PM (en-US)<br /><br /> 2009-06-15T13:45:30 -> den 15 juni 2009 20:45:30 (sv-SE)<br /><br /> 2009-06-15T13:45:30 -> Δευτέρα, 15 Ιουνίου 2009 8:45:30 μμ (el-GR)|
|"Y", "y"|年月模式。<br /><br /> 詳細資訊： [year 月份 ( "Y" ) 格式規範](#YearMonth)。|2009-06-15T13：45： 30-> 2009 年6月 (en-us) <br /><br /> 2009-06-15T13:45:30 -> juni 2009 (da-DK)<br /><br /> 2009-06-15T13:45:30 -> Juni 2009 (id-ID)|
...
|----------------------------|----------------------------------------------------------|--------------------------|
|"O" 或 "o"|無|yyyy'-'mm'-'dd't'hh-YYYY'-'MM'-'DD'T'HH-Yyyy'-'mm'-'dd't'hh '： ' MM '： ' ss '。fffffffK|
...
- [簡短日期 ( "d" ) 格式規範](#the-short-date-d-format-specifier)
- [完整日期 ( "D" ) 格式規範](#the-long-date-d-format-specifier)
...
- [完整日期簡短時間 ( "f" ) 格式規範](#the-full-date-short-time-f-format-specifier)
- [完整日期長時間 ( "F" ) 格式規範](#the-full-date-long-time-f-format-specifier)
- [一般日期簡短時間 ( "g" ) 格式規範](#the-general-date-short-time-g-format-specifier)
- [一般日期完整時間 ( "G" ) 格式規範](#the-general-date-long-time-g-format-specifier)
- [來回行程 ( "O"、"o" ) 格式規範](#the-round-trip-o-o-format-specifier)
- [RFC1123 ( "R"、"r" ) 格式規範](#the-rfc1123-r-r-format-specifier)
- [可排序的 ( "s" ) 格式規範](#the-sortable-s-format-specifier)
- [可排序的通用 ( "u" ) 格式規範](#the-universal-sortable-u-format-specifier)
- [通用 full ( "U" ) 格式規範](#the-universal-full-u-format-specifier)
...
下列範例使用 "o" 格式規範，在 <xref:System.DateTime> 美國太平洋時區的系統上顯示一連串的值和 <xref:System.DateTimeOffset> 值。
...
- [簡短時間 ( "t" ) 格式規範](#the-short-time-t-format-specifier)
- [Long time ( "T" ) 格式規範](#the-long-time-t-format-specifier)
...
- [月份 ( "M"、"m" ) 格式規範](#the-month-m-m-format-specifier)
- [年月 ( "Y"、"y" ) 格式規範](#the-year-month-y-y-format-specifier)
...
在 Windows 中，主控台中 [ **地區及語言選項** ] 專案的設定會影響格式化作業所產生的結果字串。 這些設定是用來初始化與目前執行緒文化特性相關的 <xref:System.Globalization.DateTimeFormatInfo> 物件，該物件會提供用來管理格式的值。 使用不同設定的電腦會產生不同的結果字串。
