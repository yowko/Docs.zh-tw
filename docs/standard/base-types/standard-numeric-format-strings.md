---
title: 標準數值格式字串
description: 在本文中，您將瞭解如何使用標準數值格式字串，將常見的數數值型別格式化為 .NET 中的文字表示。
ms.date: 06/10/2018
...
下列範例會 <xref:System.Double> 使用貨幣格式規範來格式化值：
...
下列範例會 <xref:System.Double> 使用指數格式規範來格式化值：
