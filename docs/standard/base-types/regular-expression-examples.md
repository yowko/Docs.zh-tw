...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：從字串中剝離無效字元](../../../docs/standard/base-types/how-to-strip-invalid-characters-from-a-string.md)  
 提供從字串中刪除無效非英數字元的範例。  
...
## <a name="related-sections"></a>相關章節  
 ...
 [正則運算式物件模型](../../../docs/standard/base-types/the-regular-expression-object-model.md)  
 說明包含在 `System.Text.RegularExpression` 命名空間的規則運算式類別，並提供其使用範例。  
  
 [正則運算式行為的詳細資訊](../../../docs/standard/base-types/details-of-regular-expression-behavior.md)  
