...
## <a name="see-also"></a>請參閱
 ...
 [格式化類型](../../../docs/standard/base-types/formatting-types.md) [標準日期和時間格式字串](../../../docs/standard/base-types/standard-date-and-time-format-strings.md) [範例：.NET Framework 4 Formatting Utility](https://code.msdn.microsoft.com/NET-Framework-4-Formatting-9c4dae8d)
