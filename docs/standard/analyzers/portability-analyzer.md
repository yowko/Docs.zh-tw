...
將專案轉換成目標平臺（例如 .NET Core）之後，您可以使用以 Roslyn 為基礎的 [API 分析器工具] （[ https://docs.microsoft.com/en-us/dotnet/standard/analyzers/api-analyzer](api-analyzer.md)來識別引發 PlatformNotSupportedException 的 api，以及一些其他相容性問題。
