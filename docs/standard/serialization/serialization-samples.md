...
## <a name="in-this-section"></a>本節內容  
 ...
 [版本相容的序列化技術範例](../../../docs/standard/serialization/version-tolerant-serialization-technology-sample.md)  
 示範.NET 序列化的版本相容功能。  
 ...
 [以 XmlSerializer 自訂序列化順序](../../../docs/standard/serialization/custom-serialization-order-with-xmlserializer.md)  
 顯示在 XML 序列化中，如何控制已序列化及已還原序列化項目的順序。  
