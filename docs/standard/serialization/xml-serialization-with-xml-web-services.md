...
description: 瞭解 xml 序列化做為 XML Web Service 架構中使用的傳輸機制。 XML 序列化是由 XmlSerializer 類別執行。
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
