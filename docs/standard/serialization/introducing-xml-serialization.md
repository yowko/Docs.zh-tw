...
- **DataSet** 物件。
 ...
 如需序列化或還原序列化物件的詳細資訊，請參閱[How to:將物件序列化](how-to-serialize-an-object.md)和[How to:將物件還原序列化](how-to-deserialize-an-object.md)。
...
- 類別必須具有要序列化的無參數建構函式**XmlSerializer**。
