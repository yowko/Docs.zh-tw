...
Common language runtime 和.NET 提供許多實用的類別和服務，可讓開發人員輕鬆地撰寫安全程式碼，並讓系統管理員自訂權限授與程式碼，使其可以存取受保護的資源。 此外，執行階段和.NET 提供實用的類別和服務，方便使用的密碼編譯和以角色為基礎的安全性。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 提供.NET 所提供的密碼編譯服務的概觀。 本節適用於開發人員。  
