...
### <a name="view-model"></a>View Model
 ...
 An implementation of the <xref:System.Windows.Input.ICommand> interface is frequently used with the MVVM pattern. 下列範例會示範 <xref:System.Windows.Input.ICommand> 介面的實作。
