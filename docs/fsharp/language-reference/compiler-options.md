...
|編譯器選項|說明|
|---------------|-----------|
|**-a * * *&lt;輸出檔名&gt;**|產生的程式庫，並指定其檔案名稱。 這個選項是一種的簡短形式**-目標： 媒體櫃 *&lt;filename&gt;**。|
|**-baseaddress:&lt;字串&gt;**|指定要建置程式庫的基底位址。<br /><br />這個編譯器選項相當於相同名稱的 C# 編譯器選項。 如需詳細資訊，請參閱[&#47; baseaddress &#40;& #35。編譯器選項 &#41;](https://msdn.microsoft.com/library/2fdbz5xd.aspx).|
...
|**-檢查**[**+**&#124;**-**]|啟用或停用產生溢位檢查。<br /><br />這個編譯器選項相當於相同名稱的 C# 編譯器選項。 如需詳細資訊，請參閱[（& s) #47; 檢查 &#40;& #35。編譯器選項 &#41;](https://msdn.microsoft.com/library/h25wtyxf.aspx).|
|**-偵錯**[**+**&#124;**-**]<br /><br />**-g**[**+**&#124;**-**]<br /><br />**-偵錯**: [**完整**&#124;**pdbonly**]<br /><br />**-g:** [**完整**&#124;**pdbonly**]|啟用或停用偵錯資訊的產生，或指定產生的偵錯資訊類型。 預設值是完整的這允許附加至正在執行的程式。 選擇**pdbonly**取得限制儲存在 pdb （程式資料庫） 檔案中的偵錯資訊。<br /><br />相當於 C# 編譯器選項的名稱相同。 如需詳細資訊，請參閱<br /><br />[&#47; 偵錯 &#40;& #35。編譯器選項 &#41;](https://msdn.microsoft.com/library/8cw0bt21.aspx).|
|**-定義：&lt;字串&gt;**<br /><br />**-d:&lt;字串&gt;**|定義條件式編譯符號，以供使用。|
|**-決定性**[**+**&#124;**-**]|產生的具決定性的組件 （包括模組版本 GUID 與時間戳記）。  這不能使用萬用字元的版本號碼，並僅支援內嵌和可攜式的偵錯類型|
|**-doc:&lt;xmldoc 檔名&gt;**|指示編譯器產生指定之檔案的 XML 文件註解。 如需詳細資訊，請參閱[XML 文件](xml-documentation.md)。<br /><br />這個編譯器選項相當於相同名稱的 C# 編譯器選項。 如需詳細資訊，請參閱[&#47; 文件 &#40;& #35。編譯器選項 &#41;](https://msdn.microsoft.com/library/3260k4x7.aspx).|
...
|**-說明**<br /><br />**-?**|顯示使用方式資訊，包括所有的編譯器選項的簡短描述。|
...
|**-keyfile:&lt;檔名&gt;**|指定的公開金鑰來簽署產生的組件檔案名稱。|
|**-lib:&lt;資料夾名稱&gt;**<br /><br />**-I:&lt;資料夾名稱&gt;**|指定要在其中搜尋參考的組件的目錄。<br /><br />這個編譯器選項相當於相同名稱的 C# 編譯器選項。 如需詳細資訊，請參閱[&#47; lib &#40;& #35。編譯器選項 &#41;](https://msdn.microsoft.com/library/s5bac5fx.aspx).|
|**-linkresource**:**&lt;資源資訊&gt;**|指定的資源連結至組件中。 資源資訊的格式是*filename*[，*名稱*[，*公用*&#124;*私用*]]<br /><br />連結到單一資源，使用此選項是內嵌整個資源檔的替代方式**-資源**選項。<br /><br />這個編譯器選項相當於相同名稱的 C# 編譯器選項。 如需詳細資訊，請參閱[&#47; linkresource &#40;& #35。編譯器選項 &#41;](https://msdn.microsoft.com/library/xawyf94k.aspx).|
