...
## <a name="using-azure-virtual-machines-with-f"></a>使用 F # 中使用 Azure 虛擬機器 #
...
## <a name="using-azure-functions-with-f"></a>F # 搭配使用 Azure 的函數 #
...
* [使用 Azure 的型別提供者搭配 Azure 的函式](https://compositional-it.com/blog/2017/08-30-using-the-azure-type-provider-with-azure-functions/index.html)

## <a name="using-azure-storage-with-f"></a>使用 Azure 儲存體與 F # #
...
## <a name="using-azure-app-service-with-f"></a>使用 F # 中使用 Azure App Service #
...
## <a name="using-azure-notification-hubs-with-f"></a>使用 F # 中使用 Azure 通知中樞 #
...
## <a name="using-webjobs-with-f"></a>使用 F # 中使用 Webjobs #
