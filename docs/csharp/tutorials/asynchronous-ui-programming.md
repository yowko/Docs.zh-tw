---
title: "非同步 UI 程式設計 - C# 指南 | Microsoft Docs"
...
# <a name="-asynchronous-ui-programming"></a>🔧非同步 UI 程式設計

> **注意**
> 
> 本主題尚未開稿！ 
>
> 歡迎您提供意見，協助擬定範圍和方向。 您可以追蹤狀態，並在 GitHub 提供關於此[問題](https://github.com/dotnet/docs/issues/951)的輸入。
> 
