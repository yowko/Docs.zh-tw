...
## <a name="numbers-in-c"></a>[C# 中的數字](intro-to-csharp/numbers-in-csharp.yml)
...
## <a name="branches-and-loops"></a>[分支和迴圈](intro-to-csharp/branches-and-loops.yml)
...
## <a name="list-collection"></a>[清單集合](intro-to-csharp/list-collection.yml)
...
## <a name="introduction-to-c----work-locally"></a>[C# 簡介 -- 在本機執行](intro-to-csharp/local-environment.md)
