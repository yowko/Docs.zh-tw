...
無法解析類型 'type' 所參考組件 'assembly' 中的基底類別或介面 'class'  
 ...
 如需詳細資訊，請參閱[加入參考對話方塊](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)和[/reference （C# 編譯器選項）](../../csharp/language-reference/compiler-options/reference-compiler-option.md)。  
...
## <a name="see-also"></a>另請參閱  
 [加入參考對話方塊](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)  
