...
很抱歉，我們沒有關于此錯誤的任何特定資訊。 您可以搜尋錯誤號碼與訊息文字，以在網路上尋找資訊。 或者，您可以使用下列其中一項來要求其他開發人員：
  
 [Msdn 論壇-Visual C#](https://social.msdn.microsoft.com/Forums/vstudio/home?forum=csharpgeneral)  
 提供有關 Visual c # 的問題以及其他論壇未討論之問題的論壇。  

 [Stack Overflow](https://stackoverflow.com/questions/tagged/c%23)  
針對 Visual c # 的問題和問題提供 QA 網站。  
