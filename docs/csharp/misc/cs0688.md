...
'method1' 有連結需求，但是會覆寫或實作沒有連結需求的 'method2'。 可能會產生安全性弱點。  
 ...
 藉由呼叫基底類別方法，即可輕鬆地規避衍生類別方法上所設定的連結需求。 若要關閉安全性漏洞，基底類別方法也必須使用連結需求。 如需詳細資訊，請參閱[Demand 與。LinkDemand](http://msdn.microsoft.com/en-us/1ab877f2-70f4-4e0d-8116-943999dfe8f5)。  
