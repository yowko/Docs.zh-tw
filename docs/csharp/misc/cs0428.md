...
ms.locfileid: "33286106"
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="95d44-102">編譯器錯誤 CS0428</span><span class="sxs-lookup"><span data-stu-id="95d44-102">Compiler Error CS0428</span></span>
<span data-ttu-id="95d44-103">無法將 'Identifier' 方法群組轉換為非委派類型 'type'。</span><span class="sxs-lookup"><span data-stu-id="95d44-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="95d44-104">您是否想要叫用方法？</span><span class="sxs-lookup"><span data-stu-id="95d44-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="95d44-105">將方法群組轉換為非委派類型時，或嘗試叫用方法但未使用括弧時，就會發生此錯誤。</span><span class="sxs-lookup"><span data-stu-id="95d44-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="95d44-106">範例</span><span class="sxs-lookup"><span data-stu-id="95d44-106">Example</span></span>  
 <span data-ttu-id="95d44-107">下列範例會產生 CS0428：</span><span class="sxs-lookup"><span data-stu-id="95d44-107">The following sample generates CS0428:</span></span>  
