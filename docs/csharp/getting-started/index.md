...
- [在 Visual Studio 中使用 .NET Core 建立 c # Hello World 應用程式](../../core/tutorials/with-visual-studio.md)
...
- [在 Visual Studio 中使用 c # 和 .NET Standard 建立類別庫](../../core/tutorials/library-with-visual-studio.md)
