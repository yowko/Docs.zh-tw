...
# <a name="-getting-started-with-c-interactive"></a>🔧 開始使用 C# Interactive

> **注意**
> 
> 本主題尚未開稿！ 
>
> 歡迎您提供意見，協助擬定範圍和方向。 您可以追蹤狀態，並在 GitHub 提供關於此[問題](https://github.com/dotnet/docs/issues/946)的輸入。
> 
