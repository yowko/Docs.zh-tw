...
## <a name="challenge---log-all-transactions"></a><span data-ttu-id="da2a9-208">挑戰 - 記錄所有交易</span><span class="sxs-lookup"><span data-stu-id="da2a9-208">Challenge - log all transactions</span></span>
