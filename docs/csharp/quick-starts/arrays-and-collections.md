...
本快速入門提供 C# 語言的簡介，以及 <xref:System.Collections.Generic.List%601> 類別的基本概念。
...
您可以[在 GitHub 上查看完成的範例程式碼](https://github.com/dotnet/samples/tree/master/csharp/list-quickstart/Program.cs#L13-L23) \(英文\) 來取得範例解決方案
