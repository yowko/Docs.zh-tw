...
```  
 ...
 如需詳細資訊，請參閱 [LINQ 查詢運算式](../../../../visual-basic/reference/command-line-compiler/index.md)。  
...
```  
 ...
 如需詳細資訊，請參閱[匿名類型](../../../../visual-basic/programming-guide/language-features/objects-and-classes/anonymous-types.md)。  
