...
---
# <a name="how-to-stream-xml-fragments-from-an-xmlreader-c"></a>如何從 XmlReader （C#） 資料流 XML 片段
...
主題["如何資料流具有標頭資訊 （C#） 的 XML 片段](./how-to-stream-xml-fragments-with-access-to-header-information.md)包含有關如何資料流更複雜的文檔的資訊和示例。
  
 主題["如何對大型 XML 文檔 （C#） 執行流式轉換"](./how-to-perform-streaming-transform-of-large-xml-documents.md)包含一個示例，即使用 LINQ 到 XML 轉換非常大的 XML 文檔，同時保持較小的記憶體佔用空間。  
