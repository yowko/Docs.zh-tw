...
|[如何：撰寫 LINQ to XML 軸方法 (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)|顯示如何撰寫 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] 座標軸方法。|  
|[如何：執行文字到 XML 的串流轉換 (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-perform-streaming-transformations-of-text-to-xml.md)|顯示如何將非常大的文字檔轉換為 XML，同時維護小的記憶體使用量。|  
