...
## <a name="testconfigxml"></a><span data-ttu-id="28d4a-105">TestConfig.xml</span><span class="sxs-lookup"><span data-stu-id="28d4a-105">TestConfig.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="28d4a-106">請參閱</span><span class="sxs-lookup"><span data-stu-id="28d4a-106">See Also</span></span>  
 [<span data-ttu-id="28d4a-107">範例 XML 文件 (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="28d4a-107">Sample XML Documents (LINQ to XML)</span></span>](../../../../csharp/programming-guide/concepts/linq/sample-xml-documents-linq-to-xml.md)
