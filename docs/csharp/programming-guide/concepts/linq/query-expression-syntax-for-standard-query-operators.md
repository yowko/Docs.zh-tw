...
|方法|C# 查詢運算式語法|  
|------------|---------------------------------|  
|<xref:System.Linq.Enumerable.Cast%2A>|使用明確類型範圍變數，例如：<br /><br /> `from int i in numbers`<br /><br />  (需詳細資訊，請參閱 [from 子句](../../../language-reference/keywords/from-clause.md)。 ) |  
...
|<xref:System.Linq.Enumerable.SelectMany%2A>|多個 `from` 子句。<br /><br />  (需詳細資訊，請參閱 [from 子句](../../../language-reference/keywords/from-clause.md)。 ) |  
...
|<xref:System.Linq.Enumerable.Where%2A>|`where`<br /><br />  (需詳細資訊，請參閱 [where 子句](../../../language-reference/keywords/where-clause.md)。 ) |  
