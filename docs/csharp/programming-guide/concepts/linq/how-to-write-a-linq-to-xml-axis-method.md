...
XML[座標軸方法](linq-to-xml-axes-overview.md)會從 xml 檔或祖系元素抓取 xml 專案的集合。 您可以撰寫自己的座標軸方法來擷取 XML 樹狀結構中的集合。 其中一個最好的方式是，撰寫可傳回項目或屬性集合的擴充方法。 您可以根據您應用程式的需求，撰寫您的擴充方法來傳回項目或屬性的特定子集。  
