...
許多檔案系統作業基本上就是查詢，因此很適合使用 LINQ 方法。  
 ...
 [如何：查詢具有指定屬性或名稱的檔案 (C#)](./how-to-query-for-files-with-a-specified-attribute-or-name.md)  
 ...
 [如何：比較兩個資料夾的內容 (LINQ) (C#)](./how-to-compare-the-contents-of-two-folders-linq.md)  
