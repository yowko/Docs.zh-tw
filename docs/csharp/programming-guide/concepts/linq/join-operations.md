...
---
# <a name="no-locjoin-operations-c"></a><span data-ttu-id="af604-104">Join作業（c #）</span><span class="sxs-lookup"><span data-stu-id="af604-104">Join Operations (C#)</span></span>
...
|-----------------|-----------------|---------------------------------|----------------------|  
|Join|<span data-ttu-id="af604-122">Joins 以索引鍵選取器函式為基礎的兩個序列，並會解壓縮值的配對。</span><span class="sxs-lookup"><span data-stu-id="af604-122">Joins two sequences based on key selector functions and extracts pairs of values.</span></span>|`join … in … on … equals …`|<xref:System.Linq.Enumerable.Join%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Join%2A?displayProperty=nameWithType>|  
|GroupJoin|<span data-ttu-id="af604-123">Join以索引鍵選取器函式為基礎的兩個序列，並將每個元素的結果相符專案分組。</span><span class="sxs-lookup"><span data-stu-id="af604-123">Joins two sequences based on key selector functions and groups the resulting matches for each element.</span></span>|`join … in … on … equals … into …`|<xref:System.Linq.Enumerable.GroupJoin%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.GroupJoin%2A?displayProperty=nameWithType>|  
...
- [<span data-ttu-id="af604-130">制訂 Join 和交叉乘積查詢</span><span class="sxs-lookup"><span data-stu-id="af604-130">Formulate Joins and Cross-Product Queries</span></span>](../../../../framework/data/adonet/sql/linq/formulate-joins-and-cross-product-queries.md)
...
- [<span data-ttu-id="af604-132">Join使用複合索引鍵</span><span class="sxs-lookup"><span data-stu-id="af604-132">Join by using composite keys</span></span>](../../../linq/join-by-using-composite-keys.md)
