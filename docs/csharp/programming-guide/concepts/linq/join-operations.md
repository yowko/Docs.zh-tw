...
- [如何：使用複合索引鍵執行聯結](../../linq-query-expressions/how-to-join-by-using-composite-keys.md)
- [如何：從不同的檔案聯結內容 (LINQ) (C#)](./how-to-join-content-from-dissimilar-files-linq.md)
- [如何：排序 Join 子句的結果](../../linq-query-expressions/how-to-order-the-results-of-a-join-clause.md)
- [如何：執行自訂的聯結作業](../../linq-query-expressions/how-to-perform-custom-join-operations.md)
- [如何：執行群組聯結](../../linq-query-expressions/how-to-perform-grouped-joins.md)
- [如何：執行內部聯結](../../linq-query-expressions/how-to-perform-inner-joins.md)
- [如何：執行左方外部聯結](../../linq-query-expressions/how-to-perform-left-outer-joins.md)
