---
title: "如何：尋找具有特定項目名稱的子系 (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-find-descendants-with-a-specific-element-name-c"></a>如何：尋找具有特定項目名稱的子系 (C#)
有時候您會想要尋找具有特定名稱的所有子代。 您可以撰寫程式碼來逐一查看所有子系，但是使用 <xref:System.Xml.Linq.XContainer.Descendants%2A> 座標軸比較容易。  
