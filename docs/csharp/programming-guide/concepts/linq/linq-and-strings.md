...
您也可以使用本節所述的技巧，將半結構化的文字資料轉換成 XML。 如需詳細資訊，請參閱 [如何從 CSV 檔案產生 XML](../../../../standard/linq/generate-xml-csv-files.md)。
...
- [如何在字串中計算單字的出現次數 (LINQ)  (c # ) ](how-to-count-occurrences-of-a-word-in-a-string-linq.md)  
...
- [如何從 CSV 檔案產生 XML](../../../../standard/linq/generate-xml-csv-files.md)
