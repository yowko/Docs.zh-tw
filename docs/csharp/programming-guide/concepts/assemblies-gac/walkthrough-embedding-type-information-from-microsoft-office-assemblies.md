...
## <a name="see-also"></a>另請參閱  
 [逐步解說：在 Visual Studio 中內嵌來自 Managed 組件的型別 (C#)](../../../../csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-visual-studio.md)   
