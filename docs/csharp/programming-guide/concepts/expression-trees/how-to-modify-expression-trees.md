...
---
# <a name="how-to-modify-expression-trees-c"></a>作法：修改運算式樹狀架構 (C#)
...
- [作法：執行運算式樹狀架構 (C#)](../../../../csharp/programming-guide/concepts/expression-trees/how-to-execute-expression-trees.md)
