...
##  <a name="BKMK_RelatedTopics"></a> 相關主題和範例  
 [逐步解說：在 Visual Studio 中保存物件 (#C)](../../../../csharp/programming-guide/concepts/serialization/walkthrough-persisting-an-object-in-visual-studio.md)  
