...
|<xref:System.Runtime.CompilerServices.CallerMemberNameAttribute>|呼叫端的方法或屬性名稱。 請參閱本主題稍後的[成員名稱](#member-names)。|`String`|
...
- [屬性 (C#)](./attributes/index.md)
- [常見屬性 (C#)](./attributes/common-attributes.md)
