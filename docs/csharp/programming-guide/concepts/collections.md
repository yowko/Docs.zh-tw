...
|<xref:System.Collections.Generic.Stack%601>|表示物件的後進先出 (LIFO) 集合。|  
 ...
 如需其他資訊，請參閱[常用的集合類型](../../../standard/collections/commonly-used-collection-types.md)、[選取集合類別](../../../standard/collections/selecting-a-collection-class.md)和 @System.Collections.Generic。  
