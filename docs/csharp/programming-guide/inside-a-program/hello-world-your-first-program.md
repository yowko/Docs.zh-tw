...
## Main 方法  
 ...
 `Main` 方法是位於類別或結構內的[static](../../../visual-basic/language-reference/modifiers/static.md) 方法。  在上一個 "Hello World\!" 範例中，它常駐在名為 `Hello` 的類別中。  您可以以下列其中一種方式宣告 `Main` 方法：  
...
2.  執行下列其中一個步驟，開啟命令提示字元視窗：  
    ...
    -   從標準命令提示字元視窗中啟用命令列建置。  
         ...
         請參閱 [How to: Set Environment Variables for the Visual Studio Command Line](../Topic/How%20to:%20Set%20Environment%20Variables%20for%20the%20Visual%20Studio%20Command%20Line.md)。  
