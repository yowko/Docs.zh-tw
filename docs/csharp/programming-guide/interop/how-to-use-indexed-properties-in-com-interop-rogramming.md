...
---
# <a name="how-to-use-indexed-properties-in-com-interop-programming-c-programming-guide"></a>如何在 COM 交互操作程式設計中使用索引屬性（C# 程式設計指南）
...
## <a name="example"></a>範例  
 下列程式碼顯示完整範例。 有關如何設置訪問 Office API 的專案的詳細資訊，請參閱[如何使用 C# 功能訪問 Office 交互操作物件](./how-to-access-office-onterop-objects.md)。
