...
> [!NOTE]
>  這個範例中所用的檔案是在主題中 [如何：寫入文字檔](../Topic/How%20to:%20Write%20to%20a%20Text%20File%20\(C%23%20Programming%20Guide\).md)建立。  
...
## 編譯程式碼  
 ...
 如果您不使用 [如何：寫入文字檔](../Topic/How%20to:%20Write%20to%20a%20Text%20File%20\(C%23%20Programming%20Guide\).md)的文字檔，請取代電腦上的引數傳遞至 `ReadAllText` 和 `ReadAllLines` 用適當的路徑和檔案名稱。  
