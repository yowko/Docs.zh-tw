---
title: 作法：了解傳遞結構和傳遞類別參考給方法之間的差異 - C# 程式設計手冊
ms.custom: seodec18
ms.date: 07/20/2015
helpviewer_keywords:
...
ms.locfileid: "69596792"
---
# <a name="how-to-know-the-difference-between-passing-a-struct-and-passing-a-class-reference-to-a-method-c-programming-guide"></a>作法：了解傳遞結構和傳遞類別參考給方法之間的差異 (C# 程式設計手冊)
