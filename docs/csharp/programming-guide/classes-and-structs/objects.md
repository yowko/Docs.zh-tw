...
> [!NOTE]
> 靜態型別的行為會和此處描述的不同。 有關詳細資訊，請參閱[靜態類和靜態類成員](./static-classes-and-static-class-members.md)。
  
## <a name="struct-instances-vs-class-instances"></a>結構實例與類實例  
...
## <a name="object-identity-vs-value-equality"></a>物件標識與價值相等性  
...
- [C# 程式設計指南](../index.md)
- [物件](../../language-reference/builtin-types/reference-types.md)
- [繼承](./inheritance.md)
