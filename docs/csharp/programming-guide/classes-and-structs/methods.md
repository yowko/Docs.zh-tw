...
## 非同步方法  
 使用非同步功能，您就可以呼叫非同步方法，而不需要使用明確回呼或手動將您的程式碼分散到多種方法或 lambda 運算式上。 非同步功能是在 [!INCLUDE[vs_dev11_long](../../../csharp/programming-guide/classes-and-structs/includes/vs_dev11_long_md.md)] 中引進。  
