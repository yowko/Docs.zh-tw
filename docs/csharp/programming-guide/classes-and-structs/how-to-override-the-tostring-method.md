...
---
# <a name="how-to-override-the-tostring-method-c-programming-guide"></a>如何重寫 ToString 方法（C# 程式設計指南）
...
- [類別和結構](./index.md)
- [字串](../strings/index.md)
- [字串](../../language-reference/builtin-types/reference-types.md)
- [覆蓋](../../language-reference/keywords/override.md)
