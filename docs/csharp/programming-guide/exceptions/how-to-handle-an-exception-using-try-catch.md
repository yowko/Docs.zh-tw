---
title: HOW TO：使用 try-catch 處理例外狀況 - C# 程式設計指南
ms.custom: seodec18
ms.date: 07/20/2015
helpviewer_keywords:
...
ms.locfileid: "53244920"
---
# <a name="how-to-handle-an-exception-using-trycatch-c-programming-guide"></a>HOW TO：使用 try-catch 處理例外狀況 (C# 程式設計指南)
