...
|[&&](../../../csharp/language-reference/operators/conditional-and-operator.md), [&#124;&#124;](../../../csharp/language-reference/operators/conditional-or-operator.md)|條件式邏輯運算子無法多載，但它們可以使用可多載的 `&` 和 `&#124;` 評估。|  
