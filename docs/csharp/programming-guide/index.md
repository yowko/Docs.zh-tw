...
這個章節提供關鍵 C\# 語言功能以及能夠透過 .NET Framework 存取的 C\# 功能之詳細資訊。  
 ...
 如需特定關鍵字、運算子和前置處理器指示詞的詳細資訊，請參閱 [C\# 參考](../../visual-basic/reference/command-line-compiler/index.md)。  如需 C\# 語言規格的詳細資訊，請參閱 [C\# 語言規格](../../csharp/language-reference/language-specification.md)。  
