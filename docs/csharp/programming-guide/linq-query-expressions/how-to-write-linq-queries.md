...
> [!NOTE]
>  雖然這些查詢是在記憶體中的集合上操作，但是基本語法與 [!INCLUDE[vbtecdlinq](../../../csharp/language-reference/keywords/includes/vbtecdlinq_md.md)] 和 [!INCLUDE[sqltecxlinq](../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] 中使用的語法相同。  
