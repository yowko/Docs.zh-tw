...
ms.locfileid: "89122403"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="c1cee-103">編譯器錯誤 CS0015</span><span class="sxs-lookup"><span data-stu-id="c1cee-103">Compiler Error CS0015</span></span>

<span data-ttu-id="c1cee-104">類型 'type' 的名稱過長</span><span class="sxs-lookup"><span data-stu-id="c1cee-104">The name of type 'type' is too long</span></span>

 <span data-ttu-id="c1cee-105">使用者定義類型的完整名稱必須少於 1024 個字元，包括句號。</span><span class="sxs-lookup"><span data-stu-id="c1cee-105">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="c1cee-106">下列範例會產生 CS0015：</span><span class="sxs-lookup"><span data-stu-id="c1cee-106">The following sample generates CS0015:</span></span>
