...
簽署組件 'assembly' 時密碼編譯失敗 — 'reason'  
 ...
 如需詳細資訊，請參閱[如何：使用強式名稱簽署組件](../../../standard/assembly/sign-strong-name.md)、[/keyfile (C# 編譯器選項)](../compiler-options/keyfile-compiler-option.md) 和 [/delaysign (C# 編譯器選項)](../compiler-options/delaysign-compiler-option.md)。  
