...
### <a name="c-language-specification"></a>C# 語言規格
 ...
 C# 2.0 [c042926_ISO_IEC_23270_2006(E).zip](http://go.microsoft.com/fwlink/?LinkId=144406) PDF 格式的 ISO/IEC 23270:2006：ISO 自由可用標準   
 ...
 C# 5.0 [CSharp Language Specification.docx](https://www.microsoft.com/en-us/download/details.aspx?id=7029) C# 語言規格版本 5.0：Microsoft Corporation   
