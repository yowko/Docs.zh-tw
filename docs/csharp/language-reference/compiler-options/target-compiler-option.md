...
您可以使用四種形式之一來指定**/target** 編譯器選項︰  
 ...
 除非您指定 **/target:module**，否則 **/target** 會將 .NET Framework 組件資訊清單放入輸出檔中。 如需詳細資訊，請參閱 [Common Language Runtime 中的組件](../../../framework/app-domains/assemblies-in-the-common-language-runtime.md)和 [Common Attributes](../../programming-guide/concepts/attributes/common-attributes.md) (常見屬性)。  
