---
title: "依字母順序列出 C# 編譯器選項 | Microsoft Docs"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
|[/bugreport](../../../csharp/language-reference/compiler-options/bugreport-compiler-option.md)|建立「錯誤報告」檔案。 如果您搭配使用這個檔案與 **/errorreport:prompt** 或 **/errorreport:send**，則會將該檔案與任何損毀的資訊一起傳送。|  
...
|[/langversion:\<字串>](../../../csharp/language-reference/compiler-options/langversion-compiler-option.md)|指定語言版本模式：ISO-1、ISO-2、3、4、5、6 或 Default|  
