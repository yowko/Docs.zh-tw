...
|[var](../../../csharp/language-reference/keywords/var.md)|[when (篩選條件)](when.md)|[where (泛型型別條件約束)](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|[where (查詢子句)](../../../csharp/language-reference/keywords/where-clause.md)|  
