...
如果您使用 Visual Studio，就可以用類似的方式提供別名。

在 Visual Studio 中將 *grid.dll* 和 *grid20.dll* 的參考新增至您的專案。 開啟 [內容] 索引標籤，並分別將別名從 global 變更為 GridV1 和 GridV2。
...
- [- (c # 編譯器選項的參考) ](../compiler-options/reference-compiler-option.md)
