...
`descending` 內容關鍵字可用於查詢運算式的 [orderby 子句](../../../csharp/language-reference/keywords/orderby-clause.md)，以指定從大到小的排序次序。  
  
## <a name="example"></a>範例  
 下列範例示範 [orderby 子句](../../../csharp/language-reference/keywords/orderby-clause.md)中 `descending` 的用法。  
