...
## 範例  
 在單一 `where` 子句內，您可以使用 [&&](../../../csharp/language-reference/operators/conditional-and-operator.md) 和 [&#124;&#124;](../Topic/%7C%7C%20Operator%20\(C%23%20Reference\).md) 運算子，指定任何所需要的述詞。  在下列範例中，查詢會指定兩個述詞，以便只選取小於 5 的偶數。  
