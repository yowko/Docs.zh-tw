...
在下例中，一起新增 [int](../builtin-types/integral-numeric-types.md)、[short](../../../csharp/language-reference/builtin-types/integral-numeric-types.md)、[float](../../../csharp/language-reference/keywords/float.md) 和 `double` 以得到 `double` 結果。
