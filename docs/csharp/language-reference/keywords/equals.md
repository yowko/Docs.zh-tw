...
## <a name="example"></a><span data-ttu-id="78586-105">範例</span><span class="sxs-lookup"><span data-stu-id="78586-105">Example</span></span>  
 <span data-ttu-id="78586-106">下列範例示範 `join` 子句中 `equals` 關鍵字的用法。</span><span class="sxs-lookup"><span data-stu-id="78586-106">The following example shows the use of the `equals` keyword in a `join` clause.</span></span>  
  
 [!code-csharp[csrefKeywordsContextual#12](../../../csharp/language-reference/keywords/codesnippet/CSharp/equals_1.cs)]  
  
## <a name="see-also"></a><span data-ttu-id="78586-107">請參閱</span><span class="sxs-lookup"><span data-stu-id="78586-107">See Also</span></span>  
 [<span data-ttu-id="78586-108">LINQ 查詢運算式</span><span class="sxs-lookup"><span data-stu-id="78586-108">LINQ Query Expressions</span></span>](../../../csharp/programming-guide/linq-query-expressions/index.md)
