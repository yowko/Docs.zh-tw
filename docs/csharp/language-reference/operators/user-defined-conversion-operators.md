...
[is](type-testing-and-cast.md#is-operator) 和 [as](type-testing-and-cast.md#as-operator) 運算子不會考慮使用者定義的轉換。 使用[強制轉換表達式](type-testing-and-cast.md#cast-expression)調用使用者定義的顯式轉換。
