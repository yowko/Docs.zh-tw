...
- [使用 <xref:System.String.Split%2A> 來分隔字串](../programming-guide/strings/how-to-parse-strings-using-string-split.md)。
- [將多個字串合併為一個字串](../programming-guide/strings/how-to-concatenate-multiple-strings.md)。
