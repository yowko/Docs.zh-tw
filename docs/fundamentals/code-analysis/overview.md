...
### <a name="enable-on-build"></a><span data-ttu-id="99f0a-205">在組建時啟用</span><span class="sxs-lookup"><span data-stu-id="99f0a-205">Enable on build</span></span>
