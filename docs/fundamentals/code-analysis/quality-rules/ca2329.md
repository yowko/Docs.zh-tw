...
當傳遞至還原序列化方法或初始化為欄位或屬性的 [Newtonsoft.Json.JsonSerializer](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) 實例符合下列兩個條件時，就會引發此規則：
