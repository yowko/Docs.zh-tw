...
Windows Server 2012 支援 .NET Framework 4.7.1。 Windows 8 不予支援。

[.NET Framework 4.7.1](https://www.microsoft.com/en-us/download/details.aspx?id=56115&desc=dotnet47) 可用來執行針對 .NET Framework 4.0 或更新版本建置的應用程式。

## <a name="net-framework-46"></a>.NET Framework 4.6

[.NET Framework 4.6](https://www.microsoft.com/en-us/download/details.aspx?id=48130) 是 Windows 8 支援的最新版 .NET Framework。

.NET Framework 4.6 支援針對 .NET Framework 4.0 到 4.6 建置的應用程式。

## <a name="net-framework-35"></a>.NET Framework 3.5

請遵循指示[在 Windows 8 和 10 上安裝 .NET Framework 3.5](dotnet-35-windows-10.md)。
