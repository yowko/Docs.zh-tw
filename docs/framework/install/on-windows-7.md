...
這些指令將協助您安裝所需的 .NET Framework 版本。 [.NET Framework 4.7.2](http://go.microsoft.com/fwlink/?LinkID=863255) 是最新版本。 Windows 7 SP1 和 Windows Server 2008 R2 支援它，並且包含於 [Windows 10 2018 4 月更新](https://www.microsoft.com/software-download/windows10)。
