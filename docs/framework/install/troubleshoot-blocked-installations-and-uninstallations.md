...
|這部電腦已安裝 .NET Framework 4.5.x/4.6.x/4.7.x (繁體中文) 或更新版本。|不需要採取任何動作。<br /><br /> 若要判斷系統上所安裝之 .NET Framework 的版本，請參閱[如何：判斷所安裝的 .NET Framework 版本](../migration-guide/how-to-determine-which-versions-are-installed.md)。|  
...
- [操作說明：判斷安裝的 .NET Framework 版本](../migration-guide/how-to-determine-which-versions-are-installed.md)
