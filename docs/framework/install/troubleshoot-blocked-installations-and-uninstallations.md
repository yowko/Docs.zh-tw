...
您可以判斷系統上所安裝之 .NET Framework 的版本。 請參閱[How to:判斷安裝的 .NET Framework 版本](../migration-guide/how-to-determine-which-versions-are-installed.md)以取得詳細資訊。
...
|這部電腦已安裝 .NET Framework 4.5.x/4.6.x/4.7.x (繁體中文) 或更新版本。|不需要採取任何動作。<br /><br /> 若要判斷系統上所安裝的 .NET Framework 版本，請參閱[如何：判斷安裝的 .NET Framework 版本](../migration-guide/how-to-determine-which-versions-are-installed.md)。|  
...
|.NET Framework 4.5..x/4.6.x/4.7.x/4.8 已經包含在此作業系統中。 您不需要安裝 .NET Framework 4.5.x/4.6.x/4.7.x/4.8 可轉散發套件。|不需執行任何動作。<br /><br /> 若要判斷系統上所安裝的 .NET Framework 版本，請參閱[如何：判斷安裝的 .NET Framework 版本](../migration-guide/how-to-determine-which-versions-are-installed.md)。 如需支援的作業系統，請參閱[系統需求](../get-started/system-requirements.md)。|  
...
- [版本和相依性](../migration-guide/versions-and-dependencies.md)
