...
當您執行[web 或離線安裝程式](../../../docs/framework/install/guide-for-developers.md)的.NET Framework 4.5 或更新版本中，您可能會遇到阻止或封鎖安裝.NET Framework 的問題。 下面表格列出可能造成阻礙的問題並且提供疑難排解資訊。
...
> [!IMPORTANT]
> .NET Framework 4.x 版本時就地更新，因為您無法安裝舊版的.NET Framework 4.x 的系統上已經有安裝較新版本。 比方說，在系統上與 Windows 10 年秋季建立者的更新，您無法安裝.NET Framework 4.6.2，因為.NET Framework 4.7.1 會預先安裝作業系統。
...
下表中，4.5。*x*指的是.NET Framework 4.5 和其點發行版本 4.5.1 和 4.5.2、 4.6。*x*指的是.NET Framework 4.6 和其點發行版本中，4.6.1 4.6.2 和 4.7。*x*指的是.NET Framework 4.7 和其點發行版本，4.7.1。
...
|.NET Framework 4.5*.x*/4.6*.x*/4.7*.x* (*語言*) 需要.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*。 請安裝.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*從下載中心取得重新執行安裝程式。|在安裝語言套件之前，必須安裝指定 .NET Framework 版本的英文版本。 如需詳細資訊，請參閱《安裝指南》中的[安裝語言套件](../../../docs/framework/install/guide-for-developers.md#to-install-language-packs)一節。|  
...
|無法解除安裝.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*。 電腦上的其他應用程式依存於這個程式。|一般而言，您不應該解除安裝電腦上的任何 .NET Framework 版本，因為您使用的應用程式可能相依於特定的 .NET Framework 版本。 如需詳細資訊，請參閱*使用者入門*指南中的[適用於使用者的 .NET Framework](../../../docs/framework/get-started/index.md#ForUsers)。|  
|.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*可轉散發套件不適用於此作業系統。 請下載.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*適用於您的作業系統從 Microsoft 下載中心取得。|您可能想要安裝[!INCLUDE[net_v451](../../../includes/net-v451-md.md)]、 4.5.2、 4.6、 4.6.1、 4.6.2、 4.7，或不受支援的平台上 4.7.1 或您選擇不包含元件，所有支援作業系統所需的安裝套件。 使用離線安裝程式重新執行安裝 ([4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=309493)， [4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706)， [4.6](http://go.microsoft.com/fwlink/p/?LinkId=528233)， [4.6.1](http://go.microsoft.com/fwlink/p/?LinkId=671744)，如[4.6.2](http://go.microsoft.com/fwlink/p/?LinkId=780604)，如[4.7](http://go.microsoft.com/fwlink/p/?LinkId=825306))，或如[4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090)。 如需詳細資訊，請參閱[安裝指南](../../../docs/framework/install/guide-for-developers.md)和[系統需求](../../../docs/framework/get-started/system-requirements.md)以了解支援的作業系統。|  
...
|.NET framework 4.5*.x*/4.6*.x*/4.7*.x*元件存放區已損毀，因為尚未安裝。|如需詳細資訊，請參閱[使用 DISM 或系統更新整備工具修復 Windows Update 錯誤](https://support.microsoft.com/en-us/kb/947821)。|  
...
|這個安裝程式需要 x86 電腦， 無法安裝在 x64 或 IA64 電腦上。|請參閱[系統需求](../../../docs/framework/get-started/system-requirements.md)。|  
|這個安裝程式需要 x64 或 x86 電腦， 無法安裝在 IA64 電腦上。|請參閱[系統需求](../../../docs/framework/get-started/system-requirements.md)。|  
...
1. 在 [名稱] 欄中，尋找[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]、 4.5.1、 4.5.2、 4.6、 4.6.1、 4.6.2、 4.7 或 4.7.1 下載名稱，取決於哪一個版本您要安裝，並刪除這些項目。 如需下載名稱，請參閱[安裝適用於開發人員的 .NET Framework](../../../docs/framework/install/guide-for-developers.md)一文。

1. 重新執行 4.5、 4.5.1、 4.5.2 或 4.6、 4.6.1、 4.6.2、 4.7 或 4.7.1 版的.NET Framework 安裝程式。
