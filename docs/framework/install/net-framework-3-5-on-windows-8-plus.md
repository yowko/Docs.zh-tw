...
1.  按下鍵盤上的 Windows 鍵 ![Windows 標誌](../../../docs/framework/install/media/windowskeyboardlogo.png "Windowskeyboardlogo")，輸入「Windows 功能」，然後按 Enter 鍵。 這會開啟 \[開啟或關閉 Windows 功能\] 對話方塊。 或者，開啟 \[控制台\]，並按一下 \[程式\] 項目，然後按一下 \[程式和功能\] 下的 \[開啟或關閉 Windows 功能\]。  
...
2.  選取 \[.NET Framework 3.5\] \(包括 .NET 2.0 和 3.0\) 核取方塊，按下 \[確定\]，然後在出現提示時重新啟動電腦。  
 ...
 ![在 Windows 8 或 8.1 上安裝 .NET Framework](../../../docs/framework/install/media/clr-net35-win8.png "CLR\_NET35\_Win8")  
