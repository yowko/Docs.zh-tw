...
本文提供的安裝.NET Framework 4.5、 其點發行版本 （4.5.1、 4.5.2） 的連結[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]、 其點發行版本 （4.6.1、 4.6.2） 和.NET Framework 4.7 其點發行版本 (4.7.1) 電腦上。 如果您是開發人員，也可以使用這些連結下載 .NET Framework 並隨應用程式轉散發。
...
|----------------------------|----------------------------|----------------------------------|----------------------|  
|**4.7.1**|[NET Framework 4.7.1 開發人員套件](http://go.microsoft.com/fwlink/?LinkId=852105)|[下載頁面 4.7.1 web 安裝程式](http://go.microsoft.com/fwlink/?LinkId=852095)<br /><br /> [下載頁面 4.7.1 離線安裝程式](http://go.microsoft.com/fwlink/?LinkId=852107)|包含在： <br/>Windows 10 年秋季建立者更新<br/>Windows Server 版本 1709<br /><br /> 您可以安裝於：<br/> Windows 10 Creators Update <br /> Windows 10 年度更新<br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> (如需完整清單，請參閱[系統需求](~/docs/framework/get-started/system-requirements.md))||
|**4.7**|[NET Framework 4.7 開發人員套件](http://go.microsoft.com/fwlink/?LinkId=825319)|[4.7 Web 安裝程式的下載頁面](http://go.microsoft.com/fwlink/?LinkId=825299)<br /><br /> [4.7 離線安裝程式的下載頁面](http://go.microsoft.com/fwlink/?LinkId=825303)|包含在： <br/>Windows 10 Creators Update<br /><br /> 您可以安裝於：<br /> Windows 10 年度更新<br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> (如需完整清單，請參閱[系統需求](~/docs/framework/get-started/system-requirements.md))||
|**4.6.2**|[NET Framework 4.6.2 開發人員套件](http://go.microsoft.com/fwlink/?LinkId=780617)|[4.6.2 Web 安裝程式的下載頁面](http://go.microsoft.com/fwlink/?LinkId=780597)<br /><br /> [4.6.2 離線安裝程式的下載頁面](http://go.microsoft.com/fwlink/?LinkId=780601)|包含在： <br /> Windows 10 Anniversary Edition<br /><br /> 您可以安裝於：<br /> Windows 10 <br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> (如需完整清單，請參閱[系統需求](~/docs/framework/get-started/system-requirements.md))|
...
## <a name="to-install-the-net-framework-developer-or-targeting-pack"></a>安裝 .NET Framework 開發人員套件或目標套件

.NET Framework 4.5.1 或 4.5.2 為目標組件的開發人員套件[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]，和開發人員套件[!INCLUDE[net_v461](../../../includes/net-v461-md.md)]，4.6.2、 4.7 或 4.7.1 提供.NET Framework 4.5.1 或 4.5.2 或[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]，4.6.1 或.NET 4.6.2，Framework 4.7 或 4.7.1 參考組件、 語言套件與 IntelliSense 檔案，可用於 Visual Studio 這類的整合式的開發環境中。  若是使用 Visual Studio，開發人員套件或目標套件也會將已安裝的 .NET Framework 版本加入您在建立新專案時所選擇的目標。  選擇下列其中一個開發人員套件或目標套件：  

- [Microsoft.NET Framework 4.7.1 開發人員套件](http://go.microsoft.com/fwlink/?LinkId=852105)

- [Microsoft .NET Framework 4.7 開發人員套件](http://go.microsoft.com/fwlink/?LinkId=825319)
...
- [!INCLUDE[net_v451](../../../includes/net-v451-md.md)]和 4.5.2 以及[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]、 4.6.1、 4.6.2、 4.7 和 4.7.1 進行就地更新[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]。  
  
- [!INCLUDE[net_v45](../../../includes/net-v45-md.md)]、 其點發行版本[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]及其點發行版本及.NET Framework 4.7 及及其點發行取代[!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)]。 如果您在已安裝 [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] 的系統上安裝這些版本，組件就會被取代。
  
- 解除安裝[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]、 其點發行版本[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]及其點發行版本或.NET Framework 4.7 及及其點發行也會移除已存在[!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)]檔案。 如果您想要回到 [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)]，則必須重新安裝它及其所有更新 (請參閱 [安裝 .NET Framework 4](http://go.microsoft.com/fwlink/p/?LinkId=230665))。  
  
- 您必須具有系統管理認證才能安裝[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]、 其點發行版本、.NET Framework 4.6 和及其點發行版本，和.NET Framework 4.7 和其點發行版本。
...
- 新功能和增強功能，在.NET Framework 4.5 和所有更新的版本，請參閱[What's New](../../../docs/framework/whats-new/index.md)。  
...
- 請參閱 [.NET Framework 參考來源](http://referencesource.microsoft.com/)在線上瀏覽 .NET Framework 原始程式碼。 參考來源上也會提供[GitHub](https://github.com/Microsoft/referencesource)。 您可以[下載參考來源](http://referencesource.microsoft.com/download.html)供離線檢視，以及在偵錯期間逐步執行原始檔 (包含修補程式和更新) 之用。 如需詳細資訊，請參閱部落格文章：[.NET 參考來源的新風貌 (英文)](http://blogs.msdn.com/b/dotnet/archive/2014/02/24/a-new-look-for-net-reference-source.aspx)。  
