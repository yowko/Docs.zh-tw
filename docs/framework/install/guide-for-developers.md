...
> [!NOTE]
> 本主題面向希望在其系統上安裝 .NET 框架或希望隨應用程式安裝 .NET 框架的**開發人員**。 對於有興趣安裝 .NET 框架**的使用者**，請參閱有關在特定作業系統上安裝 .NET 框架的單個主題，例如[在 Windows 10 上安裝 .NET 框架和 Windows Server 2016](on-windows-10.md)。
...
使用下表取得快速連結，或進一步閱讀詳細資料。 若要檢閱 .NET Framework 的系統需求再進行安裝，請參閱[系統需求](../get-started/system-requirements.md)。 如需疑難排解的協助，請參閱[疑難排解](troubleshoot-blocked-installations-and-uninstallations.md)。

| .NET Framework 版本 | 安裝程式（開發人員包和運行時） | 平台支援 |
| ---------------------- | -------------------------------------- | ---------------- |
|**4.8**   | [.NET Framework 4.8](https://dotnet.microsoft.com/download/dotnet-framework/net48)    | **包含在：**<br/><br/>Windows 10 2019 年 5 月更新<br/>[視覺工作室 2019 （16.3 更新）](https://my.visualstudio.com/Downloads?q=visual%20studio%202017)<br/><br/> **您可以安裝於：**<br/><br/>Windows 10 2018 年 10 月更新<br/>Windows 10 2018 4 月更新<br/>Windows 10 Fall Creators Update<br/>Windows 10 Creators Update <br /> Windows 10 年度更新<br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2019<br/>Windows Server，版本 1809<br/>Windows Server，版本 1803<br /><br/> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）||
|**4.7.2** | [.NET Framework 4.7.2](https://dotnet.microsoft.com/download/dotnet-framework/net472) | **包含在：** <br/><br/>Windows 10 2018 年 10 月更新<br/>Windows 10 2018 4 月更新<br/>Windows Server 2019<br/>Windows Server，版本 1809<br/>Windows Server，版本 1803<br/>[視覺工作室 2017 （15.8 更新）](https://my.visualstudio.com/Downloads?q=visual%20studio%202017)<br/><br/> **您可以安裝於：**<br/> <br/>Windows 10 Fall Creators Update<br/>Windows 10 Creators Update <br /> Windows 10 年度更新<br /> Windows 8.1 (含) 以前版本<br /> Windows Server，1709 版 (含) 以前版本<br /><br/> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）||
|**4.7.1** | [.NET Framework 4.7.1](https://dotnet.microsoft.com/download/dotnet-framework/net471) | **包含在：** <br/><br/>Windows 10 Fall Creators Update<br/>Windows Server 1709 版<br/>[視覺工作室 2017 （15.5 更新）](https://my.visualstudio.com/Downloads?q=visual%20studio%202017)<br/><br/> **您可以安裝於：**<br/><br/> Windows 10 Creators Update <br /> Windows 10 年度更新<br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2016 (含) 以前版本<br /> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）||
|**4.7**   | [.NET Framework 4.7](https://dotnet.microsoft.com/download/dotnet-framework/net47)    | **包含在：** <br/><br/>Windows 10 Creators Update<br/>[視覺工作室 2017 （15.3 更新）](https://my.visualstudio.com/Downloads?q=visual%20studio%202017)<br/><br/> **您可以安裝於：**<br /><br/> Windows 10 年度更新<br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2016 (含) 以前版本<br /> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）||
|**4.6.2** | [.NET Framework 4.6.2](https://dotnet.microsoft.com/download/dotnet-framework/net462) | **包含在：** <br/><br/>Windows 10 年度更新<br /><br /> **您可以安裝於：**<br /><br/> Windows 10 11 月更新 <br/> Windows 10 <br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）|
|**4.6.1** | [.NET Framework 4.6.1](https://dotnet.microsoft.com/download/dotnet-framework/net461) | **包含在：** <br/><br/>[Visual Studio 2015 Update 2](https://my.visualstudio.com/Downloads?q=visual%20studio%202015)<br/><br/>**您可以安裝於：**<br /><br/> Windows 10 <br /> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）|
|**4.6**   | [.NET Framework 4.6](https://dotnet.microsoft.com/download/dotnet-framework/net46)    | **包含在：** <br/><br/> Windows 10 <br />[Visual Studio 2015](https://my.visualstudio.com/Downloads?q=visual%20studio%202015)<br /><br /> **您可以安裝於：**<br /><br/> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）|
|**4.5.2** | [.NET Framework 4.5.2](https://dotnet.microsoft.com/download/dotnet-framework/net452) | **您可以安裝於：**<br/><br/> Windows 8.1 (含) 以前版本<br /> Windows Server 2012 R2 (含) 以前版本<br /> （有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）|
|**4.5.1** | [.NET Framework 4.5.1](https://dotnet.microsoft.com/download/dotnet-framework/net451) | **包含在：**<br/><br/>Windows 8.1<br /> Windows Server 2012 R2<br /> [Visual Studio 2013](https://my.visualstudio.com/Downloads?q=visual%20studio%202013)<br /><br /> **您可以安裝於：**<br /><br/> Windows 8 及更早版本<br /> Windows 伺服器 2012 及更早版本<br />（有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）|
|**4.5**   | [.NET Framework 4.5](https://dotnet.microsoft.com/download/dotnet-framework/net45)    | **包含在：** <br/><br/>Windows 8<br /> Windows Server 2012<br /> [Visual Studio 2012](https://my.visualstudio.com/Downloads?q=visual%20studio%202012)<br /><br /> **您可以安裝於：**<br/><br /> Windows 7 (含) 以前版本<br /> Windows Server 2008 SP2 (含) 以前版本 <br />（有關完整清單，請參閱[系統要求](../get-started/system-requirements.md)）|
...
如需完整清單，請參閱[系統需求](../get-started/system-requirements.md)。

如需適用於使用者和開發人員的 .NET Framework 一般簡介，請參閱[使用者入門](../get-started/index.md)。 如需隨應用程式部署 .NET Framework 的資訊，請參閱[部署指南](../deployment/deployment-guide-for-developers.md)。 若要閱讀有關 .NET Framework 架構與重要功能的資訊，請參閱[概觀](../get-started/overview.md)。
...
- [.NET 框架 4.5.2](https://dotnet.microsoft.com/download/dotnet-framework/net452)用於在 Windows 8.1 或更早版本、Visual Studio 2013、Visual Studio 2012 或其他 IDEs 上安裝版本 4.5.2。
- [.NET 框架 4.5.1](https://dotnet.microsoft.com/download/dotnet-framework/net451)用於在 Visual Studio 2012 或其他 IDEs 上安裝版本 4.5.1。
...
- **離線安裝程式** (獨立可轉散發套件) 包含安裝 .NET Framework 所需的全部必要元件，但不包含語言套件。 這個下載的大小大於 Web 安裝程式。 離線安裝程式不需要網際網路連線。 運行離線安裝程式後，可以下載[獨立語言包](#to-install-language-packs)以安裝語言支援。 如果無法提供穩定的網際網路連線，請使用離線安裝程式。
...
- .NET 框架 4.5 和更高版本替換 .NET 框架 4.0。 如果您在已安裝 .NET Framework 4 的系統上安裝這些版本，組件就會被取代。

- 卸載 .NET 框架 4.5 或更高版本也會刪除預先存在的 .NET 框架 4 檔。 如果您想要回到 .NET Framework 4，則必須重新安裝它及其所有更新。 請參閱[安裝 .NET 框架 4](https://go.microsoft.com/fwlink/p/?LinkId=230665)。

- 您必須具有管理認證才能安裝 .NET 框架 4.5 或更高版本。

- .NET Framework 4.5 可轉散發套件已於 2012 年 10 月 9 日更新，更正了與數位憑證時間戳記錯誤相關的問題，這個問題會造成 Microsoft 所產生和簽署之檔案中的數位簽章提前過期。 如果您以前安裝了 .NET Framework 4.5 可轉散布包日期為 2012 年 8 月 16 日，我們建議您使用[.NET Framework 下載頁](https://dotnet.microsoft.com/download/dotnet-framework/net45)中的最新可轉散布更新副本。 如需這個問題的詳細資訊，請參閱 [Microsoft 資訊安全諮詢 2749655](https://docs.microsoft.com/security-updates/SecurityAdvisories/2012/2749655) 和[知識庫文章 2770445](https://support.microsoft.com/kb/2770445)。

## <a name="to-install-language-packs"></a>若要安裝語言套件

語言套件是包含所支援語言之當地語系化資源的可執行檔 (例如，翻譯的錯誤訊息和 UI 文字)。 如果您未安裝語言套件，則會以英文顯示 .NET Framework 錯誤訊息及其他文字。  請注意，Web 安裝程式會自動安裝符合您作業系統的語言套件，但是您可以將其他語言套件下載至您的電腦。 離線安裝程式不包含任何語言包。
...
- 有關將應用從 .NET 框架 4 遷移到 .NET 框架 4.5 或更高版本的資訊，請參閱[遷移指南](../migration-guide/index.md)。
...
- [排除已阻止的 .NET 框架安裝和卸載](troubleshoot-blocked-installations-and-uninstallations.md)
