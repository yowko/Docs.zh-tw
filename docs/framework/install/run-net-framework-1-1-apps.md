...
---
# <a name="running-net-framework-11-apps-on-windows-8-windows-81-or-windows-10"></a>在 Windows 8、Windows 8.1 或 Windows 10 上執行 .NET Framework 1.1 應用程式
...
## <a name="installing-the-net-framework-11-from-a-cd-or-download-center"></a>從光碟或下載中心安裝 .NET Framework 1.1  
...
## <a name="see-also"></a>另請參閱  
 ...
 [在 Windows 8 和更新版本上安裝 .NET Framework 3.5](../../../docs/framework/install/net-framework-3-5-on-windows-8-plus.md)
