---
title: "在 Windows 10、Windows 8.1 及 Windows 8 上安裝 .NET Framework 3.5 | Microsoft Docs"
...
<a id="install-the-net-framework-35-on-windows-10-windows-81-and-windows-8" class="xliff"></a>

# 在 Windows 10、Windows 8.1 及 Windows 8 上安裝 .NET Framework 3.5
