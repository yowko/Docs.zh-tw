...
description: 瞭解如何處理 SendingRequest 事件，以將新的標頭新增至要求訊息，然後再將它傳送至 WCF Data Services 中的資料服務。
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
