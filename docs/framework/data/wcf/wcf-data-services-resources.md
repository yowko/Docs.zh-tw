...
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 可以在下列位置找到簡介主題。 這些主題中有許多也包含其中含有詳細資訊的相關主題連結。  
...
## <a name="external-resources"></a>外部資源  
 ...
 [WCF 資料服務論壇 (英文)](https://go.microsoft.com/fwlink/?LinkId=150512)  
 針對 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 開發人員提供的資料程式設計支援。  
  
 [WCF 資料服務小組部落格](https://go.microsoft.com/fwlink/?LinkId=150511)  
 ...
 [OData 部落格 (英文)](https://go.microsoft.com/fwlink/?LinkId=185868)  
 包含有關討論的部落格[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]程式設計。  
  
 [資料存取及儲存開發人員中心 (英文)](https://go.microsoft.com/fwlink/?LinkId=91903)  
 可尋找用於處理資料的相關資訊及資源的中央位置。  
  
 [資料平台入門 影片：WCF Data Services 系列](https://go.microsoft.com/fwlink/?LinkId=124600)  
 包含一組影片，示範如何建置及存取資料服務。  
  
 [概觀：WCF 資料服務](https://go.microsoft.com/fwlink/?LinkID=131074)  
 此白皮書提供與 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 優點有關的高階詳細資訊。  
  
 [使用 Microsoft WCF 資料服務 (英文)](https://go.microsoft.com/fwlink/?LinkID=131075)  
