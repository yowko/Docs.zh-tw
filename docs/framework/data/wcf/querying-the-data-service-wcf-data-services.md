...
如需詳細資訊, 請參閱[LINQ 考慮](../../../../docs/framework/data/wcf/linq-considerations-wcf-data-services.md)。
...
查詢選項提供您另一種表示 LINQ 查詢語法元件的方式。 如需詳細資訊, 請參閱[LINQ 考慮](../../../../docs/framework/data/wcf/linq-considerations-wcf-data-services.md)。
...
> [!NOTE]
> 因為資料服務可能傳回分頁的回應，我們建議您的應用程式使用程式設計模式來處理分頁的資料服務回應。 如需詳細資訊, 請參閱[載入延](../../../../docs/framework/data/wcf/loading-deferred-content-wcf-data-services.md)後的內容。
