...
ms.locfileid: "73975347"
---
# <a name="data-services-providers-wcf-data-services"></a>資料服務提供者 (WCF 資料服務)
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 支援將資料公開為開放式資料通訊協定（OData）摘要的多個提供者模型。 本主題所提供的資訊能讓您針對您的資料來源，選擇最適合的 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 提供者。  
