...
#### <a name="tryresolveserviceaction"></a>TryResolveServiceAction
 這個方法會搜尋指定的[ServiceAction](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/hh544089(v=vs.103)) ，並在找到[ServiceAction](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/hh544089(v=vs.103))時傳回 `true`。 如果找到， [ServiceAction](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/hh544089(v=vs.103))會在 `serviceAction` `out` 參數中傳回。
