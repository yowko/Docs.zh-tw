...
本節中的主題可協助您快速瞭解開放式資料通訊協定（OData），以及如何使用 WCF Data Services 藉由說明基礎技術來公開及取用 OData 摘要。 本節包含概念內容和[快速入門](quickstart-wcf-data-services.md)教學課程。  
  
## <a name="in-this-section"></a>本章節內容  
 下列主題說明如何使用 WCF Data Services 來建立資料服務。  
  
 [將資料當作服務公開](exposing-your-data-as-a-service-wcf-data-services.md)  
 說明使用 WCF Data Services 建立資料服務所需的步驟。  
 ...
 示範如何建立和存取以 OData 為基礎的簡單服務，以公開以 Northwind 範例資料庫為基礎的摘要。  
  
 [應用程式案例](application-scenarios-wcf-data-services.md)  
 反白顯示 WCF Data Services 支援的一組核心 OData 案例。  
