...
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 可讓您定義資料模型，只要這些類別會公開為實作的物件，以任意類別為基礎<xref:System.Linq.IQueryable%601>介面。 如需詳細資訊，請參閱 <<c0> [ 資料服務提供者](../../../../docs/framework/data/wcf/data-services-providers-wcf-data-services.md)。  
