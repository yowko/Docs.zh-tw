...
---
# <a name="how-to-create-a-data-service-using-the-reflection-provider-wcf-data-services"></a>作法：使用反映提供者建立資料服務 (WCF Data Services)
...
> [!NOTE]
> 由於本範例示範的是記憶體內部資料提供者，在目前物件執行個體外部所進行的變更將無法持續，因此實作 <xref:System.Data.Services.IUpdatable> 介面並不會產生任何益處。 如需實作為<xref:System.Data.Services.IUpdatable>介面的範例, 請參閱[如何:使用 LINQ to SQL 資料來源](../../../../docs/framework/data/wcf/create-a-data-service-using-linq-to-sql-wcf.md)建立資料服務。  
