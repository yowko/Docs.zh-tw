...
## <a name="in-this-section"></a>本章節內容  
 ...
 描述 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 提供的資料服務組態選項。  
 ...
 [摘要的自訂](../../../../docs/framework/data/wcf/feed-customization-wcf-data-services.md)  
 ...
 描述如何使用不同版本的[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]。  
  
 [WCF Data Services 通訊協定實作詳細資料](../../../../docs/framework/data/wcf/wcf-data-services-protocol-implementation-details.md)  
