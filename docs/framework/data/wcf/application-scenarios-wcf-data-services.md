...
ms.locfileid: "70791282"
---
# <a name="application-scenarios-wcf-data-services"></a>應用程式案例 (WCF 資料服務)

[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]支援一組核心案例，可將資料公開及取用[!INCLUDE[ssODataFull](../../../../includes/ssodatafull-md.md)]為摘要。 本主題會為您指出與這些案例有關的主題。
...
- [ODataJavaScript 物件標記法（JSON）格式](https://go.microsoft.com/fwlink/?LinkId=185790)
...
- [如何：使用專案資料來源系結資料](how-to-bind-data-using-a-project-data-source-wcf-data-services.md)
