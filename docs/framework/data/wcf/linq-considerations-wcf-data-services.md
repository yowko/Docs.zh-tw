...
|<xref:System.Linq.Expressions.Expression?qualifyHint=False&autoUpgrade=True> 成員|支援的 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 函數|  
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|  
