...
|<xref:System.DateTime.Year>|`int year(DateTime p0)`|  
 ...
 <sup>1</sup>同時也支援 <xref:Microsoft.VisualBasic.DateAndTime?displayProperty=nameWithType>的對等日期和時間屬性，以及 Visual Basic 中的 <xref:Microsoft.VisualBasic.DateAndTime.DatePart%2A> 方法。  
