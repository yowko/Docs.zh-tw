...
## <a name="in-this-section"></a>本節內容  
 [SQL Server 連線共用 (ADO.NET)](../../../../docs/framework/data/adonet/sql-server-connection-pooling.md)  
 提供連接共用的概觀並描述連接共用如何在 [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)] 中運作。  
