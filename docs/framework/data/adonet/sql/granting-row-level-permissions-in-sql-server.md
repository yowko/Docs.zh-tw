---
title: "在 SQL Server 中授與資料列層級權限 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   啟用資料列層級篩選：  
    ...
    -   如果您使用 SQL Server 2016 \(含\) 以上版本或 [Azure SQL Database](https://azure.microsoft.com/documentation/services/sql-database/)，請建立一個安全性原則將述詞加入資料表中，以限制傳回的資料列必須符合目前的資料庫使用者 \(使用 CURRENT\_USER\(\) 內建函式\) 或目前的登入名稱 \(使用 SUSER\_SNAME\(\) 內建函式\)：  
