...
> [!NOTE]
> 非同步程式設計是 .NET Framework 的核心功能，而 ADO.NET 可充分利用這些標準設計模式。 如需開發人員可用之不同非同步技術的詳細資訊，請參閱[以非同步方式呼叫同步方法](../../../../standard/asynchronous-programming-patterns/calling-synchronous-methods-asynchronously.md)。  
...
- [非同步呼叫同步方法](../../../../standard/asynchronous-programming-patterns/calling-synchronous-methods-asynchronously.md)
