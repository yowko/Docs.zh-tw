...
|資源|描述|  
|--------------|-----------------|  
|[程式碼存取安全性](https://msdn.microsoft.com/library/23a20143-241d-4fe5-9d9f-3933fd594c03)|包含說明 .NET Framework 中的 CAS 的主題。|  
|[CLR 整合安全性](https://go.microsoft.com/fwlink/?LinkId=59998)|討論在 SQL Server 內部執行之 Managed 程式碼的安全性模型。|  
