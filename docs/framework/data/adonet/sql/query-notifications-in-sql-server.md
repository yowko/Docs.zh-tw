---
title: "SQL Server 中的查詢通知 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
3.  此外，使用 ASP.NET 2.0 或更新版本建置的 Web 應用程式可以使用 `SqlCacheDependency` Helper 類別 \(Class\)。  
 ...
 如果您所開發的應用程式在資料變更時需擁有可靠的次秒通知，請查看**規劃有效率的查詢通知策略**和**查詢通知的替代方案**這兩節，其位於《SQL Server 線上叢書》的[通知計畫](http://go.microsoft.com/fwlink/?LinkId=211984)主題中。  如需查詢通知和 SQL Server Service Broker 的詳細資訊，請參閱下列《SQL Server 線上叢書》主題的連結。  
...
-   [開發 \(Service Broker\)](http://msdn.microsoft.com/library/bb522889.aspx)  
...
## 在本節中  
 ...
 [使用 SqlDependency 來偵測變更](../../../../../docs/framework/data/adonet/sql/detecting-changes-with-sqldependency.md)  
 示範如何偵測查詢結果何時會與原來接收的結果不同。  
  
 [使用 SqlNotificationRequest 的 SqlCommand 執行](../../../../../docs/framework/data/adonet/sql/sqlcommand-execution-with-a-sqlnotificationrequest.md)  
