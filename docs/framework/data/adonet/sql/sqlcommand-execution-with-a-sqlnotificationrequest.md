---
title: "使用 SqlNotificationRequest 的 SqlCommand 執行 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 使用 SqlNotificationRequest 的 SqlCommand 執行
...
### 範例  
 下列程式碼片段將示範如何建立 <xref:System.Data.Sql.SqlNotificationRequest> 並將它與 <xref:System.Data.Sql.SqlCommand> 產生關聯。  
