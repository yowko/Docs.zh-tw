---
title: "HOW TO：指定資料庫名稱 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# HOW TO：指定資料庫名稱
在 <xref:System.Data.Linq.Mapping.DatabaseAttribute> 屬性 \(Attribute\) 上使用 <xref:System.Data.Linq.Mapping.DatabaseAttribute.Name%2A> 屬性 \(Property\)，可在連接未提供名稱時指定資料庫名稱。  
