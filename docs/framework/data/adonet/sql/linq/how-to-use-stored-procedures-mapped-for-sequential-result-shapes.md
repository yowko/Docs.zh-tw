...
這種預存程序可以產生一個以上的結果圖案，但您會知道傳回結果的順序。 將此案例與您不知道傳回順序的案例相比較。 如需詳細資訊，請參閱[如何：針對多個結果圖形使用對應的預存程式](how-to-use-stored-procedures-mapped-for-multiple-result-shapes.md)。  
