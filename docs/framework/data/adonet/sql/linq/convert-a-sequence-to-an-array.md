...
---
# <a name="convert-a-sequence-to-an-array"></a>將序列轉換為陣列
使用 <xref:System.Linq.Enumerable.ToArray%2A> 可從序列建立陣列。  
  
## <a name="example"></a>範例  
 下列範例使用 <xref:System.Linq.Enumerable.ToArray%2A> 立即將查詢評估為陣列，並取得第三個項目。  
