...
- 搜尋 Microsoft Docs 中的特定問題。  
  
- 參與[LINQ 論壇](https://go.microsoft.com/fwlink/?LinkId=76488)，您可以在其中與專家討論更複雜的主題。  
  
- 研究詳述 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 技術的白皮書，其中包含 Visual Basic 和C#程式碼範例。 如需詳細資訊，請參閱[LINQ to SQL：關聯式資料的 .Net 語言整合式查詢](https://go.microsoft.com/fwlink/?LinkId=93205)。  
  
## <a name="in-this-section"></a>本章節內容  
 [ADO.NET 和 LINQ to SQL](ado-net-and-linq-to-sql.md)  
 描述 ADO.NET 和 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]的關聯性。  
 ...
 描述 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 如何使用 <xref:System.ComponentModel.IListSource> 來支援資料系結。  
 ...
 描述 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 中查詢的各個層面，與 LINQ 中的查詢不同。  
