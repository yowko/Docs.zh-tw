...
- 搜索 Microsoft 文檔以查找特定問題。  
  
- 參加[LINQ論壇](https://social.msdn.microsoft.com/forums/home?forum=linqtosql)，在那裡你可以與專家詳細討論更複雜的話題。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 描述ADO.NET和[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]的關係。  
 ...
 描述如何使用[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]<xref:System.ComponentModel.IListSource>來支援資料繫結。  
 ...
 描述與[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]LINQ 中的查詢不同的查詢的各個方面。  
