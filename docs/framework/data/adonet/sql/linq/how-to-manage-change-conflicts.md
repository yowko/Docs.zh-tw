...
---
# <a name="how-to-manage-change-conflicts"></a>HOW TO：管理變更衝突
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 提供一系列 Api，可協助您探索、 評估和解決並行衝突。  
  
## <a name="in-this-section"></a>本節內容  
 [如何：偵測和解決衝突的提交內容](../../../../../../docs/framework/data/adonet/sql/linq/how-to-detect-and-resolve-conflicting-submissions.md)  
 描述如何偵測和解決並行存取衝突。  
  
 [如何：指定時的並行存取例外狀況的擲回](../../../../../../docs/framework/data/adonet/sql/linq/how-to-specify-when-concurrency-exceptions-are-thrown.md)  
 ...
 [如何：與資料庫值合併來解決衝突](../../../../../../docs/framework/data/adonet/sql/linq/how-to-resolve-conflicts-by-merging-with-database-values.md)  
 描述如何合併資料庫和目前值來解決衝突。  
