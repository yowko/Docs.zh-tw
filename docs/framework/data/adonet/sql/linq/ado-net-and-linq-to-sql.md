...
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 是 ADO.NET 系列技術的一部分。 它是以 ADO.NET 提供者模型所提供的服務為基礎。 因此，您可以混用現有 ADO.NET 應用程式的 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 程式碼，並將目前的 ADO.NET 解決方案遷移至 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]。 下圖提供關聯性 (Relationship) 的高層級檢視。  
  
 ![LINQ to SQL 和 ADO.NET](./media/dlinq-3.png "DLinq_3")  
  
## <a name="connections"></a>連線  
 當您建立 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] <xref:System.Data.Linq.DataContext>時，可以提供現有的 ADO.NET 連接。 針對 <xref:System.Data.Linq.DataContext> 的所有作業（包括查詢）都會使用此提供的連接。 如果連接已開啟，[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 將其保留為已完成。  
