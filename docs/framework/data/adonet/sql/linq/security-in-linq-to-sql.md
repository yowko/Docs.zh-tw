---
title: "LINQ to SQL 的安全性 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   使用 <xref:System.Data.SqlClient.SqlConnection?displayProperty=fullName> 類別 \(Class\) 來取代連接字串，因為它會限制公開的持續期間。  您可以使用 <xref:System.Data.SqlClient.SqlConnection> 來具現化 LINQ to SQL <xref:System.Data.Linq.DataContext?displayProperty=fullName> 類別。  
