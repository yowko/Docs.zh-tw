---
title: "從識別快取擷取物件 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  預先編譯的查詢不會從識別快取傳回物件。  如需預先編譯之查詢的詳細資訊，請參閱 <xref:System.Data.Linq.CompiledQuery> 和 [HOW TO：儲存和重複使用查詢](../../../../../../docs/framework/data/adonet/sql/linq/how-to-store-and-reuse-queries.md)。  
