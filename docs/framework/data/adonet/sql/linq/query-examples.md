...
本節提供一般[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]查詢的C# Visual Basic 和範例。 使用 Visual Studio 的開發人員可以在範例一節中提供的範例解決方案中找到更多範例。 如需詳細資訊, 請參閱[範例](../../../../../../docs/framework/data/adonet/sql/linq/samples.md)。  
  
> [!IMPORTANT]
> 在[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]檔的程式碼範例中, 通常會使用 db。 假設*db*是*Northwind*類別的實例, 它會繼承自<xref:System.Data.Linq.DataContext>。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 提供與其他功能`select` (例如*匿名型別*) 結合以形成查詢投影的範例。  
