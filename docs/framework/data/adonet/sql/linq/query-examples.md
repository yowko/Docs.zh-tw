...
## <a name="in-this-section"></a>本章節內容  
 ...
 [排序順序中的項目](../../../../../../docs/framework/data/adonet/sql/linq/sort-elements-in-a-sequence.md)  
 提供 <xref:System.Linq.Enumerable.OrderBy%2A> 的使用範例。  
  
 [序列中的群組項目](../../../../../../docs/framework/data/adonet/sql/linq/group-elements-in-a-sequence.md)  
 提供 <xref:System.Linq.Enumerable.GroupBy%2A> 的使用範例。  
  
 [排除重複的項目，從序列](../../../../../../docs/framework/data/adonet/sql/linq/eliminate-duplicate-elements-from-a-sequence.md)  
 提供 <xref:System.Linq.Enumerable.Distinct%2A> 的使用範例。  
  
 [決定是否序列中的任何或所有項目滿足條件](../../../../../../docs/framework/data/adonet/sql/linq/determine-if-any-or-all-elements-in-a-sequence-satisfy-a-condition.md)  
 ...
 [將序列轉換為一般清單](../../../../../../docs/framework/data/adonet/sql/linq/convert-a-sequence-to-a-generic-list.md)  
 提供 <xref:System.Linq.Enumerable.ToList%2A> 的使用範例。  
  
 [將類型轉換成泛型 IEnumerable](../../../../../../docs/framework/data/adonet/sql/linq/convert-a-type-to-a-generic-ienumerable.md)  
