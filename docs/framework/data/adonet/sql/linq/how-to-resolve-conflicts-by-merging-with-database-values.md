---
title: "HOW TO：藉由合併資料庫值來解決並行衝突 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# HOW TO：藉由合併資料庫值來解決並行衝突
若要先協調預期和實際資料庫值之間的差異再重新送出變更，可以使用 <xref:System.Data.Linq.RefreshMode> 來合併資料庫值與目前用戶端成員值。  如需詳細資訊，請參閱[開放式並行存取概觀](../../../../../../docs/framework/data/adonet/sql/linq/optimistic-concurrency-overview.md)。  
...
## 請參閱  
 [HOW TO：藉由覆寫資料庫值來解決並行衝突](../../../../../../docs/framework/data/adonet/sql/linq/how-to-resolve-conflicts-by-overwriting-database-values.md)   
 [HOW TO：藉由保留資料庫值來解決並行衝突](../../../../../../docs/framework/data/adonet/sql/linq/how-to-resolve-conflicts-by-retaining-database-values.md)   
