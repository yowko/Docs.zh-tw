...
## <a name="selecting"></a>選取  
 只要以您自己的程式設計語言撰寫 LINQ 查詢，然後執行該查詢來抓取結果，就可以選取（*投影*）。 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 會將所有必要的作業轉譯成熟悉的 SQL 作業。 如需詳細資訊，請參閱 [LINQ to SQL](index.md)。  
...
> [!NOTE]
> [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 無法辨識串聯刪除作業。 如果您想要刪除具有條件約束之資料表中的資料列，請參閱[如何：從資料庫刪除資料列](how-to-delete-rows-from-the-database.md)。  
