---
title: "LINQ to SQL 的功能 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 無法辨識串聯刪除作業。 如果您要刪除有條件約束之資料表中的資料列，請參閱[HOW TO：從資料庫刪除資料列](../../../../../../docs/framework/data/adonet/sql/linq/how-to-delete-rows-from-the-database.md)。  
