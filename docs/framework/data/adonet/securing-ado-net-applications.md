...
## <a name="in-this-section"></a>本章節內容  
 ...
 [保護用戶端應用程式](../../../../docs/framework/data/adonet/secure-client-applications.md)  
 說明用戶端應用程式的安全性考量。  
  
 [程式碼存取安全性和 ADO.NET](../../../../docs/framework/data/adonet/code-access-security.md)  
 說明 CAS 如何協助保護 ADO.NET 程式碼， 也將討論如何使用部分信任。  
  
 [隱私權與資料安全性](../../../../docs/framework/data/adonet/privacy-and-data-security.md)  
...
## <a name="related-sections"></a>相關章節  
 ...
 [安全性工具](http://msdn.microsoft.com/en-us/2a3eb98a-2de6-4fba-b41c-01a74d354c11)  
 保護及管理安全性原則的 .NET Framework 工具。  
  
 [建立安全應用程式資源](http://msdn.microsoft.com/en-us/0ebf5f69-76f2-498a-a2df-83cf3443e132)  
 提供建立安全應用程式的主題連結。  
