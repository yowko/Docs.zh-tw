...
## <a name="windows-applications"></a>Windows 應用程式  
 ...
 [ClickOnce 部署適用於 Windows Forms 應用程式](http://msdn.microsoft.com/en-us/34d8c770-48f2-460c-8d67-4ea5684511df)  
...
|[NIB： 基本的 ASP.NET Web 應用程式的安全性做法](http://msdn.microsoft.com/en-us/94a52ab8-731d-417e-b997-721baf43df38)|一般安全性資訊以及進階討論區的連結。|  
