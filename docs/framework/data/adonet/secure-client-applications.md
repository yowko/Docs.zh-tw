...
|Resource|描述|  
|--------------|-----------------|  
|[保護 ASP.NET 的網站](https://docs.microsoft.com/previous-versions/aspnet/91f66yxt(v=vs.100))|討論如何保護 ASP.NET 應用程式。|  
|[保護使用 ASP.NET 建立的 XML Web Service](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/w67h0dw7(v=vs.100))|討論如何實作 ASP.NET Web 服務的安全性。|  
|[腳本攻擊總覽](https://docs.microsoft.com/previous-versions/aspnet/w1sw53ds(v=vs.100))|說明如何防堵指令碼式攻擊，此類攻擊會嘗試在網頁中插入惡意的字元。|  
