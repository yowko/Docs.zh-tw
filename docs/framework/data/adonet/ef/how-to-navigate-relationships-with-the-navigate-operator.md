...
## <a name="example"></a>範例  
 下列範例示範如何 [!INCLUDE[esql](../../../../../includes/esql-md.md)] 使用 [導覽](./language-reference/navigate-entity-sql.md) 運算子來導覽中的關聯性。 `Navigate`運算子會使用下列參數：實體的實例、關聯性類型、關聯性的結尾，以及關聯性的開頭。 （選擇性）您只能將實體的實例和關聯性類型傳遞給 `Navigate` 運算子。  
