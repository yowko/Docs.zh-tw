...
## <a name="collections"></a>集合  
 集合型別代表零個或多個其他物件的執行個體。 如需如何建立集合的資訊，請參閱[建構類型](../../../../../../docs/framework/data/adonet/ef/language-reference/constructing-types-entity-sql.md)。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [轉型](../../../../../../docs/framework/data/adonet/ef/language-reference/cast-entity-sql.md)  
