...
[!INCLUDE[esql](../../../../../../includes/esql-md.md)] 包含日期和時間標準函式。  
...
|`CreateTime(hour,minute,second)`|傳回新 `Time` 值做為目前時間。<br /><br /> **引數**<br /><br /> `hour` 並`minute`: `Int32`。<br /><br /> `second`: `Double`.<br /><br /> **傳回值**<br /><br /> `Time`。|  
