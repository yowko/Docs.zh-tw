...
|`Year(` `expression` `)`|傳回的年部分`expression`為`Int32``YYYY`。<br /><br /> **引數**<br /><br /> `DateTime` 和 `DateTimeOffset`。<br /><br /> **傳回值**<br /><br /> `Int32`。<br /><br /> **範例**<br /><br /> `-- The following example returns 1998.`<br /><br /> `Year(cast('03/12/1998' as DateTime))`|  
