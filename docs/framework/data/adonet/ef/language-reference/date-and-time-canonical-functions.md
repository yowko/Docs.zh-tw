...
## <a name="remarks"></a>備註  
 ...
 下表顯示日期和時間標準函式 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 。 `datetime` 這是一個 <xref:System.DateTime> 值。  
...
|`GetTotalOffsetMinutes(datetimeoffset)`|傳回 `datetimeoffset` 與格林威治標準時間 (GMT) 間的時差分鐘數。 這項值通常介於 +780 到 -780 之間 (+ 或 - 13 小時)。 **注意：**  只有 SQL Server 2008 支援此函數。 <br /><br /> **引數**<br /><br /> `DateTimeOffset`。<br /><br /> **傳回值**<br /><br /> `Int32`。|  
...
|`Year(expression)`|傳回的年份部分 `expression` `Int32` `YYYY` 。<br /><br /> **引數**<br /><br /> `DateTime` 和 `DateTimeOffset`。<br /><br /> **傳回值**<br /><br /> `Int32`。<br /><br /> **範例**<br /><br /> `-- The following example returns 1998.`<br /><br /> `Year(cast('03/12/1998' as DateTime))`|  
