---
title: "Null 常值和類型推斷 (Entity SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Null 常值和類型推斷 (Entity SQL)
Null 常值與 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 型別系統中的任何型別都相容。  但是，若要能夠正確推斷 Null 常值的型別，[!INCLUDE[esql](../../../../../../includes/esql-md.md)] 對於可以使用 Null 常值的情況會加諸某些限制。  
