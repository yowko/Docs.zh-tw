---
title: "查詢運算式語法範例：投影 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 查詢運算式語法範例：投影
本主題中的範例將示範如何使用 `Select` 方法和 `From … From …` 關鍵字，透過查詢運算式語法來查詢 [AdventureWorks 銷售模型](http://msdn.microsoft.com/zh-tw/f16cd988-673f-4376-b034-129ca93c7832)。  `From … From …` 以查詢為基礎，等同於 `SelectMany` 方法。  這些範例中使用的 AdventureWorks Sales Model 是根據 AdventureWorks 範例資料庫中的 Contact、Address、Product、SalesOrderHeader 和 SalesOrderDetail 資料表所建立。  
