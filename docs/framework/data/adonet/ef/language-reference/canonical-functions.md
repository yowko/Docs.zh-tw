...
本節討論所有資料提供者都支援，而且可由所有查詢技術使用的標準函式。  標準函式無法由提供者擴允。  
 ...
 就 LINQ 案例而言，針對 [!INCLUDE[adonet_ef](../../../../../../includes/adonet-ef-md.md)] 的查詢必須將 CLR 方法對應到基礎資料來源中的方法。  CLR 方法會對應到標準函式，這樣一來便會正確對應一組特定的方法，而不用顧慮資料來源為何。  
...
## 請參閱  
 ...
 [概念模型標準與 SQL Server 函式對應](../../../../../../docs/framework/data/adonet/ef/conceptual-model-canonical-to-sql-server-functions-mapping.md)   
