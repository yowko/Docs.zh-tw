...
本節討論所有資料提供者都支援，而且可由所有查詢技術使用的標準函式。 標準函式無法由提供者擴允。  
 ...
 在 LINQ 案例中，對 Entity Framework 的查詢牽涉到將 CLR 方法對應到基礎資料來源中的方法。 CLR 方法會對應到標準函式，這樣一來便會正確對應一組特定的方法，而不用顧慮資料來源為何。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 [日期及時間標準函式](date-and-time-canonical-functions.md)  
