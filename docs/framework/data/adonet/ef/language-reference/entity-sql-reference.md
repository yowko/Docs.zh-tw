---
title: "Entity SQL 參考 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Entity SQL 參考
本章節內容包括 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 參考主題。本主題依照分類摘要說明和分組 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 運算子。  
...
|運算子|用法|  
|---------|--------|  
|[\+ \(加號\)](../../../../../../docs/framework/data/adonet/ef/language-reference/add.md)|加法。|  
|[\/ \(除號\)](../../../../../../docs/framework/data/adonet/ef/language-reference/divide-entity-sql.md)|除法。|  
|[% \(模數\)](../../../../../../docs/framework/data/adonet/ef/language-reference/modulo-entity-sql.md)|傳回除法的餘數。|  
|[\* \(乘號\)](../../../../../../docs/framework/data/adonet/ef/language-reference/multiply-entity-sql.md)|乘法。|  
|[\- \(負號\)](../../../../../../docs/framework/data/adonet/ef/language-reference/negative-entity-sql.md)|否定。|  
|[\- \(減號\)](../../../../../../docs/framework/data/adonet/ef/language-reference/subtract-entity-sql.md)|減法。|  
...
|[日期及時間標準函式](../../../../../../docs/framework/data/adonet/ef/language-reference/date-and-time-canonical-functions.md)|討論日期和時間 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 標準函式。|  
...
|運算子|描述|  
|---------|--------|  
|[\= \(等號\)](../../../../../../docs/framework/data/adonet/ef/language-reference/equals-entity-sql.md)|比較兩個運算式是否相等。|  
...
|[IS &#91;NOT&#93; NULL](../../../../../../docs/framework/data/adonet/ef/language-reference/isnull-entity-sql.md)|判斷查詢運算式是否為 null。|  
...
|[THEN](../../../../../../docs/framework/data/adonet/ef/language-reference/then-entity-sql.md)|[WHEN](http://msdn.microsoft.com/zh-tw/6233fe9f-00b0-460e-8372-64e138a5f998) 子句的評估為 true 時，該子句的結果。|  
...
|運算子|用法|  
|---------|--------|  
|[FROM](../../../../../../docs/framework/data/adonet/ef/language-reference/from-entity-sql.md)|指定 [SELECT](../../../../../../docs/framework/data/adonet/ef/language-reference/select-entity-sql.md) 陳述式中使用的集合。|  
|[GROUP BY](../../../../../../docs/framework/data/adonet/ef/language-reference/group-by-entity-sql.md)|指定要放置查詢 \([SELECT](../../../../../../docs/framework/data/adonet/ef/language-reference/select-entity-sql.md)\) 運算式所傳回物件的群組。|  
...
|[LIMIT](../../../../../../docs/framework/data/adonet/ef/language-reference/limit-entity-sql.md)|與 [ORDER BY](../../../../../../docs/framework/data/adonet/ef/language-reference/order-by-entity-sql.md) 子句搭配，在已執行的實際分頁中使用。|  
|[ORDER BY](../../../../../../docs/framework/data/adonet/ef/language-reference/order-by-entity-sql.md)|指定 [SELECT](../../../../../../docs/framework/data/adonet/ef/language-reference/select-entity-sql.md) 陳述式所傳回之物件使用的排序順序。|  
|[SELECT](../../../../../../docs/framework/data/adonet/ef/language-reference/select-entity-sql.md)|指定查詢傳回的投影項目。|  
|[SKIP](../../../../../../docs/framework/data/adonet/ef/language-reference/skip-entity-sql.md)|與 [ORDER BY](../../../../../../docs/framework/data/adonet/ef/language-reference/order-by-entity-sql.md) 子句搭配，在已執行的實際分頁中使用。|  
...
## 參考運算子參考  
 參考是指向特定實體集中特定實體的邏輯指標 \(外部索引鍵\)。  [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 支援下列經由參考來建構、解構及巡覽的運算子。  
...
## 集合運算子  
 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 提供許多功能強大的設定作業。  其中包括類似 Transact\-SQL 運算子的設定運算子，例如 UNION、INTERSECT、EXCEPT 和 EXISTS。  [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 也支援重複項目刪除 \(SET\)、成員資格測試 \(IN\) 和聯結 \(JOIN\) 運算子。  以下資料表列出 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 設定運算子。  
...
## 運算子型別  
 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 提供一些運算子，可用於建構、查詢和操作運算式 \(值\) 的型別。  以下資料表列出可與型別一起使用的運算子。  
  
|運算子|用法|  
|---------|--------|  
|[CAST](../../../../../../docs/framework/data/adonet/ef/language-reference/cast-entity-sql.md)|將一種資料類型的運算式轉換成另一種。|  
|[COLLECTION](../../../../../../docs/framework/data/adonet/ef/language-reference/collection-entity-sql.md)|用於 [FUNCTION](../../../../../../docs/framework/data/adonet/ef/language-reference/function-entity-sql.md) 作業之中，可宣告實體類型或複雜型別的集合。|  
...
## 其他運算子  
 以下資料表列出其他 [!INCLUDE[esql](../../../../../../includes/esql-md.md)] 運算子。  
