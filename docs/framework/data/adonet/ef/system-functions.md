...
|功能|描述|  
|--------------|-----------------|  
|`CHECKSUM (` `value`, [`value`, [`value`]]`)`|傳回總和檢查碼值。 `CHECKSUM` 是用來建立雜湊索引。<br /><br /> **引數**<br /><br /> `value`:A `Boolean`， `Byte`， `Int16`， `Int32`， `Int64`， `Single`， `Decimal`， `Double`， `DateTime`， `String`， `Binary`，或`Guid`。 您可以指定一個、兩個或三個值。<br /><br /> **傳回值**<br /><br /> 指定之運算式的絕對值。<br /><br /> **範例**<br /><br /> `SqlServer.CHECKSUM(10,100,1000.0)`|  
...
|---------------------|---------------------|---------------------|  
|[系統函數 (Transact-SQL)](https://go.microsoft.com/fwlink/?LinkId=115918)|[系統函數 (Transact-SQL)](https://go.microsoft.com/fwlink/?LinkId=115917)|[系統函數 (Transact-SQL)](https://go.microsoft.com/fwlink/?LinkId=115919)|  
