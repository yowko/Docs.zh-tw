...
ms.locfileid: "54648228"
---
# <a name="facet"></a>facet
A *facet*用以基本型別屬性定義中加入詳細資料。 A[屬性](../../../../docs/framework/data/adonet/property.md)定義包含有關屬性型別資訊，但通常是需要更多詳細資料。 例如，概念模型中的實體類型可能會有 `String` 型別的屬性，其值不可設為 null。 Facet 可讓您指定此詳細層級。  
