...
## <a name="in-this-section"></a>本章節內容  
 ...
 [從使用 OracleDataReader 的多個 REF Cursor 擷取資料](../../../../docs/framework/data/adonet/retrieving-data-from-multiple-ref-cursors.md)  
 示範如何執行傳回兩個 REF CURSOR 參數，並讀取值使用的 PL/SQL 預存程序**OracleDataReader**。  
  
 [填入資料集使用其中一或多個 REF Cursor](../../../../docs/framework/data/adonet/filling-a-dataset-using-one-or-more-ref-cursors.md)  
