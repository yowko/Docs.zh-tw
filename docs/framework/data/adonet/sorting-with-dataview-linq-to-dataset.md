...
## <a name="creating-dataview-from-a-query-with-sorting-information"></a>從含有排序資訊的查詢中建立 DataView  
 ...
 在您建立 <xref:System.Data.DataView> 以及修改任何排序或篩選資訊時，系統就會建立 <xref:System.Data.DataView> 的索引。 在建立的 LINQ to DataSet 查詢<xref:System.Data.DataView>中提供排序準則, 並在稍後不修改排序資訊, 以獲得最佳效能。 如需詳細資訊, 請參閱[DataView Performance](../../../../docs/framework/data/adonet/dataview-performance.md)。  
...
## <a name="using-the-string-based-sort-property"></a>使用以字串為基礎的 Sort 屬性  
 ...
 如需以字串為基礎<xref:System.Data.DataView.Sort%2A>之篩選的詳細資訊, 請參閱[排序和篩選資料](../../../../docs/framework/data/adonet/dataset-datatable-dataview/sorting-and-filtering-data.md)。  
