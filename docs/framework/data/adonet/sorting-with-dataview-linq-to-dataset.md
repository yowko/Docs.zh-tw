...
## <a name="using-the-string-based-sort-property"></a>使用以字串為基礎的 Sort 屬性  
 ...
 如需有關字串型<xref:System.Data.DataView.Sort%2A>篩選，請參閱[排序及篩選資料](../../../../docs/framework/data/adonet/dataset-datatable-dataview/sorting-and-filtering-data.md)。  
