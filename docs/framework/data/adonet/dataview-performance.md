---
title: "DataView 效能 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# DataView 效能
本主題將討論使用 <xref:System.Data.DataView> 類別 \(Class\) 之 <xref:System.Data.DataView.Find%2A> 和 <xref:System.Data.DataView.FindRows%2A> 方法以及在 Web 應用程式中快取 <xref:System.Data.DataView> 的效能提升。  
