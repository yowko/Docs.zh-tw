...
## <a name="linq-to-dataset"></a>LINQ to DataSet  
 <xref:System.Data.DataSet>是中斷連接程式設計模型，ADO.NET 為基礎，並廣泛使用的重要項目。 [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)] 可讓開發人員使用適用於許多其他資料來源的相同查詢編寫機制，在 <xref:System.Data.DataSet> 中建立更豐富的查詢功能。 如需詳細資訊，請參閱 [LINQ to DataSet](../../../../docs/framework/data/adonet/linq-to-dataset.md)。  
