...
### <a name="xboolean"></a>x:Boolean  
 ...
 XAML 將 `x:Boolean` 的值剖析為不區分大小寫。 請注意， `x:Bool` 不是可接受的替代方案。 如需 XAML 語言規格定義，請參閱[ \[第5.2.17 和\] 5.4.11 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### <a name="xchar"></a>x:Char  
 對於 CLR 支援， `x:Char` 基本類型對應至 <xref:System.Char>。  
  
 字串和 char 類型會與 XML 層級之檔案的整體編碼間互動。 如需 XAML 語言規格定義，請參閱[ \[5.2.7 和\] 5.4.1 版的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### <a name="xstring"></a>x:String  
 對於 CLR 支援， `x:String` 基本類型對應至 <xref:System.String>。  
  
 字串和 char 類型會與 XML 層級之檔案的整體編碼間互動。 如需 XAML 語言規格定義，請參閱 < [ \[MS\] -XAML 區段 microsoft.aspnet.webapi 5.2.6](https://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### <a name="xdecimal"></a>x:Decimal  
 ...
 如需 XAML 語言規格定義，請參閱[ \[第5.2.14 和\] 5.4.8 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### <a name="xsingle"></a>x:Single  
 ...
 如需 XAML 語言規格定義，請參閱[ \[第5.2.8 和\] 5.4.2 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### <a name="xdouble"></a>x:Double  
 ...
 如需 XAML 語言規格定義，請參閱[ \[第5.2.9 和\] 5.4.3 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### <a name="xint16"></a>x:Int16  
 對於 CLR 支援， `x:Int16` 基本類型對應至 <xref:System.Int16> ，並將 `x:Int16` 視為帶正負號。 在 XAML 中，文字語法中沒有加號 (`+`) 隱含為正數的帶正負號值。  
  
 如需 XAML 語言規格定義，請參閱[ \[第5.2.11 和\] 5.4.5 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### <a name="xint32"></a>x:Int32  
 對於 CLR 支援， `x:Int32` 基本類型對應至 <xref:System.Int32>。 `x:Int32` 視為帶正負號。 在 XAML 中，文字語法中沒有加號 (`+`) 隱含為正數的帶正負號值。  
  
 如需 XAML 語言規格定義，請參閱[ \[第5.2.12 和\] 5.4.6 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### <a name="xint64"></a>x:Int64  
 對於 CLR 支援， `x:Int64` 基本類型對應至 <xref:System.Int64>。 `x:Int64` 視為帶正負號。 在 XAML 中，文字語法中沒有加號 (`+`) 隱含為正數的帶正負號值。  
  
 如需 XAML 語言規格定義，請參閱[ \[第5.2.13 和\] 5.4.7 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### <a name="xtimespan"></a>x:TimeSpan  
 ...
 如需 XAML 語言規格定義，請參閱[ \[5.2.16 和\] 5.4.10 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### <a name="xuri"></a>x:Uri  
 ...
 如需 XAML 語言規格定義，請參閱[ \[第5.2.15 和\] 5.4.9 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### <a name="xbyte"></a>x:Byte  
 對於 CLR 支援， `x:Byte` 基本類型對應至 <xref:System.Byte>。 會被視為不<xref:System.Byte>帶正負號。  /  `x:Byte`  
  
 如需 XAML 語言規格定義，請參閱[ \[第5.2.10 和\] 5.4.4 的 MS-XAML 區段](https://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### <a name="xarray"></a>x:Array  
 ...
 如需 XAML 語言規格定義，請參閱 < [ \[MS\] -XAML 區段 5.2.18](https://go.microsoft.com/fwlink/?LinkId=114525)。  
