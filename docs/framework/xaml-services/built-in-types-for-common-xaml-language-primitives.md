...
### x:Boolean  
 ...
 XAML 將 `x:Boolean` 的值剖析為不區分大小寫。 請注意，`x:Bool` 不是可接受的替代方案。 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.17 和 5.4.11 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### x:Char  
 對於 CLR 支援，`x:Char` 基本類型對應至 <xref:System.Char>。  
  
 字串和 char 類型會與 XML 層級之檔案的整體編碼間互動。 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.7 和 5.4.1 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### x:String  
 對於 CLR 支援，`x:String` 基本類型對應至 <xref:System.String>。  
  
 字串和 char 類型會與 XML 層級之檔案的整體編碼間互動。 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.6 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### x:Single  
 ...
 如果文字語法中的第一個字元是 `e` 或 `E`，`x:Single` 可以支援科學標記法格式的值。  
...
### x:Double  
 ...
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.9 和 5.4.3 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### x:Int16  
 對於 CLR 支援，`x:Int16` 基本類型對應至 <xref:System.Int16>，並將 `x:Int16` 視為帶正負號。 在 XAML 中，文字語法中沒有加號 \(`+`\) 隱含為正數的帶正負號值。  
  
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.11 和 5.4.5 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### x:Int32  
 對於 CLR 支援，`x:Int32` 基本類型對應至 <xref:System.Int32>。`x:Int32` 視為帶正負號。 在 XAML 中，文字語法中沒有加號 \(`+`\) 隱含為正數的帶正負號值。  
  
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.12 和 5.4.6 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### x:Int64  
 對於 CLR 支援，`x:Int64` 基本類型對應至 <xref:System.Int64>。`x:Int64` 視為帶正負號。 在 XAML 中，文字語法中沒有加號 \(`+`\) 隱含為正數的帶正負號值。  
  
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.13 和 5.4.7 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### x:TimeSpan  
 ...
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.16 和 5.4.10 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### x:Uri  
 ...
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.15 和 5.4.9 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
### x:Byte  
 對於 CLR 支援，`x:Byte` 基本類型對應至 <xref:System.Byte>。<xref:System.Byte>\/`x:Byte` 視為不帶正負號。  
  
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.10 和 5.4.4 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
...
### x:Array  
 ...
 如需 XAML 語言規格定義，請參閱 [\[MS\-XAML\] 第 5.2.18 節](http://go.microsoft.com/fwlink/?LinkId=114525)。  
  
<a name="wpf_support"></a>   
## WPF 支援  
 在 WPF 中，您可以使用 XAML 2009 功能，但只能針對未編譯標記的 XAML。 WPF 之編譯標記的 XAML 和 BAML 形式的 XAML 目前不支援 XAML 2009 關鍵字和功能。  
  
 可以搭配使用 XAML 2009 功能與 WPF 的情況是您編寫鬆散的 XAML，然後使用 <xref:System.Windows.Markup.XamlReader.Load%2A?displayProperty=fullName> 將該 XAML 載入 WPF 執行階段和物件圖。 WPF <xref:System.Windows.Markup.XamlReader?displayProperty=fullName> 和其 <xref:System.Windows.Markup.XamlReader.Load%2A> 可以將 XAML 2009 語言關鍵字和功能處理為有效的物件圖表示法。