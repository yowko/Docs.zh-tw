...
-   請勿變更 **InprocServer32** 或已經註冊之 COM 伺服器的其他登錄項目。  
...
## 檔案版本號碼和組件版本號碼  
 ...
 [全域組件快取工具 \(Gacutil.exe\)](../../../docs/framework/tools/gacutil-exe-gac-tool.md) 讓您可以在只有檔案版本號碼較新時取代組件。  除非組件版本號碼比較高，否則安裝程式通常不會在組件上執行覆寫安裝。  
