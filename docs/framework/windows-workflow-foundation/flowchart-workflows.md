...
## <a name="flowchart-workflow-structure"></a>流程圖工作流程結構
...
## <a name="types-of-flow-nodes"></a>流程節點的類型
...
### <a name="creating-a-basic-activity-sequence-with-a-flowstep-node"></a>使用 FlowStep 節點建立基本活動順序
...
### <a name="creating-a-conditional-flowchart-with-a-flowdecision-node"></a>建立具有 FlowDecision 節點的條件式流程圖
...
### <a name="creating-an-exclusive-switch-with-a-flowswitch-node"></a>建立具有 FlowSwitch-節點的獨佔交換器
