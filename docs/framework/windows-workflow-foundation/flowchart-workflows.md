...
## <a name="flowchart-workflow-structure"></a>流程圖工作流結構
...
## <a name="types-of-flow-nodes"></a>流節點的類型
...
### <a name="creating-a-basic-activity-sequence-with-a-flowstep-node"></a>使用 FlowStep 節點創建基本活動序列
...
### <a name="creating-a-conditional-flowchart-with-a-flowdecision-node"></a>使用 Flow決策節點創建條件流程圖
...
### <a name="creating-an-exclusive-switch-with-a-flowswitch-node"></a>使用 FlowSwitch-節點創建獨佔交換器
