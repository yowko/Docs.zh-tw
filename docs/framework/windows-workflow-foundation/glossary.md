---
title: ".NET Framework 4.5 的 Windows Workflow Foundation 字彙 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "WF [WF], 字彙"
  - "Windows Workflow Foundation [WF], 字彙"
...
---
# .NET Framework 4.5 的 Windows Workflow Foundation 字彙
...
|詞彙|定義|  
|--------|--------|  
|Activity \- 活動|Windows Workflow Foundation 中程式行為的單元。可將單一活動組成更複雜的活動。|  
...
|Compensation \- 補償|設計用來恢復或降低先前完成工作之影響的動作群組。|  
|Correlation \- 相互關聯|路由傳送訊息至工作流程或服務執行個體的機制。|  
...
|Variable \- 變數|表示必須儲存以供稍後存取之一些資料的儲存體。|  
|Workflow \- 工作流程|主機處理序所叫用之單一活動或活動樹狀結構。|  
|XAML|eXtensible 應用程式標記語言|