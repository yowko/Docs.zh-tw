...
[!INCLUDE[wfd1](../../../includes/wfd1-md.md)] 可因建立、修改與監控工作流程等目的，在 [!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)] 之外的環境重新裝載。  
 ...
 <xref:System.Activities.Presentation.WorkflowDesigner> 型別是畫布、屬性方格與其他項目的包裝函式，並公開基本程式設計模型以處理大部分的設計工具重新裝載實例。 在 <xref:System.Activities.Presentation.WorkflowDesigner> 應用程式中裝載 [!INCLUDE[avalon1](../../../includes/avalon1-md.md)] 是 [!INCLUDE[wfd2](../../../includes/wfd2-md.md)] 的一般重新裝載案例。  
