...
1.  開啟**WF45GettingStartedTutorial**中的解決方案[!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)]如果尚未開啟。  
...
9. 重新開啟**WF45GettingStartedTutorial**中的解決方案[!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)]。  
...
**1 是過低。**   
**請輸入介於 1 到 10 之間的數字**   
**2 是正確的。您猜猜看 4。**      追蹤檔中包含更新的 `WriteLine` 輸出，包括在本主題中加入之 `WriteLine` 的輸出。  
