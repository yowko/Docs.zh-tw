...
###  <span data-ttu-id="0f865-115"><a name="WFDesigner"></a>在工作流程設計工具中使用 C# 運算式</span><span class="sxs-lookup"><span data-stu-id="0f865-115"><a name="WFDesigner"></a> Using C# expressions in the Workflow Designer</span></span>  
...
####  <span data-ttu-id="0f865-124"><a name="BackwardCompat"></a>回溯相容性</span><span class="sxs-lookup"><span data-stu-id="0f865-124"><a name="BackwardCompat"></a> Backwards compatibility</span></span>  
...
###  <span data-ttu-id="0f865-130"><a name="CodeWorkflows"></a>在程式碼工作流程中使用 C# 運算式</span><span class="sxs-lookup"><span data-stu-id="0f865-130"><a name="CodeWorkflows"></a> Using C# expressions in code workflows</span></span>  
...
###  <span data-ttu-id="0f865-147"><a name="XamlWorkflows"></a>在 XAML 工作流程中使用 C# 運算式</span><span class="sxs-lookup"><span data-stu-id="0f865-147"><a name="XamlWorkflows"></a> Using C# expressions in XAML workflows</span></span>  
...
####  <span data-ttu-id="0f865-152"><a name="CompiledXaml"></a>編譯的 Xaml</span><span class="sxs-lookup"><span data-stu-id="0f865-152"><a name="CompiledXaml"></a> Compiled Xaml</span></span>  
...
####  <span data-ttu-id="0f865-155"><a name="LooseXaml"></a>鬆散的 Xaml</span><span class="sxs-lookup"><span data-stu-id="0f865-155"><a name="LooseXaml"></a> Loose Xaml</span></span>  
...
###  <span data-ttu-id="0f865-162"><a name="WFServices"></a>在 XAMLX 工作流程服務中使用 C# 運算式</span><span class="sxs-lookup"><span data-stu-id="0f865-162"><a name="WFServices"></a> Using C# expressions in XAMLX workflow services</span></span>  
