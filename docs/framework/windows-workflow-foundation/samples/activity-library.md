 ---
標題: 「 活動程式庫 」 ms.custom:""ms.date:"03/30/2017"ms.prod: <.net framework > ms.reviewer 會:""ms.suite:""ms.tgt_pltfrm:""ms.topic: 「 發行項"ms.assetid: 5323e9d4-71d6-47eb-bfa6-31feac62044d caps.latest.revision: 7 作者:"dotnet bot「 ms.author:"dotnetcontent"管理員:"wpickett"ms.workload: 
  - 「 dotnet"
---
...
## <a name="in-this-section"></a>本節內容  
 ...
 示範 Policy4 活動如何讓 Windows Workflow Foundation [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] (WF 3.5)<xref:System.Workflow.Activities.Rules.RuleSet>物件使用中 Windows Workflow Foundation [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)] (WF 4.5) 是直接使用 WF 3.5 隨附的規則引擎。  
 ...
 示範如何使用 Windows Workflow Foundation 中的 ADO.NET Entity Framework，以簡化資料存取。  
 ...
 示範 ExternalizedPolicy4 活動如何讓執行中的現有 Windows Workflow Foundation [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] (WF 3.5)<xref:System.Workflow.Activities.Rules.RuleSet>物件中 Windows Workflow Foundation [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)] (WF 4.5) 直接使用規則引擎也就是WF 3.5 隨附。  
