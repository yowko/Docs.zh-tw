...
## <a name="in-this-section"></a>本節內容  
 ...
 示範 SQL 工作流程執行個體存放區中已提升屬性的使用方式和組態。  
  
 [屬性促銷活動](../../../../docs/framework/windows-workflow-foundation/samples/property-promotion-activity.md)  
 此範例提供端對端方案，可將 <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore> 提升功能直接整合到工作流程撰寫經驗中。
