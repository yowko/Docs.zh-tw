---
title: "While 活動中的模擬中斷 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 中斷迴圈  
 [!INCLUDE[wf](../../../../includes/wf-md.md)] 不包括可中斷迴圈的活動。此程式碼範例會使用 <xref:System.Activities.Statements.If> 活動和幾個變數來完成中斷迴圈的工作。在範例中，一旦 `reliableVendor` 變數指派了 `null` 以外的值，<xref:System.Activities.Statements.While> 活動就會中斷。  
