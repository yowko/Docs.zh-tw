...
#### [使用變數搭配 .NET Framework 3.5 Ruleset](using-variables-with-dotnet-ruleset.md)
...
#### [與 3.5 規則集互通](interop-with-3-5-rule-set.md)
### [補償](compensation-samples.md)
#### [可補償的活動](compensable-activity-sample.md)
#### [自訂補償](custom-compensation-sample.md)
#### [組態](confirmation.md)
#### [可補償活動上的取消處理常式](cancellation-handler-on-compensable-activity.md)
...
##### [公開和叫用 ActivityActions](exposing-and-invoking-activityactions.md)
##### [在活動中使用 AsyncOperationContext](using-asyncoperationcontext-in-an-activity-sample.md)
...
#### [條件式活動群組](conditioned-activity-group.md)
#### [使用原則處理訂單](order-processing-with-policy.md)
### [服務](services.md)
#### [絕對延遲](absolute-delay.md)
#### [永久性延遲](durable-delay.md)
#### [傳送及處理錯誤](sending-and-handling-faults.md)
#### [SendParameters 和 ReceiveParameters 活動的基本使用](basic-usage-of-sendparameters-and-receiveparameters-activities.md)
#### [基本 XAML 僅服務](basic-xaml-only-service.md)
#### [格式化工作流程服務中的訊息](formatting-messages-in-workflow-services.md)
#### [永久性雙面](durable-duplex.md)
