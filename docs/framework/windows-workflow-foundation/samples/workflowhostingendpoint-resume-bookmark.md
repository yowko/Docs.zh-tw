---
title: "WorkflowHostingEndpoint 繼續書籤 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  執行應用程式。建立工作流程執行個體之後，`CreationEndpoint` 主控台會顯示包含執行個體識別碼的訊息。在書籤成功繼續時工作流程會列印 "Hello World\!" 訊息。  
