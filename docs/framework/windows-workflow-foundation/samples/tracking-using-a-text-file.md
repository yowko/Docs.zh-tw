...
12. 查看位於應用程式目錄之記錄檔 \(即 %APPDATA%\\trackingRecords.log\) 的追蹤事件。  
    ...
    > [!NOTE]
    >  %APPDATA% 是環境變數，在 [!INCLUDE[wv](../../../../includes/wv-md.md)]、[!INCLUDE[lserver](../../../../includes/lserver-md.md)] 或 Windows Server 2008 中會解析為 %SystemDrive%\\Users\\\<username\>\\AppData\\Roaming。  
