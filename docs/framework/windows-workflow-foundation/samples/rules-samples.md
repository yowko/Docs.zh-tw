...
## 在本節中  
 ...
 示範如何使用工作流程中的 <xref:System.Workflow.Activities.PolicyActivity> 活動。  
 ...
 [使用原則處理訂](../../../../docs/framework/windows-workflow-foundation/samples/order-processing-with-policy.md)  
 示範 [!INCLUDE[wf](../../../../includes/wf-md.md)] 的 [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] 中所引進的一些重要功能。