...
## <a name="in-this-section"></a>本章節內容  
 ...
 [SendParameters 及 ReceiveParameters 活動的基本使用方式](../../../../docs/framework/windows-workflow-foundation/samples/basic-usage-of-sendparameters-and-receiveparameters-activities.md)  
 ...
 [工作流程服務中的格式化訊息](../../../../docs/framework/windows-workflow-foundation/samples/formatting-messages-in-workflow-services.md)  
 示範不同使用者類型在訊息活動中的使用方式 (WF 服務)。 範例服務是簡單的經費支出核准服務，會公開三個作業。  
  
 [永久性雙工](../../../../docs/framework/windows-workflow-foundation/samples/durable-duplex.md)  
 ...
 [傳送快取的通道](../../../../docs/framework/windows-workflow-foundation/samples/channel-caching-with-send.md)  
 ...
 [緩衝接收](../../../../docs/framework/windows-workflow-foundation/samples/buffered-receive.md)  
