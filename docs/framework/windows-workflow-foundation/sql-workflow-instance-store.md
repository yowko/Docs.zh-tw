...
-   [如何：啟用 SQL 持續性工作流程與工作流程服務](../../../docs/framework/windows-workflow-foundation/how-to-enable-sql-persistence-for-workflows-and-workflow-services.md)  
