...
> [!NOTE]
> 工作流程專案中的 c # 運算式支援是在 .NET Framework 4.5 中引進。 如需詳細資訊，請參閱 [c # 運算式](csharp-expressions.md)。
...
```
 ...
 使用 c # lambda 運算式可以更簡潔地地表示相同的工作流程，如下列範例所示：
...
```
 ...
 使用這個新活動，您可以重寫先前新增三個值的工作流程，如下列範例所示：
