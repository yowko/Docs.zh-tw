---
title: "運算式 [.NET Framework 4] | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)]以程式碼使用運算式的詳細資訊，請參閱[使用命令式程式碼撰寫工作流程、活動和運算式](../../../docs/framework/windows-workflow-foundation//authoring-workflows-activities-and-expressions-using-imperative-code.md)。