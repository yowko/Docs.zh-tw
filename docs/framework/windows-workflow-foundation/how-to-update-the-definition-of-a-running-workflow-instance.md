...
3.  接下來，更新兩個運算式`WriteLine`活動，顯示使用者的猜測是否過高或太低，使其符合所做的更新[How to： 主應用程式的工作流程-並存的多個版本](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md)。
...
3.  瀏覽至**NumberGuessWorkflowActivities_du**資料夾中建立[How to： 主應用程式的工作流程-並存的多個版本](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md)，選取**NumberGuessWorkflowActivities.csproj** (或**vbproj**)，然後按一下**開啟**。
...
6.  瀏覽至**NumberGuessWorkflowActivities_du**資料夾中建立[How to： 主應用程式的工作流程-並存的多個版本](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md)。
...
12. 重新命名**NumberGuessWorkflowActivities.dll**要**NumberGuessWorkflowActivities_v15.dll**，並將它複製到**PreviousVersions** 中建立的資料夾[How to： 裝載工作流程-並存的多個版本](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md)。
...
4.  選取其中一個`v1`您開始在開頭的工作流程[How to： 主應用程式的工作流程-並存的多個版本](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md)主題。 請注意，在狀態視窗下的版本資訊會表示工作流程是版本**1.5.0.0**工作流程。 請注意，除太大或太小之外，沒有任何資訊指示先前的猜測。
