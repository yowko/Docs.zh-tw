---
title: "快速入門教學課程 [.NET Framework 4.5] | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "WF [WF], 快速入門"
  - "Windows Workflow Foundation [WF], 快速入門"
...
## 在本節中  
 ...
 [HOW TO：建立自訂追蹤參與者](../../../docs/framework/windows-workflow-foundation//how-to-create-a-custom-tracking-participant.md)  
 說明如何建立自訂的追蹤參與者和追蹤設定檔。  
  
 [HOW TO：裝載工作流程並存的多個版本](../../../docs/framework/windows-workflow-foundation//how-to-host-multiple-versions-of-a-workflow-side-by-side.md)  
 描述如何使用 `WorkflowIdentity` 裝載工作流程並存的多個版本。  
  
 [HOW TO：更新執行中工作流程執行個體的定義](../../../docs/framework/windows-workflow-foundation//how-to-update-the-definition-of-a-running-workflow-instance.md)  
