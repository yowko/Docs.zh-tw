---
title: "設計和實作自訂活動 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!IMPORTANT]
>  在工作流程設計工具中，自訂活動預設會顯示成附有活動名稱的簡單矩形。  若要在工作流程設計工具中提供自訂的視覺化活動表示形式，您還必須建立自訂的設計工具。  [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [使用自訂活動設計工具及範本](../../../docs/framework/windows-workflow-foundation//using-custom-activity-designers-and-templates.md)。  
...
## 本章節內容  
 ...
 [在執行階段建立活動](../../../docs/framework/windows-workflow-foundation//creating-an-activity-at-runtime-with-dynamicactivity.md)  
 ...
 [從流程中使用 OData 摘要](../../../docs/framework/windows-workflow-foundation//consuming-odata-feeds-from-a-workflow.md)  
 說明從工作流程中呼叫 WCF 資料服務的幾種方法。  
  
 [活動定義範圍和可視性](../../../docs/framework/windows-workflow-foundation//activity-definition-scoping-and-visibility.md)  
