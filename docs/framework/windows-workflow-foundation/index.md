...
## <a name="in-this-section"></a>本節內容  
 ...
 [Windows Workflow Foundation 的新增功能](../../../docs/framework/windows-workflow-foundation/whats-new.md)  
 討論與舊版數種開發架構的不同之處。  
 ...
 [Windows Workflow 概念性概觀](../../../docs/framework/windows-workflow-foundation/conceptual-overview.md)  
