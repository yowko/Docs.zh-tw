---
title: "使用 CacheMetadata 公開資料 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 預設 CacheMetadata 行為  
 衍生自 <xref:System.Activities.NativeActivity> 之活動 <xref:System.Activities.NativeActivity.CacheMetadata%2A> 的預設實作會以下列方式處理下列方法類型：  
...
-   型別為 <xref:System.Activities.Variable> 的 <xref:System.Collections.ICollection>：集合中的所有項目都會公開至執行階段當做公用變數。  
  
-   型別為 <xref:System.Activities.Activity> 的 <xref:System.Collections.ICollection>：集合中的所有項目都會公開至執行階段當做公用子系。  
  
-   型別為 <xref:System.Activities.ActivityDelegate> 的 <xref:System.Collections.ICollection>：集合中的所有項目都會公開至執行階段當做公用委派。  
  
 衍生自 <xref:System.Activities.Activity>、<xref:System.Workflow.Activities.CodeActivity> 和 <xref:System.Activities.AsyncCodeActivity> 之活動的 <xref:System.Activities.Activity.CacheMetadata%2A> 也會依照上述方式運作，不過具有下列差異：  
