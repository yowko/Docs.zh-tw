...
## <a name="related-sections"></a>相關章節  
 ...
 [進階 COM 互通性](https://msdn.microsoft.com/library/bd9cdfyx(v=vs.100).aspx)  
 提供有關將 COM 元件納入 .NET Framework 應用程式的詳細資訊連結。  
  
 [組件至型別程式庫轉換的摘要](https://msdn.microsoft.com/library/xk1120c3(v=vs.100).aspx)  
 描述組件至類型程式庫匯出轉換的程序。  
  
 [型別程式庫至組件轉換的摘要](https://msdn.microsoft.com/library/k83zzh38(v=vs.100).aspx)  
 描述類型程式庫至組件匯入轉換的程序。  
  
 [使用泛型型別互通](https://msdn.microsoft.com/library/ms229590(v=vs.100).aspx)  
