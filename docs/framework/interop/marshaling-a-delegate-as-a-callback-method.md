...
-   從 PinvokeLib.dll 匯出的 **TestCallBack2**。  
 ...
 [PinvokeLib.dll](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/as6wyhwt(v=vs.100)) 是自訂的 Unmanaged 程式庫，其中包含先前所列出函式的實作。  
...
- [平台叫用資料類型](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ac7ay120(v=vs.100))
