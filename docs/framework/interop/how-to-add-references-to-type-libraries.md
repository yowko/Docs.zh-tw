...
2. 使用 [-link (c # 編譯器選項) ](../../csharp/language-reference/compiler-options/link-compiler-option.md) 或 [-link (Visual Basic) ](../../visual-basic/reference/command-line-compiler/link.md) 編譯器選項搭配 interop 元件名稱，將 COM 類型的類型資訊內嵌到可執行檔中。  
...
- [-連結 (Visual Basic) ](../../visual-basic/reference/command-line-compiler/link.md)
