---
title: "如何：登錄主要 Interop 組件 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 如何：登錄主要 Interop 組件
類別只能由 COM Interop 封送處理，並且一律封送處理為介面。  在某些情況下，用來封送處理類別的介面就是所謂的類別介面。  如需以您選擇的介面來覆寫類別介面的相關資訊，請參閱 [COM 可呼叫包裝函式](../../../docs/framework/interop/com-callable-wrapper.md)。  
 ...
 您必須先在開發電腦上註冊所有取得的主要 Interop 組件，才能使用 [!INCLUDE[vsprvsext](../../../includes/vsprvsext-md.md)] 來加以參考。  Visual Studio 會在您第一次從 COM 類型程式庫參考類型時，尋找並使用主要 Interop 組件。  如果 Visual Studio 找不到與類型程式庫相關聯的主要 Interop 組件，它會提示您取得該組件，或是提供您建立 Interop 組件的方式。  同樣地，[類型程式庫匯入工具 \(Tlbimp.exe\)](../../../docs/framework/tools/tlbimp-exe-type-library-importer.md) 也會使用登錄來找出主要 Interop 組件。  
...
## 請參閱  
 ...
 [Locating Primary Interop Assemblies](http://msdn.microsoft.com/zh-tw/d6768e4b-cd80-414d-a4f8-05d979eb393b)   
 [Redistributing Primary Interop Assemblies](http://msdn.microsoft.com/zh-tw/e76384f0-d631-474c-bdbd-13884cba0265)