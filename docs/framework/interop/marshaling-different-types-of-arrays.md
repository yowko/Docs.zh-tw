...
-   從 PinvokeLib.dll 匯出的**TestArrayOfStructs2** 。  
 ...
 [PinvokeLib.dll](http://msdn.microsoft.com/library/5d1438d7-9946-489d-8ede-6c694a08f614)是自訂的 unmanaged 程式庫，包含先前所列出的函式和兩個結構變數的實作**MYPOINT**和**MYPERSON**。 這些結構包含下列項目：  
