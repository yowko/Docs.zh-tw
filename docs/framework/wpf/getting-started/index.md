...
|剛開始使用 .NET 嗎？|[.NET Framework 概觀](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [.NET Framework 應用程式基本概念](../../../../docs/standard/application-essentials.md)<br /><br /> [Visual C# 和 Visual Basic 使用者入門](/visualstudio/ide/getting-started-with-visual-csharp-and-visual-basic)|  
