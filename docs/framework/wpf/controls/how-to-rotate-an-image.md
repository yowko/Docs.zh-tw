...
---
# 如何：旋轉影像
本範例示範如何使用 <xref:System.Windows.Media.Imaging.BitmapImage> 的 <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> 屬性，將影像旋轉 90 度。  
