...
---
# <a name="how-to-rotate-an-image"></a>HOW TO：旋轉影像
此範例示範如何使用 90 度旋轉影像<xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A>屬性<xref:System.Windows.Media.Imaging.BitmapImage>。  
