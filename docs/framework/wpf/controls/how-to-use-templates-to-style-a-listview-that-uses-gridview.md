...
## <a name="example"></a>範例  
 ...
 <xref:System.Windows.Controls.GridViewColumn.HeaderContainerStyle%2A>並<xref:System.Windows.Controls.GridViewColumn.HeaderTemplate%2A>只有兩種數個屬性，您可以使用自訂資料行的標頭外觀<xref:System.Windows.Controls.GridView>控制項。 如需詳細資訊，請參閱 [GridView 資料行標頭樣式和範本概觀](../../../../docs/framework/wpf/controls/gridview-column-header-styles-and-templates-overview.md)。  
