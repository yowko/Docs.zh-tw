...
![核取方塊具有預設控制項範本。](./media/ndp-checkboxdefault.png "NDP_CheckBoxDefault")使用預設控制項範本的核取方塊

![核取方塊具有自訂控制項範本。](./media/ndp-checkboxcustom.png "NDP_CheckBoxCustom")使用自訂控制項範本的核取方塊
...
![NumericUpDown 自訂控制項。](./media/ndp-numericupdown.png "NDP_NumericUPDown")自訂的 NumericUpDown 控制項
