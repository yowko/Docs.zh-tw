...
本主題描述 <xref:System.Windows.Controls.Primitives.StatusBar> 控制項的樣式和範本。 您可以修改預設 <xref:System.Windows.Controls.ControlTemplate>，為控制項提供獨特的外觀。 如需詳細資訊，請參閱[建立控制項的範本](../../../desktop-wpf/themes/how-to-create-apply-template.md)。  
  
## <a name="statusbar-parts"></a>狀態列部分  
 <xref:System.Windows.Controls.Primitives.StatusBar> 控制項沒有任何已命名的元件。  
  
## <a name="statusbar-states"></a>狀態列狀態  
 下表列出 <xref:System.Windows.Controls.Primitives.StatusBar> 控制項的視覺狀態。  
...
## <a name="statusbaritem-parts"></a>StatusBarItem 元件  
 <xref:System.Windows.Controls.Primitives.StatusBarItem> 控制項沒有任何已命名的元件。  
  
## <a name="statusbar-states"></a>狀態列狀態  
 下表列出 <xref:System.Windows.Controls.Primitives.StatusBarItem> 控制項的視覺狀態。  
...
## <a name="statusbar-controltemplate-example"></a>狀態列 ControlTemplate 範例  
