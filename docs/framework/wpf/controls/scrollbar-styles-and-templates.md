...
ms.locfileid: "34457556"
---
# <a name="scrollbar-styles-and-templates"></a>ScrollBar 樣式和範本
本主題描述樣式和範本<xref:System.Windows.Controls.Primitives.ScrollBar>控制項。 您可以修改預設<xref:System.Windows.Controls.ControlTemplate>來提供獨特的外觀的控制項。 如需詳細資訊，請參閱[透過建立 ControlTemplate 自訂現有控制項的外觀](../../../../docs/framework/wpf/controls/customizing-the-appearance-of-an-existing-control.md)。  
...
|組件|類型|描述|  
|-|-|-|  
|PART_Track|<xref:System.Windows.Controls.Primitives.Track>|此元素會指出的位置的容器<xref:System.Windows.Controls.Primitives.ScrollBar>。|  
...
## <a name="scrollbar-controltemplate-example"></a>捲軸 ControlTemplate 範例  
 下列範例示範如何定義<xref:System.Windows.Controls.ControlTemplate>如<xref:System.Windows.Controls.Primitives.ScrollBar>控制項。  
