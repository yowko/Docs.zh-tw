...
## <a name="using-the-properties-of-the-tooltip-and-tooltipservice-classes"></a>使用 ToolTip 和 ToolTipService 類別的屬性  
 ...
 如需如何設定屬性，才能使用指定的工具提示內容位置的範例<xref:System.Windows.Controls.ToolTip>並<xref:System.Windows.Controls.ToolTipService>屬性，請參閱[置放工具提示](../../../../docs/framework/wpf/controls/how-to-position-a-tooltip.md)。  
