...
[!INCLUDE[TLA#tla_wpf](../../../../includes/tlasharptla-wpf-md.md)] 控制項可從邏輯上分成幾類。 從這些分類可看出哪些控制項有類似的使用模式或功能，方便您視情況選擇適合的控制項。  
...
## <a name="data-display"></a>資料顯示  
 資料顯示控制項用於顯示來自資料來源的資訊。  
...
## <a name="date-display-and-selection"></a>日期顯示和選取  
 日期控制項用於顯示及選取行事曆資訊。  
...
## <a name="user-information"></a>使用者資訊  
 使用者資訊控制項可提供內容回饋或說明應用程式的使用者介面。 使用者通常無法與這些控制項互動。  
