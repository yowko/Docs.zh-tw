---
title: "Window 樣式和範本 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Window 樣式和範本
本主題說明 <xref:System.Windows.Window> 控制項的樣式和範本。  您可以修改預設的 <xref:System.Windows.Controls.ControlTemplate>，讓控制項擁有獨特的外觀。  如需詳細資訊，請參閱[透過建立 ControlTemplate 自訂現有控制項的外觀](../../../../docs/framework/wpf/controls/customizing-the-appearance-of-an-existing-control.md)。  
  
## Window 組件  
 <xref:System.Windows.Window> 控制項沒有任何具名組件。  
  
## Window 狀態  
 下表列出 <xref:System.Windows.Window> 控制項的可見狀態。  
