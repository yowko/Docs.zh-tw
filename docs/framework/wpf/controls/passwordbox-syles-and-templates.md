...
|組件|類型|描述|  
|-|-|-|  
|PART_ContentHost|<xref:System.Windows.FrameworkElement>|可包含的視覺元素<xref:System.Windows.FrameworkElement>。 文字<xref:System.Windows.Controls.PasswordBox>會顯示此項目中。|  
