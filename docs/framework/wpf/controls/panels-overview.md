...
|<xref:System.Windows.Controls.WrapPanel>|[是]|<xref:System.Windows.Controls.WrapPanel> 連續位置放置子元素由左到右，將內容換至下一行，在容器方塊邊緣。 後續排序作業會以循序方式從上或由右至左，根據的值<xref:System.Windows.Controls.WrapPanel.Orientation%2A>屬性。|  
...
#### <a name="virtualizingstackpanel"></a>VirtualizingStackPanel  
 ...
 下列標記會示範如何使用<xref:System.Windows.Controls.VirtualizingStackPanel>做為項目的主機。 <xref:System.Windows.Controls.VirtualizingStackPanel.IsVirtualizingProperty?displayProperty=nameWithType>附加的屬性必須設為`true`（預設） 發生的虛擬化。  
