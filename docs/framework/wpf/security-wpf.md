...
- **鬆散 XAML**。 控制 Internet Explorer 是否可以導覽至檔案或[!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)]鬆散檔案。 ([啟用]、[停用] 和 [提示] 選項)。  
