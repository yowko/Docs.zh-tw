...
>  <xref:System.Windows.Documents.Table> 類似於<xref:System.Windows.Controls.Grid>元素但具有更多的功能，因此需要更高的資源負荷。  
 ...
 ![螢幕擷取畫面：轉譯基本表格](./media/basictablerrender.png "BasicTablerRender")  
...
### <a name="row-groupings"></a>資料列群組  
 ...
 ![螢幕擷取畫面：資料表資料列分組](./media/table-rowgroups.png "Table_RowGroups")  
...
5.  <xref:System.Windows.Documents.TableCell>  
 ...
 ![螢幕擷取畫面：資料表 z&#45;順序](./media/table-zorder.png "Table_ZOrder")  
...
### <a name="spanning-rows-or-columns"></a>跨越資料列和資料行  
 ...
 ![螢幕擷取畫面：資料格跨越所有三個資料行](./media/table-columnspan.png "Table_ColumnSpan")  
