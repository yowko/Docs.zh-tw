...
## <a name="requirements"></a>需求  
 ...
 此外，也會指引您使用專案檔。 如需如何使用[!INCLUDE[TLA2#tla_msbuild](../../../../includes/tla2sharptla-msbuild-md.md)]和專案檔的指示, 請參閱[組建和部署](../app-development/building-and-deploying-wpf-applications.md)。  
