...
## <a name="improved-quality-and-performance-of-text"></a>提升文字的品質與效能  
 ...
 ![以 ClearType y 的文字&#45;反方向&#45;別名](../../../../docs/framework/wpf/advanced/media/typographyinwpf02.gif "TypographyInWPF02")  
...
使用 SkewTransform 的文字  
 ...
 ![旋轉文字的文字效果螢幕擷取畫面](../../../../docs/framework/wpf/advanced/media/texteffect01.jpg "TextEffect01")  
旋轉文字效果動畫的範例  
...
影像筆刷套用至筆劃並反白顯示的範例  
 ...
 如需詳細資訊<xref:System.Windows.Media.FormattedText>物件，請參閱 <<c2> [ 繪製格式化的文字](../../../../docs/framework/wpf/advanced/drawing-formatted-text.md)。  
