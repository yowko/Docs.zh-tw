...
## <a name="xaml-globalization"></a>XAML 全球化
 Extensible Application Markup Language （XAML）是以 XML 為基礎，並利用 XML 規格中定義的全球化支援。 下列各節將說明一些您應該注意的 [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] 功能。
...
### <a name="unicode"></a>Unicode
 [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] 支援包括代理的所有 Unicode 功能。 只要字元集可以對應到 Unicode，就會受到支援。 例如，GB18030 推出可對應至中文、日文和韓文 (CFK) 延伸模組 A 和 B 及 surrogate 字組的某些字元，因此受到完整支援。 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 的應用程式可以使用 <xref:System.Globalization.StringInfo> 來操作字串，而不需要瞭解它們是否有代理項配對或合併字元。

<a name="design_intl_ui_with_xaml"></a>
## <a name="designing-an-international-user-interface-with-xaml"></a>使用 XAML 設計國際化的使用者介面
 本節說明撰寫應用程式時，您應該考慮的 [!INCLUDE[TLA#tla_ui](../../../../includes/tlasharptla-ui-md.md)] 功能。

<a name="intl_text"></a>
### <a name="international-text"></a>國際文字
 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 包括所有 Microsoft .NET Framework 支援的書寫系統的內建處理。
...
### <a name="international-layout"></a>國際版面配置
 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 提供非常方便的方式來支援水平、雙向和垂直版面配置。 在展示架構中，<xref:System.Windows.FrameworkElement.FlowDirection%2A> 屬性可以用來定義版面配置。 流程方向模式有︰
