...
> [!NOTE]
> 為了簡單起見，上述範例會使用 .xps 副檔名， \*做為其測試檔案為 xps。 不過，XPS 檔案不一定要有此延伸模組。 [IsXPS （IsXPS 一致性工具）](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/aa348104(v=vs.100))是測試檔案以取得 XPS 有效性的一種方式。
