...
## <a name="choosing-which-element-to-derive-from"></a>選擇要從中衍生的項目  
 ...
 如果您正在實作控制項，這實際上是衍生自的更常見原因之一[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]類別，您可能想要衍生自為實用控制項，控制項系列基底類別，類別，或在從最低<xref:System.Windows.Controls.Control>基底類別。 如需某些指引和實用範例，請參閱[控制項撰寫概觀](../../../../docs/framework/wpf/controls/control-authoring-overview.md)。  
...
-   樣式和分鏡腳本的支援。 如需詳細資訊，請參閱 <<c0> <xref:System.Windows.Style> 並[分鏡腳本概觀](../../../../docs/framework/wpf/graphics-multimedia/storyboards-overview.md)。  
...
-   樣式和分鏡腳本的支援。 如需詳細資訊，請參閱 <<c0> <xref:System.Windows.Style> 並[動畫概觀](../../../../docs/framework/wpf/graphics-multimedia/animation-overview.md)。  
