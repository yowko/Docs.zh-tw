...
> [!NOTE]
>  <xref:System.Windows.Controls.PrintDialog?displayProperty=nameWithType>控制[!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]，本主題討論應不與混淆<xref:System.Windows.Forms.PrintDialog?displayProperty=nameWithType>Windows Form 的元件。  
