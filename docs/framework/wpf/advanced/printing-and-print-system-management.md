...
ms.locfileid: "33547416"
---
# <a name="printing-and-print-system-management"></a>列印和列印系統管理
[!INCLUDE[TLA#tla_winvista](../../../../includes/tlasharptla-winvista-md.md)] 和 Microsoft.NET Framework 中引進新的列印路徑 — 替代[!INCLUDE[TLA#tla_gdi](../../../../includes/tlasharptla-gdi-md.md)]列印 — 組大幅擴充的列印系統管理和[!INCLUDE[TLA#tla_api#plural](../../../../includes/tlasharptla-apisharpplural-md.md)]。  
