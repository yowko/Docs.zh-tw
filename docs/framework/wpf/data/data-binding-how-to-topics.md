...
---
# <a name="data-binding-how-to-topics"></a>資料系結的使用說明主題

本節中的主題說明如何使用資料系結，將元素系結至各種資料來源中的資料，其格式為 common language runtime （CLR）物件和 XML。
...
- [WPF 中的資料系結](../../../desktop-wpf/data/data-binding-overview.md)
- [資料系結效能](../advanced/optimizing-performance-data-binding.md)
