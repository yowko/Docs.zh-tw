...
---
# <a name="how-to-bind-to-an-adonet-data-source"></a>作法：繫結至 ADO.NET 資料來源

此範例示範如何繫結[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] <xref:System.Windows.Controls.ListBox> ADO.NET 控制項`DataSet`。
