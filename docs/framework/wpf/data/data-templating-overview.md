...
這個範例會使用[DataTemplate](xref:System.Windows.FrameworkTemplate.Resources%2A)屬性。 該區段中定義的資源會由 <xref:System.Windows.DataTemplate>內的元素共用。
