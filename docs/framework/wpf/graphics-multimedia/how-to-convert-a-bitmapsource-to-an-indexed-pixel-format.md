...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="e0bd2-102">HOW TO：將 BitmapSource 轉換為索引像素格式</span><span class="sxs-lookup"><span data-stu-id="e0bd2-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="e0bd2-103">此範例示範如何將轉換<xref:System.Windows.Media.Imaging.BitmapSource>為索引像素格式。</span><span class="sxs-lookup"><span data-stu-id="e0bd2-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="e0bd2-104">範例</span><span class="sxs-lookup"><span data-stu-id="e0bd2-104">Example</span></span>  
