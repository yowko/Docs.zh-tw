...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a>如何：將 BitmapSource 轉換為索引像素格式
這個範例示範如何將轉換<xref:System.Windows.Media.Imaging.BitmapSource>索引像素格式。  
