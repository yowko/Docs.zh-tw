...
ms.locfileid: "33560847"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="3a2f4-102">如何：將 BitmapSource 轉換為索引像素格式</span><span class="sxs-lookup"><span data-stu-id="3a2f4-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="3a2f4-103">這個範例示範如何將轉換<xref:System.Windows.Media.Imaging.BitmapSource>索引像素格式。</span><span class="sxs-lookup"><span data-stu-id="3a2f4-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="3a2f4-104">範例</span><span class="sxs-lookup"><span data-stu-id="3a2f4-104">Example</span></span>  
