...
---
# <a name="how-to-create-a-shape-using-a-streamgeometry"></a>HOW TO：使用 StreamGeometry 建立圖案
...
## <a name="example"></a>範例  
 ...
 如需詳細資訊<xref:System.Windows.Media.StreamGeometry>屬性的語法，請參閱[路徑標記語法](../../../../docs/framework/wpf/graphics-multimedia/path-markup-syntax.md)頁面。  
