...
## <a name="example"></a>範例  
 ...
 此範例中，已省略的程式碼。 完整的範例也會示範如何以動畫顯示的不透明度<xref:System.Windows.Media.Color>內<xref:System.Windows.Media.LinearGradientBrush>。  如需完整的範例，請參閱[建立項目範例的不透明度動畫](https://go.microsoft.com/fwlink/?LinkID=159968)。
