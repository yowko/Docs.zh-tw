 ...
 **相關主題**  
 ...
 如需詳細資訊<xref:System.Windows.Media.SolidColorBrush>和其他範例，請參閱[使用純色和漸層概觀繪製](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md)概觀。  
