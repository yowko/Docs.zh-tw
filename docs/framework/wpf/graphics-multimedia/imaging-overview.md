...
影像筆刷可以填滿圖形、控制項、文字等等  
 ...
 如需詳細資訊<xref:System.Windows.Media.ImageBrush>繪製影像看[使用影像、 繪圖和視覺效果繪製](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md)。  
