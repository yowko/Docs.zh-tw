...
ms.locfileid: "33561497"
---
# <a name="how-to-use-a-bitmapimage"></a>如何：使用 BitmapImage
這個範例示範如何使用<xref:System.Windows.Media.Imaging.BitmapImage>做為來源的<xref:System.Windows.Controls.Image>控制[!INCLUDE[TLA#tla_xaml](../../../../includes/tlasharptla-xaml-md.md)]。  
