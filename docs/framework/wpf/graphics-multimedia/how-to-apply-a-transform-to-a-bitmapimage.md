...
---
# <a name="how-to-apply-a-transform-to-a-bitmapimage"></a>HOW TO：對 BitmapImage 套用轉換
此範例示範如何套用<xref:System.Windows.Media.Transform>至<xref:System.Windows.Media.Imaging.BitmapImage>。  
...
- [旋轉影像](../controls/how-to-rotate-an-image.md)
