...
## <a name="prerequisites"></a>必要條件  
 此概觀假設您已熟悉<xref:System.Windows.Media.Brush>物件。 如需筆刷的概觀，請參閱[使用純色和漸層繪製的概觀](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md)。 如需<xref:System.Windows.Media.ImageBrush>並<xref:System.Windows.Media.DrawingBrush>，請參閱[使用影像、 繪圖和視覺效果繪製](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md)。  
...
>  雖然此概觀中的範例示範如何使用影像項目上的不透明度遮罩，但不透明度遮罩可套用至任何項目或<xref:System.Windows.Media.Visual>，包括面板和控制項。  
 ...
 ![具有 LinearGradientBrush 不透明度遮罩的物件](../../../../docs/framework/wpf/graphics-multimedia/media/wcpsdk-graphicsmm-opacitymask-imageexample.png "wcpsdk_graphicsmm_opacitymask_imageexample")  
不透明度遮罩範例  
...
-   <xref:System.Windows.Media.LinearGradientBrush>, <xref:System.Windows.Media.RadialGradientBrush>:用來使元素或從檢視的視覺淡出。  
     ...
     ![具有 LinearGradientBrush 不透明度遮罩的物件](../../../../docs/framework/wpf/graphics-multimedia/media/wcpsdk-graphicsmm-brushes-lineagradientopacitymasksingle.jpg "wcpsdk_graphicsmm_brushes_lineagradientopacitymasksingle")  
...
-   <xref:System.Windows.Media.ImageBrush>：用來建立紋理及柔邊或撕裂邊效果。  
     ...
     ![具有 ImageBrush 不透明度遮罩的物件](../../../../docs/framework/wpf/graphics-multimedia/media/wcpsdk-graphicsmm-brushes-imageasopacitymasksingle.jpg "wcpsdk_graphicsmm_brushes_imageasopacitymasksingle")  
LinearGradientBrush 不透明度遮罩範例  
...
-   <xref:System.Windows.Media.DrawingBrush>：用來建立複雜不透明度遮罩的圖形、 影像和漸層的模式。  
     ...
     ![具有 DrawingBrush 不透明度遮罩的物件](../../../../docs/framework/wpf/graphics-multimedia/media/wcpsdk-drawingbrushasopacitymask-single.jpg "wcpsdk_drawingbrushasopacitymask_single")  
...
## <a name="using-an-image-as-an-opacity-mask"></a>使用影像作為不透明度遮罩  
 ...
 ![具有 ImageBrush 不透明度遮罩的物件](../../../../docs/framework/wpf/graphics-multimedia/media/wcpsdk-graphicsmm-imageasopacitymask.png "wcpsdk_graphicsmm_imageasopacitymask")  
不透明度遮罩範例  
...
## <a name="creating-an-opacity-mask-from-a-drawing"></a>從繪圖建立不透明度遮罩  
 ...
 ![具有 DrawingBrush 不透明度遮罩的物件](../../../../docs/framework/wpf/graphics-multimedia/media/wcpsdk-drawingbrushasopacitymask.png "wcpsdk_drawingbrushasopacitymask")  
DrawingBrush 不透明度遮罩範例  
