...
點陣圖效果啟用設計工具，並套用至視覺效果的開發人員轉譯 Windows Presentation Foundation (WPF) 內容。 例如，點陣圖效果可讓您輕鬆地套用<xref:System.Windows.Media.Effects.DropShadowBitmapEffect>效果或模糊效果的影像或按鈕。  
