...
## <a name="example"></a>範例  
 ...
 如需說明如何<xref:System.Windows.Media.Brush.RelativeTransform%2A>並<xref:System.Windows.Media.Brush.Transform%2A>屬性運作，請參閱[筆刷轉換概觀](../../../../docs/framework/wpf/graphics-multimedia/brush-transformation-overview.md)。  
