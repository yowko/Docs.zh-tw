...
---
# <a name="how-to-create-a-new-bitmapsource"></a>HOW TO：建立新的 BitmapSource
此範例示範如何使用<xref:System.Windows.Media.Imaging.BitmapSource.Create%2A>方法<xref:System.Windows.Media.Imaging.BitmapSource>來建立新的<xref:System.Windows.Media.Imaging.BitmapSource>物件。  
