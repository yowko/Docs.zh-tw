...
---
# <a name="how-to-transform-points-and-vectors"></a>如何：轉換點和向量
這個範例示範如何使用<xref:System.Windows.Media.Matrix>轉換<xref:System.Windows.Point>和<xref:System.Windows.Vector>物件。  
