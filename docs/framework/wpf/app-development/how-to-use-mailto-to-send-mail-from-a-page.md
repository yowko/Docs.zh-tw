...
---
# <a name="how-to-use-mailto-to-send-mail-from-a-page"></a>如何： 使用 mailto： 要傳送郵件從頁面
這個範例示範如何使用<xref:System.Windows.Documents.Hyperlink>搭配**mailto:**[!INCLUDE[TLA#tla_uri](../../../../includes/tlasharptla-uri-md.md)]。  
  
## <a name="example"></a>範例  
 下列程式碼示範如何使用**mailto:** [!INCLUDE[TLA#tla_uri](../../../../includes/tlasharptla-uri-md.md)]開啟新郵件視窗中，其中包含電子郵件地址和電子郵件地址和主旨和電子郵件地址、 主旨和本文。  
