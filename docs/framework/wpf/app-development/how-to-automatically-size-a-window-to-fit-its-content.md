...
ms.locfileid: "61947845"
---
# <a name="how-to-automatically-size-a-window-to-fit-its-content"></a>HOW TO：自動調整視窗大小以符合其內容
此範例示範如何設定<xref:System.Windows.Window.SizeToContent%2A>屬性來指定視窗如何調整大小以符合其內容。  
