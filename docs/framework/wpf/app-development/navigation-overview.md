...
> [!NOTE]
>  本主題不討論如何建置和部署[!INCLUDE[TLA2#tla_xbap#plural](../../../../includes/tla2sharptla-xbapsharpplural-md.md)]。 如需詳細資訊[!INCLUDE[TLA2#tla_xbap#plural](../../../../includes/tla2sharptla-xbapsharpplural-md.md)]，請參閱 < [WPF XAML 瀏覽器應用程式概觀](../../../../docs/framework/wpf/app-development/wpf-xaml-browser-applications-overview.md)。  
...
### <a name="implementing-a-page"></a>實作頁面  
 ...
 `Page.Content` 只能包含一個子項目。在上例中，內容是單一字串 "Hello, Page!" 在實務上，您通常會使用的版面配置控制項作為子項目 (請參閱[版面配置](../../../../docs/framework/wpf/advanced/layout.md)) 來容納及撰寫您的內容。  
 ...
 在此情況下，`Page.Content`的子項目會自動設定`Page`項目。 如需詳細資訊，請參閱 [WPF 內容模型](../../../../docs/framework/wpf/controls/wpf-content-model.md)。  
...
-   類別必須是在程式碼後置`partial`類別所指定的同名`x:Class`屬性標記，而且必須衍生自<xref:System.Windows.Controls.Page>。 這可讓程式碼後置檔案相關聯`partial`建置應用程式時，會將標記檔案產生的類別 (請參閱 <<c2> [ 建置 WPF 應用程式](../../../../docs/framework/wpf/app-development/building-a-wpf-application-wpf.md))。  
...
### <a name="configuring-a-start-page"></a>設定起始頁  
 [!INCLUDE[TLA2#tla_xbap#plural](../../../../includes/tla2sharptla-xbapsharpplural-md.md)] 需要瀏覽器中裝載一定數量的應用程式基礎結構。 在  [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]，則<xref:System.Windows.Application>類別是建立必要的應用程式基礎結構的應用程式定義的一部分 (請參閱[應用程式管理概觀](../../../../docs/framework/wpf/app-development/application-management-overview.md))。  
...
> [!NOTE]
>  如需開發和部署的詳細資訊[!INCLUDE[TLA2#tla_xbap#plural](../../../../includes/tla2sharptla-xbapsharpplural-md.md)]，請參閱 < [WPF XAML 瀏覽器應用程式概觀](../../../../docs/framework/wpf/app-development/wpf-xaml-browser-applications-overview.md)並[部署 WPF 應用程式](../../../../docs/framework/wpf/app-development/deploying-a-wpf-application-wpf.md)。  
...
> [!NOTE]
>  如需發佈和啟動鬆散[!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)]頁面，請參閱[部署 WPF 應用程式](../../../../docs/framework/wpf/app-development/deploying-a-wpf-application-wpf.md)。  
  
 鬆散的一項限制[!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)]是您可以只裝載能夠安全地在部分信任中執行的內容。 例如，`Window`不能鬆散的根項目[!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)]檔案。 如需詳細資訊，請參閱 [WPF 部分信任安全性](../../../../docs/framework/wpf/wpf-partial-trust-security.md)。  
...
### <a name="navigating-to-html-files-by-using-frame"></a>使用框架巡覽至 HTML 檔案  
 ...
 瀏覽至[!INCLUDE[TLA2#tla_html](../../../../includes/tla2sharptla-html-md.md)]需要特殊權限。 例如，您無法從瀏覽[!INCLUDE[TLA2#tla_xbap](../../../../includes/tla2sharptla-xbap-md.md)]網際網路區域部分信任安全性沙箱中執行。 如需詳細資訊，請參閱 [WPF 部分信任安全性](../../../../docs/framework/wpf/wpf-partial-trust-security.md)。  
...
### <a name="navigating-to-html-files-by-using-the-webbrowser-control"></a>使用 WebBrowser 控制項巡覽至 HTML 檔案  
 ...
 像是<xref:System.Windows.Controls.Frame>，請巡覽至[!INCLUDE[TLA2#tla_html](../../../../includes/tla2sharptla-html-md.md)]使用<xref:System.Windows.Controls.WebBrowser>需要特殊權限。 例如，從部分信任應用程式，您可以巡覽至[!INCLUDE[TLA2#tla_html](../../../../includes/tla2sharptla-html-md.md)]位於來源網站上。 如需詳細資訊，請參閱 [WPF 部分信任安全性](../../../../docs/framework/wpf/wpf-partial-trust-security.md)。  
  
<a name="Navigating_to_Objects"></a>   
### <a name="navigating-to-custom-objects"></a>巡覽至自訂物件  
 如果您有儲存為自訂物件的資料，顯示該資料的一種方法是建立<xref:System.Windows.Controls.Page>繫結至這些物件的內容 (請參閱 <<c2> [ 資料繫結概觀](../../../../docs/framework/wpf/data/data-binding-overview.md))。 如果您不需要建立整個頁面此額外負荷，而只要顯示物件，則您可以改為直接巡覽至它們。  
...
[!code-xaml[NavigateToObjectSnippets#PageThatNavsToObject3](../../../../samples/snippets/csharp/VS_Snippets_Wpf/NavigateToObjectSnippets/CSharp/HomePage.xaml#pagethatnavstoobject3)]  
 ...
 如需有關資料範本的詳細資訊，請參閱 <<c0> [ 資料範本化概觀](../../../../docs/framework/wpf/data/data-templating-overview.md)。  
  
<a name="Security"></a>   
## <a name="security"></a>安全性  
 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] 巡覽支援可[!INCLUDE[TLA2#tla_xbap#plural](../../../../includes/tla2sharptla-xbapsharpplural-md.md)]巡覽跨網際網路，而且可讓應用程式裝載協力廠商內容。 保護應用程式和使用者的有害行為，[!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]提供了各種中討論的安全性功能[安全性](../../../../docs/framework/wpf/security-wpf.md)並[WPF 部分信任安全性](../../../../docs/framework/wpf/wpf-partial-trust-security.md)。  
