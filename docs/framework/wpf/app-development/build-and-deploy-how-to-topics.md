...
---
# <a name="build-and-deploy-how-to-topics"></a>建立及部署 how to 主題

下列主題示範如何建立各種 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 應用程式類型的專案檔。
...
- [判斷安裝的 WPF 版本（.NET Framework 3.5）](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.5/aa349641(v=vs.90))
