---
title: "如何：從頁面函式傳回 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 範例  
 若要從頁面函式傳回結果，您必須呼叫 <xref:System.Windows.Navigation.PageFunction%601.OnReturn%2A>，並傳回 <xref:System.Windows.Navigation.ReturnEventArgs%601> 的執行個體。  
