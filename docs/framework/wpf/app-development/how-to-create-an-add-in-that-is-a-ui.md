...
- .NET Framework 增益集模型的知識, 包括管線、增益集和主機開發。 如果您不熟悉這些概念, 請參閱[增益集和](/previous-versions/dotnet/netframework-4.0/bb384200(v%3dvs.100))擴充性。 如需示範管線、增益集和主應用程式之執行的教學課程, 請參閱[逐步解說:建立可擴充的應用](/previous-versions/dotnet/netframework-4.0/bb788290(v%3dvs.100))程式。  
