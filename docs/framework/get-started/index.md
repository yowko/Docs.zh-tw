...
- 多目標。 將目標設為 [.NET Standard](~/docs/standard/net-standard.md)，開發人員就能建立可在該標準版本所支援的多個 .NET Framework 平台上運作的類別庫。 例如，以 .NET Standard 2.0 為目標的類別庫，可由目標為 .NET Framework 4.6.1、.NET Core 2.0 和 UWP 10.0.16299 的應用程式使用。 
...
- 有些 .NET Framework 版本是舊版的就地更新。 例如，[!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)] 是 2.0 版的就地更新，而 .NET Framework 4.7.2 是 4 到 4.7.1 版的就地更新。 如需詳細資訊，請參閱 [.NET Framework 版本和相依性](../../../docs/framework/migration-guide/versions-and-dependencies.md)。
...
| [.NET Standard](~/docs/standard/net-standard.md) | 討論 .NET Standard，這是個別 .NET 實作支援的版本化規格，以保證在多個平台上都能使用一組一致的 API。
