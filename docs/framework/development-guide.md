...
## 在本節中  
 ...
 [使用 WCF 以服務為導向的應用程式](../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md)  
 ...
 [Building Workflows in the .NET Framework](http://msdn.microsoft.com/zh-tw/cbf3880f-dc7b-466d-b808-1109b1223f4a)  
 提供使用 Windows Workflow Foundation \(WF\) 程式撰寫模型、範例和工具的相關資訊。  
  
 [Advanced Reading for the .NET Framework](http://msdn.microsoft.com/zh-tw/faae8083-fecb-4514-b133-b0a5a32a7c3c)  
 提供 .NET Framework 中進階的應用程式開發工作和技巧 \(包括擴充性、互通性與反映\) 的相關資訊。  此外也包含可供 Managed 應用程式 \(例如執行階段主應用程式、編譯器、反組譯工具、偵錯工具及分析工具\) 使用之 Unmanaged 應用程式開發介面的參考主題。  
  
## 參考  
 [.NET Framework 類別庫](http://go.microsoft.com/fwlink/p/?LinkId=215807)  
