...
Represents a binding that a Windows Communication Foundation (WCF) service can use to configure and expose endpoints that are able to communicate over HTTP. 與雙工合約搭配使用時，將會使用 Web 通訊端，否則使用 HTTP。  
