...
## <a name="example"></a>範例  
 ...
 下列範例示範使用 NetPeerTcpBinding 繫結，此繫結會使用對等通道提供多方通訊。 如需使用此系結的詳細案例，請參閱 [Net 對等 TCP](/previous-versions/dotnet/netframework-3.5/ms751426(v=vs.90))。  
...
- [\<binding>](bindings.md)
- [網路對等 TCP](/previous-versions/dotnet/netframework-3.5/ms751426(v=vs.90))
