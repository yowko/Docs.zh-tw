...
這個組態區段表示為特定端點定義的所有行為。 如需設定用戶端行為的詳細資訊，請參閱[指定用戶端執行階段行為](../../../../../docs/framework/wcf/specifying-client-run-time-behavior.md)和[設定用戶端行為](../../../../../docs/framework/wcf/configuring-client-behaviors.md)。  
