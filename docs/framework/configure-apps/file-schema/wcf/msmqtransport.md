...
|deadLetterQueue|指定要使用的寄不出的信件佇列類型。<br /><br /> 有效值包括：<br /><br /> 自訂： 自訂寄不出信件佇列。<br />-None： 沒有寄不出信件佇列是用。<br />系統： 使用系統的寄不出信件佇列。<br /><br /> 此屬性的型別為 DeadLetterQueue。|  
