...
## <a name="remarks"></a>備註  
 UdpBinding 允許 WCF 服務透過 UDP 傳輸進行通訊。 It allows for "fire and forget" message exchanges where a client sends a message to a service and expects no response back.  
