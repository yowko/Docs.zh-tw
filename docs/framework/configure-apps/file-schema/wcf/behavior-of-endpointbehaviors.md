...
|[\<Enablewebscript&gt >](../../../../../docs/framework/configure-apps/file-schema/wcf/enablewebscript.md)|可啟用端點行為，以取用 ASP.NET AJAX 網頁上的服務。 應該只是搭配使用的行為\<webHttpBinding > 標準繫結，或\<webMessageEncoding > 繫結項目。|  
