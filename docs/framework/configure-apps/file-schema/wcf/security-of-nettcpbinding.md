...
|項目|描述|  
|-------------|-----------------|  
|[\<傳輸 >](transport-of-nettcpbinding.md)|定義傳輸的安全性設定。 此項目的型別為 <xref:System.ServiceModel.Configuration.TcpTransportSecurityElement>。|  
...
|項目|描述|  
|-------------|-----------------|  
|繫結|[\<netTcpBinding >](nettcpbinding.md)的繫結項目。|  
