...
---
# <a name="add-of-baseaddressprefixfilter"></a>\<添加>的\<基底位址首碼篩選器>
表示指定直通篩選器的配置元素，該篩選器提供了在 IIS 中託管 Windows 通信基礎 （WCF） 應用程式時選擇相應 Internet 資訊服務 （IIS） 綁定的機制。  
  
[**\<配置>**](../configuration-element.md)\
&nbsp;&nbsp;[**\<系統.服務模式>**](system-servicemodel.md)\
&nbsp;&nbsp;&nbsp;&nbsp;[**\<服務託管環境>**](servicehostingenvironment.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[**\<基本位址首碼篩選器>**](baseaddressprefixfilters.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**\<添加>**  
...
|元素|描述|  
|-------------|-----------------|  
|[\<基本位址首碼篩選器>](baseaddressprefixfilters.md)|指定傳遞篩選器的配置元素的集合，這些元素提供了在 IIS 中託管 Windows 通信基礎 （WCF） 應用程式時選擇適當 IIS 綁定的機制。|  
