...
|`textEncoding`|設定要在繫結上發出訊息時使用的字元集編碼方式。 有效值包括以下的值：<br /><br /> BigEndianUnicodeUnicode Big Endian 編碼。<br />消除16位編碼。<br />UTF88位編碼。<br /><br /> 預設為 UTF8。 此屬性的型別為 <xref:System.Text.Encoding>。|
