...
|屬性|描述|  
|---------------|-----------------|  
|protectionLevel|定義具名管道的保護層級。 簽署訊息可以降低訊息在傳輸時遭到第三者竄改的風險。 加密可在傳輸時提供資料等級的隱私權。 有效值如下：<br /><br /> -None：沒有保護。<br />-Sign：訊息已簽署。<br />-EncryptAndSign：訊息會經過加密和簽署。<br /><br /> 預設值為 EncryptAndSign。|  
