...
|[\<簽發者 >](../../../../../docs/framework/configure-apps/file-schema/wcf/issuer.md)|指定發行安全性權杖的端點。 此項目的型別為 <xref:System.ServiceModel.Configuration.IssuedTokenParametersEndpointAddressElement>。|  
