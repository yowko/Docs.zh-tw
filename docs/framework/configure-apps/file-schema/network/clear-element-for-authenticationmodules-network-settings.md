...
---
# <a name="clear-element-for-authenticationmodules-network-settings"></a>適用于 Authenticationmodules 專案的 @no__t 0clear > 元素（網路設定）
清除應用程式中的所有驗證模組。  
...
## <a name="remarks"></a>備註  
 @No__t-0 元素會移除先前在設定檔或設定階層中較高層級定義的所有驗證模組。  
