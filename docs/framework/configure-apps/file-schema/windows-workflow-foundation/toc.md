# [Windows Workflow Foundation 組態結構描述](index.md)
...
######## [<states>](states.md)
######### [<state>](state.md)
###### [在查詢中使用註解](using-annotation-in-queries.md)
## [其他受管理的參考](additional-managed-reference.md)
...
#### [Microsoft.VisualStudio.Activities.Asr.ClientActivityBuilder...建構函式](microsoft-visualstudio-activities-asr-clientactivitybuilder-ctor.md)
