...
## <a name="see-also"></a>另請參閱  
 ...
 [指定組件的位置](../../../docs/framework/configure-apps/specify-assembly-location.md)   
 [重新導向組件版本](../../../docs/framework/configure-apps/redirect-assembly-versions.md)   
 [使用組態檔註冊遠端物件](http://msdn.microsoft.com/en-us/bc503ee1-c811-4f82-9525-470343326adc)   
 [管理 ASP.NET 網站](http://msdn.microsoft.com/library/1298034b-5f7d-464d-abd1-ad9e6b3eeb7e)   
