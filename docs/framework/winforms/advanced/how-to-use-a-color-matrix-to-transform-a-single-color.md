...
2.  加上紅色、 綠色和藍色元件 0.2  
 ...
 ![重新著色](../../../../docs/framework/winforms/advanced/media/recoloring01.gif "recoloring01")  
 ...
 矩陣和轉換的詳細討論，請參閱[座標系統和轉換](../../../../docs/framework/winforms/advanced/coordinate-systems-and-transformations.md)。  
