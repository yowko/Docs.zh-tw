...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：變更應用程式工作階段之間的設定值](../../../../docs/framework/winforms/advanced/how-to-change-the-value-of-a-setting-between-application-sessions.md)  
  
 詳細說明如何變更應用程式工作階段之間的編譯應用程式中設定的值。  
 ...
 說明如何使用程式碼撰寫，並儲存的使用者設定的值C#。  
  
 [如何：將多組設定新增至您的應用程式C#](../../../../docs/framework/winforms/advanced/how-to-add-multiple-sets-of-settings-to-your-application-in-csharp.md)  
  
 詳細說明如何將多組設定新增至應用程式與C#。  
