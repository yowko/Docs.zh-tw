---
title: "編碼方式和 Windows Form 全球化 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "DateTimePicker 控制項 [Windows Form], 不支援 Unicode"
  - "全球化 [Windows Form], 字元集"
  - "ImageList 元件 [Windows Form], 不支援 Unicode"
  - "國際應用程式 [Windows Form], 字元顯示"
  - "國際字元"
  - "ListView 控制項 [Windows Form], 不支援 Unicode"
  - "當地語系化 [Windows Form], 字元集"
  - "MonthCalendar 控制項 [Windows Form], 不支援 Unicode"
  - "ProgressBar 控制項 [Windows Form], Unicode 的表單"
  - "StatusBar 控制項 [Windows Form], 不支援 Unicode"
  - "TabControl 控制項 [Windows Form], 不支援 Unicode"
  - "ToolBar 控制項 [Windows Form], 不支援 Unicode"
  - "TrackBar 控制項 [Windows Form], 不支援 Unicode"
  - "TreeView 控制項 [Windows Form], 不支援 Unicode"
  - "Unicode [Windows Form]"
  - "Windows Form, 編碼"
...
Windows Form 應用程式完全支援 Unicode，這表示不論是何種平台、程式或語言，每個字元都會以唯一號碼來表示。  如需 Unicode 的詳細資訊，請參閱 [Unicode 協會網站](http://www.unicode.org)。  
