...
2.  在 [設計] 檢視中，確定已選取 `UserControl1`。 如需詳細資訊，請參閱[如何： 選取並在設計介面上的 移動項目](http://msdn.microsoft.com/en-us/54cb70b6-b35b-46e4-a0cc-65189399c474)。  
  
3.  在**屬性**視窗中，設定的值<xref:System.Windows.FrameworkElement.Width%2A>和<xref:System.Windows.FrameworkElement.Height%2A>屬性`200`。  
  
4.  新增<xref:System.Windows.Controls.Button?displayProperty=nameWithType>控制權傳輸至<xref:System.Windows.Controls.UserControl>和設定的值<xref:System.Windows.Controls.ContentControl.Content%2A>屬性**取消**。  
  
5.  新增第二個<xref:System.Windows.Controls.Button?displayProperty=nameWithType>控制權傳輸至<xref:System.Windows.Controls.UserControl>和設定的值<xref:System.Windows.Controls.ContentControl.Content%2A>屬性**確定**。  
