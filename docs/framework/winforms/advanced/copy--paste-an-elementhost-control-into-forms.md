---
title: "逐步解說：將 ElementHost 控制項複製並貼至另外的 Windows Form | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   在 Visual Basic 或 Visual C\# 中，建立名為 `CopyElementHost` 的新 Windows Form 應用程式專案。  
...
4.  將 `UserControl1` 的執行個體從 \[工具箱\] 拖曳到表單上。  
