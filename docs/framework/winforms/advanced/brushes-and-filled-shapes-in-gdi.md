...
## <a name="texture-brushes"></a>紋理筆刷  
 ...
 ![填滿形狀](./media/aboutgdip02-art19.gif "Aboutgdip02_Art19")  
...
## <a name="gradient-brushes"></a>漸層筆刷  
 ...
 ![填滿形狀](./media/aboutgdip02-art21.gif "AboutGdip02_Art21")  
  
 若要變更色彩，當您從邊緣，圖案的中心移動，可以設定路徑漸層筆刷。  
  
 ![填滿形狀](./media/aboutgdip02-art22.gif "AboutGdip02_Art22")  
  
 路徑漸層筆刷會很有彈性。 漸層筆刷，用來填滿每個頂點的三個不同色彩逐漸從紅色中心下列圖變更中的三角形。  
  
 ![填滿形狀](./media/aboutgdip02-art23.gif "AboutGdip02_Art23")  
...
- [HOW TO：在 Windows Form 上繪製實心矩形](how-to-draw-a-filled-rectangle-on-a-windows-form.md)
- [HOW TO：在 Windows Form 上繪製實心橢圓形](how-to-draw-a-filled-ellipse-on-a-windows-form.md)
