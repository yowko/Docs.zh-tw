...
## <a name="example"></a>範例  
 ...
 如需取得詳細資訊<xref:System.Drawing.Graphics>，請參閱[How to:建立繪圖的圖形物件](../../../../docs/framework/winforms/advanced/how-to-create-graphics-objects-for-drawing.md)。 如需有關建構<xref:System.Drawing.Font>，請參閱[How to:建構字型系列和字型](../../../../docs/framework/winforms/advanced/how-to-construct-font-families-and-fonts.md)。  
