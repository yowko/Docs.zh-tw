...
您也可以使用<xref:System.Windows.Forms.HelpProvider>連結控制項至檔案，在說明系統中，即使您已實作快顯說明元件。 如需詳細資訊，請參閱 < [Windows 應用程式中提供幫助](how-to-provide-help-in-a-windows-application.md)。

## <a name="display-pop-up-help"></a>顯示快顯說明

1. 在 Visual Studio 中，拖曳[HelpProvider](../controls/helpprovider-component-windows-forms.md)元件從工具箱拖曳至表單。
