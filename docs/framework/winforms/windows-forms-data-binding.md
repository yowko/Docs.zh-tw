...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：瀏覽 Windows Form 中的資料](../../../docs/framework/winforms/how-to-navigate-data-in-windows-forms.md)  
 示範如何瀏覽資料來源中的項目。  
 ...
 [如何：確認子資料表中選取的資料列保持在正確的位置](../../../docs/framework/winforms/ensure-the-selected-row-in-a-child-table-correct.md)  
