...
2. 在 Visual Studio 中, 選取表單上的控制項, 然後開啟 **屬性** 視窗。

3. 展開 [ **(** 系結)] 屬性, 然後在 [ **(Advanced)** ] 方塊中, 按一下省略號![按鈕 (Visual Studio](./media/how-to-create-a-bound-control-and-format-the-displayed-data/visual-studio-ellipsis-button.png)的屬性視窗中的省略號按鈕 (...), 以顯示**格式設定和 [高級]** [系結] 對話方塊, 其中包含該控制項的完整屬性清單。

4. 選取您想要系結的屬性, 然後選取 [系結] 箭號。
...
7. 在 [**格式類型**] 方塊中, 選取您想要套用至控制項中所顯示之資料的格式。
...
8. 選取 **[確定]** 關閉 [**格式化和高級**系結] 對話方塊, 並返回屬性視窗。
