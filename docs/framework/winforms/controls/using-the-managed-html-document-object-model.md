...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：存取 Managed 的 HTML 文件物件模型中的 HTML 原始檔](how-to-access-the-html-source-in-the-managed-html-document-object-model.md)  
 描述濆爧髍孮原始、 未修改的 HTML 原始檔，以及如何取得的 「 即時 」 的來源，以反映 DOM 的目前狀態  
  
 [如何：變更 Managed 的 HTML 文件物件模型中的項目樣式](how-to-change-styles-on-an-element-in-the-managed-html-document-object-model.md)  
