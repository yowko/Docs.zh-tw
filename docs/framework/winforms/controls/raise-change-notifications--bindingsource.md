...
## <a name="example"></a>範例  
 ...
 如果您使用 `CallerMemberName` 屬性 (attribute)，呼叫 `NotifyPropertyChanged` 方法時，不需要指定屬性 (property) 名稱做為字串引數。 如需詳細資訊, 請參閱[呼叫C#端資訊 ()](../../../csharp/programming-guide/concepts/caller-information.md)或[呼叫端資訊 (Visual Basic)](../../../visual-basic/programming-guide/concepts/caller-information.md)。  
