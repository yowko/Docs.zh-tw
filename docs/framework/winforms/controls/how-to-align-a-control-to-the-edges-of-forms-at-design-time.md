...
---
# <a name="how-to-align-a-control-to-the-edges-of-forms-at-design-time"></a>HOW TO：將控制項和表單邊緣對齊在設計階段
...
|<xref:System.Windows.Forms.DockStyle.Top>|停駐在表單上方。|  
 ...
 也可以在程式碼中設定這些值。 如需詳細資訊，請參閱[＜How to：將控制項和表單邊緣對齊](../../../../docs/framework/winforms/controls/how-to-align-a-control-to-the-edges-of-forms.md)。  
