...
## <a name="in-this-section"></a>本節內容  
 ...
 [操作說明：使用邊框距離在 Windows Forms 控制項周圍建立框線](../../../../docs/framework/winforms/controls/how-to-create-a-border-around-a-windows-forms-control-using-padding.md)  
 示範如何使用<xref:System.Windows.Forms.Control.Padding%2A>概述控制項的屬性。  
  
 [操作說明：實作自訂配置引擎](../../../../docs/framework/winforms/controls/how-to-implement-a-custom-layout-engine.md)  
