...
1.  決定要使用 <xref:System.Windows.Forms.OpenFileDialog> 元件開啟的檔案路徑。 如需概觀，請參閱[OpenFileDialog 元件概觀](../../../../docs/framework/winforms/controls/openfiledialog-component-overview-windows-forms.md)。  
