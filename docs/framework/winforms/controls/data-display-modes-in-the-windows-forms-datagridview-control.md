...
## <a name="unbound"></a>未繫結  
 ...
 如需範例，會使用唯讀未繫結<xref:System.Windows.Forms.DataGridView>，請參閱[How to:建立未繫結的 Windows Forms DataGridView 控制項](../../../../docs/framework/winforms/controls/how-to-create-an-unbound-windows-forms-datagridview-control.md)。  
...
## <a name="bound"></a>繫結  
 ...
 如需範例，會使用繫結至<xref:System.Windows.Forms.DataGridView>控制項，請參閱[逐步解說：驗證資料，在 Windows Form DataGridView 控制項](../../../../docs/framework/winforms/controls/walkthrough-validating-data-in-the-windows-forms-datagridview-control.md)。  
...
## <a name="virtual"></a>虛擬  
 ...
 如需有關虛擬模式的詳細資訊，請參閱[Windows Forms DataGridView 控制項中的虛擬模式](../../../../docs/framework/winforms/controls/virtual-mode-in-the-windows-forms-datagridview-control.md)。 如需示範如何使用虛擬模式事件的範例，請參閱[逐步解說：實作虛擬模式中的 Windows Form DataGridView 控制項](../../../../docs/framework/winforms/controls/implementing-virtual-mode-wf-datagridview-control.md)。  
