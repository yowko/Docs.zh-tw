...
3. <xref:System.Windows.Forms.Button>將控制項移到靠近表單的右框線, 直到對齊線出現為止。 此距離現在是由表單的<xref:System.Windows.Forms.Control.Padding%2A>屬性值提供。

4. 從 [工具箱] <xref:System.Windows.Forms.GroupBox>**將** 控制項拖曳至表單。

5. 在 [**屬性**] 視窗<xref:System.Windows.Forms.GroupBox>中展開<xref:System.Windows.Forms.Control.Padding%2A> <xref:System.Windows.Forms.Control.Padding%2A>專案, 並將屬性設定為10,以變更控制項的屬性值。<xref:System.Windows.Forms.Padding.All%2A>

6. 將控制項從 [ <xref:System.Windows.Forms.GroupBox>工具箱] 拖曳至控制項。 <xref:System.Windows.Forms.Button>

7. 將控制項移至靠近<xref:System.Windows.Forms.GroupBox>控制項的右框線, 直到對齊線出現為止。 <xref:System.Windows.Forms.Button> 移動<xref:System.Windows.Forms.Button> 控制項<xref:System.Windows.Forms.GroupBox>內的控制項, 並注意對齊線的顯示位置。
...
3. 按**Ctrl** +**向下**鍵, 直到控制項到達表單的底部為止。 請注意它在表單向下移動時所佔用的位置。
...
7. 按**Shift** +**方向鍵**, 以一個圖元的增量來調整控制項大小。<xref:System.Windows.Forms.Button>

8. 按**Ctrl** + <xref:System.Windows.Forms.Button>Shift箭頭+**鍵**, 以調整控制項的對齊方式遞增。
