...
|Menu 控制項|<xref:System.Windows.Forms.MenuStrip> 控制項|建立自訂功能表。 **注意：** <xref:System.Windows.Forms.MenuStrip> 是設計用來取代 <xref:System.Windows.Forms.MainMenu> 控制項。|  
||<xref:System.Windows.Forms.ContextMenuStrip> 控制項|建立自訂內容功能表。 **注意：** <xref:System.Windows.Forms.ContextMenuStrip> 是設計用來取代 <xref:System.Windows.Forms.ContextMenu> 控制項。|  
