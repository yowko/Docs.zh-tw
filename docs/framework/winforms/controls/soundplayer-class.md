...
## <a name="in-this-section"></a>本節內容  
 ...
 提供程式碼來播放經由檔案路徑、 UNC 路徑或 HTTP 路徑指定的音效。  
  
 [操作說明：播放 Windows Forms 中的嗶聲](../../../../docs/framework/winforms/controls/how-to-play-a-beep-from-a-windows-form.md)  
 提供播放電腦嗶聲音效的程式碼。  
  
 [操作說明：播放內嵌在 Windows Forms 資源中的音效](../../../../docs/framework/winforms/controls/how-to-play-a-sound-embedded-in-a-resource-from-a-windows-form.md)  
 提供從資源播放音效的程式碼。  
...
## <a name="related-sections"></a>相關章節  
 ...
 提供專為搭配 Windows Form 使用所設計之控制項的相關主題連結。  
