...
---
# <a name="how-to-implement-virtual-mode-in-the-windows-forms-datagridview-control"></a>HOW TO：在 Windows Form DataGridView 控制項中實作虛擬模式
下列程式碼範例示範如何使用 <xref:System.Windows.Forms.DataGridView> 控制項 (其 <xref:System.Windows.Forms.DataGridView.VirtualMode%2A> 屬性設定為 `true`) 來管理大量的資料。  
 ...
 如需這個程式碼範例的完整說明，請參閱[逐步解說：實作虛擬模式中的 Windows Form DataGridView 控制項](../../../../docs/framework/winforms/controls/implementing-virtual-mode-wf-datagridview-control.md)。  
