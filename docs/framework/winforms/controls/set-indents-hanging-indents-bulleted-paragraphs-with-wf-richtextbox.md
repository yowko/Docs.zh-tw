...
---
# <a name="how-to-set-indents-hanging-indents-and-bulleted-paragraphs-with-the-windows-forms-richtextbox-control"></a>HOW TO：設定縮排、 首行縮排和分項段落與 Windows Forms RichTextBox 控制項
