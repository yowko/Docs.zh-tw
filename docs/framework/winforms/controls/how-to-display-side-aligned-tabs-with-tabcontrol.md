---
title: "如何：使用 TabControl 顯示對齊側邊的定位點 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "索引標籤頁, 顯示對齊側邊的索引標籤"
  - "TabControl 控制項 [Windows Form], 顯示對齊側邊的索引標籤"
  - "索引標籤, 顯示對齊側邊的索引標籤"
...
2.  將 <xref:System.Windows.Forms.TabControl.Alignment%2A> 屬性設定為 <xref:System.Windows.Forms.TabAlignment>。  
  
3.  設定 <xref:System.Windows.Forms.TabControl.SizeMode%2A> 屬性為 <xref:System.Windows.Forms.TabSizeMode>，好讓所有的索引標籤有相同寬度。  
...
5.  將 <xref:System.Windows.Forms.TabControl.DrawMode%2A> 屬性設定為 <xref:System.Windows.Forms.TabDrawMode>。  
