...
另請參閱[如何：使用設計工具加入和移除具有 Windows Forms TreeView 控制項的節點](add-and-remove-nodes-with-wf-treeview-control-using-the-designer.md)和[如何：使用設計工具將快捷方式功能表附加至 TreeNode](how-to-attach-a-shortcut-menu-to-a-treenode-using-the-designer.md)。  
