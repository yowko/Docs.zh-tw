...
## <a name="add-a-component-to-a-windows-form"></a>將元件新增至 Windows 表單

1. 在 Visual Studio 中開啟表單。 如需詳細資訊，請參閱[如何：在設計工具中顯示 Windows Form](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/w5yd62ts(v=vs.100))。
...
## <a name="add-a-component-to-a-windows-form-programmatically"></a>以程式設計方式將元件新增至 Windows 表單
