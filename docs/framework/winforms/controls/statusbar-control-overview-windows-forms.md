...
## <a name="using-the-statusbar-control"></a>使用 StatusBar 控制項  
 Internet Explorer 使用狀態列表示網頁的 URL，當滑鼠彙總超連結。[!INCLUDE[ofprword](../../../../includes/ofprword-md.md)]提供頁面的位置、 區段位置，以及編輯模式，例如取代和修訂追蹤; 上的資訊和[!INCLUDE[vsprvs](../../../../includes/vsprvs-md.md)]使用，讓內容相關資訊，例如告訴您如何管理可停駐的 [狀態] 列為停駐或浮動視窗。  
