...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：將 ToolStripContainer 新增至表單](how-to-add-a-toolstripcontainer-to-a-form.md)  
 示範如何將 <xref:System.Windows.Forms.ToolStripContainer> 加入應用程式，以及將控制項加入 <xref:System.Windows.Forms.ToolStripContainer> 的特定面板。  
  
 [如何：將控制項新增至 ToolStripContentPanel](how-to-add-a-control-to-a-toolstripcontentpanel.md)  
