...
> [!IMPORTANT]
> 雖然 <xref:System.Windows.Forms.SplitContainer> 會取代並新增舊版 <xref:System.Windows.Forms.Splitter> 控制項的功能，但如果您選擇，<xref:System.Windows.Forms.Splitter> 會保留以供回溯相容性及未來使用。  
