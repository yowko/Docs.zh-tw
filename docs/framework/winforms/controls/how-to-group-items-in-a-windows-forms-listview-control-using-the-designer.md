...
---
# <a name="how-to-group-items-in-a-windows-forms-listview-control-using-the-designer"></a>作法：使用設計工具在 Windows Forms ListView 控制項中分組項目
...
1. 在 [**屬性**] 視窗中，按一下**省略符號**(![。 Visual Studio 的 [屬性] 視窗中的省略符號按鈕 （...）](./media/visual-studio-ellipsis-button.png)) 按鈕旁<xref:System.Windows.Forms.ListView.Groups%2A>屬性.
...
1. 在 [**屬性**] 視窗中，按一下**省略符號**(![。 Visual Studio 的 [屬性] 視窗中的省略符號按鈕 （...）](./media/visual-studio-ellipsis-button.png)) 按鈕旁<xref:System.Windows.Forms.ListView.Items%2A>屬性.
