...
## <a name="in-this-section"></a>本節內容
 ...
 說明如何放置在表單上的控制項，以及在使用<xref:System.Windows.Forms.Control.Margin%2A>， <xref:System.Windows.Forms.Control.Padding%2A>，並<xref:System.Windows.Forms.Control.AutoSize%2A>內的屬性**Form 設計工具**Visual Studio 中。
