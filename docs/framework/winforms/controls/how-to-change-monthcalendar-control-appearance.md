...
---
# <a name="how-to-change-the-windows-forms-monthcalendar-controls-appearance"></a>如何：變更 Windows Form MonthCalendar 控制項的外觀
...
- 將 <xref:System.Windows.Forms.MonthCalendar.ShowWeekNumbers%2A> 屬性設為 `true`。 您可以在程式碼或屬性視窗中設定此屬性。  
