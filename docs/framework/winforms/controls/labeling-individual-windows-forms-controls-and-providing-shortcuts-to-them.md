...
## <a name="in-this-section"></a>本節內容  
 ...
 [操作說明：設定由 Windows Forms 控制項所顯示的影像](../../../../docs/framework/winforms/controls/how-to-set-the-image-displayed-by-a-windows-forms-control.md)  
 說明如何設定控制項來顯示影像。  
  
 [操作說明：建立 Windows Forms 控制項的便捷鍵](../../../../docs/framework/winforms/controls/how-to-create-access-keys-for-windows-forms-controls.md)  
 提供建立預先定義之鍵盤快速鍵的相關資訊。  
  
 [為 Windows Forms 上的控制項提供協助工具資訊](../../../../docs/framework/winforms/controls/providing-accessibility-information-for-controls-on-a-windows-form.md)  
 提供讓您的控制項搭配協助工具輔助使用的相關資訊。  
