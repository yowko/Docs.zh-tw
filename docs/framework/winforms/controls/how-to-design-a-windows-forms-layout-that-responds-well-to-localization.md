...
## <a name="example"></a>範例  
 ...
 在 Visual Studio 中對於本工作有更詳盡的支援。  另請參閱[逐步解說：建立版面配置調整比例以配合當地語系化](https://msdn.microsoft.com/library/7k9fa71y\(v=vs.110\))。  
...
2.  [逐步解說：排列 Windows Form 使用 FlowLayoutPanel 控制項](https://msdn.microsoft.com/library/z9w7ek2f\(v=vs.110\))  
...
5.  [逐步解說：一般工作，使用智慧標籤執行 Windows Form 控制項](https://msdn.microsoft.com/library/xhz359sc\(v=vs.110\))  
  
6.  [逐步解說：排列 Windows Form 使用 TableLayoutPanel 控制項](https://msdn.microsoft.com/library/w4yc3e8c\(v=vs.110\))  
  
7.  [逐步解說：配置 Windows Form 控制項和邊框距離、 邊界和 AutoSize 屬性](https://msdn.microsoft.com/library/3z3f9e8b\(v=vs.110\))  
  
8.  [如何：支援使用 AutoSize 和 TableLayoutPanel 控制項的 Windows Form 的當地語系化](https://msdn.microsoft.com/library/1zkt8b33\(v=vs.110\))  
