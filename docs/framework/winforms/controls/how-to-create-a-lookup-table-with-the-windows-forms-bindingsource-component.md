---
title: "如何：使用 Windows Form BindingSource 元件建立查閱資料表 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "BindingSource 元件 [Windows Form], 建立查閱資料表"
  - "BindingSource 元件 [Windows Form], 範例"
  - "查閱資料表"
  - "資料表 [Windows Form], 建立查閱資料表"
...
|904|2004 年 2 月 13 日|713|  
 ...
 [ComboBox 控制項](../../../../docs/framework/winforms/controls/combobox-control-windows-forms.md) 控制項上設定了四個重要的屬性，以供建立查閱資料表。  
...
1.  從 \[工具箱\] 將 <xref:System.Windows.Forms.ComboBox> 控制項拖曳至表單上。  
  
     此控制項會從父資料表顯示資料行。  
  
2.  拖曳其他控制項以從子資料表顯示詳細資料。  資料表中的資料格式會決定您要選擇哪些控制項。  如需詳細資訊，請參閱[依功能區分 Windows Form 控制項](../../../../docs/framework/winforms/controls/windows-forms-controls-by-function.md)。  
...
8.  從子資料表的 <xref:System.Windows.Forms.BindingSource> \(例如 `OrdersBindingSource`\)，將 <xref:System.Windows.Forms.ComboBox> 和 <xref:System.Windows.Forms.BindingNavigator> 以外的控制項繫結至您想要顯示的詳細資料欄位。  
