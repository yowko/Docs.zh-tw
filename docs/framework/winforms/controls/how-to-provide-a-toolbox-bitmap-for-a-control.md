...
如果您想要有特殊的圖示，為您的控制項出現在**工具箱**，您可以指定特定的映像使用<xref:System.Drawing.ToolboxBitmapAttribute>。 此類別是一個「屬性」，一種您可以附加至其他類別的特殊類別。 如需屬性的詳細資訊，請參閱[不在組建中︰Visual Basic 中的屬性概觀](http://msdn.microsoft.com/library/0d0cff64-892d-4f57-83bd-bef388553d4f) (適用於 [!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)]) 和[屬性](http://msdn.microsoft.com/library/ae334cee-d96c-4243-a5e3-06dd7fcaf205) (適用於 [!INCLUDE[csprcs](../../../../includes/csprcs-md.md)])。  
