...
## <a name="related-sections"></a>相關章節  
 ...
 另請參閱[使用者輸入至對話方塊](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/1s9ws53w(v=vs.100))和[如何：關閉對話方塊並保留使用者輸入](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/65ad5907(v=vs.100))。
