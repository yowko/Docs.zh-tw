...
## <a name="in-this-section"></a>本節內容  
 ...
 另請參閱[如何： 將 Windows Form 按鈕指定為接受按鈕使用設計工具](../../../../docs/framework/winforms/controls/designate-a-wf-button-as-the-accept-button-using-the-designer.md)並[如何： 將 Windows Form 按鈕指定為取消按鈕使用設計工具](../../../../docs/framework/winforms/controls/designate-a-wf-button-as-the-cancel-button-using-the-designer.md)。  
...
## <a name="related-sections"></a>相關章節  
 ...
 另請參閱[使用者輸入到對話方塊](https://msdn.microsoft.com/library/63ad8645-6842-45e8-b215-73f778e29a55)並[如何： 關閉對話方塊並保留使用者輸入](https://msdn.microsoft.com/library/9e118fad-3bf4-4f70-a3de-a0cda2b0229d)。
