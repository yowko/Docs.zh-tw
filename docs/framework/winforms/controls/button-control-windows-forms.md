...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：將 Windows Form 按鈕指定為接受按鈕](../../../../docs/framework/winforms/controls/how-to-designate-a-windows-forms-button-as-the-accept-button.md)  
 ...
 另請參閱[How to:將 Windows Form 按鈕指定為接受按鈕使用設計工具](../../../../docs/framework/winforms/controls/designate-a-wf-button-as-the-accept-button-using-the-designer.md)和[How to:將 Windows Form 按鈕指定為取消按鈕使用設計工具](../../../../docs/framework/winforms/controls/designate-a-wf-button-as-the-cancel-button-using-the-designer.md)。  
...
## <a name="related-sections"></a>相關章節  
 ...
 另請參閱[使用者輸入到對話方塊](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/1s9ws53w(v=vs.100))和[How to:關閉對話方塊並保留使用者輸入](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/65ad5907(v=vs.100))。
