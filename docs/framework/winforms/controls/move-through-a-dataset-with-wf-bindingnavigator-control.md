...
## <a name="example"></a>範例  
 下列程式碼範例示範如何使用 <xref:System.Windows.Forms.BindingNavigator> 控制項在資料中移動。 這個集合會包含在使用 <xref:System.Data.DataView> 元件繫結至 <xref:System.Windows.Forms.TextBox> 控制項的 <xref:System.Windows.Forms.BindingSource> 中。  
