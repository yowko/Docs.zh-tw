...
---
# <a name="how-to-get-the-selected-cells-rows-and-columns-in-the-windows-forms-datagridview-control"></a>HOW TO：取得 Windows Form DataGridView 控制項中的 選取的資料格、 資料列和資料行
