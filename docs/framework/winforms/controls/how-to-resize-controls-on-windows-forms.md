...
---
# <a name="how-to-resize-controls-on-windows-forms"></a>如何：在 Windows Forms 上調整控制項大小

您可以調整個別控制項的大小，也可以調整相同或不同類型的多個控制項大小，例如 <xref:System.Windows.Forms.Button> 和 <xref:System.Windows.Forms.GroupBox> 控制項。
