...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：使用 Windows Forms NumericUpDown 控制項設定和傳回數值](set-and-return-numeric-values-with-wf-numericupdown-control.md)  
 描述如何測試控制項的值。  
...
## <a name="related-sections"></a>相關章節  
 ...
 引進類似于 <xref:System.Windows.Forms.NumericUpDown>的控制項，不同之處在于 <xref:System.Windows.Forms.DomainUpDown> 控制項會顯示字串而非數值。
