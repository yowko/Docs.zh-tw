...
-   設定<xref:System.Windows.Forms.ToolStripItem.Overflow%2A>屬性<xref:System.Windows.Forms.ToolStripItem>所要的值。 您可以徹底`Always`， `Never`，和`AsNeeded`。 Defaultis `AsNeeded`。  
