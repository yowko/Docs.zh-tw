...
---
# <a name="how-to-programmatically-resize-cells-to-fit-content-in-the-windows-forms-datagridview-control"></a>作法：以程式設計方式調整儲存格大小使符合 Windows Forms DataGridView 控制項的內容
