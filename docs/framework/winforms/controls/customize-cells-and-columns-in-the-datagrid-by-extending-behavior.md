---
title: "如何：擴充儲存格和資料行的行為和外觀以自訂 Windows Form DataGridView 控制項中的儲存格和資料行 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "資料行 [Windows Form], 在 DataGridView 控制項中自訂"
...
> [!NOTE]
>  當您自 <xref:System.Windows.Forms.DataGridViewCell> 或 <xref:System.Windows.Forms.DataGridViewColumn> 中衍生時，以及在衍生類別中加入新的屬性時，請務必覆寫 `Clone` 方法，在複製作業期間複製新的屬性。  您也應該呼叫基底類別的 `Clone` 方法，讓基底類別的屬性都會複製到新的儲存格或資料行。  
  
### 若要自訂 DataGridView 控制項中的資料格和資料行  
