...
有時候您會想要顯示<xref:System.Windows.Forms.DataGridView>沒有資料行標頭。 在<xref:System.Windows.Forms.DataGridView>控制項，<xref:System.Windows.Forms.DataGridView.ColumnHeadersVisible%2A>屬性值會決定是否顯示資料行標頭。  
