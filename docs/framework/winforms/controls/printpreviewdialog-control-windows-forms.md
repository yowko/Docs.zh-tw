...
## <a name="in-this-section"></a>本節內容  
 ...
 介紹 `PrintPreviewDialog` 控制項的一般概念，這個控制項可讓您顯示一個預先設定的對話方塊，使用者可以在這個對話方塊中查看文件列印後的結果。  
  
 [如何：顯示預覽列印在 Windows Forms 應用程式](how-to-display-print-preview-in-windows-forms-applications.md)  
