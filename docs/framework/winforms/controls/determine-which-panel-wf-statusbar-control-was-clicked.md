...
1.  在<xref:System.Windows.Forms.StatusBar.PanelClick>事件處理常式，使用`Select Case`(在[!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)]) 或`switch case`([!INCLUDE[csprcs](../../../../includes/csprcs-md.md)]或[!INCLUDE[vcprvc](../../../../includes/vcprvc-md.md)]) 陳述式來判斷哪個面板已按下藉由檢查事件引數中按下的面板的索引。  
