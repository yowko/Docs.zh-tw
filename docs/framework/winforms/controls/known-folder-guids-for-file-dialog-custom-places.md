---
title: "檔案對話方塊自訂位置的已知資料夾 GUID | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
您會在將資料夾加入至 <xref:System.Windows.Forms.FileDialog.CustomPlaces%2A> 集合時，使用 <xref:System.Guid> 指定 [!INCLUDE[wiprlhext](../../../../includes/wiprlhext-md.md)] 已知資料夾。  已知資料夾 GUID 不區分大小寫，並且是在 [!INCLUDE[winSDK](../../../../includes/winsdk-md.md)] 的 KnownFolders.h 檔中定義。  
  
> [!NOTE]
>  在某些情況下，加入至 <xref:System.Windows.Forms.FileDialogCustomPlacesCollection> 的已知資料夾不會顯示於 \[**我的最愛連結**\] 區域中。  例如，如果指定的已知資料夾不在執行應用程式的電腦上，則不會顯示已知資料夾。  
  
## GUID 清單  
 下表列出 [!INCLUDE[wiprlhext](../../../../includes/wiprlhext-md.md)] 已知資料夾及其相關的 <xref:System.Guid>。  
...
## 請參閱  
 ...
 [如何：將自訂位置加入至檔案對話方塊](../../../../docs/framework/winforms/controls/how-to-add-a-custom-place-to-a-file-dialog-box.md)