...
若要實作虛擬模式中的其中一個原因<xref:System.Windows.Forms.DataGridView>控制項是只有在需要時擷取資料。 這就叫做 *-just-in-time 資料載入*。  
 ...
 若要複製一份清單列出本主題中的程式碼，請參閱[How to:實作虛擬模式，以在 Just-in-time 資料載入，在 Windows Form DataGridView 控制項](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md)。  
...
- [如何：Windows Form DataGridView 控制項中實作虛擬模式，以在 Just-in-time 資料載入](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md)
