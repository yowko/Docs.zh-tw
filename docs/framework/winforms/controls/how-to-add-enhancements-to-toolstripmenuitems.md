...
-   <span data-ttu-id="3a3f3-105">新增以視覺方式表示功能表命令的映像。</span><span class="sxs-lookup"><span data-stu-id="3a3f3-105">Add images that visually represent menu commands.</span></span>  
