...
## <a name="add-load-save-and-cancel-buttons-to-the-bindingnavigator-component"></a>將載入、 儲存，和 [取消] 按鈕至 BindingNavigator 元件

1. 在 Visual Studio 中，新增<xref:System.Windows.Forms.TextBox>控制項至表單。
