...
---
# <a name="how-to-put-quotation-marks-in-a-string-windows-forms"></a>作法：以字串括住引號 (Windows Forms)
...
1. 在 Visual Basic 中, 將資料列中的兩個引號插入為內嵌引號。 在 [ C#視覺效果C++] 和 [視覺效果\\] 中, 插入 [escape 序列] 做為內嵌的引號。 例如，若要建立前置字串，請使用下列程式碼。  
