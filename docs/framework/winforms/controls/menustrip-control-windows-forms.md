...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：新增 toolstripmenuitems 的功能的增強功能](../../../../docs/framework/winforms/controls/how-to-add-enhancements-to-toolstripmenuitems.md)  
 描述如何將核取記號、影像、快速鍵、便捷鍵和分隔線加入功能表和功能表命令。  
  
 [如何：將 MenuStrip 附加至 MDI 父視窗](../../../../docs/framework/winforms/controls/how-to-append-a-menustrip-to-an-mdi-parent-window-windows-forms.md)  
 ...
 [如何：從 MDI 下拉式功能表移除 ToolStripMenuItem](../../../../docs/framework/winforms/controls/how-to-remove-a-toolstripmenuitem-from-an-mdi-drop-down-menu-windows-forms.md)  
 描述如何設定數個屬性，從 MDI 父功能表的下拉式部分中移除功能表項目。  
  
 [如何：設定 MenuStrip 核取邊界和影像邊界](../../../../docs/framework/winforms/controls/how-to-configure-menustrip-check-margins-and-image-margins.md)  
 ...
 [如何：在 MenuStrip 中顯示選項按鈕](../../../../docs/framework/winforms/controls/how-to-display-option-buttons-in-a-menustrip-windows-forms.md)  
