...
在 Visual Studio 中建立名為"DebuggingExample 」 的 Windows 應用程式專案 (**檔案** > **新增** > **專案** > **Visual C#** 或是**Visual Basic** > **傳統桌面** > **Windows Forms 應用程式**).
...
若要檢查您的進度，請找出呼叫新的索引標籤**DebugControlLibrary 元件**並按一下以選取它。 當它開啟時，您會看到控制項列為**DebugControl**與它旁邊的預設圖示。

## <a name="add-a-property-to-your-custom-control"></a>將屬性加入至您的自訂控制項
...
## <a name="add-your-custom-control-to-the-host-form"></a>將您的自訂控制項加入至主表單
...
## <a name="set-up-the-project-for-design-time-debugging"></a>設定設計階段偵錯的專案
...
## <a name="debug-your-custom-control-at-design-time"></a>在設計階段偵錯您的自訂控制項
