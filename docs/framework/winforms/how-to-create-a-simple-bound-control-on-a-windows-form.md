...
4. 如果您要系結的屬性不是其中一個常用的屬性, 請按一下 [ **(Advanced)** ] 方塊中的**省略號**按鈕 (![屬性視窗中 Visual Studio 的省略號按鈕 (...)](./media/how-to-create-a-simple-bound-control-on-a-windows-form/visual-studio-ellipsis-button.png), 以顯示 **[格式化] 和 [Advanced Binding]** 對話方塊, 其中包含該控制項的完整屬性清單。

5. 選取您想要系結的屬性，然後按一下 [系結] 底下的下拉箭**號。**
