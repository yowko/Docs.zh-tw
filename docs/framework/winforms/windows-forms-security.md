...
## <a name="related-sections"></a>相關章節  
 ...
 [危險的使用權限和原則管理](../misc/dangerous-permissions-and-policy-administration.md)  
 討論一些可能會允許安全性系統受到危害的.net Framework 權限。  
