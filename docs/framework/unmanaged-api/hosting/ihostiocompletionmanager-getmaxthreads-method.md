...
## <a name="parameters"></a>參數  
 ...
 脫銷執行緒集區中的執行緒最大數目的指標，可讓主機為服務 i/o 要求進行分配。  
...
## <a name="remarks"></a>備註  
 主機可能會想要獨佔控制可配置給處理 i/o 要求的執行緒數目，原因包括執行、效能或擴充性。 基於這個理由，主機不需要執行 `GetMaxThreads` 。 在此情況下，主機應該會從這個方法傳回 E_NOTIMPL。  
