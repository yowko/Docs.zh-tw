...
## <a name="remarks"></a>備註  
 CLR 會呼叫`CreateRWLockWriterEvent`方法來取得參考`IHostAutoEvent`寫入器鎖定的實作中使用的執行個體。 主機可以使用指定的 cookie，以判斷哪些工作正在等候鎖定的反覆項目方法[ICLRSyncManager](../../../../docs/framework/unmanaged-api/hosting/iclrsyncmanager-interface.md)介面。  
