...
## <a name="parameters"></a>參數  
 ...
 `ppOwnerHostTask`  
 脫銷目前擁有此監視器之 `IHostTask` 的指標，如果沒有任何工作具有擁有權，則為 null。  
  
## <a name="return-value"></a>傳回值  
  
|HRESULT|描述|  
|-------------|-----------------|  
|S_OK|已成功傳回 `GetMonitorOwner`。|  
...
## <a name="remarks"></a>備註  
 主機通常會呼叫 `GetMonitorOwner` 做為鎖死偵測機制的一部分。 當使用[IHostSyncManager：： CreateMonitorEvent](../../../../docs/framework/unmanaged-api/hosting/ihostsyncmanager-createmonitorevent-method.md)的呼叫建立時，cookie 會與監視相關聯。  
