...
ms.locfileid: "33430421"
---
# <a name="hosting-global-static-functions"></a>裝載全域靜態函式
本章節描述裝載 Api 的.NET Framework 所使用的 unmanaged 裝載函式。  
  
## <a name="in-this-section"></a>本節內容  
 [.NET Framework 4 裝載全域靜態函式](../../../../docs/framework/unmanaged-api/hosting/net-framework-4-hosting-global-static-functions.md)  
 描述.NET Framework 4 中引入的函數。  
  
 [已被取代的 CLR 裝載函式](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-functions.md)  
 說明導入.NET Framework 1.1 和 2.0 中已被取代的函式[!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)]。  
