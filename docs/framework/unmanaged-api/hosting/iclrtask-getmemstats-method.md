...
取得與目前 [ICLRTask](iclrtask-interface.md) 實例所代表之工作相關的統計記憶體使用量資訊。  
...
## <a name="parameters"></a>參數  
 ...
 `pMemUsage`  
 擴展 [COR_GC_THREAD_STATS](cor-gc-thread-stats-structure.md) 實例的指標，其中包含工作的記憶體使用量詳細資料，包括配置的位元組數目。  
  
## <a name="return-value"></a>傳回值  
  
|HRESULT|描述|  
|-------------|-----------------|  
|S_OK|`GetMemStats` 傳回成功。|  
