...
## <a name="remarks"></a>備註  
 CLR 會呼叫`SetCLRTask`產生關聯`ICLRTask`與目前的執行個體`IHostTask`執行個體，這由呼叫[ihosttaskmanager:: Createtask](../../../../docs/framework/unmanaged-api/hosting/ihosttaskmanager-createtask-method.md)。  
