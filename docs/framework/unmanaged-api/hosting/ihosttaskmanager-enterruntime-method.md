...
## <a name="remarks"></a>備註  
 呼叫 `EnterRuntime` 以通知主機，先前呼叫[LeaveRuntime](../../../../docs/framework/unmanaged-api/hosting/ihosttaskmanager-leaveruntime-method.md)方法的非受控函式已完成執行，並將執行控制傳回執行時間。  
