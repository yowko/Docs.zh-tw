...
終止目前的使用者身分識別模擬，並傳回原始的執行緒 token。  
...
## <a name="remarks"></a>備註  
 `RevertToSelf` 呼叫以傳回至原始的執行緒 token，在先前呼叫後[ImpersonateLoggedOnUser](../../../../docs/framework/unmanaged-api/hosting/ihostsecuritymanager-impersonateloggedonuser-method.md)方法。  
