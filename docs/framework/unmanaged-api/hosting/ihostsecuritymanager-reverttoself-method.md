...
## <a name="remarks"></a>備註  
 ...
 `RevertToSelf` 在先前呼叫 [ImpersonateLoggedOnUser](ihostsecuritymanager-impersonateloggedonuser-method.md) 方法之後，呼叫以返回原始執行緒標記。  
