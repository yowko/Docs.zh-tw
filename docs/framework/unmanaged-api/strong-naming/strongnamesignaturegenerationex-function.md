...
根據指定的旗標，產生指定元件的強式名稱簽章。  
 ...
 此函數已被取代。 請改用 [ICLRStrongName：： StrongNameSignatureGenerationEx](../hosting/iclrstrongname-strongnamesignaturegenerationex-method.md) 方法。  
...
## <a name="remarks"></a>備註  
 ...
 如果函式 `StrongNameSignatureGenerationEx` 未順利完成，請呼叫 [StrongNameErrorInfo](strongnameerrorinfo-function.md) 函式來取出最後產生的錯誤。  
