...
|方法|描述|  
|------------|-----------------|  
|[Commit 方法](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedwriter3-commit-method.md)|認可的變更寫入目前資料流。|  
|[OpenMethod2 方法](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedwriter3-openmethod2-method.md)|開啟的方法，並提供其實際的區段位移，映像中。|  
