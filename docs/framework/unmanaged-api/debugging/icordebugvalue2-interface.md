...
延伸以支援 「 ICorDebugType 「 物件 」 ICorDebugValue"介面。  
  
## <a name="methods"></a>方法  
  
|方法|描述|  
|------------|-----------------|  
|[GetExactType 方法](../../../../docs/framework/unmanaged-api/debugging/icordebugvalue2-getexacttype-method.md)|取得的介面指標`ICorDebugType`物件，表示<xref:System.Type>此值。|  
