...
取得處理序所參考的可執行檔的完整路徑[ICorPublishProcess](../../../../docs/framework/unmanaged-api/debugging/icorpublishprocess-interface.md)。  
...
## <a name="parameters"></a>參數  
 ...
 `pcchName`  
 [out]中傳回的寬字元數目`szName`陣列。  
  
 `szName`  
 [out]要儲存的名稱，包括可執行檔的完整路徑的陣列。 名稱是以 null 結束。  
