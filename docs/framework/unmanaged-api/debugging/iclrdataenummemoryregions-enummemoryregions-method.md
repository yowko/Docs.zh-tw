...
## <a name="parameters"></a>參數  
 ...
 `callback`  
 在 [ICLRDataEnumMemoryRegionsCallback](iclrdataenummemoryregionscallback-interface.md) 實例的指標，此方法會針對每個列舉的記憶體區域呼叫這個方法，以通知偵錯工具結果。  
...
## <a name="remarks"></a>備註  
 ...
 這個方法會使用指定的 [ICLRDataEnumMemoryRegionsCallback](iclrdataenummemoryregionscallback-interface.md) 實例，通知呼叫端結果。  
