...
|[SetDesiredNGENCompilerFlags 方法](icordebugprocess2-setdesiredngencompilerflags-method.md)|設定即時（JIT）編譯器所需的旗標，以將影像載入正在進行調試的進程。|  
|[SetUnmanagedBreakpoint 方法](icordebugprocess2-setunmanagedbreakpoint-method.md)|在指定的原生映射位移處設定非受控中斷點。|  
