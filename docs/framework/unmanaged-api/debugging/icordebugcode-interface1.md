...
|[GetAddress 方法](../../../../docs/framework/unmanaged-api/debugging/icordebugcode-getaddress-method.md)|取得此 `ICorDebugCode` 所代表之程式碼區段的相對虛擬位址（RVA）。|  
...
|[GetFunction 方法](../../../../docs/framework/unmanaged-api/debugging/icordebugcode-getfunction-method.md)|取得與此 `ICorDebugCode`相關聯的 "ICorDebugFunction"。|  
...
|[GetSize 方法](../../../../docs/framework/unmanaged-api/debugging/icordebugcode-getsize-method.md)|取得此 `ICorDebugCode`所表示之二進位代碼的大小（以位元組為單位）。|  
