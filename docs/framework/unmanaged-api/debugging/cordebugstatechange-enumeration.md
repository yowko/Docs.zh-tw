...
## <a name="remarks"></a>備註  
 成員`CorDebugStateChange`列舉型別提供做為引數，當偵錯工具呼叫[ProcessStateChanged](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess6-processstatechanged-method.md)方法  
