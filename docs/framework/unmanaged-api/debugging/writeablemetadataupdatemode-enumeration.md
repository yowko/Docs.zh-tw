...
## <a name="remarks"></a>備註  
 列舉的成員 `WriteableMetadataUpdateMode` 可以傳遞至[SetWriteableMetadataUpdateMode](icordebugprocess7-setwriteablemetadataupdatemode-method.md)方法，以控制是否可以在偵錯工具中看到目標進程中中繼資料的記憶體中更新。  
