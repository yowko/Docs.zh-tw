...
提供偵錯應用程式定義域的方法。 此介面是 ICorDebugController 的子類別。  
...
|[EnumerateBreakpoints 方法](icordebugappdomain-enumeratebreakpoints-method.md)|取得應用程式域中所有作用中中斷點的列舉值。|  
|[EnumerateSteppers 方法](icordebugappdomain-enumeratesteppers-method.md)|取得應用程式域中所有使用中 steppers 的列舉值。|  
|[GetId 方法](icordebugappdomain-getid-method.md)|取得應用程式域的唯一識別碼。|  
|[GetModuleFromMetaDataInterface 方法](icordebugappdomain-getmodulefrommetadatainterface-method.md)|取得具有指定中繼資料介面的 ICorDebugModule 物件。|  
...
|[IsAttached 方法](icordebugappdomain-isattached-method.md)|判斷偵錯工具是否已附加至應用程式域。|  
