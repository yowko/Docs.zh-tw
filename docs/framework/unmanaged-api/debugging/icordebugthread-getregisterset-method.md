...
取得為這個 ICorDebugThread 物件的使用中部分相關聯的登錄設定的介面指標。  
...
#### <a name="parameters"></a>參數  
 `ppRegisters`  
 [out]位址指標[ICorDebugRegisterSet](../../../../docs/framework/unmanaged-api/debugging/icordebugregisterset-interface.md)介面物件，表示登錄設定這個執行緒的使用中部分。  
