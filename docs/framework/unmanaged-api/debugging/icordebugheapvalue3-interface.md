...
|方法|描述|  
|------------|-----------------|  
|[GetThreadOwningMonitorLock 方法](icordebugheapvalue3-getthreadowningmonitorlock-method.md)|傳回在這個物件上擁有監視器鎖定的 managed 執行緒。|  
|[GetMonitorEventWaitList 方法](icordebugheapvalue3-getmonitoreventwaitlist-method.md)|提供已排序的執行緒清單，這些執行緒會排入與監視器鎖定相關聯的事件上。|  
