...
## <a name="remarks"></a>備註  
 ...
 [ICorDebugStackWalk](icordebugstackwalk-interface.md)方法不會調整堆疊上推送之參數的堆疊指標。 相反地，您可以使用傳回的值 `GetStackParameterSize` 來調整堆疊指標，以植入原生回溯器，而這會對參數進行調整。  
