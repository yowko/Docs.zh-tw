...
|`ver_ICorDebugHeapValue3`|[ICorDebugHeapValue3 介面](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue3-interface.md)|4|  
|`ver_ICorDebugBlockingObjectEnum`|[ICorDebugBlockingObjectEnum 介面](../../../../docs/framework/unmanaged-api/debugging/icordebugblockingobjectenum-interface.md)|4|  
...
- [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)]導入混合的介面版本。 例如，`ICorDebugThread3` 和 `ICorDebugThread4` 會以 `ICorDebugThread` 介面的第三和第四版出現。 .NET Framework 4 也引進了第一版`ICorDebugStackWalk`介面和第二版`ICorDebugNativeFrame`介面 (`ICorDebugNativeFrame2`)。  
