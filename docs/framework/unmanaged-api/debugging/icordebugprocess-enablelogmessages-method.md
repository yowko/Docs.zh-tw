...
#### <a name="parameters"></a>參數  
 `fOnOff`  
 [in]`true`啟用傳輸記錄檔訊息。`false`停用傳送。  
  
## <a name="remarks"></a>備註  
 這個方法是之後才有效[icordebugmanagedcallback:: Createprocess](../../../../docs/framework/unmanaged-api/debugging/icordebugmanagedcallback-createprocess-method.md)回呼發生時。  
