...
## <a name="parameters"></a>參數  
 `fOnOff`  
 [in]`true`啟用傳輸記錄檔訊息;`false`停用傳輸。  
  
## <a name="remarks"></a>備註  
 這個方法會有效之後，才[icordebugmanagedcallback:: Createprocess](../../../../docs/framework/unmanaged-api/debugging/icordebugmanagedcallback-createprocess-method.md)回呼，就會發生。  
