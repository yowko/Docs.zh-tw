...
## <a name="net-framework-version-2-profiling-functions"></a>.NET framework 第 2 版程式碼剖析函式  
 ...
 控制項已傳遞至函式，並提供資訊堆疊框架和函式的引數，請通知分析工具。 中已被取代[!INCLUDE[net_v40_short](../../../../includes/net-v40-short-md.md)]。  
 ...
 通知分析工具，目前正在執行的函式執行至另一個函式的 tail 呼叫，並提供有關堆疊框架資訊。 中已被取代[!INCLUDE[net_v40_short](../../../../includes/net-v40-short-md.md)]。  
