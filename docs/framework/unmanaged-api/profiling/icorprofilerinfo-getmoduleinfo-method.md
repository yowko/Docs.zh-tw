...
## <a name="remarks"></a>備註  
 ...
 雖然此 `GetModuleInfo` 方法可能會在模組的識別碼存在時立即呼叫，但是在分析工具收到 [ICorProfilerCallback：： ModuleAttachedToAssembly](icorprofilercallback-moduleattachedtoassembly-method.md) 回呼之前，將無法使用父元件的識別碼。  
