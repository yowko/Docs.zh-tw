...
## <a name="remarks"></a>備註  
 ...
 雖然可以在模組的識別碼存在的情況下呼叫 `GetModuleInfo2` 方法，但在分析工具收到[ICorProfilerCallback：： ModuleAttachedToAssembly](icorprofilercallback-moduleattachedtoassembly-method.md)回呼之前，父元件的識別碼將無法使用。  
