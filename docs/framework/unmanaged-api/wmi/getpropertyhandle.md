...
`pType`\
脫銷表示屬性之 CIM 類型的[`CIMTYPE`](/windows/win32/api/wbemcli/ne-wbemcli-cimtype_enumeration)列舉成員的指標。
...
|`WBEM_E_NOT_SUPPORTED` | 0x8004100c | 要求的屬性屬於類型 `CIM_OBJECT` 或 `CIM_ARRAY`。 |
