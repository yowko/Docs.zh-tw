...
取得值，指出目前的「編輯後繼續」會話所產生之中繼資料大小的任何變更。  
...
## <a name="parameters"></a>參數  
 `fSave`  
 在其中一個[CorSaveSize](../../../../docs/framework/unmanaged-api/metadata/corsavesize-enumeration.md)值，表示所需的精確度層級。 針對 .NET Framework 版本2.0，會忽略這個參數。  
