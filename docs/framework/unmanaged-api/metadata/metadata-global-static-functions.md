...
ms.locfileid: "62049787"
---
# <a name="metadata-global-static-functions"></a>中繼資料全域靜態函式
開頭[!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)]，文件`_Cor*`， `CoInitialize*`， `CoUninitialize*`，和`CoEEShutDownCOM`函式，適用於裝載，它們位於[取代 CLR 裝載函式](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-functions.md)。 沒有與中繼資料相關的全域靜態函式。  
