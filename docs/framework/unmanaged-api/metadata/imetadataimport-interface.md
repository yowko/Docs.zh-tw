...
|[EnumProperties 方法](imetadataimport-enumproperties-method.md)|列舉 PropertyDef 語彙基元，其代表指定的 TypeDef 語彙基元所參考的類型屬性。|  
...
|[GetTypeDefProps 方法](imetadataimport-gettypedefprops-method.md)|傳回指定 TypeDef 語彙基元所代表類型的中繼資料資訊。|  
