...
## <a name="protected-objects"></a>受保護的物件  
 ...
 這類物件的最簡單的防禦是要求相同**FileIOPermission**試圖透過公用應用程式開發介面項目取得物件參考的任何程式碼。  
