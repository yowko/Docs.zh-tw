...
-   [Windows Identity Foundation 4.5 概觀](../../../docs/framework/security/wif-overview.md)  
  
    -   [宣告式身分識別模型](../../../docs/framework/security/claims-based-identity-model.md)  
  
    -   [使用 WIF 進行宣告式授權](../../../docs/framework/security/claims-based-authorization-using-wif.md)  
  
    -   [WIF 宣告程式設計模型](../../../docs/framework/security/wif-claims-programming-model.md)  
...
-   [WIF 功能](../../../docs/framework/security/wif-features.md)  
    ...
    -   [WIF 和 Web 伺服陣列](../../../docs/framework/security/wif-and-web-farms.md)  
  
    -   [WSFederation 驗證模組概觀](../../../docs/framework/security/wsfederation-authentication-module-overview.md)  
...
-   [WIF 的操作說明索引](../../../docs/framework/security/wif-how-tos-index.md)  
    ...
    -   [操作說明︰啟用權杖重新執行偵測](../../../docs/framework/security/how-to-enable-token-replay-detection.md)  
  
    -   [操作說明︰啟用 WIF 追蹤](../../../docs/framework/security/how-to-enable-wif-tracing.md)  
  
    -   [操作說明：啟用 WCF Web 服務應用程式的 WIF](../../../docs/framework/security/how-to-enable-wif-for-a-wcf-web-service-application.md)  
  
    -   [操作說明：轉換傳入宣告](../../../docs/framework/security/how-to-transform-incoming-claims.md)  
  
-   [WIF 方針](../../../docs/framework/security/wif-guidelines.md)  
...
-   [WIF 程式碼範例索引](../../../docs/framework/security/wif-code-sample-index.md)  
  
-   [WIF 擴充功能](../../../docs/framework/security/wif-extensions.md)  
