...
- [WIF 的操作說明索引](../../../docs/framework/security/wif-how-tos-index.md)
  ...
  - [如何：啟用 WIF 追蹤](../../../docs/framework/security/how-to-enable-wif-tracing.md)

  - [如何：啟用 WCF Web 服務應用程式的 WIF](../../../docs/framework/security/how-to-enable-wif-for-a-wcf-web-service-application.md)

  - [如何：轉換傳入宣告](../../../docs/framework/security/how-to-transform-incoming-claims.md)
