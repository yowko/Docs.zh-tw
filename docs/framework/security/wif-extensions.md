...
ms.locfileid: "64592191"
---
# <a name="wif-extensions"></a>WIF 擴充功能
本節描述 Windows Identity Foundation 延伸模組。  
  
- [JSON Web 語彙基元處理常式](../../../docs/framework/security/json-web-token-handler.md)  
  
- [驗證簽發者名稱登錄](../../../docs/framework/security/validating-issuer-name-registry.md)
