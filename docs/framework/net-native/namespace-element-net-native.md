---
title: "&lt;Namespace&gt; 項目 (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|值|說明|  
|-----------|-----------------|  
|*namespace_name*|命名空間名稱。 如果<>\>元素是子系[ <> \</> \> ](../../../docs/framework/net-native/application-element-net-native.md)， [ <> \</> \> ](../../../docs/framework/net-native/library-element-net-native.md)，或[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)項目， *namespace_name*必須是完整的命名空間名稱。 如果<>\>項目是另一個子系<>\>項目， *namespace_name*必須是相對的命名空間名稱。|  
...
|項目|描述|  
|-------------|-----------------|  
|[<>\>](../../../docs/framework/net-native/application-element-net-native.md)|做為整個應用程式的類型和類型成員的容器，這些類型和類型成員的中繼資料可在執行階段用於反映。 [ <> \> ](../../../docs/framework/net-native/application-element-net-native.md)元素可以有零個、 一個或多個[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)項目。|  
|[<>\>](../../../docs/framework/net-native/assembly-element-net-native.md)|將執行階段反映原則套用至指定組件中的所有類型。|  
|[<>\>](../../../docs/framework/net-native/library-element-net-native.md)|定義包含類型和類型成員的組件，該類型和類型成員的中繼資料會在執行階段用於反映。 [ <> \> ](../../../docs/framework/net-native/library-element-net-native.md)項目可以有零個或一個[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)項目。|  
...
## <a name="remarks"></a>備註  
 ...
 當它是子系[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)項目，`<Namespace>`元素所定義的執行階段反映原則會覆寫[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)項目。  
