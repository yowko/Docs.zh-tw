---
title: "&lt;Subtypes&gt; 項目 (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 因為`<Subtypes>`指示詞，則下列程式碼來具現化`Derived1`以動態方式呼叫的執行個體<xref:System.Activator.CreateInstance%28System.Type%29?displayProperty=fullName>方法執行成功。  此處的區塊變數是<xref:System.Windows.Controls.TextBlock>的空白 Windows 市集應用程式中的物件。  
