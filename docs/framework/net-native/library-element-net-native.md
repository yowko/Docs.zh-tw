---
title: "&lt;Library&gt; 項目 (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|值|描述|  
|-------|--------|  
|*assembly\_name*|組件的簡單名稱，不包含其副檔名。  這個屬性 \(Attribute\) 會對應至 <xref:System.Reflection.AssemblyName.Name%2A?displayProperty=fullName> 屬性 \(Property\)。  例如，組件 Extensions.dll 的名稱為 "Extensions"。  如需支援從組件條件式包含中繼資料之 *assembly\_name* 的特殊格式，請參閱＜備註＞一節。|  
...
## 備註  
 [\<Directives\>](../../../docs/framework/net-native/directives-element-net-native.md) 項目可包含零個、一個或多個 `<Library>` 項目。  
...
## 請參閱  
 [\<Application\> 項目](../../../docs/framework/net-native/application-element-net-native.md)   
