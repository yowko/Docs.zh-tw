---
title: "執行緒集區 ETW 事件 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### ThreadPoolWorkerThreadStart 與 ThreadPoolWorkerThreadStop  
 下表顯示這些事件的關鍵字與層級。 \(如需詳細資訊，請參閱 [CLR ETW 關鍵字和層級](../../../docs/framework/performance/clr-etw-keywords-and-levels.md)\)。  
