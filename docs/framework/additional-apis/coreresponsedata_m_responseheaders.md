...
---
# <a name="coreresponsedatamresponseheaders-field"></a>CoreResponseData.m\_ResponseHeaders 欄位

`CoreResponseData.m_ResponseHeaders` 是<xref:System.Net.WebHeaderCollection>與伺服器的回應相關聯的標頭。
