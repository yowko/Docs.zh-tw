...
## <a name="remarks"></a>備註  
 這個命令列工具僅用於在本機電腦上設定基本 WS-AT 設定。 如果您必須在本機和遠端電腦上進行設定, 應使用 MMC 嵌入式管理單元, 如設定 WS-不可部分完成的[交易支援](../../../docs/framework/wcf/feature-details/configuring-ws-atomic-transaction-support.md)中所述。  
...
|-traceLevel:\<Off&#124;錯誤&#124;重大&#124;警告&#124;資訊&#124;詳細&#124;說明所有 >}|指定追蹤層級。|  
