...
## <a name="remarks"></a>備註  
 ...
 如果您執行的是 [!INCLUDE[wxp](../../../includes/wxp-md.md)] 或 [!INCLUDE[ws2003](../../../includes/ws2003-md.md)]，則必須先下載更新，再執行 WsatConfig.exe。 如需此更新的詳細資訊，請參閱[Windows Communication Foundation 的更新（KB912817）](https://www.microsoft.com/en-us/download/details.aspx?id=21520)。  
