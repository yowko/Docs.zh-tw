---
title: ".NET Framework 4.5 的 Windows Communication Foundation 字彙 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "WCF [WCF], 字彙"
  - "Windows Communication Foundation [WCF], 字彙"
...
|服務作業|服務作業是指在服務的程式碼中定義的程序，此程序會實作作業的功能。  這項作業會向用戶端公開為 WCF 用戶端上的方法。  此方法可能會傳回值且接受選擇性的引數數目，或者不接受引數且不會傳回回應。  例如，作用為「Hello」的作業，可以做為用戶端出席狀態的通知，並且用來開始一系列的作業。|  
