...
您可以控制 Windows Communication Foundation (WCF) 服務主機 (WcfSvcHost.exe) 的自動啟動功能[!INCLUDE[indigo2](../../../includes/indigo2-md.md)]服務程式庫專案，當您偵錯包含多個專案的相同 Visual Studio 方案中另一個專案.  
