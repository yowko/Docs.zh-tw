...
> [!NOTE]
> 當 System.servicemodel 註冊工具在 Windows Vista 上執行時，[ **Windows 功能**] 對話方塊可能不會反映 [ **Microsoft .NET Framework 3.0** ] 底下的 [ **Windows Communication Foundation HTTP**啟動] 選項已開啟。 按一下 [**開始**]，然後按一下 [**執行**]，再輸入**OptionalFeatures**，即可存取 [ **Windows 功能**] 對話方塊。  
