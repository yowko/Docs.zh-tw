...
-   **擴充性**  
     ...
     [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 架構具有若干擴充點。 如果需要額外的功能，有數個進入點可讓您自訂服務的行為。 [!INCLUDE[crabout](../../../includes/crabout-md.md)] 可用擴充點的詳細資訊，請參閱 [Extending WCF](../../../docs/framework/wcf/extending/extending-wcf.md).  
