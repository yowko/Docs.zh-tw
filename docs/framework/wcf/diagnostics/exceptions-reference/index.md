...
本節列出下列區域中由 [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] 所產生的所有例外狀況：  
 ...
 [裝載](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/hosting-exceptions.md)  
  
 [對等通道](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/peer-channel.md)  
  
 [MSMQ 整合傳輸](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/msmq-integration-transport.md)  
  
 [MSMQ 傳輸](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/msmq-transport.md)  
  
 [可信賴傳訊](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/reliable-messaging.md)  
  
 [安全性例外狀況](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/security-exceptions.md)  
  
 [服務架構](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework.md)  
