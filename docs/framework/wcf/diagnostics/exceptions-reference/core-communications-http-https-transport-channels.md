...
|HttpRegistrationAccessDenied|HTTP 無法註冊指定的 URL。 您的程序並沒有此命名空間的存取權限 (請參閱 http://msdn.microsoft.com/library/default.asp?url=/library/http/http/namespace_reservations_registrations_and_routing.asp 如需詳細資訊)。|  
