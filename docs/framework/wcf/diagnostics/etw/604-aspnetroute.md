...
## <a name="description"></a>描述  
 加入具有 serviceType '%2' 和 serviceHostFactoryType '%3' 的新 Asp.Net 路由 '%1' 時，就會發出此事件。  
  
## <a name="message"></a>訊息  
 已加入具有 serviceType '%2' 和 serviceHostFactoryType '%3' 的新 Asp.Net 路由 '%1'。  
