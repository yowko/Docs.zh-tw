...
|[1443 - MaxRetryCyclesExceededMsmq](1443-maxretrycyclesexceededmsmq.md)|Error|在 ID 為 '%1' 之 MSMQ 訊息上已超過最大重試循環|Quota|  
...
|[3300 - ReceiveContextCompleteFailed](3300-receivecontextcompletefailed.md)|警告|無法完成 %1。|管道|  
|[3301 - ReceiveContextAbandonFailed](3301-receivecontextabandonfailed.md)|警告|無法放棄 %1。|管道|  
|[3303 - ReceiveContextAbandonWithException](3303-receivecontextabandonwithexception.md)|警告|接收內容發生錯誤。|ServiceModel|  
|[3303 - ReceiveContextAbandonWithException](3303-receivecontextabandonwithexception.md)|資訊|已放棄 %1，發生例外狀況 %2。|管道|  
...
|[3312 - MessageReadByEncoder](3312-messagereadbyencoder.md)|資訊|編碼器讀取大小為 '%1' 位元組的訊息。|管道|  
|[3312 - MessageReadByEncoder](3312-messagereadbyencoder.md)|資訊|編碼器寫入大小為 '%1' 位元組的訊息。|管道|  
...
|[3321 - ConnectionPoolMiss](3321-connectionpoolmiss.md)|「詳細資訊」|%1 的集區沒有可用的連線和 %2 忙碌的連線。|管道|  
...
|[3337 - ChannelReceiveStart](3337-channelreceivestart.md)|「詳細資訊」|ChannelHandlerId：%1 - 訊息接收迴圈已啟動。|管道|  
|[3338 - ChannelReceiveStop](3338-channelreceivestop.md)|「詳細資訊」|ChannelHandlerId：%1 - 訊息接收迴圈已停止。|管道|  
|[3339 - ChannelFactoryCreated](3339-channelfactorycreated.md)|「詳細資訊」|已建立 ChannelFactory。|ServiceModel|  
|[3340 - PipeConnectionAcceptStart](3340-pipeconnectionacceptstart.md)|「詳細資訊」|管道連線接受已在 %1 上啟動。|管道|  
|[3341 - PipeConnectionAcceptStop](3341-pipeconnectionacceptstop.md)|「詳細資訊」|管道連線已接受。|管道|  
|[3342 - EstablishConnectionStart](3342-establishconnectionstart.md)|「詳細資訊」|已啟動 %1 的連線建立。|管道|  
|[3343 - EstablishConnectionStop](3343-establishconnectionstop.md)|「詳細資訊」|已建立連線。|管道|  
|[3345 - SessionPreambleUnderstood](3345-sessionpreambleunderstood.md)|「詳細資訊」|了解 '%1' 的工作階段前序編碼。|管道|  
|[3346 - ConnectionReaderSendFault](3346-connectionreadersendfault.md)|Error|連線讀取器正在傳送錯誤 '%1'。|管道|  
...
|[3349 - ListenerOpenStart](3349-listeneropenstart.md)|「詳細資訊」|開啟 '%1' 的接聽項。|管道|  
|[3350 - ListenerOpenStop](3350-listeneropenstop.md)|「詳細資訊」|接聽項開啟完成。|管道|  
...
|[3367 - ConnectionPoolPreambleFailed](3367-connectionpoolpreamblefailed.md)|Error|ConnectionPoolPreambleFailed。|管道|  
...
|[3370 - BinaryMessageEncodingStart](3370-binarymessageencodingstart.md)|「詳細資訊」|BinaryMessageEncoder 開始編碼訊息。|管道|  
|[3371 - MtomMessageEncodingStart](3371-mtommessageencodingstart.md)|「詳細資訊」|MtomMessageEncoder 開始編碼訊息。|管道|  
|[3372 - TextMessageEncodingStart](3372-textmessageencodingstart.md)|「詳細資訊」|TextMessageEncoder 開始編碼訊息。|管道|  
|[3373 - BinaryMessageDecodingStart](3373-binarymessagedecodingstart.md)|「詳細資訊」|BinaryMessageEncoder 開始解碼訊息。|管道|  
|[3374 - MtomMessageDecodingStart](3374-mtommessagedecodingstart.md)|「詳細資訊」|MtomMessageEncoder 開始解碼訊息。|管道|  
|[3375 - TextMessageDecodingStart](3375-textmessagedecodingstart.md)|「詳細資訊」|TextMessageEncoder 開始解碼訊息。|管道|  
...
|[3381 - SequenceAcknowledgementSent](3381-sequenceacknowledgementsent.md)|「詳細資訊」|SessionId：%1 認可已傳送。|管道|  
|[3382 - ClientReliableSessionReconnect](3382-clientreliablesessionreconnect.md)|資訊|SessionId：%1 重新連線中。|管道|  
|[3383 - ReliableSessionChannelFaulted](3383-reliablesessionchannelfaulted.md)|資訊|SessionId：%1 發生錯誤。|管道|  
...
|[3389 - ClientSendPreambleStart](3389-clientsendpreamblestart.md)|「詳細資訊」|用戶端傳送前序編碼開始。|管道|  
|[3390 - ClientSendPreambleStop](3390-clientsendpreamblestop.md)|「詳細資訊」|用戶端傳送前序編碼停止。|管道|  
...
|[3393 - StreamedMessageReadByEncoder](3393-streamedmessagereadbyencoder.md)|資訊|資料流訊息由編碼器讀取。|管道|  
|[3394 - StreamedMessageWrittenByEncoder](3394-streamedmessagewrittenbyencoder.md)|資訊|資料流訊息由編碼器寫入。|管道|  
|[3395 - MessageWrittenAsynchronouslyByEncoder](3395-messagewrittenasynchronouslybyencoder.md)|資訊|編碼器將訊息寫入為非同步。|管道|  
|[3396 - BufferedAsyncWriteStart](3396-bufferedasyncwritestart.md)|資訊|BufferId：%1 已完成寫入 '%2' 個位元組至基礎資料流。|管道|  
|[3397 - BufferedAsyncWriteStop](3397-bufferedasyncwritestop.md)|資訊|編碼器將訊息寫入為非同步。|管道|  
|[3398 - PipeSharedMemoryCreated](3398-pipesharedmemorycreated.md)|「詳細資訊」|管線共用記憶體建立在 '%1'。|管道|  
|[3399 - NamedPipeCreated](3399-namedpipecreated.md)|「詳細資訊」|NamedPipe '%1' 已建立。|管道|  
...
|[5203 - JsonMessageDecodingStart](5203-jsonmessagedecodingstart.md)|「詳細資訊」|JsonMessageEncoder 開始解碼訊息。|管道|  
|[5204 - JsonMessageEncodingStart](5204-jsonmessageencodingstart.md)|「詳細資訊」|JsonMessageEncoder 開始編碼訊息。|管道|  
