...
### <a name="channels"></a>通道  
 ...
 中的 WCF 分析追蹤功能[!INCLUDE[netfx_current_short](../../../../../includes/netfx-current-short-md.md)]寫入 Microsoft Windows-應用程式層伺服器-應用程式通道。 這個通道被專為想要監視的健全狀況在生產環境中的 WCF 服務的使用者。 它會定義一個小型事件集，可在許多健康狀況監控和疑難排解的情況中使用。  
