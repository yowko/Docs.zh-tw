...
3. 開啟在 Visual Studio 2012 的[消費者入門教學](../getting-started-tutorial.md)課程中建立的範例。 請注意，您必須以系統管理員身分執行 Visual Studio 2012，才能建立服務。 如果您已安裝 WCF 範例，可以開啟[消費者入門](../samples/getting-started-sample.md)，其中包含在教學課程中建立的已完成專案。
