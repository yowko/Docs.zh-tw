...
10. 在識別的組件和程式碼產生器版本的檔案頂端插入註解：`// This code was auto-generated by Microsoft.VisualStudio.Portable.AddServiceReference, version 1.0.0.0`  
...
14. <xref:System.ServiceModel.MessageContractAttribute.IsWrapped%2A> 不支援在可攜式子集專案中。  
