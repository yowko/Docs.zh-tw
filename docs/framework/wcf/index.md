...
[!INCLUDE[indigo1](../../../includes/indigo1-md.md)] 是 Microsoft 的統一程式設計模型，用於建置服務導向的應用程式。  開發人員可運用它來建置安全、可靠與可交易性的方案，且這些方案會跨平台進行整合，並與現有投資交互操作。  
  
## 在本節中  
 [Windows Communication Foundation 4.5 的新功能](../../../docs/framework/wcf/whats-new.md)  
