...
-   自訂 WCF 執行階段驗證器。 您可以安裝會檢查服務、合約與繫結的自訂驗證器，以強制執行有關 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 應用程式的企業層級原則。 (例如，請參閱[How to： 鎖定向企業的端點](../../../../docs/framework/wcf/extending/how-to-lock-down-endpoints-in-the-enterprise.md)。)  
