...
helpviewer_keywords: 
  - "擴充性 [WCF]"
  - "WCF, 擴充性"
  - "Windows Communication Foundation, 擴充性"
...
---
# 延伸 WCF
[!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 允許您修改及延伸執行階段元件，以精確控制及延伸服務應用程式。  本節中的主題將深入說明延伸性結構。  如需有關基本程式設計的詳細資訊，請參閱[基本 WCF 程式設計](../../../../docs/framework/wcf/basic-wcf-programming.md)。  
