...
這是建立基本 Windows Communication Foundation (WCF) 服務和用戶端可呼叫服務所需的六個工作的第二個。 如需這六項工作的概觀，請參閱 <<c0> [ 入門教學課程](../../../docs/framework/wcf/getting-started-tutorial.md)主題。
...
開啟 Service1.cs 或 Service1.vb 檔案，並加入下列程式碼：
...
建置方案，以確保沒有任何編譯錯誤。 如果您使用 Visual Studio 中，在**建置**功能表中，選取**建置方案**(或按下**Ctrl**+**Shift** + **B**)。

## <a name="next-steps"></a>後續步驟

現在，服務合約已建立且已實作。 在下一個步驟中，您可以執行服務。
