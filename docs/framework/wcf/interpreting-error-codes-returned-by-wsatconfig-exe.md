---
title: "解譯 wsatConfig.exe 傳回的錯誤碼 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|31|`-traceLevel` 命令列選項無效。|更正 `-traceLevel` 命令列選項，以指定下列的有效值，<br /><br /> -   Off<br />-   Error<br />-   嚴重<br />-   警告<br />-   資訊<br />-   詳細資訊<br />-   全部|  
