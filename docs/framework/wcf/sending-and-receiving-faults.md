...
### <a name="abort-the-channel-if-necessary"></a>必要時中止通道  
 ...
 如果錯誤傳送了與某項作業相關的特定錯誤資訊，而其他作業也可能透過它來傳送資訊時，就不需要中止通道 (儘管這些情況很罕見)。 在其他任何情況中，建議您中止通道。 如需示範所有這些點的範例，請參閱[預期的例外狀況](../../../docs/framework/wcf/samples/expected-exceptions.md)。  
