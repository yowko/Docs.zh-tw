...
---
# <a name="general-reference"></a>一般參考
區段[ \<system.serviceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md)說明可用來設定 Windows Communication Foundation (WCF) 用戶端和服務的項目。
