...
---
# <a name="general-reference"></a><span data-ttu-id="241a9-102">一般參考</span><span class="sxs-lookup"><span data-stu-id="241a9-102">General Reference</span></span>
<span data-ttu-id="241a9-103">區段[ \<system.serviceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md)說明用來設定的項目[!INCLUDE[indigo1](../../../includes/indigo1-md.md)]用戶端和服務。</span><span class="sxs-lookup"><span data-stu-id="241a9-103">The section [\<system.serviceModel>](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) describes the elements that are used to configure [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] clients and services.</span></span>
