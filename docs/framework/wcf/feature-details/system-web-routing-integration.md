---
title: "System.Web.Routing 整合 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 這會載入路由需要的模組與處理常式。[!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][路由](../../../../docs/framework/wcf/feature-details/routing.md).您也必須在 `<serviceHostingEnvironment>` 項目中，將 `aspNetCompatibilityEnabled` 屬性設定為 `true`，如下列範例所示。  
