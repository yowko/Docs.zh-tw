...
> [!NOTE]
> 這份文件原本是針對.NET Framework 3.0 撰寫的。  .NET framework 3.5 的內建支援使用 POX 應用程式。 如需詳細資訊，請參閱關於[WCF Web HTTP 程式設計模型](../../../../docs/framework/wcf/feature-details/wcf-web-http-programming-model.md)。
