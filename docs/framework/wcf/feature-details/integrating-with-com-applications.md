...
Windows Communication Foundation (WCF) 服務使用 WCF 服務 moniker 可以直接整合您現有的程式碼中。 服務 Moniker 可以從多種 COM 架構開發環境中使用，例如 Office VBA、Visual Basic 6.0 或 Visual C++ 6.0。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 若要使用 WCF 服務 moniker，在 COM 應用程式中的，向 COM 註冊必要的屬性的類型，並以必要的繫結組態設定 COM 應用程式和 moniker。  
 ...
 描述如何呼叫使用 WCF WSDL moniker 的 WCF 範例。  
 ...
 描述如何呼叫使用指定 Mex 端點的 WCF moniker 的 WCF 範例。  
  
 [如何：指定通道安全性認證](../../../../docs/framework/wcf/feature-details/how-to-specify-channel-security-credentials.md)  
 WCF 服務 moniker 支援`IChannelCredentials`介面，提供一系列的替代方法，以指定通道認證。  
