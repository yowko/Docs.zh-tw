---
title: "ServiceModel 交易組態 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 設定 transactionTimeout  
 您可以在組態檔的 `behavior` 項目內為您的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 服務設定 `transactionTimeout` 屬性。下列程式碼會示範如何執行此項作業。  
