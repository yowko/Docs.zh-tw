...
#### <a name="iis-70"></a>IIS 7.0  
 若要設定[!INCLUDE[iisver](../../../../includes/iisver-md.md)]為安全主機 （使用 SSL），請參閱[IIS 7.0 Beta： 在 IIS 7.0 中設定安全通訊端層](http://go.microsoft.com/fwlink/?LinkId=88600)。  
  
 若要設定用於憑證[!INCLUDE[iisver](../../../../includes/iisver-md.md)]，請參閱[IIS 7.0 Beta： 在 IIS 7.0 中設定伺服器憑證](http://go.microsoft.com/fwlink/?LinkID=88595)。  
  
#### <a name="iis-60"></a>IIS 6.0  
 若要設定[!INCLUDE[iis601](../../../../includes/iis601-md.md)]為安全主機 （使用 SSL），請參閱[設定安全通訊端層](http://go.microsoft.com/fwlink/?LinkId=88601)。  
