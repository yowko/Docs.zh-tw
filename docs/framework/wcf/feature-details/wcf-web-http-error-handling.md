---
title: "WCF Web HTTP 錯誤處理 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   服務作業所指定 <xref:System.ServiceModel.Web.WebGetAttribute> 或 <xref:System.ServiceModel.Web.WebInvokeAttribute> 屬性之 `ResponseFormat` 參數的值。  
  
-   <xref:System.ServiceModel.Description.WebHttpBehavior.AutomaticFormatSelectionEnabled%2A> 的值。  
  
-   透過存取 <xref:System.ServiceModel.Web.OutgoingWebResponseContext> 之 <xref:System.ServiceModel.Web.OutgoingWebResponseContext.Format%2A> 屬性的值。  
  
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]這些值如何影響作業格式化的詳細資訊，請參閱 [WCF Web HTTP 格式化](../../../../docs/framework/wcf/feature-details/wcf-web-http-formatting.md)。  
