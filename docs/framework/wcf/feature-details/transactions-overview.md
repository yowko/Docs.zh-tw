---
title: "Windows Communication Foundation 交易概觀 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "交易 [WCF]"
  - "WCF, 異動"
  - "Windows Communication Foundation, 異動"
...
-   持續性 \(Durability\)。  這個屬性表示在經過認可之後，對於 Managed 資源 \(例如資料庫記錄\) 的更新在遇到失敗時仍會持續。  
 ...
 您可以使用應用程式組態檔，將繫結設定成啟用或停用交易流程，以及設定繫結上所需要的交易通訊協定。  此外，您也可以使用組態檔設定服務層級的交易逾時。  [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [啟用交易流程](../../../../docs/framework/wcf/feature-details/enabling-transaction-flow.md).  
