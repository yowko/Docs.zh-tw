...
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|  
|PerCall|-工作階段通道的行為： 工作階段和<xref:System.ServiceModel.InstanceContext>每個呼叫。<br />的無工作階段通道行為： 擲回例外狀況。|-工作階段通道的行為： 工作階段和<xref:System.ServiceModel.InstanceContext>每個呼叫。<br />的無工作階段通道行為：<xref:System.ServiceModel.InstanceContext>每個呼叫。|-工作階段通道的行為： 擲回例外狀況。<br />的無工作階段通道行為：<xref:System.ServiceModel.InstanceContext>每個呼叫。|  
