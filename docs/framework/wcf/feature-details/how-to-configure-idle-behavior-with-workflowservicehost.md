...
---
# <a name="how-to-configure-idle-behavior-with-workflowservicehost"></a>作法：以 WorkflowServiceHost 設定閒置行為
...
1. 將 <`workflowIdle`> 元素新增至 <`serviceBehaviors`>`behavior`專案中的 < > 專案, 如下列範例所示。  
