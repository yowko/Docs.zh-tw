---
title: "AJAX 整合與 JSON 支援 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# AJAX 整合與 JSON 支援
[!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 對 ASP.NET Asynchronous JavaScript and XML \(AJAX\) 及 JavaScript 物件標記法 \(JSON\) 資料格式的支援，可允許 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 服務對 AJAX 用戶端公開作業。AJAX 用戶端指的是執行 JavaScript 程式碼並使用 HTTP 要求來存取這些 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 服務的網頁。本節中的主題會提供有關此支援以及如何實作的詳細資訊。  
  
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] ASP.NET AJAX 以及其與 ASP.NET 2.0 整合的詳細資訊，請參閱 [ASP.NET AJAX 概觀](http://go.microsoft.com/fwlink/?LinkId=96725) \(本頁面可能為英文\)。  
