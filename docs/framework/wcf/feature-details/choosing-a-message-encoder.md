...
|可靠性|可靠性是編碼器抵抗傳輸錯誤的能力。 此外，也可以在訊息、傳輸或應用程式層提供可靠性。 所有標準 WCF 編碼器都假設有另一層提供可靠性。 編碼器不太能從傳輸錯誤復原。|None|  
...
|互通性|這項因素是指 WCF 編碼器與非 WCF 服務交互操作的能力。|Text<br /><br /> MTOM (部分)|  
