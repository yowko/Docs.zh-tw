...
-   如需程式碼片段和相關的資訊，請參閱[對等通道部落格](http://go.microsoft.com/fwlink/?LinkID=114531)(http://go.microsoft.com/fwlink/?LinkID=114531)。  
...
-   如需程式碼片段和相關的資訊，請參閱[對等通道部落格](http://go.microsoft.com/fwlink/?LinkID=114532)(http://go.microsoft.com/fwlink/?LinkID=114532)。  
