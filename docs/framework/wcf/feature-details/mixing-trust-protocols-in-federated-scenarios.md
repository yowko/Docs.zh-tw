---
title: "在聯合案例中混合信任通信協定 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   `KeyWrapAlgorithm`  
 ...
 如果 `SecondaryParameters` 元素中有 `EncryptionAlgorithm`、`CanonicalizationAlgorithm` 和 `KeyWrapAlgorithm` 元素，則 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 會在 RST 下從最上層元素移除這些元素。  [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 會將 `SecondaryParameters` 元素原封不動地附加至傳出的 RST。  
