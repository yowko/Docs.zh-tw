...
4.  關閉 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 用戶端。  
  
## <a name="example"></a>範例  
  
### <a name="description"></a>描述  
 下列範例提供 `IProcessOrder` 服務以及使用此服務之用戶端的程式碼。 它說明 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 如何使用佇列工作階段來提供群組行為。  
