...
|中繼資料|WS-Policy|[WS-Policy](https://www.w3.org/Submission/WS-Policy/)<br /><br /> WCF 會使用 WS-Policy 規格搭配定義域特定的判斷提示，來描述服務需求和功能。|  
|中繼資料|WS-Policy 1.5|[WS-Policy 1.5](https://www.w3.org/TR/2007/CR-ws-policy-20070605/)<br /><br /> WCF 會使用 WS-Policy 規格搭配定義域特定的判斷提示，來描述服務需求和功能。|  
|中繼資料|WS-PolicyAttachment|[WS-PolicyAttachment](http://specs.xmlsoap.org/ws/2004/09/policy/ws-policyattachment.pdf)<br /><br /> WCF 會執行 Ws-policyattachment，在 Web 服務描述語言（WSDL）的各種範圍中附加原則運算式。|  
|中繼資料|WS-MetadataExchange|[WS-MetadataExchange](http://specs.xmlsoap.org/ws/2004/09/mex/WS-MetadataExchange.pdf)<br /><br /> WCF 會執行透過 ws-metadataexchange，以取得 XML 架構、WSDL 和 WS 原則。|  
...
## <a name="wsfederationhttpbinding-and-ws2007federationhttpbinding"></a>wsFederationHttpBinding 和 ws2007FederationHttpBinding  
 [\<wsFederationHttpBinding>](../../configure-apps/file-schema/wcf/wsfederationhttpbinding.md)引進了和 [\<ws2007FederationHttpBinding>](../../configure-apps/file-schema/wcf/ws2007federationhttpbinding.md) 元素，以提供同盟案例的支援，其中協力廠商發出用來驗證用戶端的權杖。 除了 `wsHttpBinding` 使用的通訊協定外，`wsFederationHttpBinding` 還使用：  
...
|Messaging (傳訊)|SOAP 1.2|[門](https://www.w3.org/TR/soap12-part0/)<br /><br /> [訊息架構](https://www.w3.org/TR/2007/REC-soap12-part1-20070427/)<br /><br /> [附加 (包括 HTTP 繫結)](https://www.w3.org/TR/soap12-part2/)|  
|Messaging (傳訊)|WS-ADDRESSING 2005/08|[Web Services Addressing 1.0 - Core](https://www.w3.org/TR/ws-addr-core/)<br /><br /> [Web 服務定址 1.0 - SOAP](https://www.w3.org/TR/ws-addr-soap/)|  
|中繼資料|WS-MetadataExchange|[WS-MetadataExchange](http://specs.xmlsoap.org/ws/2004/09/mex/WS-MetadataExchange.pdf)<br /><br /> WCF 會執行透過 ws-metadataexchange，以取得 XML 架構、WSDL 和 WS 原則。|  
