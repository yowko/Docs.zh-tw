...
Windows 通訊基礎 (WCF) 旨在與支援一組稱為 Web 服務規範的規範的 Web 服務進行互通。 為了簡化互操作性最佳實務的服務配置,WCF 引入了三個可相互操作的系統提供的綁定<xref:System.ServiceModel.BasicHttpBinding?displayProperty=nameWithType>:<xref:System.ServiceModel.WSHttpBinding?displayProperty=nameWithType><xref:System.ServiceModel.WSDualHttpBinding?displayProperty=nameWithType>和 。 為了與結構化資訊標準 (OASIS) 組織的標準進行互通性,WCF 包括一個可相互操作的系統提供的<xref:System.ServiceModel.WS2007HttpBinding?displayProperty=nameWithType>綁定: 。 對於中繼資料發布,WCF 包括兩個可相互作業的系統提供的綁定[\<:mexHttp綁定>](../../../../docs/framework/configure-apps/file-schema/wcf/mexhttpbinding.md)和[\<mexHS綁定>](../../../../docs/framework/configure-apps/file-schema/wcf/mexhttpsbinding.md)。 本主題列出系統提供之繫結支援的規格。  
...
|中繼資料|WS-Policy|[WS-Policy](https://www.w3.org/Submission/WS-Policy/)<br /><br /> WCF 使用 WS-策略規範以及特定於域的斷言來描述服務要求和功能。|  
|中繼資料|WS-Policy 1.5|[WS-Policy 1.5](https://www.w3.org/TR/2007/CR-ws-policy-20070605/)<br /><br /> WCF 使用 WS-策略規範以及特定於域的斷言來描述服務要求和功能。|  
...
|Messaging (傳訊)|WS-Addressing 1.0 - 中繼資料|[WS 定址 1.0 元資料](https://www.w3.org/2007/05/addressing/metadata/)通過在 ServiceMetadata 行為中設定策略版本來啟用對此協定的支援 - 策略版本設定為 1.2(預設值),wsdl 描述符合 WS-定址 wsdl,策略版本設定為 1.5,wsdl 描述符合 ws 定址元數據。<br /><br /> 雖然 WS-* 規格允許 WS-Addressing 標頭加密，但是 WCF 並不提供這項支援。|  
...
|交易|WS-AtomicTransaction|[WS-AtomicTransaction](http://specs.xmlsoap.org/ws/2004/10/wsat/wsat.pdf)<br /><br /> 用於交易管理員之間的通訊。 WCF 用戶端和服務始終使用本地事務管理器。|  
...
## <a name="wsfederationhttpbinding-and-ws2007federationhttpbinding"></a>wsFederationHttpBinding 和 ws2007FederationHttpBinding  
 [\<引入 wsFederatHttpBinding>](../../../../docs/framework/configure-apps/file-schema/wcf/wsfederationhttpbinding.md)和[\<ws2007 聯邦Hding>](../../../../docs/framework/configure-apps/file-schema/wcf/ws2007federationhttpbinding.md)元素是為了支援聯合方案,其中第三方發出用於驗證用戶端的權杖。 除了 `wsHttpBinding` 使用的通訊協定外，`wsFederationHttpBinding` 還使用：  
...
### <a name="mexhttpbinding"></a>mexHttpBinding  
 mexHttp綁定>綁定支援以下協定。 [ \< ](../../../../docs/framework/configure-apps/file-schema/wcf/mexhttpbinding.md) 有關使用此繫定的詳細資訊,請參閱[發佈中繼資料](../../../../docs/framework/wcf/feature-details/publishing-metadata.md)。  
...
### <a name="mexhttpsbinding"></a>mexHttpsBinding  
 mexHTHH [ \< ](../../../../docs/framework/configure-apps/file-schema/wcf/mexhttpsbinding.md) 有關使用此繫定的詳細資訊,請參閱[發佈中繼資料](../../../../docs/framework/wcf/feature-details/publishing-metadata.md)。  
...
- [\<基本HTTP繫結>](../../../../docs/framework/configure-apps/file-schema/wcf/basichttpbinding.md)
- [\<wsHttp繫結>](../../../../docs/framework/configure-apps/file-schema/wcf/wshttpbinding.md)
- [\<wsDualHttp綁定>](../../../../docs/framework/configure-apps/file-schema/wcf/wsdualhttpbinding.md)
- [\<mexH00](../../../../docs/framework/configure-apps/file-schema/wcf/mexhttpsbinding.md)
- [\<mexHttp 繫結>](../../../../docs/framework/configure-apps/file-schema/wcf/mexhttpbinding.md)
