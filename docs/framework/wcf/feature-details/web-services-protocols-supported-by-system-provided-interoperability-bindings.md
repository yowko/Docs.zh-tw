...
|中繼資料|WS-Policy|[WS-Policy](https://www.w3.org/Submission/WS-Policy/)<br /><br /> WCF 會搭配網域特定的判斷提示使用 WS 原則規格，以描述服務需求和功能。|  
|中繼資料|WS-Policy 1.5|[WS-Policy 1.5](https://www.w3.org/TR/2007/CR-ws-policy-20070605/)<br /><br /> WCF 會搭配網域特定的判斷提示使用 WS 原則規格，以描述服務需求和功能。|  
|中繼資料|WS-PolicyAttachment|[WS-PolicyAttachment](http://specs.xmlsoap.org/ws/2004/09/policy/ws-policyattachment.pdf)<br /><br /> WCF 會執行 Ws-policyattachment，以在 Web 服務描述語言 (WSDL) 的不同範圍附加原則運算式。|  
|中繼資料|WS-MetadataExchange|[WS-MetadataExchange](http://specs.xmlsoap.org/ws/2004/09/mex/WS-MetadataExchange.pdf)<br /><br /> WCF 會實透過 ws-metadataexchange 來取得 XML 架構、WSDL 和 WS 原則。|  
