---
title: "確保對等通道應用程式安全 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   憑證。  將會使用特定的應用程式驗證。  使用這個認證類型時，您必須在 `ClientCredentialSettings.Peer.PeerAuthentication` 中使用實體 <xref:System.IdentityModel.Selectors.X509CertificateValidator> 實作。  
