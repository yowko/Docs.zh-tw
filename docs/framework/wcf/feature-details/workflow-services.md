...
## <a name="in-this-section"></a>本章節內容  
 ...
 [次序不對的訊息處理](../../../../docs/framework/wcf/feature-details/out-of-order-message-processing.md)  
 說明如何設定服務以接受順序錯誤的訊息。  
 ...
 [工作流程中使用合約](../../../../docs/framework/wcf/feature-details/using-contracts-in-workflow.md)  
 說明不同型別的合約和合約推斷。
