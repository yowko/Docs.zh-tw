---
title: "設定 Net.TCP Port Sharing Service | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  在啟用了使用者帳戶控制 \(UAC\) 的 [!INCLUDE[wv](../../../../includes/wv-md.md)] 系統上，即使本機使用者屬於 Administrators 群組的成員之一，還是需要較高的權限。  若要允許這些使用者在不提高權限的前提下使用通訊埠共用服務，使用者的 SID \(或使用者所屬群組的 SID\) 必須明確地新增至 SMSvcHost.exe.config 中的 \<allowAccounts\> 區段。  
