...
|WS 原則|[Web 服務原則 1.2-架構（WS-原則）](https://www.w3.org/Submission/WS-Policy/)<br /><br /> [Web 服務原則 1.5-架構](https://www.w3.org/TR/ws-policy/)<br /><br /> WCF 使用 WS-Policy 1.2 或1.5 規格搭配特定領域的判斷提示，來描述服務需求和功能。|  
|WS 原則附件|[Web 服務原則 1.2-附件（WS-Ws-policyattachment）](https://www.w3.org/Submission/WS-PolicyAttachment/)<br /><br /> WCF 會執行 WS-Policy 附件，以在 WSDL 中的各種範圍附加原則運算式。|  
|WS 中繼資料交換|[Web 服務中繼資料交換（WS-透過 ws-metadataexchange）版本1。1](https://specs.xmlsoap.org/ws/2004/09/mex/WS-MetadataExchange.pdf)<br /><br /> WCF 會執行透過 ws-metadataexchange，以取得 XML 架構、WSDL 和 WS 原則。|  
|WSDL 的 WS 定址繫結|[Web 服務定址 1.0-WSDL 系結](https://www.w3.org/TR/ws-addr-wsdl/)<br /><br /> WCF 會執行 WSDL 的 WS-ADDRESSING 系結，以便在 WSDL 中附加定址資訊。|  
