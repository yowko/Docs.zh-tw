---
title: "HOW TO：服務資料切割 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# HOW TO：服務資料切割
本主題概要說明在相同目的地服務之多個執行個體中分割訊息所需的基本步驟。使用服務資料分割的時機，通常是在需要調整服務的規模以便提供更優良的服務品質，或是需要以某種特定的方式處理來自不同客戶的要求。例如，與來自標準客戶的訊息相比，來自重要或「黃金級」客戶的訊息，可能需要以更高的優先順序來處理。  
...
4.  若要針對包含在篩選資料表中的篩選評估傳入的訊息，您必須使用路由行為讓篩選資料表與服務端點產生關聯。下列範例呈現 “filterTable1” 與服務端點的關聯方法：  
