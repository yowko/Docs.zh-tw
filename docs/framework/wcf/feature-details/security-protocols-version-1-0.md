---
title: "安全性通訊協定 1.0 版 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### 2.1 TimeStamp  
 時間戳記存在是使用 <xref:System.ServiceModel.Channels.SecurityBindingElement> 類別的 <xref:System.ServiceModel.Channels.SecurityBindingElement.IncludeTimestamp%2A> 屬性加以控制。  [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 永遠使用 wsse:Created 和 wsse:Expires 欄位以序列化 wsse:TimeStamp。  使用簽章時，一定會簽署 wsse:TimeStamp。  
...
#### 6.2.3 搭配使用 SymmetricBinding 與 X.509 服務驗證  
