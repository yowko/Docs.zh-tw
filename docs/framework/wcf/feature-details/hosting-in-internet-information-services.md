...
-   IIS 所裝載的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 服務與 [!INCLUDE[vstecasplong](../../../../includes/vstecasplong-md.md)] 所使用的動態編譯模型是一樣的，都會針對裝載的服務簡化其開發與部署。  
 ...
 在決定將 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 服務裝載到 IIS 時，請務必記得 IIS 5.1 和 [!INCLUDE[iis601](../../../../includes/iis601-md.md)] 僅限於 HTTP 通訊用途。 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]選擇裝載環境，請參閱[裝載服務](../../../../docs/framework/wcf/hosting-services.md)。  
