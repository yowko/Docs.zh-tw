...
在工作流程應用程式中加入服務參考的運作方式與在一般 WCF 應用程式中加入服務參考的運作方式稍有不同。 當您選取 [**新增** > **服務參考**] 並指定服務的 URL 時，就會下載中繼資料，並產生可讓您呼叫該 wcf 服務或 wcf 工作流程服務的自訂活動。 加入服務參考之後，重建方案，因而建置所產生的活動。 接著，這些活動會出現在工作流程設計工具工具箱中。 只有當您在工作流程方案中加入服務參考時，這才會有效。 下列 web 轉換顯示如何在其他類型的專案中加入服務參考：[從 Web 專案中的工作流程呼叫 WCF 服務](https://docs.microsoft.com/archive/blogs/endpoint/how-to-consume-a-wcf-service-from-a-wf4-workflow)。
