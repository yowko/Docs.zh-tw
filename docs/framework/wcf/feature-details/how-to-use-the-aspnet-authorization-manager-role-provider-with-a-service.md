...
```  
 ...
 如需有關整合[!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)]角色提供者與 WCF 應用程式，請參閱[How to： 使用 ASP.NET 角色提供者搭配服務](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-role-provider-with-a-service.md)。 如需有關使用授權管理員與[!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)]，請參閱[How to： 使用 ASP.NET 2.0 的使用授權管理員 (AzMan)](http://go.microsoft.com/fwlink/?LinkId=71303)。  
