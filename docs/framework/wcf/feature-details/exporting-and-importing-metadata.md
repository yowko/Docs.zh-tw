...
## <a name="exporting-metadata"></a>匯出中繼資料  
 若要從 <xref:System.ServiceModel.Description.ServiceEndpoint?displayProperty=nameWithType> 執行個體匯出中繼資料，請使用 <xref:System.ServiceModel.Description.MetadataExporter> 抽象類別的實作。 <xref:System.ServiceModel.Description.WsdlExporter> 型別是包含在 <xref:System.ServiceModel.Description.MetadataExporter> 中的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 抽象類別的實作。  
...
### <a name="importing-wsdl-documents"></a>匯入 WSDL 文件  
 若要將服務中繼資料匯入 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]，請使用 <xref:System.ServiceModel.Description.MetadataImporter> 抽象類別的實作。 <xref:System.ServiceModel.Description.WsdlImporter?displayProperty=nameWithType> 型別是包含在 <xref:System.ServiceModel.Description.MetadataImporter> 中的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 抽象類別的實作。 <xref:System.ServiceModel.Description.WsdlImporter> 型別會匯入 WSDL 中繼資料，其中包含與 <xref:System.ServiceModel.Description.MetadataSet> 物件組合在一起的附加原則。  
