...
## <a name="in-this-section"></a>本節內容  
 ...
 WCF 是建置來與支援一組稱為 Web 服務規格的規格的 Web 服務交互操作。 本主題會列出支援的規格以及支援這些規格的繫結。  
 ...
 說明 WCF 如何提供服務和用戶端會使用"Plain Old XML"(POX) 訊息。  
