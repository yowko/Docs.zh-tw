...
## <a name="in-this-section"></a>本節內容  
 ...
 描述如何裝載 Windows Communication Foundation (WCF) 服務的 Internet Information Services 中或[Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkId=196496)。  
  
 [在 Windows 處理序啟用服務中裝載](../../../../docs/framework/wcf/feature-details/hosting-in-windows-process-activation-service.md)  
 描述如何裝載 WCF 服務的 Windows 處理序啟用服務。  
  
 [在 Windows 服務應用程式中裝載](../../../../docs/framework/wcf/feature-details/hosting-in-a-windows-service-application.md)  
 描述由 Windows 服務裝載 WCF 服務的方式。  
 ...
 描述 IIS 或 WAS 底下裝載 WCF 服務的方式，而不使用.svc 檔案。  
