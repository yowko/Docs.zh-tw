...
## <a name="to-add-an-interface-to-the-set-of-interfaces-exposed-as-web-services-using-the-com-hosting-mode"></a>若要將介面新增至公開為 Web 服務的介面集合，請使用 COM + 裝載模式  
...
## <a name="to-add-only-specific-methods-from-an-interface-to-the-set-of-interfaces-exposed-as-web-services-using-the-com-hosting-mode"></a>若只要將介面中的特定方法加入至公開為 Web 服務的介面集合，請使用 COM + 裝載模式  
...
## <a name="to-add-an-interface-to-the-set-of-interfaces-exposed-as-web-services-using-the-web-hosting-mode"></a>若要將介面新增至公開為 Web 服務的介面集合，請使用 Web 裝載模式  
