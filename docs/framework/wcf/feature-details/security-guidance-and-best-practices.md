...
本節中的主題將就建立安全 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 應用程式時要考慮的項目提供指引。 如需有關 Windows Server AppFabric 和安全性，請參閱[安全性模型的 Windows Server App Fabric](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x409)  
