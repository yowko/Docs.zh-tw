...
-   處理序模型  
 ...
 若要讓[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]或任何[!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)]應用程式運作，檢查**.NET 環境**核取方塊。 這表示需要所有的 WAS 元件才能讓 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 與 [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] 正常運作。 一旦您安裝任何其中一個上述元件，這些應用程式便會自動核取。  
