...
|NetMsmqBinding|透過 MSMQ 在 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 軟體實體之間進行的通訊。|  
|MsmqIntegrationBinding|透過 MSMQ 在 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 軟體實體和其他軟體實體之間進行的通訊。|  
|NetPeerTcpBinding|透過 Windows 對等網路在 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 軟體實體之間進行的通訊。|  
...
```  
 ...
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 會提供屬性 <xref:System.ServiceModel.MessageContractAttribute>、<xref:System.ServiceModel.MessageHeaderAttribute> 和 <xref:System.ServiceModel.MessageBodyMemberAttribute> 來描述服務所傳送及接收之 SOAP 訊息的結構。  
