...
基礎結構通訊協定互通性是由 WS-* 規格所提供。 WCF 通道提供許多的 WS \* 基礎結構通訊協定支援。 WCF 通道是使用繫結項目來設定。 下表包含各種 WCF 繫結項目所執行之 WS \* 基礎結構通訊協定的完整清單。
...
|SOAP 1.2 HTTP 繫結|[SOAP 版本1.2 第2部分：附加 (第二版) ，第 ](https://www.w3.org/TR/soap12-part2/)7 節|
...
|規格/文件|連結|
|-----------------------------|----------|
|XML|[可延伸標記語言 (XML) 1.0 (第四版)](https://www.w3.org/TR/REC-xml/)|
|SOAP 1.1|[簡易物件存取通訊協定 (SOAP) 1.1](https://www.w3.org/TR/2000/NOTE-SOAP-20000508/)|
|SOAP 1.2 核心|[SOAP 1.2 版第 1 部分：訊息架構 (第二版)](https://www.w3.org/TR/2007/REC-soap12-part1-20070427/)|
|WS-Addressing 2004/08|[Web 服務定址 (WS-Addressing)](https://www.w3.org/Submission/2004/SUBM-ws-addressing-20040810/)|
|W3C Web 服務定址 1.0 - 核心|[Web Services Addressing 1.0 - Core](https://www.w3.org/TR/2006/REC-ws-addr-core-20060509/)|
|W3C Web 服務定址 1.0 - SOAP 繫結|[Web 服務定址 1.0 - SOAP 繫結](https://www.w3.org/TR/2006/REC-ws-addr-soap-20060509/)|
|W3C Web 服務定址 1.0 - WSDL 繫結*|[Web 服務定址 1.0 - WSDL 繫結](https://www.w3.org/TR/2006/CR-ws-addr-wsdl-20060529/)|
...
|WSDL SOAP1.2 繫結|[SOAP 1.2 的 WSDL 1.1 繫結延伸](https://www.w3.org/Submission/wsdl11soap12/)|

<xref:System.ServiceModel.Channels.MtomMessageEncodingBindingElement> 支援下表中的規格。

|規格/文件|連結|
|-----------------------------|----------|
|XOP|[XML 二進位最佳化套件](https://www.w3.org/TR/xop10/)|
|MTOM + SOAP1.2 繫結|[SOAP 訊息傳輸最佳化機制](https://www.w3.org/TR/soap12-mtom/)|
|MTOM SOAP 1.1 繫結|[MTOM 1.0 的 SOAP 1.1 繫結](https://www.w3.org/Submission/soap11mtom10/)|
...
|WSS：使用者名稱權杖設定檔 1.0|[Web 服務安全性 UsernameToken 設定檔1。0](https://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0.pdf)<br /><br /> 需要 Password/@Type = PasswordText (預設) |
|WSS：X.509 權杖設定檔 1.0|[Web Services Security X.509 Certificate Token Profile](https://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0.pdf)|
|WSS：SAML 1.1 權杖設定檔 1.0|[Web 服務安全性：SAML 權杖設定檔](https://docs.oasis-open.org/wss/oasis-wss-saml-token-profile-1.0.pdf)|
|WSS：SOAP 訊息安全性 1.1|[Web 服務安全性：SOAP 訊息安全性 1.1](https://www.oasis-open.org/committees/download.php/16790/wss-v1.1-spec-os-SOAPMessageSecurity.pdf)|
|WSS：使用者名稱權杖設定檔 1.1|[Web 服務安全性 UsernameToken 設定檔 1.1](https://www.oasis-open.org/committees/download.php/16782/wss-v1.1-spec-os-UsernameTokenProfile.pdf)<br /><br /> 不會實作密碼架構金鑰衍生；<br /><br /> 需要 Password/@Type = PasswordText (預設) |
...
- [XML 結構描述第一部分：結構第二版](https://www.w3.org/TR/xmlschema-1/)

- [XML 結構描述第二部分：資料型別第二版](https://www.w3.org/TR/xmlschema-2/)
...
- [簡單 SOAP 繫結 1.0](http://www.ws-i.org/Profiles/SimpleSoapBindingProfile-1.0-2004-08-24.html)

- [基本安全性設定檔 1.0 工作草稿](http://www.ws-i.org/Profiles/BasicSecurityProfile-1.0-2006-03-29.html)
