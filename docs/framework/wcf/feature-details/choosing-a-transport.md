...
本主題將說明選擇 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 中包含的三種主要傳輸的準則：HTTP、TCP 和具名管道。 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 也包括訊息佇列 (亦稱為 MSMQ) 傳輸，但是本文件不討論訊息佇列。  
 ...
 在選擇傳輸之後，您必須選取使用它的繫結。 您可以選擇系統提供的繫結 (請參閱[之繫結](../../../../docs/framework/wcf/system-provided-bindings.md))，或者您可以建立您自己的自訂繫結 (請參閱[自訂繫結](../../../../docs/framework/wcf/extending/custom-bindings.md))。 您也可以建立自己的繫結。 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][建立使用者定義繫結](../../../../docs/framework/wcf/extending/creating-user-defined-bindings.md)。  
...
|裝載|所有的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 端點都必須裝載在應用程式內。 [!INCLUDE[iis601](../../../../includes/iis601-md.md)] 及更早版本只支援使用 HTTP 傳輸的裝載應用程式。 在 [!INCLUDE[wv](../../../../includes/wv-md.md)] 上，已新增對於裝載所有 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 傳輸的支援，包括 TCP 和具名管道。 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][裝載在 Internet Information Services](../../../../docs/framework/wcf/feature-details/hosting-in-internet-information-services.md)和[Windows Process Activation Service 中裝載](../../../../docs/framework/wcf/feature-details/hosting-in-windows-process-activation-service.md)。|HTTP|  
