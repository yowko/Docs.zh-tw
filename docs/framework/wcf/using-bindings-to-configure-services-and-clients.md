---
title: "使用繫結來設定服務和用戶端 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   <xref:System.ServiceModel.NetMsmqBinding>：使用 .NET 二進位編碼和框架技術搭配訊息佇列 \(亦稱為 MSMQ\)，以建立與其他 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 端點的佇列訊息連線。  
 ...
 如需系統提供之繫結的完整清單和描述，請參閱[系統提供的繫結](../../../docs/framework/wcf/system-provided-bindings.md)。  
  
## 自訂繫結  
 如果系統提供的繫結集合沒有服務應用程式所需的正確功能組合，您可以建立 <xref:System.ServiceModel.Channels.CustomBinding> 繫結。  [!INCLUDE[crabout](../../../includes/crabout-md.md)] <xref:System.ServiceModel.Channels.CustomBinding> 繫結之元素的詳細資訊，請參閱 [\<customBinding\>](../../../docs/framework/configure-apps/file-schema/wcf/custombinding.md) 與 [自訂繫結](../../../docs/framework/wcf/extending/custom-bindings.md)。  
...
-   [HOW TO：在 Managed 應用程式中裝載 WCF 服務](../../../docs/framework/wcf/how-to-host-a-wcf-service-in-a-managed-application.md) 提供以程式碼建立繫結的範例。  
  
-   [HOW TO：設定用戶端](../../../docs/framework/wcf/how-to-configure-a-basic-wcf-client.md)提供使用組態建立用戶端的範例。  
