...
```  
 ...
 您可以在服務和作業實作層級進行一些設定，例如並行和執行個體。[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][設計與實作服務](../../../docs/framework/wcf/designing-and-implementing-services.md).  
  
 在實作服務合約之後，必須為服務建立一個或多個端點。[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][端點建立概觀](../../../docs/framework/wcf/endpoint-creation-overview.md).[!INCLUDE[crabout](../../../includes/crabout-md.md)]如何執行服務的詳細資訊，請參閱[裝載服務](../../../docs/framework/wcf/hosting-services.md)。  
