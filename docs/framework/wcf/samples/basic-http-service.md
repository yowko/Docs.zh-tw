---
title: "基本 HTTP 服務 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 基本 HTTP 服務
此範例會示範如何使用 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] REST 程式設計模型實作 HTTP、RPC 的服務，也就是一般所謂的 “POX” \(Plain Old XML\) 服務。此範例由兩個元件所組成：自我裝載的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] HTTP 服務 \(Service.cs\)，以及建立服務並呼叫該服務的主控台應用程式 \(Program.cs\)。  
