---
title: "具備傳輸安全性的 BasicBinding | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
這個範例會示範透過基本繫結來使用 SSL 傳輸安全性。  這個範例是以實作計算機服務的[使用者入門](../../../../docs/framework/wcf/samples/getting-started-sample.md)為基礎。  
...
>  此範例的安裝程序與建置指示位於本主題的結尾。  
 ...
 本範例中的程式碼與[使用者入門](../../../../docs/framework/wcf/samples/getting-started-sample.md)服務中的程式碼相同。  組態檔設定中的端點定義與繫結定義會修改成啟用安全通訊，如下列範例組態所示。  
...
5.  若要在單一或跨機器的組態中執行本範例，請遵循[執行 Windows Communication Foundation 範例](../../../../docs/framework/wcf/samples/running-the-samples.md)中的指示進行。  
