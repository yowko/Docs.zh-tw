...
此範例示範如何使用 <xref:System.ServiceModel.NetTcpBinding> 繫結。 這個範例是以實作為計算機服務的 [消費者入門](getting-started-sample.md) 為基礎。 在此範例中，服務會自我裝載。 用戶端和服務都是主控台應用程式。  
...
> `<InstallDrive>:\WF_WCF_Samples\WCF\Basic\Binding\Net\TCP\Default`  
 ...
 用戶端和服務的組態檔中會指定繫結。 系結類型是在專案的屬性中指定， `binding` [\<endpoint>](../../configure-apps/file-schema/wcf/endpoint-element.md) 如下列範例設定所示。  
