...
## 用戶端  
 這個範例會示範在 <xref:System.ServiceModel.Discovery.DiscoveryClient> 上呼叫 <xref:System.ServiceModel.Discovery.DiscoveryClient.Find%2A> 方法。  接著會查詢產生的 <xref:System.ServiceModel.Discovery.FindResponse> 中適當的預期 XML 項目。  然後會將這些項目列印至主控台。  
