...
>  此範例的安裝程序與建置指示位於本主題的結尾。  
 ...
 此範例會公開`ICalculator`合約使用[ \<wsHttpBinding >](../../../../docs/framework/configure-apps/file-schema/wcf/wshttpbinding.md)。 這個繫結的組態已展開於 Web.config 檔中。  
...
```  
 ...
 在  [\<安全性 >](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wshttpbinding.md)，則`mode`值會設定應該使用哪一種安全性模式。 在此範例中，使用訊息安全性時，這就是為什麼[\<訊息 >](../../../../docs/framework/configure-apps/file-schema/wcf/message-of-wshttpbinding.md)內部指定[\<安全性 >](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wshttpbinding.md)。  
