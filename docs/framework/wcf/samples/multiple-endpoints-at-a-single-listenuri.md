---
title: "單一 ListenUri 的多個端點 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 單一 ListenUri 的多個端點
這個範例會示範在單一 `ListenUri` 裝載多個端點的服務。這個範例是以實作計算機服務的[使用者入門](../../../../docs/framework/wcf/samples/getting-started-sample.md)為基礎。  
  
> [!NOTE]
>  此範例的安裝程序與建置指示位於本主題的結尾。  
  
 如[多個端點](../../../../docs/framework/wcf/samples/multiple-endpoints.md)範例所示範，服務可以裝載多個端點，並且每個端點都有不同的位址，可能也有不同的繫結。這個範例會示範如何在相同位址裝載多個端點。此外，這個範例還會示範服務端點所具有兩種位址的差異：`EndpointAddress` 和 `ListenUri`。  
