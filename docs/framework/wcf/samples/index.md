---
title: Windows Communication Foundation (WCF) 範例文件
ms.date: 09/24/2018
...
> [!TIP]
> 在本節中的文章會說明部分的範例中所下載的封裝。 涵蓋所有的範例是完整的文件集，檢查[WCF 範例的.NET Framework 4 文件](/previous-versions/dotnet/netframework-4.0/dd483346(v%3dvs.100))。
