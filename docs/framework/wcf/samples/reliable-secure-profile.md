...
這個範例會示範如何撰寫[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]和[可靠的安全設定檔](http://go.microsoft.com/fwlink/?LinkId=178140)(RSP)。 這個範例會示範實作[建立連線](http://go.microsoft.com/fwlink/?LinkId=178141)通道可以在與可信賴傳訊，並選擇性地撰寫安全的通道，以建立可靠的安全繫結根據 RSP 規格。  
