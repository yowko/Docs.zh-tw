---
title: "Windows Communication Foundation 至訊息佇列 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 對所有使用 `MsmqIntegration` 繫結傳送訊息的 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 應用程式來說，自訂用戶端基本上都相同。與其他用戶端不同的是，它並不包含服務作業的範圍，而只是一項送出訊息的作業。  
...
> [!NOTE]
>  這個範例需要安裝訊息佇列。請參閱[訊息佇列](http://go.microsoft.com/fwlink/?LinkId=94968) \(本頁面可能為英文\) 中的安裝指示。  
...
4.  若要在單一電腦組態中執行範例，請遵循[執行 Windows Communication Foundation 範例](../../../../docs/framework/wcf/samples/running-the-samples.md)中的指示。  
