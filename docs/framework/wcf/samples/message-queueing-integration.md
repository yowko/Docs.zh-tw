...
ms.locfileid: "62006586"
---
# <a name="message-queueing-integration"></a>訊息佇列整合
本節包含示範訊息佇列與 Windows Communication Foundation (WCF) 之間的整合範例。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 示範 WCF 應用程式如何傳送訊息至訊息佇列 (MSMQ) 應用程式。  
  
 [訊息相互關聯](../../../../docs/framework/wcf/samples/message-correlation.md)  
 示範訊息佇列 (MSMQ) 應用程式如何將 MSMQ 訊息傳送至 WCF 服務，以及如何關聯的訊息，要求/回應案例中的傳送者與接收者應用程式之間。
