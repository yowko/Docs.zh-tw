---
title: "NamedPipe 啟用 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# NamedPipe 啟用
此範例示範裝載服務，該服務使用 Windows Process Activation Service \(WAS\) 啟用透過名稱管道通訊的服務。  此範例以[使用者入門](../../../../docs/framework/wcf/samples/getting-started-sample.md)為基礎，且需要 [!INCLUDE[wv](../../../../includes/wv-md.md)] 才能執行。  
