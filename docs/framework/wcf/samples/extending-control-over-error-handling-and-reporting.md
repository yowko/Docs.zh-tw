---
title: "延伸對錯誤處理和報告的控制 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 延伸對錯誤處理和報告的控制
這個範例示範如何使用 <xref:System.ServiceModel.Dispatcher.IErrorHandler> 介面延伸對 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 服務中錯誤處理與錯誤報告的控制。這個範例以[使用者入門](../../../../docs/framework/wcf/samples/getting-started-sample.md)為基礎，另外在服務上增加了一些其他程式碼來處理錯誤。用戶端會強制產生數個錯誤狀況。服務則攔截這些錯誤並記錄在檔案中。  
