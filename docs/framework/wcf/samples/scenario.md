...
本節包含的範例示範 Windows Communication Foundation (WCF) 案例。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 示範如何讓 WCF 開發人員使用已還原序列化的任意 JSON 物件，而不需建立使用者定義的類型。  
  
 [信任的外觀服務](trusted-facade-service.md)  
 示範如何使用 WCF 安全性基礎結構，將呼叫端的身分識別資訊從一個服務流動到另一個服務。  
  
 [設計模式：以清單為基礎的發行訂閱](design-patterns-list-based-publish-subscribe.md)  
 示範以清單為基礎的 Publish-Subscribe 模式，其實作為 Windows Communication Foundation (WCF) 程式。
