...
> [!NOTE]
>  這個範例會在組態中實作探索。 如需程式碼中實作探索的範例，請參閱[基本](../../../../docs/framework/wcf/samples/basic-sample.md)。  
...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]範圍，請參閱[探索尋找與尋找準則](../../../../docs/framework/wcf/feature-details/discovery-find-and-findcriteria.md)。  
