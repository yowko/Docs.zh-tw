...
---
# TCP 啟用
這個範例會示範裝載使用 Windows Process Activation Service \(WAS\) 的服務，以便啟用透過 net.tcp 通訊協定進行通訊的服務。  這個範例是以[使用者入門](../../../../docs/framework/wcf/samples/getting-started-sample.md)為基礎。  
