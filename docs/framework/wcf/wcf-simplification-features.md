...
WCF 現可支援合約優先開發。 Svcutil 工具具有/serviceContract 參數，可讓您從 WSDL 檔案產生服務和資料合約。
...
> [!IMPORTANT]
> 如需保護資料安全的詳細資訊，請參閱[資料的安全性考慮](./feature-details/security-considerations-for-data.md)底下的「安全地使用 XML」。
