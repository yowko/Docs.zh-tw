...
## 範例  
 下列範例會使用 <xref:System.Windows.Automation.WindowPattern> 和 <xref:System.Windows.Automation.TransformPattern> 控制項模式，藉此以程式設計方式將 [!INCLUDE[TLA#tla_win32](../../../includes/tlasharptla-win32-md.md)] 目標應用程式移動至個別畫面位置，並追蹤 <xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> <xref:System.Windows.Automation.AutomationElement.AutomationPropertyChangedEvent>。  
...
## 請參閱  
 [WindowPattern Sample](http://msdn.microsoft.com/zh-tw/598b695c-8baf-406e-bbfb-2a1c7842a1de)