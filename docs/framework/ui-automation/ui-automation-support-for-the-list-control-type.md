...
|清單<br /><br /> -   DataItem \(0 個以上\)<br />-   ListItem \(0 個以上\)<br />-   Group \(0 個以上\)<br />-   ScrollBar \(0、1 或 2 個\)|清單<br /><br /> -   DataItem \(0 個以上\)<br />-   ListItem \(0 個以上\)<br />-   Group \(0 個以上\)|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ClickablePointProperty>|請參閱備註。|如果清單控制項有可按的點 \(可以按一下讓清單取得焦點的點\)，則該點必須透過此屬性公開。<br /><br /> 若 `IsOffScreen` 屬性值為 true，則會引發 <xref:System.Windows.Automation.NoClickablePointException>。|  
