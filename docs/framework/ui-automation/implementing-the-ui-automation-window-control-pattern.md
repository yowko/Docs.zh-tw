...
-   為能夠使用使用者介面自動化修改視窗大小和螢幕位置，控制項除了必須實作 <xref:System.Windows.Automation.Provider.IWindowProvider> 之外，還必須實作 <xref:System.Windows.Automation.Provider.ITransformProvider>。  
...
|<xref:System.Windows.Automation.WindowInteractionState>|事件|不保證是 <xref:System.Windows.Automation.WindowInteractionState>|  
