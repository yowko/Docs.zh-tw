...
|-----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|  
|DataItem<br /><br /> -   視情況而定 \(0 個以上；可以結構化為階層\)|DataItem<br /><br /> -   視情況而定 \(0 個以上；可以結構化為階層\)|  
...
## 在大型清單中使用資料項目  
 ...
 在資料項目的 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 自動化項目上呼叫 `SetFocus` 時，[!INCLUDE[TLA#tla_winexpl](../../../includes/tlasharptla-winexpl-md.md)] 會將焦點成功傳回資料項目樹狀子目錄中並設為 Edit。  
...
## DataItem 控制項類型範例  
 ...
 ![包含兩個資料項目之 List View 控制項的圖形](../../../docs/framework/ui-automation/media/uiauto-data-grid-detailed.GIF "uiauto\_data\_grid\_detailed")  
