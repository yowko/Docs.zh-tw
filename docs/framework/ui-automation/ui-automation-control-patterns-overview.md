...
## <a name="ui-automation-providers-and-clients"></a>使用者介面自動化提供者和用戶端  
 ...
 用戶端使用<xref:System.Windows.Automation.AutomationElement>方法 （如<xref:System.Windows.Automation.AutomationElement.GetCurrentPropertyValue%2A?displayProperty=nameWithType><xref:System.Windows.Automation.AutomationElement.GetCachedPropertyValue%2A?displayProperty=nameWithType>或 ） 或通用語言運行時 （CLR） 訪問器訪問[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]模式上的屬性。 每個控制項模式類都有一個欄位成員（例如，<xref:System.Windows.Automation.InvokePattern.Pattern?displayProperty=nameWithType>或<xref:System.Windows.Automation.SelectionPattern.Pattern?displayProperty=nameWithType>），用於標識該控制項模式，並可以作為參數傳遞給<xref:System.Windows.Automation.AutomationElement.GetCachedPattern%2A>或<xref:System.Windows.Automation.AutomationElement.GetCurrentPattern%2A>檢索 該模式。 <xref:System.Windows.Automation.AutomationElement>  
...
|<xref:System.Windows.Automation.GridPattern>|<xref:System.Windows.Automation.Provider.IGridProvider>|用於支援格線功能 (例如調整大小及移動至指定的儲存格) 的控制項。 例如，Windows 資源管理器中的大圖示視圖或 Microsoft Word 中沒有標頭的簡單表。|  
|<xref:System.Windows.Automation.GridItemPattern>|<xref:System.Windows.Automation.Provider.IGridItemProvider>|用於格線中有儲存格的控制項。 個別儲存格應該支援 GridItem 模式。 例如，Microsoft Windows 資源管理器詳細資訊視圖中的每個儲存格。|  
...
|<xref:System.Windows.Automation.TablePattern>|<xref:System.Windows.Automation.Provider.ITableProvider>|用於有格線以及標題資訊的控制項。 例如，微軟 Excel 工作表。|  
...
|<xref:System.Windows.Automation.WindowPattern>|<xref:System.Windows.Automation.Provider.IWindowProvider>|公開視窗特定的資訊 (Microsoft Windows 作業系統的基本概念)。 作為視窗的控制項的示例包括頂級應用程式視窗（微軟 Word、Microsoft Windows 資源管理器等）、多重文件介面 （MDI） 子視窗和對話方塊。|  
