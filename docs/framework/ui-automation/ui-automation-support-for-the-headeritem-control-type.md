...
|控制項模式|支援|注意|  
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.ITransformProvider>|相依|如果此標題項目控制項可以調整大小，即實作此控制項模式。|  
|<xref:System.Windows.Automation.Provider.IInvokeProvider>|相依|如果標題項目控制項可按一下將資料進行排序，即實作此控制項模式。|  
