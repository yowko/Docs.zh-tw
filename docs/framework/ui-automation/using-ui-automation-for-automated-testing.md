...
description: 閱讀說明如何在自動化測試案例中，以程式設計方式使用 UI 自動化作為架構的總覽。
ms.date: 03/30/2017
helpviewer_keywords:
- automated testing
...
|||  
|-|-|  
|加入使用者介面自動化參考。|以下列出使用者介面自動化用戶端所需的 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] DLL。<br /><br /> -UIAutomationClient.dll 提供用戶端 Api 的存取權 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 。<br />-UIAutomationClientSideProvider.dll 提供自動化 Win32 控制項的功能。 請參閱 [UI Automation Support for Standard Controls](ui-automation-support-for-standard-controls.md)。<br />-UIAutomationTypes.dll 提供在中定義之特定類型的存取權 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 。|  
...
- Inspect.exe 是圖形化使用者介面（GUI）應用程式，可以用來收集 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 提供者和用戶端開發和偵錯工具的資訊。 Inspect.exe 包含在 Windows SDK 中。  
  
- MSAABridge 會 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 將資訊公開給 Active Accessibility 的用戶端。 橋接到 Active Accessibility 的主要目標 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 是要讓現有的 Active Accessibility 用戶端能夠與任何已執行的架構進行互動 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 。  
