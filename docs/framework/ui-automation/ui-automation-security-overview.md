...
本總覽描述 [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)] Windows Vista 中的安全性模型。
...
若要取得受保護系統 UI 的存取權，應用程式必須使用包含標記中屬性的資訊清單檔來建立，如下所示 `uiAccess` `requestedExecutionLevel` ：
