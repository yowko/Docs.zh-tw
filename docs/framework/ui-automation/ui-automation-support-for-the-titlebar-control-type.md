...
|控制項檢視|內容檢視|  
|------------------|------------------|  
|標題列<br /><br /> -Menu (0 或 1)<br />-按鈕 (0 個以上)|不適用。 (標題列控制項沒有任何內容)。|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsKeyboardFocusableProperty>|偽|標題列一律沒有鍵盤焦點。|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|偽|標題列控制項絕不會是內容。|  
