...
## <a name="example"></a>範例  
 這個範例會使用 <xref:System.Windows.Automation.AutomationElement> 類別的 <xref:System.Windows.Automation.AutomationElement.GetCurrentPattern%2A> 方法，從控制項取得 <xref:System.Windows.Automation.TogglePattern> 物件，並傳回其 <xref:System.Windows.Automation.ToggleState> 屬性。  
