...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|偽|捲軸控制項不是內容項目。 如果捲軸是獨立的控制項，則必須符合滑桿控制項類型，並傳回 `ControlType.Slider` 屬性的 `ControlType` 。|  
