...
>  這份文件適用於想要使用 <xref:System.Windows.Automation> 命名空間中定義之 Managed [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 類別的 .NET Framework 開發人員。 如需最新資訊[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]，請參閱[Windows Automation API:使用者介面自動化](https://go.microsoft.com/fwlink/?LinkID=156746)。  
 ...
 [!INCLUDE[TLA#tla_aa](../../../includes/tlasharptla-aa-md.md)] 是先前的解決方案，讓應用程式的存取。 [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)] 是的新協助工具模型[!INCLUDE[TLA#tla_win](../../../includes/tlasharptla-win-md.md)]旨在滿足輔助技術產品和自動化測試工具。 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 透過提供許多改善[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]。  
...
## <a name="support-in-windows-presentation-foundation"></a>Windows Presentation Foundation 的支援  
 Windows Presentation Foundation (WPF) 是新的模型來建立使用者介面。 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] 項目不包含的原生支援[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]; 不過，它們支援[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]，其中包括橋接支援[!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)]用戶端。 只有特別為 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 撰寫的用戶端可完整利用 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)]協助工具的功能，例如豐富的文字支援。  
...
## <a name="ui-elements"></a>UI 項目  
 [!INCLUDE[TLA2#tla_aa](../../../includes/tla2sharptla-aa-md.md)] 呈現[!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)]項目為 「 與`IAccessible`介面或子識別碼。 因此我們很難藉由比較兩者的 `IAccessible` 指標，來判斷它們是否參考同一個項目。  
...
## <a name="roles-and-control-types"></a>角色和控制項類型  
 ...
 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 支援自訂控制項，藉以<xref:System.Windows.Automation.ControlType.Custom>屬性，而且可以藉由描述<xref:System.Windows.Automation.AutomationElement.LocalizedControlTypeProperty>屬性。  
...
|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------------|  
|`get_accKeyboardShortcut`|<xref:System.Windows.Automation.AutomationElement.AccessKeyProperty> 或 <xref:System.Windows.Automation.AutomationElement.AcceleratorKeyProperty>|`AccessKeyProperty` 如果兩者均存在，則會優先。|  
...
|`get_accDescription`|不支援 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|`accDescription` 沒有清楚的規格，在 MSAA，導致將不同資訊片段放在這個屬性的提供者。|  
|`get_accHelpTopic`|不支援 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]||  
...
|-----------------------------------------------------------------------|------------------------------------------------------------------------------------|----------------------------|  
|STATE_SYSTEM_CHECKED|核取方塊， <xref:System.Windows.Automation.TogglePattern.ToggleStateProperty><br /><br /> 選項按鈕 <xref:System.Windows.Automation.SelectionItemPattern.IsSelectedProperty>|Y|  
...
|STATE_SYSTEM_HASPOPUP|<xref:System.Windows.Automation.ExpandCollapsePattern> 功能表項目|N|  
|STATE_SYSTEM_INVISIBLE|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> = True 和<xref:System.Windows.Automation.AutomationElement.GetClickablePoint%2A>導致 <xref:System.Windows.Automation.NoClickablePointException>|N|  
...
|STATE_SYSTEM_SELECTABLE|<xref:System.Windows.Automation.SelectionItemPattern> 支援|N|  
...
|-----------------------------------------------------------------------|-------------|  
|STATE_SYSTEM_BUSY|中無法使用 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_DEFAULT|中無法使用 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_ANIMATED|中無法使用 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|STATE_SYSTEM_TRAVERSED|中無法使用 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|STATE_SYSTEM_HOTTRACKED|中無法使用 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
|STATE_SYSTEM_PRESSED|中無法使用 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|  
...
|EVENT_OBJECT_CONTENTSCROLLED|<xref:System.Windows.Automation.ScrollPattern.VerticalScrollPercentProperty> 或<xref:System.Windows.Automation.ScrollPattern.HorizontalScrollPercentProperty>相關聯的捲軸上的屬性變更|  
...
|沒有對等項目|<xref:System.Windows.Automation.AutomationElement.AsyncContentLoadedEvent> Event - 事件|  
