...
|控制項檢視|內容檢視|  
|------------------|------------------|  
|SplitButton<br /><br /> <ul><li>影像 (0 或 1)</li><li>文字 (0 或 1)</li><li>按鈕 (1 或 2)<br /><br /> <ul><li>功能表 (0 或 1；顯示為支援 ExpandCollapse 模式的按鈕子項目)</li><li>MenuItem (1 個以上)</li></ul></li></ul>|SplitButton<br /><br /> -MenuItem (1 到多個)|  
