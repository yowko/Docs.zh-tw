...
>  這份文件適用於想要使用 <xref:System.Windows.Automation> 命名空間中定義之 Managed [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 類別的 .NET Framework 開發人員。 如需 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 的最新資訊，請參閱 [Windows Automation API：使用者介面自動化](http://go.microsoft.com/fwlink/?LinkID=156746)。  
 ...
 [!INCLUDE[TLA#tla_wpf](../../../includes/tlasharptla-wpf-md.md)] 項目和非 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] 項目 \(例如針對 [!INCLUDE[TLA#tla_winforms](../../../includes/tlasharptla-winforms-md.md)] 設計的項目\) 的實作在本質上不同。[!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] 項目透過衍生自 <xref:System.Windows.Automation.Peers.AutomationPeer> 的類別提供 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 的支援。 非[!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] 項目透過提供者介面的實作提供支援。  
...
|功能|實作|  
|--------|--------|  
|將提供者公開至 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]|在回應傳送至控制項視窗的 WM\_GETOBJECT 訊息時，傳回實作 <xref:System.Windows.Automation.Provider.IRawElementProviderSimple> 的物件 \(或衍生的介面\)。 對於片段，這必須是片段根的提供者。|  
...
>   
>  應該針對 [!INCLUDE[TLA#tla_winforms](../../../includes/tlasharptla-winforms-md.md)] 控制項中裝載的提供者傳回 <xref:System.Windows.Automation.AutomationElementIdentifiers.IsKeyboardFocusableProperty>。 在此情況下，預設視窗提供者可能無法擷取正確值。  
>   
...
> [!NOTE]
>  根以外的片段項目必須從 <xref:System.Windows.Automation.Provider.IRawElementProviderSimple.HostRawElementProvider%2A> 傳回 `null` 參考，因為它們不會直接裝載在視窗中，而且沒有預設提供者可支援項目之間的導覽。  
 ...
 片段根僅支援導覽至子項目。 例如，當方向為 <xref:System.Windows.Automation.Provider.NavigateDirection> 時，清單方塊會傳回清單中的第一個項目，而當方向為 <xref:System.Windows.Automation.Provider.NavigateDirection> 時，則傳回最後一個項目。 片段根目錄不支援導覽至父代或同層級；這是由主控視窗提供者處理。  
...
## 請參閱  
 ...
 [Simple Provider Sample](http://msdn.microsoft.com/zh-tw/c10a6255-e8dc-494b-a051-15111b47984a)   
