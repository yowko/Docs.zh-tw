...
|控制項檢視|內容檢視|  
|-----------|----------|  
|ToolTip<br /><br /> -   文字 \(0 個以上\)<br />-   影像 \(0 個以上\)|ToolTip|  
  
 如果工具提示控制項可以接收鍵盤焦點，便只會出現在 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 樹狀結構的內容檢視。 否則，所有的工具提示資訊都可由其參考之 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 項目上的 `HelpTextProperty` 取得。  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ToolTipOpenedEvent>|必要項|無|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ToolTipClosedEvent>|必要項|無|  
