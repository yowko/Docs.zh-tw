...
> [!NOTE]
>  <xref:System.Diagnostics.DebuggableAttribute?displayProperty=fullName> 控制組件的設定。 **DebuggableAttribute** 包含兩個欄位，記錄 JIT 編譯器是否應該最佳化的設定，及/或產生追蹤資訊。 在 .NET Framework 2.0 版中，JIT 編譯器一律會產生追蹤資訊。  
...
## <a name="see-also"></a>另請參閱  
 [偵錯、追蹤和分析](../../../docs/framework/debug-trace-profile/index.md)   
