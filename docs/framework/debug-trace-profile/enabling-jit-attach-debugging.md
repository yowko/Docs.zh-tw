...
-   <xref:System.Environment.FailFast%2A?displayProperty=nameWithType> 方法或 [RaiseFailFastException](http://go.microsoft.com/fwlink/?LinkId=182107) 函式 (Windows 7 系列)。  
