---
title: "適用於 Windows 市集應用程式之 .NET Framework 中的反映 | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
---
<a id="reflection-in-the-net-framework-for-windows-store-apps" class="xliff"></a>
...
<a id="typeinfo-and-assembly-loading" class="xliff"></a>
...
<a id="query-methods" class="xliff"></a>
