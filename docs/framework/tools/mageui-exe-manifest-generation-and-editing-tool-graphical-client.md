...
|**更新檢查頻率**|決定多久 [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] 應該檢查更新：<br /><br /> -   [每次執行應用程式時檢查]。 每次使用者開啟應用程式，[!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] 將會執行更新檢查。<br />-   **檢查間隔**：選取檢查更新前，必須經過多久的時間間隔和單位 (小時、天或週)。|  
