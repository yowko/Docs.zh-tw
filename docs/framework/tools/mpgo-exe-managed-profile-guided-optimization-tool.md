...
## <a name="using-mpgoexe-from-visual-studio"></a>從 Visual Studio 使用 Mpgo.exe  
 您可以從 Visual Studio 執行 Mpgo.exe (請參閱[如何：指定建置事件 (C#)](https://msdn.microsoft.com/library/b4ce1ad9-5215-4b6f-b6a2-798b249aa335) 一文)，但有下列限制：  
...
## <a name="see-also"></a>請參閱  
 ...
 [An Overview of Performance Improvements in .NET 4.5](https://go.microsoft.com/fwlink/p/?LinkId=249131) (.NET 4.5 的效能改進概觀)
