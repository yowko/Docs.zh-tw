...
## 原生映像的繫結記錄檔  
 根據預設，Fuslogvw.exe 會記錄正常的組件繫結要求。  或者，您可以記錄使用[Ngen.exe \(Native Image Generator\)](../../../docs/framework/tools/ngen-exe-native-image-generator.md) 所建立之原生映像的組件繫結。  
