...
---
<a id="how-to-view-assembly-contents" class="xliff"></a>
...
<a id="to-display-the-contents-of-an-assembly-using-ildasmexe" class="xliff"></a>

### 使用 Ildasm.exe 顯示組件的內容  
...
<a id="to-view-assembly-manifest-information" class="xliff"></a>
...
## 另請參閱  
 ...
 [應用程式定義域和組件「如何」主題](../../../docs/framework/app-domains/application-domains-and-assemblies-how-to-topics.md)   
