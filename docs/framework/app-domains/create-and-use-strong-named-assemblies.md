...
|[NIB: How to: Delay Sign an Assembly \(Visual Studio\)](http://msdn.microsoft.com/zh-tw/cab63b7a-591e-4674-b236-d77cd29a79ea)|說明如何在建立組件之後，使用強式名稱簽署組件。|  
|[Sn.exe \(Strong Name Tool\)](../../../docs/framework/tools/sn-exe-strong-name-tool.md)|描述 .NET Framework 中可協助使用強式名稱來建立組件的工具。  這個工具提供了金鑰管理、簽章產生和簽章驗證的選項。|  
