...
## <a name="example"></a><span data-ttu-id="a9433-106">範例</span><span class="sxs-lookup"><span data-stu-id="a9433-106">Example</span></span>  
...
## <a name="compiling-the-code"></a><span data-ttu-id="a9433-107">編譯程式碼</span><span class="sxs-lookup"><span data-stu-id="a9433-107">Compiling the Code</span></span>  
 <span data-ttu-id="a9433-108">這個範例需要：</span><span class="sxs-lookup"><span data-stu-id="a9433-108">This example requires:</span></span>  
  
 <span data-ttu-id="a9433-109">對 <xref:System.Net> 命名空間的參考。</span><span class="sxs-lookup"><span data-stu-id="a9433-109">References to the <xref:System.Net> namespace.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="a9433-110">請參閱</span><span class="sxs-lookup"><span data-stu-id="a9433-110">See Also</span></span>  
 [<span data-ttu-id="a9433-111">可插式通訊協定程式設計</span><span class="sxs-lookup"><span data-stu-id="a9433-111">Programming Pluggable Protocols</span></span>](../../../docs/framework/network-programming/programming-pluggable-protocols.md)
