...
## <a name="impact"></a>影響  
 這些變更會封鎖 <xref:System.IO.Path.GetDirectoryName%2A?displayProperty=fullName> 和 <xref:System.IO.Path.GetPathRoot%2A?displayProperty=fullName> 方法先前支援的一些 URI 路徑。  
  
## <a name="mitigation"></a>緩和  
 若要解決 <xref:System.IO.Path.GetDirectoryName%2A?displayProperty=fullName> 和 <xref:System.IO.Path.GetPathRoot%2A?displayProperty=fullName> 方法不再支援的先前可接受路徑問題，您可以執行下列動作：  
  
-   從 URL 手動移除配置。 例如，從 URL 移除 `file://`。  
  
-   將 URI 傳遞給 <xref:System.Uri> 建構函式，並擷取 <xref:System.Uri.LocalPath%2A?displayProperty=fullName> 屬性的值。  
