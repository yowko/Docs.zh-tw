---
title: "緩和：minFreeMemoryPercentageToActiveService 組態設定 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 緩和：minFreeMemoryPercentageToActiveService 組態設定
...
記憶體閘檢查失敗，因為可用記憶體 (nnnn 個位元組) 少於總記憶體的 nn%。  因此，傳入要求將無法使用服務。  若要解決這個問題，請降低電腦上的負載，或調整 serviceHostingEnvironment 組態項目上 minFreeMemoryPercentageToActivateService 的值。    
```  
