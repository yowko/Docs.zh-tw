---
title: ".NET Framework 4.6.2 中的應用程式相容性 | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="application-compatibility-in-the-net-framework-462"></a>.NET Framework 4.6.2 中的應用程式相容性
本主題提供 .NET Framework 4.6.1 與 4.6.2 間之應用程式相容性問題的資訊連結。 問題分為兩類：  
 ...
 重定目標變更影響以 [!INCLUDE[net_v462](../../../includes/net-v462-md.md)] 為目標來重新編譯的應用程式。 包括：  
  
-   設計階段環境中的變更。 例如，建置工具可能會發出之前未發出的警告。  
  
-   執行階段環境中的變更。 這些變更只會影響專門以 [!INCLUDE[net_v462](../../../includes/net-v462-md.md)] 為目標的應用程式。 針對舊版 .NET Framework 之應用程式的行為，就像是在這些版本下執行的行為一樣。  
  
 在描述重定目標變更的主題中，我們依每個項目的預期影響將項目分類如下：  
...
## <a name="see-also"></a>另請參閱  
 ...
 [GitHub 上的 .NET 4.6.2 清單變更](http://go.microsoft.com/fwlink/?LinkId=708778)
