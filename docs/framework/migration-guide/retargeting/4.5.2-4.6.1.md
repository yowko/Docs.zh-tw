---
title: "從.NET Framework 4.5.2 至 4.6.1 移轉重定目標變更"
ms.date: 05/19/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="da3a2-102">從.NET Framework 4.5.2 至 4.6.1 移轉重定目標變更</span><span class="sxs-lookup"><span data-stu-id="da3a2-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="da3a2-103">如果您從.NET Framework 4.5.2 至 4.6.1 移轉，請檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="da3a2-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="da3a2-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="da3a2-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="da3a2-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="da3a2-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="da3a2-106">核心</span><span class="sxs-lookup"><span data-stu-id="da3a2-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="da3a2-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="da3a2-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="da3a2-108">JIT</span><span class="sxs-lookup"><span data-stu-id="da3a2-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="da3a2-109">網路功能</span><span class="sxs-lookup"><span data-stu-id="da3a2-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="da3a2-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="da3a2-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="da3a2-111">Windows Form</span><span class="sxs-lookup"><span data-stu-id="da3a2-111">Windows Forms</span></span>

[!include[Application.FilterMessage no longer throws for re-entrant implementations of IMessageFilter.PreFilterMessage](~/includes/migration-guide/retargeting/winforms/applicationfiltermessage-no-longer-throws-for-re-entrant-implementations.md)]

## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="da3a2-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="da3a2-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="da3a2-113">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="da3a2-113">XML, XSLT</span></span>
