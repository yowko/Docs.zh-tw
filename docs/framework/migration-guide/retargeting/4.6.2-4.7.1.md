---
title: "從.NET Framework 4.6.2 至 4.7.1 移轉重定目標變更 |Microsoft 文件"
ms.date: 10/09/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-471"></a><span data-ttu-id="62f5c-102">從.NET Framework 4.6.2 至 4.7.1 移轉重定目標變更</span><span class="sxs-lookup"><span data-stu-id="62f5c-102">Retargeting Changes for Migration from .NET Framework 4.6.2 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="62f5c-103">如果您從.NET Framework 4.6.2 至 4.7.1 移轉，請檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="62f5c-103">If you are migrating from the .NET Framework 4.6.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="62f5c-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="62f5c-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="62f5c-105">核心</span><span class="sxs-lookup"><span data-stu-id="62f5c-105">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="62f5c-106">網路功能</span><span class="sxs-lookup"><span data-stu-id="62f5c-106">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="62f5c-107">安全性</span><span class="sxs-lookup"><span data-stu-id="62f5c-107">Security</span></span>
...
## <a name="wpf"></a><span data-ttu-id="62f5c-108">WPF</span><span class="sxs-lookup"><span data-stu-id="62f5c-108">WPF</span></span>

[!include[Accessibility improvements in WPF](~/includes/migration-guide/retargeting/wpf/accessibility-improvements-wpf.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="62f5c-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="62f5c-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="62f5c-110">Windows Form</span><span class="sxs-lookup"><span data-stu-id="62f5c-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="62f5c-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="62f5c-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="62f5c-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="62f5c-112">Windows Workflow Foundation (WF)</span></span>
