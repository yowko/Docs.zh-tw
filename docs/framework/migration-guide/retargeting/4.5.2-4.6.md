...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a>將移轉變更從 .NET Framework 4.5.2 重定為 4.6

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

如果您想從 .NET Framework 4.5.2 移轉至 4.6，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：
