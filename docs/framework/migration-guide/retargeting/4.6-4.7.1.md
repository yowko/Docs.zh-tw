...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a>從.NET Framework 4.6 至 4.7.1 移轉重定目標變更

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

如果您從.NET Framework 4.6 移轉至 4.7.1，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：
