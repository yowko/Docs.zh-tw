---
title: 將移轉變更從 .NET Framework 4.5.2 重定為 4.6.2
description: 尋找在從 .NET Framework 4.5.2 遷移至4.6.2 時，可能會影響應用程式之應用程式相容性問題的相關資訊。
ms.date: 07/10/2019
...
ms.locfileid: "86444231"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="efae5-103">將移轉變更從 .NET Framework 4.5.2 重定為 4.6.2</span><span class="sxs-lookup"><span data-stu-id="efae5-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="efae5-104">如果您想從 .NET Framework 4.5.2 移轉至 4.6.2，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="efae5-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="efae5-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="efae5-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="efae5-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="efae5-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="efae5-107">核心</span><span class="sxs-lookup"><span data-stu-id="efae5-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="efae5-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="efae5-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="efae5-109">JIT</span><span class="sxs-lookup"><span data-stu-id="efae5-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="efae5-110">網路</span><span class="sxs-lookup"><span data-stu-id="efae5-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="efae5-111">安全性</span><span class="sxs-lookup"><span data-stu-id="efae5-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="efae5-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="efae5-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="efae5-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="efae5-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="efae5-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="efae5-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="efae5-115">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="efae5-115">XML, XSLT</span></span>
