---
title: "從.NET Framework 4.0 為 4.5 版移轉重定目標變更"
ms.date: 05/19/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="e732d-102">從.NET Framework 4.0 為 4.5 版移轉重定目標變更</span><span class="sxs-lookup"><span data-stu-id="e732d-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="e732d-103">如果您從.NET Framework 4.0 移轉至 4.5，請檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="e732d-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e732d-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e732d-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="e732d-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="e732d-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="e732d-106">核心</span><span class="sxs-lookup"><span data-stu-id="e732d-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e732d-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e732d-107">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e732d-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="e732d-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e732d-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e732d-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e732d-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e732d-110">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e732d-111">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="e732d-111">XML, XSLT</span></span>
