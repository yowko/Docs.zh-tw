---
title: "從.NET Framework 4.5 到 4.7 移轉的執行階段變更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="4b0b2-102">從.NET Framework 4.5 到 4.7 移轉的執行階段變更</span><span class="sxs-lookup"><span data-stu-id="4b0b2-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="4b0b2-103">如果您從.NET Framework 4.5 移轉至 4.7，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="4b0b2-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="4b0b2-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="4b0b2-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="4b0b2-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4b0b2-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4b0b2-106">核心</span><span class="sxs-lookup"><span data-stu-id="4b0b2-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4b0b2-107">資料</span><span class="sxs-lookup"><span data-stu-id="4b0b2-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4b0b2-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="4b0b2-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="4b0b2-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="4b0b2-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="4b0b2-110">全球化</span><span class="sxs-lookup"><span data-stu-id="4b0b2-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="4b0b2-111">JIT</span><span class="sxs-lookup"><span data-stu-id="4b0b2-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="4b0b2-112">網路功能</span><span class="sxs-lookup"><span data-stu-id="4b0b2-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="4b0b2-113">安全性</span><span class="sxs-lookup"><span data-stu-id="4b0b2-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4b0b2-114">序列化</span><span class="sxs-lookup"><span data-stu-id="4b0b2-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="4b0b2-115">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="4b0b2-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="4b0b2-116">工具</span><span class="sxs-lookup"><span data-stu-id="4b0b2-116">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4b0b2-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4b0b2-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="4b0b2-118">Windows Form</span><span class="sxs-lookup"><span data-stu-id="4b0b2-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4b0b2-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4b0b2-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4b0b2-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4b0b2-120">Windows Workflow Foundation (WF)</span></span>
