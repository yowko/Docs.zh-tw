...
description: 從 .NET Framework 4.5.2 遷移至4.6 時，尋找可能會影響應用程式的執行時間變更之應用程式相容性問題的相關資訊。
ms.date: 07/10/2019
...
ms.locfileid: "86442164"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="68980-103">將執行階段變更從 .NET Framework 4.5.2 移轉至 4.6</span><span class="sxs-lookup"><span data-stu-id="68980-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="68980-104">如果您想從 .NET Framework 4.5.2 移轉至 4.6，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="68980-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="68980-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="68980-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="68980-106">核心</span><span class="sxs-lookup"><span data-stu-id="68980-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="68980-107">資料</span><span class="sxs-lookup"><span data-stu-id="68980-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="68980-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="68980-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="68980-109">網路</span><span class="sxs-lookup"><span data-stu-id="68980-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="68980-110">序列化</span><span class="sxs-lookup"><span data-stu-id="68980-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="68980-111">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="68980-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="68980-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="68980-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="68980-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="68980-113">Windows Presentation Foundation (WPF)</span></span>
