---
title: "從.NET Framework 4.5 到 4.7.1 移轉的執行階段變更 |Microsoft 文件"
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="23187-102">從.NET Framework 4.5 到 4.7.1 移轉的執行階段變更</span><span class="sxs-lookup"><span data-stu-id="23187-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="23187-103">如果您從.NET Framework 4.5 移轉至 4.7.1，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="23187-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="23187-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="23187-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="23187-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="23187-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="23187-106">核心</span><span class="sxs-lookup"><span data-stu-id="23187-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="23187-107">資料</span><span class="sxs-lookup"><span data-stu-id="23187-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="23187-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="23187-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="23187-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="23187-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="23187-110">全球化</span><span class="sxs-lookup"><span data-stu-id="23187-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="23187-111">網路功能</span><span class="sxs-lookup"><span data-stu-id="23187-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="23187-112">安全性</span><span class="sxs-lookup"><span data-stu-id="23187-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="23187-113">序列化</span><span class="sxs-lookup"><span data-stu-id="23187-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="23187-114">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="23187-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="23187-115">工具</span><span class="sxs-lookup"><span data-stu-id="23187-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="23187-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="23187-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="23187-117">Windows Form</span><span class="sxs-lookup"><span data-stu-id="23187-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="23187-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="23187-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="23187-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="23187-119">Windows Workflow Foundation (WF)</span></span>
