...
description: 從 .NET Framework 4.5 遷移至4.7.1 時，尋找可能影響您應用程式之執行時間變更的應用程式相容性問題的相關資訊。
ms.date: 07/10/2019
...
ms.locfileid: "86443061"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="0c7f6-103">將執行階段變更從 .NET Framework 4.5 移轉至 4.7.1</span><span class="sxs-lookup"><span data-stu-id="0c7f6-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="0c7f6-104">如果您想從 .NET Framework 4.5 移轉至 4.7.1，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="0c7f6-104">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="0c7f6-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="0c7f6-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="0c7f6-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0c7f6-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0c7f6-107">核心</span><span class="sxs-lookup"><span data-stu-id="0c7f6-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0c7f6-108">資料</span><span class="sxs-lookup"><span data-stu-id="0c7f6-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="0c7f6-109">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="0c7f6-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0c7f6-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0c7f6-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0c7f6-111">全球化</span><span class="sxs-lookup"><span data-stu-id="0c7f6-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="0c7f6-112">網路</span><span class="sxs-lookup"><span data-stu-id="0c7f6-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="0c7f6-113">安全性</span><span class="sxs-lookup"><span data-stu-id="0c7f6-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0c7f6-114">序列化</span><span class="sxs-lookup"><span data-stu-id="0c7f6-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0c7f6-115">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="0c7f6-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="0c7f6-116">工具</span><span class="sxs-lookup"><span data-stu-id="0c7f6-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0c7f6-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0c7f6-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0c7f6-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0c7f6-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0c7f6-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0c7f6-119">Windows Workflow Foundation (WF)</span></span>
