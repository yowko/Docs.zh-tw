...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-461"></a>將執行階段變更從 .NET Framework 4.0 移轉至 4.6.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

如果您想從 .NET Framework 4.0 移轉至 4.6.1，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：
