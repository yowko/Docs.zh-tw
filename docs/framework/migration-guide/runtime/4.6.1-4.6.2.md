...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="0bcb4-102">將執行階段變更從 .NET Framework 4.6.1 移轉至 4.6.2</span><span class="sxs-lookup"><span data-stu-id="0bcb4-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0bcb4-103">如果您想從 .NET Framework 4.6.1 移轉至 4.6.2，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="0bcb4-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="0bcb4-104">核心</span><span class="sxs-lookup"><span data-stu-id="0bcb4-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0bcb4-105">資料</span><span class="sxs-lookup"><span data-stu-id="0bcb4-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0bcb4-106">全球化</span><span class="sxs-lookup"><span data-stu-id="0bcb4-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="0bcb4-107">安全性</span><span class="sxs-lookup"><span data-stu-id="0bcb4-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0bcb4-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0bcb4-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0bcb4-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0bcb4-109">Windows Presentation Foundation (WPF)</span></span>
