...
ms.locfileid: "33391735"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="fb386-102">將執行階段變更從 .NET Framework 4.5 移轉至 4.6.1</span><span class="sxs-lookup"><span data-stu-id="fb386-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="fb386-103">如果您想從 .NET Framework 4.5 移轉至 4.6.1，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="fb386-103">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="fb386-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="fb386-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="fb386-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="fb386-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="fb386-106">核心</span><span class="sxs-lookup"><span data-stu-id="fb386-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="fb386-107">資料</span><span class="sxs-lookup"><span data-stu-id="fb386-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="fb386-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="fb386-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="fb386-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="fb386-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="fb386-110">網路</span><span class="sxs-lookup"><span data-stu-id="fb386-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="fb386-111">序列化</span><span class="sxs-lookup"><span data-stu-id="fb386-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="fb386-112">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="fb386-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="fb386-113">工具</span><span class="sxs-lookup"><span data-stu-id="fb386-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fb386-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="fb386-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fb386-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fb386-115">Windows Presentation Foundation (WPF)</span></span>
