...
description: 從 .NET Framework 4.5 遷移至4.6.1 時，尋找可能影響您應用程式之執行時間變更的應用程式相容性問題的相關資訊。
ms.date: 07/10/2019
...
ms.locfileid: "86443230"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="72ede-103">將執行階段變更從 .NET Framework 4.5 移轉至 4.6.1</span><span class="sxs-lookup"><span data-stu-id="72ede-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="72ede-104">如果您想從 .NET Framework 4.5 移轉至 4.6.1，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="72ede-104">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="72ede-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="72ede-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="72ede-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="72ede-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="72ede-107">核心</span><span class="sxs-lookup"><span data-stu-id="72ede-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="72ede-108">資料</span><span class="sxs-lookup"><span data-stu-id="72ede-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="72ede-109">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="72ede-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="72ede-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="72ede-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="72ede-111">網路</span><span class="sxs-lookup"><span data-stu-id="72ede-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="72ede-112">序列化</span><span class="sxs-lookup"><span data-stu-id="72ede-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="72ede-113">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="72ede-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="72ede-114">工具</span><span class="sxs-lookup"><span data-stu-id="72ede-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="72ede-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="72ede-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="72ede-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="72ede-116">Windows Presentation Foundation (WPF)</span></span>
