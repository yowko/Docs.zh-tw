---
title: "從.NET Framework 4.5 到 4.5.1 移轉的執行階段變更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="ebe7c-102">從.NET Framework 4.5 到 4.5.1 移轉的執行階段變更</span><span class="sxs-lookup"><span data-stu-id="ebe7c-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="ebe7c-103">如果您從.NET Framework 4.5 移轉至 4.5.1，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="ebe7c-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="ebe7c-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="ebe7c-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ebe7c-105">核心</span><span class="sxs-lookup"><span data-stu-id="ebe7c-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ebe7c-106">序列化</span><span class="sxs-lookup"><span data-stu-id="ebe7c-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ebe7c-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ebe7c-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ebe7c-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ebe7c-108">Windows Presentation Foundation (WPF)</span></span>
