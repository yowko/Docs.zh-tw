---
title: "從.NET Framework 4.0 來 4.7 移轉的執行階段變更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a><span data-ttu-id="b8fd0-102">從.NET Framework 4.0 來 4.7 移轉的執行階段變更</span><span class="sxs-lookup"><span data-stu-id="b8fd0-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b8fd0-103">如果您從.NET Framework 4.0 移轉至 4.7，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="b8fd0-103">If you are migrating from the .NET Framework 4.0 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b8fd0-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b8fd0-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b8fd0-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b8fd0-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b8fd0-106">核心</span><span class="sxs-lookup"><span data-stu-id="b8fd0-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b8fd0-107">資料</span><span class="sxs-lookup"><span data-stu-id="b8fd0-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b8fd0-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b8fd0-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b8fd0-109">全球化</span><span class="sxs-lookup"><span data-stu-id="b8fd0-109">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="b8fd0-110">JIT</span><span class="sxs-lookup"><span data-stu-id="b8fd0-110">JIT</span></span>
...
## <a name="linq"></a><span data-ttu-id="b8fd0-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="b8fd0-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="b8fd0-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="b8fd0-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="b8fd0-113">網路功能</span><span class="sxs-lookup"><span data-stu-id="b8fd0-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="b8fd0-114">列印</span><span class="sxs-lookup"><span data-stu-id="b8fd0-114">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="b8fd0-115">安全性</span><span class="sxs-lookup"><span data-stu-id="b8fd0-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b8fd0-116">序列化</span><span class="sxs-lookup"><span data-stu-id="b8fd0-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b8fd0-117">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="b8fd0-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b8fd0-118">工具</span><span class="sxs-lookup"><span data-stu-id="b8fd0-118">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="b8fd0-119">Web 應用程式</span><span class="sxs-lookup"><span data-stu-id="b8fd0-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b8fd0-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b8fd0-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="b8fd0-121">Windows Form</span><span class="sxs-lookup"><span data-stu-id="b8fd0-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b8fd0-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b8fd0-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b8fd0-123">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b8fd0-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="b8fd0-124">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="b8fd0-124">XML, XSLT</span></span>
