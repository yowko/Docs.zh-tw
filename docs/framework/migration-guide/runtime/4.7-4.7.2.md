...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-472"></a><span data-ttu-id="df897-102">將執行階段變更從 .NET Framework 4.7 移轉至 4.7.2</span><span class="sxs-lookup"><span data-stu-id="df897-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="df897-103">如果您想從 .NET Framework 4.7 移轉至 4.7.2，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="df897-103">If you are migrating from the .NET Framework 4.7 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="df897-104">核心</span><span class="sxs-lookup"><span data-stu-id="df897-104">Core</span></span>

[!include[Allow Unicode in URIs that resemble UNC shares](~/includes/migration-guide/runtime/core/allow-unicode-uris-that-resemble-unc-shares.md)]

[!include[Support special relative URI notation when Unicode is present](~/includes/migration-guide/runtime/core/support-special-relative-uri-notation-when-unicode-present.md)]

## <a name="jit"></a><span data-ttu-id="df897-105">JIT</span><span class="sxs-lookup"><span data-stu-id="df897-105">JIT</span></span>
...
## <a name="runtime"></a><span data-ttu-id="df897-106">執行階段</span><span class="sxs-lookup"><span data-stu-id="df897-106">Runtime</span></span>

[!include[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="df897-107">安全性</span><span class="sxs-lookup"><span data-stu-id="df897-107">Security</span></span>
...
## <a name="web-application"></a><span data-ttu-id="df897-108">Web 應用程式</span><span class="sxs-lookup"><span data-stu-id="df897-108">Web Application</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="df897-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="df897-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="df897-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="df897-110">Windows Presentation Foundation (WPF)</span></span>
