...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-48"></a>從 .NET Framework 4.6.1 移轉至 4.8 的執行階段變更

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

如果您想從 .NET Framework 4.6.1 移轉至 4.8，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：
