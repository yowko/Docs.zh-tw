---
title: "從.NET Framework 4.5 到 4.6 移轉的執行階段變更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="922a4-102">從.NET Framework 4.5 到 4.6 移轉的執行階段變更</span><span class="sxs-lookup"><span data-stu-id="922a4-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="922a4-103">如果您從.NET Framework 4.5 移轉至 4.6，請檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="922a4-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="922a4-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="922a4-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="922a4-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="922a4-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="922a4-106">核心</span><span class="sxs-lookup"><span data-stu-id="922a4-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="922a4-107">資料</span><span class="sxs-lookup"><span data-stu-id="922a4-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="922a4-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="922a4-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="922a4-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="922a4-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="922a4-110">網路功能</span><span class="sxs-lookup"><span data-stu-id="922a4-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="922a4-111">序列化</span><span class="sxs-lookup"><span data-stu-id="922a4-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="922a4-112">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="922a4-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="922a4-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="922a4-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="922a4-114">Windows Form</span><span class="sxs-lookup"><span data-stu-id="922a4-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="922a4-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="922a4-115">Windows Presentation Foundation (WPF)</span></span>
