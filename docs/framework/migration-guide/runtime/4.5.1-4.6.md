...
ms.locfileid: "73105884"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="fdffa-102">將執行階段變更從 .NET Framework 4.5.1 移轉至 4.6</span><span class="sxs-lookup"><span data-stu-id="fdffa-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="fdffa-103">如果您想從 .NET Framework 4.5.1 移轉至 4.6，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="fdffa-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="fdffa-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="fdffa-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="fdffa-105">核心</span><span class="sxs-lookup"><span data-stu-id="fdffa-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="fdffa-106">資料</span><span class="sxs-lookup"><span data-stu-id="fdffa-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="fdffa-107">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="fdffa-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="fdffa-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="fdffa-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="fdffa-109">網路功能</span><span class="sxs-lookup"><span data-stu-id="fdffa-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="fdffa-110">序列化</span><span class="sxs-lookup"><span data-stu-id="fdffa-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="fdffa-111">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="fdffa-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fdffa-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="fdffa-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fdffa-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fdffa-113">Windows Presentation Foundation (WPF)</span></span>
