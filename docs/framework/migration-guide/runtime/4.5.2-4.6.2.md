...
ms.locfileid: "68238108"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="c69c5-102">將執行階段變更從 .NET Framework 4.5.2 移轉至 4.6.2</span><span class="sxs-lookup"><span data-stu-id="c69c5-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c69c5-103">如果您想從 .NET Framework 4.5.2 移轉至 4.6.2，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="c69c5-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c69c5-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c69c5-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c69c5-105">核心</span><span class="sxs-lookup"><span data-stu-id="c69c5-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c69c5-106">資料</span><span class="sxs-lookup"><span data-stu-id="c69c5-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c69c5-107">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="c69c5-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c69c5-108">全球化</span><span class="sxs-lookup"><span data-stu-id="c69c5-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="c69c5-109">網路</span><span class="sxs-lookup"><span data-stu-id="c69c5-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c69c5-110">安全性</span><span class="sxs-lookup"><span data-stu-id="c69c5-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c69c5-111">序列化</span><span class="sxs-lookup"><span data-stu-id="c69c5-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c69c5-112">安裝和部署</span><span class="sxs-lookup"><span data-stu-id="c69c5-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="c69c5-113">工具</span><span class="sxs-lookup"><span data-stu-id="c69c5-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c69c5-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c69c5-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c69c5-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c69c5-115">Windows Presentation Foundation (WPF)</span></span>
