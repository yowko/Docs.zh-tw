---
title: 將執行階段變更從 .NET Framework 4.5 移轉至 4.5.2
description: 從 .NET Framework 4.5 遷移至4.5.2 時，尋找可能會影響應用程式之執行時間變更的應用程式相容性問題的相關資訊。
ms.date: 07/10/2019
...
ms.locfileid: "97009120"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="e5019-103">將執行階段變更從 .NET Framework 4.5 移轉至 4.5.2</span><span class="sxs-lookup"><span data-stu-id="e5019-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="e5019-104">如果您想從 .NET Framework 4.5 移轉至 4.5.2，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="e5019-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e5019-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e5019-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e5019-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e5019-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e5019-107">核心</span><span class="sxs-lookup"><span data-stu-id="e5019-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e5019-108">資料</span><span class="sxs-lookup"><span data-stu-id="e5019-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e5019-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e5019-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e5019-110">序列化</span><span class="sxs-lookup"><span data-stu-id="e5019-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e5019-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e5019-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e5019-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e5019-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="e5019-113">XML</span><span class="sxs-lookup"><span data-stu-id="e5019-113">XML</span></span>
