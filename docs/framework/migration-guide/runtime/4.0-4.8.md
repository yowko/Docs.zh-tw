...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-48"></a>將執行時間變更從 .NET Framework 4.0 遷移至4。8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

如果您要從 .NET Framework 4.0 遷移至4.8，請參閱下列主題，以瞭解可能會影響您應用程式的應用程式相容性問題：
