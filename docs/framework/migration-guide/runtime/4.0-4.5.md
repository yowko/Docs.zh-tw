---
title: 將執行階段變更從 .NET Framework 4.0 移轉至 4.5
description: 從 .NET Framework 4.0 遷移至4.5 時，尋找可能會影響應用程式之執行時間變更的應用程式相容性問題的相關資訊。
ms.date: 07/10/2019
...
ms.locfileid: "91609482"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="85c13-103">將執行階段變更從 .NET Framework 4.0 移轉至 4.5</span><span class="sxs-lookup"><span data-stu-id="85c13-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="85c13-104">如果您想從 .NET Framework 4.0 移轉至 4.5，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="85c13-104">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="85c13-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="85c13-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="85c13-106">核心</span><span class="sxs-lookup"><span data-stu-id="85c13-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="85c13-107">資料</span><span class="sxs-lookup"><span data-stu-id="85c13-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="85c13-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="85c13-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="85c13-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="85c13-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="85c13-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="85c13-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="85c13-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="85c13-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="85c13-112">網路功能</span><span class="sxs-lookup"><span data-stu-id="85c13-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="85c13-113">列印</span><span class="sxs-lookup"><span data-stu-id="85c13-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="85c13-114">序列化</span><span class="sxs-lookup"><span data-stu-id="85c13-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="85c13-115">Web 應用程式</span><span class="sxs-lookup"><span data-stu-id="85c13-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="85c13-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="85c13-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="85c13-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="85c13-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="85c13-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="85c13-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="85c13-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="85c13-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="85c13-120">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="85c13-120">XML, XSLT</span></span>
