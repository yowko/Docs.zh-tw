...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="cb7c4-102">將執行階段變更從 .NET Framework 4.0 移轉至 4.5</span><span class="sxs-lookup"><span data-stu-id="cb7c4-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cb7c4-103">如果您想從 .NET Framework 4.0 移轉至 4.5，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="cb7c4-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="cb7c4-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cb7c4-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cb7c4-105">核心</span><span class="sxs-lookup"><span data-stu-id="cb7c4-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="cb7c4-106">資料</span><span class="sxs-lookup"><span data-stu-id="cb7c4-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="cb7c4-107">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="cb7c4-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="cb7c4-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="cb7c4-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="cb7c4-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="cb7c4-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="cb7c4-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="cb7c4-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="cb7c4-111">網路</span><span class="sxs-lookup"><span data-stu-id="cb7c4-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="cb7c4-112">列印</span><span class="sxs-lookup"><span data-stu-id="cb7c4-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cb7c4-113">序列化</span><span class="sxs-lookup"><span data-stu-id="cb7c4-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="cb7c4-114">Web 應用程式</span><span class="sxs-lookup"><span data-stu-id="cb7c4-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cb7c4-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cb7c4-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="cb7c4-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="cb7c4-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cb7c4-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cb7c4-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="cb7c4-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="cb7c4-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="cb7c4-119">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="cb7c4-119">XML, XSLT</span></span>
