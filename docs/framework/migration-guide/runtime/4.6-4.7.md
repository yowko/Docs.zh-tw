...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="40c9e-102">將執行階段變更從 .NET Framework 4.6 移轉至 4.7</span><span class="sxs-lookup"><span data-stu-id="40c9e-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="40c9e-103">如果您想從 .NET Framework 4.6 移轉至 4.7，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="40c9e-103">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="40c9e-104">資料</span><span class="sxs-lookup"><span data-stu-id="40c9e-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="40c9e-105">全球化</span><span class="sxs-lookup"><span data-stu-id="40c9e-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="40c9e-106">JIT</span><span class="sxs-lookup"><span data-stu-id="40c9e-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="40c9e-107">安全性</span><span class="sxs-lookup"><span data-stu-id="40c9e-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="40c9e-108">工具</span><span class="sxs-lookup"><span data-stu-id="40c9e-108">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="40c9e-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="40c9e-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="40c9e-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="40c9e-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="40c9e-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="40c9e-111">Windows Workflow Foundation (WF)</span></span>
