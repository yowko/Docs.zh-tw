---
title: "從.NET Framework 4.0 來 4.5.1 移轉的執行階段變更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="1834d-102">從.NET Framework 4.0 來 4.5.1 移轉的執行階段變更</span><span class="sxs-lookup"><span data-stu-id="1834d-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1834d-103">如果您從.NET Framework 4.0 移轉 4.5.1，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="1834d-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="1834d-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="1834d-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="1834d-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="1834d-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="1834d-106">核心</span><span class="sxs-lookup"><span data-stu-id="1834d-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="1834d-107">資料</span><span class="sxs-lookup"><span data-stu-id="1834d-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="1834d-108">偵錯工具</span><span class="sxs-lookup"><span data-stu-id="1834d-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="1834d-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="1834d-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="1834d-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="1834d-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="1834d-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="1834d-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="1834d-112">網路功能</span><span class="sxs-lookup"><span data-stu-id="1834d-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="1834d-113">列印</span><span class="sxs-lookup"><span data-stu-id="1834d-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="1834d-114">序列化</span><span class="sxs-lookup"><span data-stu-id="1834d-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="1834d-115">Web 應用程式</span><span class="sxs-lookup"><span data-stu-id="1834d-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1834d-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1834d-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1834d-117">Windows Form</span><span class="sxs-lookup"><span data-stu-id="1834d-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1834d-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1834d-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="1834d-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="1834d-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="1834d-120">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="1834d-120">XML, XSLT</span></span>
