...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a>從.NET Framework 4.6 至 4.6.2 移轉的執行階段變更

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果您從.NET Framework 4.6 移轉至 4.6.2，檢閱下列主題可能會影響您的應用程式的應用程式相容性問題：
