...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="23080-102">將執行階段變更從 .NET Framework 4.6 移轉至 4.6.2</span><span class="sxs-lookup"><span data-stu-id="23080-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="23080-103">如果您想從 .NET Framework 4.6 移轉至 4.6.2，請檢閱下列主題中可能會影響應用程式的應用程式相容性問題：</span><span class="sxs-lookup"><span data-stu-id="23080-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="23080-104">資料</span><span class="sxs-lookup"><span data-stu-id="23080-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="23080-105">全球化</span><span class="sxs-lookup"><span data-stu-id="23080-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="23080-106">安全性</span><span class="sxs-lookup"><span data-stu-id="23080-106">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="23080-107">工具</span><span class="sxs-lookup"><span data-stu-id="23080-107">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="23080-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="23080-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="23080-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="23080-109">Windows Presentation Foundation (WPF)</span></span>
