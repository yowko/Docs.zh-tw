...
>  如需下載和安裝 .NET Framework 的資訊，請參閱[安裝適用於開發人員的 .NET Framework](../../../docs/framework/install/guide-for-developers.md)。  
 ...
 如需完整的支援作業系統清單，請參閱[系統需求](../../../docs/framework/get-started/system-requirements.md)。 如需下載，請參閱[安裝適用於開發人員的 .NET Framework](../../../docs/framework/install/guide-for-developers.md)。 判斷哪些版本的.NET Framework 已安裝在電腦上，請參閱[How to： 判斷安裝的.NET Framework 版本是](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)。  
...
|----------------------------|-----------------|--------------|---------------------------------------|----------------------------------------------------|-----------------------------------------------------------|-----------------------------------------| 
|4.7.1|4|適用於.NET 2.0 標準支援。<br/> -設定產生器，允許在執行階段的組態檔建立的支援。<br/> 執行階段功能偵測，可讓您判斷是否在執行階段環境中支援預先定義的功能。<br/> 序列化值 tuple。<br/> -記憶體回收的提升效能。<br/> -可攜式 Pdb 的支援。<br/> -Sha-2 支援<xref:System.Messaging.Message.HashAlgorithm%2A?displayProperty=nameWithType>。<br/> 以剖析的 ASP.NET cookie 支援<xref:System.Web.HttpCookie.TryParse%2A?displayProperty=nameWithType>方法。<br/> 支援 sha-2 雜湊 ASP.NET 表單驗證認證。<br/> -應用程式開發人員; 許多協助工具增強功能請參閱[新.NET Framework 中的協助工具功能](../whats-new/whats-new-in-accessibility.md)。| | ✓ 10 年秋季建立者更新 <br/> <br/> + 更新 10 的建立者 <br/> + 10 年度更新版 <br/> + 8.1 <br/> +7| + 2016 <br/> + 2012 R2 <br/> + 2012 <br/> + 2008 R2 SP1 |使用 `Release` DWORD：<br/><br/> -461308 （Windows 10 的建立者更新） <br/> -461310 （所有其他作業系統版本） <br/><br/> (請參閱[相關指示](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)) 
