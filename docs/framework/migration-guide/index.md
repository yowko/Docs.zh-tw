...
如果您使用舊版的 .NET Framework 建立應用程式，通常可以輕鬆地將它升級到 .NET Framework 4.5 及其小數點版本 (4.5.1 和 4.5.2)、.NET Framework 4.6 及其小數點版本 (4.6.1 和 4.6.2)、.NET Framework 4.7 及其小數點版本 (4.7.1 和 4.7.2) 或 .NET Framework 4.8。 在 Visual Studio 中，開啟您的專案。 如果您的專案是使用舊版 Visual Studio 所建立，則會自動開啟 [專案相容性]**** 對話方塊。 如需升級 Visual Studio 專案的詳細資訊，請參閱[移植、移轉及升級 Visual Studio 專案](/visualstudio/porting/port-migrate-and-upgrade-visual-studio-projects)和 [Visual Studio 2019 平台目標及相容性](/visualstudio/releases/2019/compatibility)。
...
- 查看[應用程式相容性](application-compatibility.md)，瞭解可能影回應用的運行時更改和重新置放更改以及如何處理這些更改。
...
- [版本和依賴項](versions-and-dependencies.md)
- [如何：將應用配置為支援 .NET 框架 4 或更高版本](how-to-configure-an-app-to-support-net-framework-4-or-4-5.md)
...
- [.NET 框架 4 遷移問題](net-framework-4-migration-issues.md)
