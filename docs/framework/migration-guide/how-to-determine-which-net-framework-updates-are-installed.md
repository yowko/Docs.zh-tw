...
1. 開啟 **regedit.exe** 程式。 在 Windows 8 和更新版本中，在 [開始] ![Windows 標誌] 上按一下滑鼠右鍵，按一下(../get-started/media/windowskeyboardlogo.png "Windowskeyboardlogo")，然後選取 [執行]。 在 [開啟]方塊中，輸入 **regedit**，然後選取 [確定]。
