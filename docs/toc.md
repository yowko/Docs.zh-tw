...
### [使用可為 Null 的參考型別](csharp/tutorials/nullable-reference-types.md)
...
### [可為 Null 的參考型別](csharp/nullable-references.md)
...
#### [值類型和參考型別](visual-basic/programming-guide/language-features/data-types/value-types-and-reference-types.md)
...
#### [二進位 'If' 運算式的第一個運算元必須可為 Null 或是參考型別](visual-basic/language-reference/error-messages/first-operand-in-a-binary-if-expression-must-be-nullable-or-a-reference-type.md)
...
#### ['Is' 需要有參考型別的運算元，但此運算元擁有實值類型 '<typename>'](visual-basic/language-reference/error-messages/is-requires-operands-that-have-reference-types.md)
