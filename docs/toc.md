...
### [無伺服器應用程式：架構、模式和 Azure 實作](standard/serverless-architecture/)
## [開放原始碼程式庫指導方針](standard/library-guidance/)
...
## [平行處理、並行機制與非同步](standard/parallel-processing-and-concurrency.md)
...
### [使用 Visual Studio 2017 針對您的 C# 或 Visual Basic .NET Core Hello World 應用程式進行偵錯](core/tutorials/debugging-with-visual-studio.md)
### [使用 Visual Studio 2017 發佈您的 Hello World 應用程式](core/tutorials/publishing-with-visual-studio.md)
### [在 Visual Studio 2017 中使用 C# 和 .NET Core 建置 .NET Standard 程式庫](core/tutorials/library-with-visual-studio.md)
...
### [從 project.json 移轉](core/migration/index.md)
...
### [容器化 .NET Core 應用程式](core/docker/docker-basics-dotnet-core.md)
### [使用 Docker 基底映像](core/docker/building-net-docker-images.md)
### [Visual Studio Tools for Docker](/aspnet/core/publishing/visual-studio-tools-for-docker)
## [單元測試](core/testing/index.md)
### [單元測試最佳做法](core/testing/unit-testing-best-practices.md)
...
### [.NET Core 版本選取項目](core/versions/selection.md)
### [移除過時的執行階段與 SDK](core/versions/remove-runtime-sdk-versions.md)
...
### [dotnet-install 指令碼](core/tools/dotnet-install-script.md)
### 專案修改命令
#### 參考
...
### [.NET Core 無法使用 .NET Framework 技術](core/porting/net-framework-tech-unavailable.md)
...
### [C# 簡介](csharp/tutorials/intro-to-csharp/index.md)
#### [Hello world](csharp/tutorials/intro-to-csharp/hello-world.yml)
#### [C# 中的數字](csharp/tutorials/intro-to-csharp/numbers-in-csharp.yml)
#### [分支和迴圈](csharp/tutorials/intro-to-csharp/branches-and-loops.yml)
#### [字串內插補點](csharp/tutorials/intro-to-csharp/interpolated-strings.yml)
#### [List 集合](csharp/tutorials/intro-to-csharp/list-collection.yml)
#### [在您的本機環境中執行](csharp/tutorials/intro-to-csharp/local-environment.md)
##### [C# 中的數字](csharp/tutorials/intro-to-csharp/numbers-in-csharp-local.md)
##### [分支和迴圈](csharp/tutorials/intro-to-csharp/branches-and-loops-local.md)
##### [字串內插補點](csharp/tutorials/intro-to-csharp/interpolated-strings-local.md)
##### [List 集合](csharp/tutorials/intro-to-csharp/arrays-and-collections.md)
...
### [將應用程式升級為可為 Null 的參考型別](csharp/tutorials/upgrade-to-nullable-references.md)
### [產生及使用非同步資料流](csharp/tutorials/generate-consume-asynchronous-stream.md)
### [使用模式比對來延伸資料功能](csharp/tutorials/pattern-matching.md)
...
### [字串內插補點](csharp/tutorials/string-interpolation.md)
### [使用屬性](csharp/tutorials/attributes.md)
...
### [版本和更新考量](csharp/whats-new/version-update-considerations.md)
<!-- End What's New -->
## C# 概念
...
### [可為 Null 的參考類型](csharp/nullable-references.md)
...
### [使用 `String.Split` 來剖析字串](csharp/how-to/parse-strings-using-split.md)
### [串連字串](csharp/how-to/concatenate-multiple-strings.md)
### [將字串轉換成 DateTime](standard/base-types/parsing-datetime.md)
### [搜尋字串](csharp/how-to/search-strings.md)
### [修改字串內容](csharp/how-to/modify-string-contents.md)
### [比較字串](csharp/how-to/compare-strings.md)
### [安全地使用模式比對進行轉換，is 和 as 運算子](csharp/how-to/safely-cast-using-pattern-matching-is-and-as-operators.md)
...
### [安裝 F#](fsharp/get-started/install-fsharp.md)
### [開始使用 Visual Studio 中的 F#](fsharp/get-started/get-started-visual-studio.md)
### [開始使用 Visual Studiof for Mac 中的 F#](fsharp/get-started/get-started-with-visual-studio-for-mac.md)
### [開始使用 Visual Studio Code 和 Ionide 中的 F#](fsharp/get-started/get-started-vscode.md)
### [搭配 F# 開始使用 .NET Core CLI](fsharp/get-started/get-started-command-line.md)

## [F# 是什麼](fsharp/what-is-fsharp.md)
## [F# 的教學課程](fsharp/tour.md)

## 教學課程
### [函數式程式設計簡介](fsharp/introduction-to-functional-programming/index.md)
#### [第一類函式](fsharp/introduction-to-functional-programming/first-class-functions.md)
### 非同步和並行程式設計
#### [非同步程式設計](fsharp/tutorials/asynchronous-and-concurrent-programming/async.md)
### [類型提供者](fsharp/tutorials/type-providers/index.md)
#### [建立型別提供者](fsharp/tutorials/type-providers/creating-a-type-provider.md)
...
### [基本類型](fsharp/language-reference/basic-types.md)
...
### [延遲運算式](fsharp/language-reference/lazy-expressions.md)
...
### [F# Interactive 選項](fsharp/language-reference/fsharp-interactive-options.md)
...
##### [如何：非同步地呼叫 Web 服務](visual-basic/developing-apps/programming/how-to-call-a-web-service-asynchronously.md)
...
#### [元組](visual-basic/programming-guide/language-features/data-types/tuples.md)
...
### [資料類型摘要](visual-basic/language-reference/data-types/index.md)
...
#### [模組](visual-basic/language-reference/modifiers/module-keyword.md)
...
##### [< 運算子](visual-basic/language-reference/operators/comparison-operators.md)
##### [<= 運算子](visual-basic/language-reference/operators/comparison-operators.md)
##### [> 運算子](visual-basic/language-reference/operators/comparison-operators.md)
##### [>= 運算子](visual-basic/language-reference/operators/comparison-operators.md)
...
##### [?() 運算子](visual-basic/language-reference/operators/null-conditional-operators.md)
##### [?.運算子](visual-basic/language-reference/operators/null-conditional-operators.md)
...
#### [要求的作業無法使用 (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
### [電影推薦 (建議)](machine-learning/tutorials/movie-recommmendation.md)
...
## 參考資料
### [API 參考](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
...
### [資料轉換](machine-learning/resources/transforms.md)
