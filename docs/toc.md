...
### [.NET Core 版本歷程記錄](core/versions/version-history.md)
...
#### [此機碼已經和此集合的項目建立關聯](visual-basic/language-reference/error-messages/this-key-is-already-associated-with-an-element-of-this-collection.md)
...
### [鸢尾花花瓣 (叢集)](machine-learning/tutorials/iris-clustering.md)
