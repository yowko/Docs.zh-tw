...
#### [<message> 此錯誤也可能是因為混用了檔案參考和組件 '<assemblyname>' 的專案參考](visual-basic/language-reference/error-messages/message-this-error-could-also-be-due-to-mixing-a-file-reference.md)
...
#### [運算子宣告必須是下列其中一個：+、-、*、-、-、^、&、Like、Mod、And、Or、Xor、Not、<<、>>、=、<>、<、<=、>、>=、CType、IsTrue、IsFalse](visual-basic/language-reference/error-messages/operator-declaration-must-be-one-of.md)
