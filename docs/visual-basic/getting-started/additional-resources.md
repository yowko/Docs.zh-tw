...
|[Visual Studio 問題](https://aka.ms/feedback/report?space=61)|可讓您提報 .NET 和 Visual Studio 相關的錯誤給 Microsoft，或提供建議。 您也可以藉由選取 [說明 **Help**  >  **傳送**  >  Visual Studio 中 **的** 意見反應回報問題] 來回報 bug。|
