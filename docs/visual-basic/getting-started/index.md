...
- [範例](https://github.com/dotnet/samples/tree/master/snippets/visualbasic)\
...
- [C#](../../csharp/index.md)\
提供利用 Visual C# 進行應用程式開發的相關文件連結。

- [Visual C++](/cpp/)\
提供 Visual C++ 文件的連結。

- [Office 和 SharePoint 程式開發](/visualstudio/vsto/office-and-sharepoint-development-in-visual-studio)\
