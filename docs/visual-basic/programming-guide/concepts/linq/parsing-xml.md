...
|[如何：建立樹狀結構從 XmlReader (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-create-a-tree-from-an-xmlreader.md)|顯示如何從 <xref:System.Xml.XmlReader> 直接建立 XML 樹狀結構。|  
