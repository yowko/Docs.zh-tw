...
---
# <a name="how-to-project-a-new-type-linq-to-xml-visual-basic"></a>HOW TO：投影新類型 (LINQ to XML) (Visual Basic)
...
```  
 ...
 此範例會使用以下主題所引進的 `M:System.Xml.Linq.XElement.Element` 方法：[如何：擷取單一子項目 (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-retrieve-a-single-child-element-linq-to-xml.md)。 它也會使用轉換以擷取 `M:System.Xml.Linq.XElement.Element` 方法所傳回的元素值。  
