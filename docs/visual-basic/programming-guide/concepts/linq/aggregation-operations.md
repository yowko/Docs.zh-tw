...
---
# <a name="aggregation-operations-visual-basic"></a> (Visual Basic) 的匯總作業
...
### <a name="average"></a>平均  
 ...
 下列程式碼範例使用 `Aggregate Into Average` Visual Basic 中的子句來計算代表溫度之數位陣列中的平均溫度。  
  
 [!code-vb[CsLINQAggregating#1](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/CsLINQAggregating/VB/Aggregating.vb#1)]  
  
### <a name="count"></a>Count  

 下列程式碼範例 `Aggregate Into Count` 會在 Visual Basic 中使用子句來計算陣列中大於或等於80的值數目。  
...
### <a name="max"></a>最大值  
 ...
 下列程式碼範例使用 `Aggregate Into Max` 子句來計算代表溫度之數位陣列中的最大溫度。  
  
 [!code-vb[CsLINQAggregating#4](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/CsLINQAggregating/VB/Aggregating.vb#4)]  
  
### <a name="min"></a>最小值  

 下列程式碼範例使用 `Aggregate Into Min` 子句來計算代表溫度之數位陣列中的最小溫度。  
  
 [!code-vb[CsLINQAggregating#5](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/CsLINQAggregating/VB/Aggregating.vb#5)]  
  
### <a name="sum"></a>Sum  

 下列程式碼範例使用 `Aggregate Into Sum` 子句來計算代表費用之值陣列的總費用金額。  
