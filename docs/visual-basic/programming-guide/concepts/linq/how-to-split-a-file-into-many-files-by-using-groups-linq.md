...
---
# <a name="how-to-split-a-file-into-many-files-by-using-groups-linq-visual-basic"></a>如何︰ 使用群組 (LINQ) (Visual Basic)，將檔案分割成許多檔案
這個範例會示範一種方式合併兩個檔案的內容，然後再建立一組新的方式組織資料的新檔案。  
...
2.  將資料複製這些名稱到名為 names2.txt 的文字檔，並將它儲存到專案資料夾中︰ 請注意，兩個檔案有一些通用名稱。  
