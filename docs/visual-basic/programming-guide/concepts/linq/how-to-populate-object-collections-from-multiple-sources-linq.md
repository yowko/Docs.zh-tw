...
- 將 names.csv 和 scores.csv 檔案複製到您的專案資料夾中，如[如何：聯結從不同的檔案 (LINQ) (Visual Basic) 的內容](../../../../visual-basic/programming-guide/concepts/linq/how-to-join-content-from-dissimilar-files-linq.md)。
