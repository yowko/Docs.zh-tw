...
|主題|描述|  
|-----------|-----------------|  
|[概念和術語 （函數式轉換） (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/concepts-and-terminology-functional-transformation.md)|說明純功能性轉換的概念與術語。|  
...
|[函數式轉換 (Visual Basic) 的適用性](../../../../visual-basic/programming-guide/concepts/linq/applicability-of-functional-transformation.md)|描述功能性轉換的典型案例。|  
