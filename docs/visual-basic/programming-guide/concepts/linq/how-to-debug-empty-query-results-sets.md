...
---
# <a name="how-to-debug-empty-query-results-sets-visual-basic"></a>作法：Debug 空的查詢結果集 (Visual Basic)
...
如需詳細資訊, 請參閱[使用 XML 命名空間 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/working-with-xml-namespaces.md)。
