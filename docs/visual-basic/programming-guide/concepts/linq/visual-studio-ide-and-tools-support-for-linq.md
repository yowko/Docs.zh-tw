...
## <a name="object-relational-designer"></a>Object Relational Designer  
 物件關聯式設計工具是視覺化設計工具，可用於[LINQ to SQL](../../../../../docs/framework/data/adonet/sql/linq/index.md)產生 Visual Basic 中的類別代表基礎資料庫中的之關聯式資料的應用程式。 如需詳細資訊，請參閱 [Visual Studio 中的 LINQ to SQL 工具](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)。  
...
## <a name="linq-aware-code-editor"></a>可感知 LINQ 的程式碼編輯器  
 Visual Basic 程式碼編輯器支援 LINQ 廣泛使用 IntelliSense 和格式化功能。  
