...
## <a name="object-relational-designer"></a>Object Relational Designer  
 ...
 物件關聯式設計工具是一種視覺化設計工具，可讓您在 [LINQ to SQL](../../../../framework/data/adonet/sql/linq/index.md) 的應用程式中，用來產生 Visual Basic 中代表基礎資料庫中之關聯式資料的類別。 如需詳細資訊，請參閱 [Visual Studio 中的 LINQ to SQL 工具](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)。  
...
## <a name="linq-aware-code-editor"></a>可感知 LINQ 的程式碼編輯器  
 ...
 Visual Basic 程式碼編輯器透過 IntelliSense 和格式化功能，廣泛支援 LINQ。  
