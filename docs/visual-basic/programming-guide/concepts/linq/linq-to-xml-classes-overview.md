...
### <a name="xattribute-class"></a>XAttribute 類別  
 <xref:System.Xml.Linq.XAttribute> 代表 XML 屬性。 如需詳細資訊和範例，請參閱[System.xml.linq.xattribute> 類別總覽（Visual Basic）](xattribute-class-overview.md)。  
...
### <a name="xdocument-class"></a>XDocument 類別  
 <xref:System.Xml.Linq.XDocument> 代表 XML 文件。 如需詳細資訊和範例，請參閱[XDocument 類別總覽（Visual Basic）](xdocument-class-overview.md)。  
...
### <a name="xelement-class"></a>XElement 類別  
 <xref:System.Xml.Linq.XElement> 代表 XML 項目。 如需詳細資訊和範例，請參閱[System.xml.linq.xelement> 類別總覽（Visual Basic）](xelement-class-overview.md)。  
  
### <a name="xname-class"></a>XName 類別  
 <xref:System.Xml.Linq.XName> 代表項目的名稱 (<xref:System.Xml.Linq.XElement>) 與屬性 (<xref:System.Xml.Linq.XAttribute>)。 如需詳細資訊和範例，請參閱[XDocument 類別總覽（Visual Basic）](xdocument-class-overview.md)。  
