...
|[在 Visual Basic (LINQ to XML) 的整合語言的軸心方法](../../../../visual-basic/programming-guide/concepts/linq/language-integrated-axes.md)|摘要說明[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]整合軸。|  
