...
4.  將您的組件新增至全域組件快取。 如需詳細資訊，請參閱[＜How to：將組件安裝到全域組件快取](../../../../framework/app-domains/how-to-install-an-assembly-into-the-gac.md)。  
  
5.  從其他應用程式存取組件內含的類型。 如需詳細資訊，請參閱[＜How to：參考強式名稱組件](../../../../framework/app-domains/how-to-reference-a-strong-named-assembly.md)。  
