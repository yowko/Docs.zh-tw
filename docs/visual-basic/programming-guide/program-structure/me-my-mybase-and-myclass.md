...
`Me``My`， `MyBase`，和`MyClass`中[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]有類似的名稱，但不同的用途。 本主題會描述每個實體以加以區別。  
...
## <a name="my"></a>My  
 `My`功能可讓您容易、 淺顯易懂的存取數目[!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)]類別，啟用[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]使用者互動的電腦、 應用程式、 設定、 資源和等等。  
