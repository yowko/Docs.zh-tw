...
- 撰寫包含存取規範、`Const` 關鍵字和運算式的宣告，如下列範例所示：  
     ...
     當[Option 推斷](../../../../visual-basic/language-reference/statements/option-infer-statement.md)為 `Off`，且[option Strict](../../../../visual-basic/language-reference/statements/option-strict-statement.md)為 `On` 時，您必須指定資料類型（`Boolean`、`Byte`、`Char`、`DateTime`、`Decimal`、`Double`、0，明確地宣告常數。、1、2、3 或 4）。  
