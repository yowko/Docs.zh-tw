...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 提供「*字元資料型別*」\(Character Data Type\) 來處理可列印及可顯示的字元。  雖然 `Char` 和 `String` 都可以處理 Unicode 字元，但前者只能存放單一字元，而後者可包含任何數目的字元。  
