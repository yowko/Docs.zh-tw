...
## 字元常值會產生編譯器錯誤  
 在有任何型別字元缺少的情況下，[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 會假設常值的預設資料型別。  字元常值的預設型別為 `String`，此預設型別會放在引號 \(`" "`\) 之中。  
