...
## <a name="in-this-section"></a>本節內容  
 [如何：驗證檔案名稱和 Visual Basic 中的路徑](../../../../visual-basic/programming-guide/language-features/strings/how-to-validate-file-names-and-paths.md)  
 如何判斷字串是否表示的檔案名稱或路徑。  
 ...
 [使用規則運算式與 MaskedTextBox 控制項，在 Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/using-regular-expressions-with-the-maskedtextbox-control.md)  
