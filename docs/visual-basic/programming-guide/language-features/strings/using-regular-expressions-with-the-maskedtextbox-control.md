...
## 遮罩語言說明  
 標準的 <xref:System.Windows.Forms.MaskedTextBox> 遮罩語言是以 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 6.0 之 `Masked Edit` 控制項中所使用的同一遮罩語言為基礎，對於從該平台移轉過來的使用者而言應該不陌生。  
