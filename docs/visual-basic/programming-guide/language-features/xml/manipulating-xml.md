...
您可以使用*XML 常值*從外部來源，例如字串、 檔案或資料流載入 XML。 然後您可以使用[!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)]操作 XML，並使用[!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext_md.md)]來查詢 XML。  
...
## <a name="in-this-section"></a>本章節內容  
 ...
 示範如何在 xml 載入<xref:System.Xml.Linq.XDocument>或<xref:System.Xml.Linq.XElement>從文字檔案、 字串或資料流的物件。</xref:System.Xml.Linq.XElement> </xref:System.Xml.Linq.XDocument>  
  
 [如何：使用 LINQ 轉換 XML](../../../../visual-basic/programming-guide/language-features/xml/how-to-transform-xml-by-using-linq.md)  
 示範如何將轉換的內容<xref:System.Xml.Linq.XDocument>物件插入新的 XML 文件。</xref:System.Xml.Linq.XDocument>  
  
 [如何：修改 XML 常值](../../../../visual-basic/programming-guide/language-features/xml/how-to-modify-xml-literals.md)  
 示範如何修改項目、 屬性和 XML 常值中的值。  
...
## <a name="related-sections"></a>相關章節  
 ...
 示範如何存取 XML 項目或在 Visual Basic 中的文件的部分。  
