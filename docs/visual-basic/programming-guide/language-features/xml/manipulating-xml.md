...
您可以使用「*XML 常值*」\(XML Literal\) 從外部來源 \(例如字串、檔案或資料流\) 載入 XML。  接著可使用 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] 管理 XML，以及使用 [!INCLUDE[vbteclinqext](../../../../csharp/programming-guide/concepts/linq/includes/vbteclinqext_md.md)] 查詢 XML。  
