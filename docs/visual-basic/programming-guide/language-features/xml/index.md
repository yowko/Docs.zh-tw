...
|主題|說明|  
|-----------|-----------------|  
|[Visual Basic 中的 LINQ to XML 概觀](../../../../visual-basic/programming-guide/language-features/xml/overview-of-linq-to-xml.md)|說明 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 如何支援 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]。|  
