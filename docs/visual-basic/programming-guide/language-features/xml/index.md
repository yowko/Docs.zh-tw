...
ms.locfileid: "33653672"
---
# <a name="xml-in-visual-basic"></a>Visual Basic 中的 XML

Visual Basic 提供整合式的語言支援，讓它能夠與互動[!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]。  
...
|主題|描述|  
|-----------|-----------------|  
|[Visual Basic 中的 LINQ to XML 概觀](../../../../visual-basic/programming-guide/language-features/xml/overview-of-linq-to-xml.md)|描述 Visual Basic 的支援方式[!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]。|  
