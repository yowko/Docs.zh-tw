...
|[How to: Embed Expressions in XML Literals](../Topic/How%20to:%20Embed%20Expressions%20in%20XML%20Literals%20\(Visual%20Basic\).md)|說明如何在 XML 常值中使用內嵌運算式建立執行階段的內容。|  
