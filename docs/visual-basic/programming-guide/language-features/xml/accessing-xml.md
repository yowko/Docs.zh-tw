...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 提供 XML 軸屬性以存取及巡覽 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)] 結構。  這些屬性使用特殊語法，可讓您經由指定 XML 名稱，存取項目和屬性 \(Attribute\)。  
  
 下表列出可以讓您存取 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 中 XML 項目和屬性的語言功能。  
...
## 相關章節  
 ...
 提供在 Visual Basic 中使用 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)] 的簡介。  
 ...
 提供說明如何在 Visual Basic 中使用 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)] 的章節連結。