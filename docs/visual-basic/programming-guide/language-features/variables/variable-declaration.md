...
```  
 ...
 如需資料型別的詳細資訊，請參閱 [資料類型](../../../../visual-basic/reference/command-line-compiler/index.md)。  如需物件的詳細資訊，請參閱 [Objects and Classes](../../../../visual-basic/reference/command-line-compiler/index.md)和[使用元件進行程式設計](../Topic/Programming%20with%20Components.md)。  
...
## 請參閱  
 [How to: Create a New Variable](../Topic/How%20to:%20Create%20a%20New%20Variable%20\(Visual%20Basic\).md)   
