...
##  <a name="HowToAndWalkthroughTopics"></a> 如何和逐步解說主題  
 ...
 [How to: Filter Query Results](../Topic/How%20to:%20Filter%20Query%20Results%20by%20Using%20LINQ%20\(Visual%20Basic\).md)  
 ...
 [How to: Find the Minimum or Maximum Value in a Query Result](../Topic/How%20to:%20Find%20the%20Minimum%20or%20Maximum%20Value%20in%20a%20Query%20Result%20by%20Using%20LINQ%20\(Visual%20Basic\).md)  
