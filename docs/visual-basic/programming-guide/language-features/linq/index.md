...
本章節包含可協助您了解和使用 Visual Basic 與 [!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext-md.md)] 的概觀、範例及背景資訊。  
  
## 在本節中  
 [Introduction to LINQ in Visual Basic](../../../../visual-basic/programming-guide/language-features/linq/introduction-to-linq.md)  
 提供 [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)] 提供者、運算子、查詢結構及語言功能的簡介。  
