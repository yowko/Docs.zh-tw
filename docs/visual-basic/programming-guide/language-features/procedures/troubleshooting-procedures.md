...
## <a name="argument-not-being-modified-by-procedure-call"></a>程序呼叫未修改引數
 ...
 **正確的方法：** 若要能夠修改基礎變數元素本身，請以傳址方式傳遞它。 下列範例顯示 `replace` 之宣告中的變更，讓它能夠在呼叫程式碼中以另一個陣列取代其中一個陣列。
...
## <a name="calling-a-wrong-version-of-an-overloaded-procedure"></a>呼叫錯誤的多載程式版本
