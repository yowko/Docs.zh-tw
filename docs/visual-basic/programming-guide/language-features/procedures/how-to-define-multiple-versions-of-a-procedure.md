...
3.  在每個宣告陳述式後面，撰寫程序程式碼以處理特定情況，在該情況中呼叫程式碼會提供與該版本之參數清單相符的引數。  您不必測試呼叫程式碼所提供的參數。  [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 會將控制權傳遞給符合的程序版本。  
