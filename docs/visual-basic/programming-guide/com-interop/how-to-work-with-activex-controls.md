...
- [HOW TO：將 ActiveX 控制項新增至 Windows Forms](../../../framework/winforms/controls/how-to-add-activex-controls-to-windows-forms.md)
- [Aximp.exe (Windows Form ActiveX 控制項匯入工具)](../../../framework/tools/aximp-exe-windows-forms-activex-control-importer.md)
