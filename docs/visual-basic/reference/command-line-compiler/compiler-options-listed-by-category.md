...
|`-checksumalgorithm:<alg>`|指定用於計算儲存在 PDB 的來源檔案總和檢查碼的演算法。  支援的值為：SHA1 (預設值) 或 SHA256。 <br>Due to collision problems with SHA1, Microsoft recommends SHA256 or better.|  
