...
## <a name="remarks"></a>備註  
 使用此選項時，應用程式會受到 Windows Vista 上的虛擬化除非您提供的 Win32 資源檔案或更新版本的組建步驟期間的應用程式資訊清單。 如需虛擬化的詳細資訊，請參閱[Windows Vista 的 ClickOnce 部署](https://docs.microsoft.com/visualstudio/deployment/clickonce-deployment-on-windows-vista)。  
