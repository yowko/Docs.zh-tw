...
## <a name="arguments"></a>引數  
 `+` &#124; `-`  
 選擇性。 如果要完整簽署組件，請使用 `-delaysign-`。 使用`-delaysign+`如果您想要將公開金鑰放入帶正負號的雜湊的組件和保留空間。 預設值為 `-delaysign-`。  
...
### <a name="to-set--delaysign-in-the-visual-studio-integrated-development-environment"></a>在 Visual Studio 整合式的開發環境中設定-delaysign  
