...
`+` &#124; `-`  
選擇性。 如果要完整簽署組件，請使用 `-delaysign-`。 如果`-delaysign+`您想要將公開金鑰放在元件中，並為帶正負號的雜湊保留空間，請使用。 預設值為 `-delaysign-`。

## <a name="remarks"></a>備註

除非`-delaysign`搭配[-keyfile](../../../visual-basic/reference/command-line-compiler/keyfile.md)或[-keycontainer](../../../visual-basic/reference/command-line-compiler/keycontainer.md)使用，否則選項不會有任何作用。
