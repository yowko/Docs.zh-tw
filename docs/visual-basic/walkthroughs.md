...
逐步解說提供通用案例的逐步解說，是開始學習產品或特定功能區域的最佳入門。  
 ...
 使用 [非同步](../visual-basic/language-reference/modifiers/async.md) 和 [等候](../visual-basic/language-reference/operators/await-operator.md)，顯示如何建立非同步的方案，在 [!INCLUDE[vs_dev11_long](../csharp/programming-guide/classes-and-structs/includes/vs_dev11_long_md.md)]中引入。  
 ...
 示範如何使用 Visual Basic 語言功能來撰寫 [!INCLUDE[vbteclinqext](../csharp/programming-guide/concepts/linq/includes/vbteclinqext_md.md)] 查詢運算式。  
 ...
 [呼叫 Windows API](../Topic/Walkthrough:%20Calling%20Windows%20APIs%20\(Visual%20Basic\).md)  
 ...
 [變更 My.Application.Log 寫入資訊的位置](../Topic/Walkthrough:%20Changing%20Where%20My.Application.Log%20Writes%20Information%20\(Visual%20Basic\).md)  
