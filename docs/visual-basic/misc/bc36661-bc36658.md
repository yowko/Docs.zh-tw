...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-typename-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>中的擴充方法的型別參數的資料類型 '&lt;methodname&gt;' 定義無法從這些引數推斷在 'typename'，因為它們不會轉換成相同的類型
