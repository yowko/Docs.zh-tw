...
條件約束清單同時包含 [Class (Visual Basic)](../language-reference/statements/class-statement.md) 條件約束和 [Structure (Visual Basic)](../language-reference/statements/structure-statement.md) 條件約束。  
