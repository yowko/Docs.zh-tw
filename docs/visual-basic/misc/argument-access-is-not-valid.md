...
ms.locfileid: "61666336"
---
# <a name="argument-access-is-not-valid-valid-values-for-output-mode-are-openaccesswrite-and-openaccessdefault"></a>引數 'Access' 無效。 Output 模式的有效值是 'OpenAccess.Write' 和 'OpenAccess.Default'
存取值在 Output 模式中無效。  
