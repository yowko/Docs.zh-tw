...
---
# <a name="type1-membername-shadows-an-overloadable-member-declared-in-the-base-type2-classname"></a>\<type1>' \<membername> ' 遮蔽了在基底 \<type2> ' ' 中宣告的可多載成員 \<classname>

\<type1> ' \<membername> ' 遮蔽基底中宣告的可多載成員 \<type2> \<classname> 。 如果您要多載基底方法，必須將這個方法宣告為 'Overloads'。  
