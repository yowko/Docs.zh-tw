...
---
# <a name="parameter-parametername-in-extension-method-methodname-defined-in-typename-already-has-a-matching-omitted-argument"></a>' @No__t-2typename > ' 中所定義擴充方法 ' \<methodname > ' 中的參數 ' @no__t 0parametername > '，已有相符的省略引數
