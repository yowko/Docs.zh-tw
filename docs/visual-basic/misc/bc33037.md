...
---
# <a name="cannot-copy-the-value-of-byref-parameter-parametername-back-to-the-matching-argument-because-type-typename1-cannot-be-converted-to-type-typename2"></a>無法複製 'ByRef' 參數的值 '\<參數名稱 >' 回相符引數，因為類型'\<typename1 >' 無法轉換為類型 '\<2&gt >'
