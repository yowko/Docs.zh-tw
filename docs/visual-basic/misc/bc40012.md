...
---
# <a name="event-eventname-implicitly-declares-membername-which-conflicts-with-a-member-in-the-base-type-classname-and-so-the-event-should-be-declared-shadows"></a>事件 ' \<eventname> ' 隱含宣告 ' \<membername> '，其與基底 ' ' 中的成員相衝突 \<type> \<classname> ，因此事件應該宣告為 ' Shadows '
