...
---
# <a name="member-ltmembername1gt-conflicts-with-a-member-implicitly-declared-for-member-ltmembername2gt-in-the-base-type-ltbasetypenamegt-and-so-should-not-be-declared-overloads"></a>成員 '&lt;1&gt&gt;'的成員互相衝突所隱含宣告成員'&lt;成員名稱 2>&gt;'中的基底類型'&lt;基&gt;'，因此不應該宣告為'多載 '
