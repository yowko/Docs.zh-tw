...
---
# <a name="data-types-of-the-type-parameters-in-method-ltmethodnamegt-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>型別參數，在方法中的資料類型 '&lt;methodname&gt;' 無法從這些引數推斷，因為它們無法轉換成相同的類型
