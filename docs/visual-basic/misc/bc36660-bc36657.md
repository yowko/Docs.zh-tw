...
---
# <a name="data-types-of-the-type-parameters-in-method-39ltmethodnamegt39-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>在方法 &#39; 型別參數的資料類型&lt;methodname&gt;&#39; 無法從這些引數推斷，因為它們無法轉換成相同的類型
