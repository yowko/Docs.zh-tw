...
---
# <a name="member-membername-implicitly-defines-a-member-implicitmembername-which-has-the-same-name-as-a-type-parameter"></a>成員 '\<membername>' 會隱含定義成員 '\<implicitmembername>'，該成員與類型參數擁有相同的名稱
