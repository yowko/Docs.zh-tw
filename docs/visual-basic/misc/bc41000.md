...
---
# <a name="attribute-ltattributenamegt-cannot-be-specified-more-than-once-in-this-project-even-with-identical-parameter-values"></a>屬性 '&lt;attributename&gt;' 不能指定這個專案，即使是使用相同的參數值中的一次以上
