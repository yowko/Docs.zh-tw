---
title: 引數的值 '&lt;pathname&gt;' 包含不是有效的路徑名稱的字元
ms.date: 07/20/2015
f1_keywords:
...
ms.locfileid: "54530888"
---
# <a name="argument-value-ltpathnamegt-contains-characters-that-are-not-valid-in-a-path-name"></a>引數的值 '&lt;pathname&gt;' 包含不是有效的路徑名稱的字元
路徑名稱包含一個或多個無效字元。  
