...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-use-the-isnot-operator-to-test-object-identity"></a>對運算子使用了 Object 類型的運算元 '&lt;符號&gt;'; 使用 'IsNot' 運算子測試物件識別
