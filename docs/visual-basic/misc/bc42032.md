...
---
# <a name="operands-of-type-object-used-for-operator-operatorsymbol-use-the-isnot-operator-to-test-object-identity"></a>供運算子 '\<operatorsymbol>' 使用的類型 Object 的運算元；請使用 'IsNot' 運算子測試物件識別
運算式會搭配使用 `<>` 運算子與 [Object Data Type](../language-reference/data-types/object-data-type.md)的一個或兩個運算元。  
