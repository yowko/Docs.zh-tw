...
---
# <a name="extension-method-methodname-defined-in-typename-does-not-have-the-same-signature-as-delegate-delegatename"></a>' ' 中定義的擴充方法 ' ' 沒有與 \<methodName> \<typeName> 委派 ' ' 相同的簽 \<delegateName> 章
