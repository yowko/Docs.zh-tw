---
title: "VbStrConv.Wide VbStrConv.Narrow 並不適用於指定的地區設定 |Microsoft 文件"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="vbstrconvwide-and-vbstrconvnarrow-are-not-applicable-to-the-locale-specified"></a>VbStrConv.Wide 和 VbStrConv.Narrow 不適用於指定的地區設定
