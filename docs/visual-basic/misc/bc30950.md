...
---
# <a name="no-accessible-method-ltprocedurenamegt-has-a--signature-compatible-with-delegate-ltdelegatenamegtltsuberrorlistgt"></a>沒有可存取的方法 '&lt;程序名稱&gt;'具有與委派相容的簽章'&lt;委派名稱&gt;':&lt;次要錯誤清單&gt;
