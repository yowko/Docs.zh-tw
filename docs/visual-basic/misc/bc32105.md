...
---
# <a name="type-argument-lttypeargumentnamegt-does-not-satisfy-the-structure-constraint-for-type-parameter-lttypeparameternamegt"></a>類型引數 '&lt;型&gt;'不符合類型參數的 'Structure' 條件約束'&lt;型別參數名稱&gt;'
