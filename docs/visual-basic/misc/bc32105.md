...
---
# <a name="type-argument-typeargumentname-does-not-satisfy-the-structure-constraint-for-type-parameter-typeparametername"></a>類型引數 ' \<typeargumentname> ' 不符合類型參數 ' ' 的 ' Structure ' 條件約束 \<typeparametername>
