...
---
# <a name="option-strict-on-disallows-implicit-conversions-from-39lttype1gt39-to-39lttype2gt39"></a>Option Strict On 不允許進行的隱含轉換 &#39;&lt;type1&gt;&#39; 加入 &#39;&lt;type2&gt;&#39;
...
1.  判斷是否有從 `<type1>` 到 `<type2>`的任何類型轉換。 如果兩者都是 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 基礎類型，或兩者都是類別的執行個體，則您通常可以參閱 [Widening and Narrowing Conversions](../../visual-basic/programming-guide/language-features/data-types/widening-and-narrowing-conversions.md)。  
