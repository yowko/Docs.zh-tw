...
---
# <a name="ltclassnamegt-is-not-cls-compliant-because-it-derives-from-ltbaseclassnamegt-which-is-not-cls-compliant"></a>'&lt;classname&gt;'不符合 CLS 標準因為其衍生自'&lt;基&gt;'，但不符合 CLS 規範
