...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>'\<variablename>' 的類型模稜兩可，因為迴圈繫結和 step 變數不會擴展為相同類型
