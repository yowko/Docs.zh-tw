...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>"變數名稱\<>"的類型不明確，因為迴圈邊界和步驟變數不會擴展到同一類型
