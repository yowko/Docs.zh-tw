...
---
# <a name="type-of-39ltvariablenamegt39-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>類型 &#39;&lt;variablename&gt;&#39; 模稜兩可，因為迴圈繫結和 step 變數不會擴展為相同的型別
