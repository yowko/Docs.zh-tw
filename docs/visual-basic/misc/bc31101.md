...
屬性宣告會指定[屬性語句](../language-reference/statements/property-statement.md)、 [Get 語句](../language-reference/statements/get-statement.md)和[Set 語句](../language-reference/statements/set-statement.md)中的存取層級。  
