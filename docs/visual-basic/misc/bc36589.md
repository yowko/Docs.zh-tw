...
---
# <a name="type-parameter-typeparametername-for-extension-method-methodname-defined-in-typename-cannot-be-inferred"></a>無法推斷在 '\<typename>' 中定義之擴充方法 '\<methodname>' 的類型參數 '\<typeparametername>'
