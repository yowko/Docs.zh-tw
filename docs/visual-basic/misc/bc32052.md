...
型別參數做為運算元[Is 運算子](../../visual-basic/language-reference/operators/is-operator.md)型別參數當定義但沒有[Class (Visual Basic)](https://msdn.microsoft.com/library/0777c6e6-46bc-451b-ad70-57b49d4ef4f7)關鍵字或其條件約束清單中的特定類別名稱。  
