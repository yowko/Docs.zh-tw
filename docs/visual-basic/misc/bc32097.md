...
如果定義類型參數，但其條件約束清單中沒有 [Class (Visual Basic)](../../visual-basic/language-reference/operators/isnot-operator.md) 關鍵字或特定類別名稱，則類型參數是作為 [IsNot Operator](http://msdn.microsoft.com/en-us/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) 的運算元。  
