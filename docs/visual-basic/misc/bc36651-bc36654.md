...
---
# <a name="data-types-of-the-type-parameters-in-method-ltmethodnamegt-cannot-be-inferred-from-these-arguments-because-more-than-one-type-is-possible"></a>型別參數，在方法中的資料類型 '&lt;methodname&gt;' 無法從這些引數推斷，因為可能會有一個以上的類型
