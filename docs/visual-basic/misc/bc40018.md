...
---
# <a name="member-membername1-implicitly-declares-implicitmembername-which-conflicts-with-a-member-implicitly-declared-for-member-membername2-in-the-base-class-baseclassname"></a>成員 ' \<membername1> ' 隱含宣告 ' \<implicitmembername> '，其與 \<membername2> 基類 ' ' 中為成員 ' ' 所隱含宣告的成員相 \<baseclassname> 衝突
成員 ' \<membername1> ' 隱含宣告 ' \<implicitmembername> '，其與基類 ' ' 中為成員 ' ' 所隱含宣告的成員相衝突 \<membername2> \<baseclassname> 。 因此該成員應該宣告為 'Shadows'。  
