...
## 記錄訊息的位置  
 ...
 您可以藉由加入或變更電腦和應用程式的組態檔以覆寫預設行為。 如需詳細資訊，請參閱[逐步解說：變更 My.Application.Log 寫入資訊的位置](../Topic/Walkthrough:%20Changing%20Where%20My.Application.Log%20Writes%20Information%20\(Visual%20Basic\).md)。  
