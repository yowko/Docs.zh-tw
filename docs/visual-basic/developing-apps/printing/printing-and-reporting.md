---
title: "列印和報告 (Visual Basic) |Microsoft 文件"
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]提供列印和報告的數個的選項。 下列主題提供概觀和相關的文件列印和報告相關的連結。  
  
## <a name="in-this-section"></a>本章節內容  
 [PrintForm 元件](../../../visual-basic/developing-apps/printing/printform-component.md)  
 提供概觀，`PrintForm`元件，可讓列印表單的內容。  
