---
title: Visual Basic Power Packs 控制項
ms.date: 07/20/2015
helpviewer_keywords:
...
ms.locfileid: "44042240"
---
# <a name="visual-basic-power-packs-controls"></a>Visual Basic Power Packs 控制項

Visual Basic Power Packs 控制項是附加的 Windows Form 控制項。 Visual Studio 中並沒有包含它們。  您可以[下載這些](https://go.microsoft.com/fwlink/?LinkId=321343)，但它們會作為-不支援。  
