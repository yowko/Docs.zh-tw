...
- [自訂 My 中可用的物件](customizing-which-objects-are-available-in-my.md)  
 描述如何藉由設定`My`專案的\_MYTYPE 條件式編譯常數，來控制要啟用哪些物件。

## <a name="related-sections"></a>相關章節

- [使用 My 進行開發](../development-with-my/index.md)  
 描述預設`My`會在不同的專案類型中提供哪些物件。
