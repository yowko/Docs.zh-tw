---
title: "雜項運算子 (Visual Basic) |Microsoft 文件"
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
---
# <a name="miscellaneous-operators-visual-basic"></a>其他運算子 (Visual Basic)
以下是中定義的其他運算子[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]。  
