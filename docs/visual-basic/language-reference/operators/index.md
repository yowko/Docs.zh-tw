...
ms.locfileid: "49452517"
---
# <a name="operators-visual-basic"></a>運算子 (Visual Basic)
## <a name="in-this-section"></a>本節內容

 [在 Visual Basic 中的運算子優先順序](operator-precedence.md)  
  
 [依功能排列的運算子](operators-listed-by-functionality.md)  
 ...
 [邏輯/位元運算子](logical-bitwise-operators.md)  
