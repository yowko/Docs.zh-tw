...
## 範例  
 Lambda 運算式是許多 [!INCLUDE[vbteclinqext](../../../csharp/programming-guide/concepts/linq/includes/vbteclinqext_md.md)] 中之查詢運算子的基礎，能明確用於方法架構查詢中。  下列範例示範了典型的 [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq_md.md)] 查詢，緊跟著則將查詢轉譯為方法格式。  
