...
## <a name="format-requirements"></a>格式需求  
 ...
 You must enclose a `String` literal within quotation marks (`" "`). If you must include a quotation mark as one of the characters in the string, you use two contiguous quotation marks (`""`). 下列範例將說明這點。  
