...
## <a name="rules"></a>規則  
 **Declaration Context.** 您只能在模組層級使用 `WriteOnly`。 This means the declaration context for a `WriteOnly` property must be a class, structure, or module, and cannot be a source file, namespace, or procedure.  
