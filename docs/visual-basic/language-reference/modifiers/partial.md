...
> [!NOTE]
> Visual Basic 支援 *部分方法*，通常會在部分類別中執行。 如需詳細資訊，請參閱 [部分方法](../../programming-guide/language-features/procedures/partial-methods.md) 和 [Sub 語句](../statements/sub-statement.md)。  
...
|`Inherits`|選擇性。 請參閱 [繼承語句](../statements/inherits-statement.md)。|  
