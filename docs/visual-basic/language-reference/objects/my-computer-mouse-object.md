...
提供用於取得屬性的格式和本機電腦上安裝的滑鼠的組態資訊。  
  
## <a name="remarks"></a>備註  
 如需方法和屬性`My.Computer.Mouse`物件，請參閱<xref:Microsoft.VisualBasic.Devices.Mouse>。  
  
 如需詳細資訊，請參閱[存取滑鼠](../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-mouse.md)。  
