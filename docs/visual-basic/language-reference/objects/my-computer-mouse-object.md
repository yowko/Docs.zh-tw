...
## <a name="remarks"></a>備註  
 如需方法和 `My.Computer.Mouse` 物件屬性的資訊，請參閱 <xref:Microsoft.VisualBasic.Devices.Mouse>。  
  
 如需詳細資訊，請參閱 <<c0> [ 存取滑鼠](../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-mouse.md)。  
