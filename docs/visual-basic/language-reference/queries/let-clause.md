...
|詞彙|定義|  
|---|---|  
|`variable`|必要項。 An alias that can be used to reference the results of the supplied expression.|  
|`expression`|必要項。 An expression that will be evaluated and assigned to the specified variable.|  
