...
ms.locfileid: "61803243"
---
# <a name="error-saving-temporary-win32-resource-file-filename-error-message"></a>儲存暫存 Win32 資源檔時發生錯誤 '\<檔案名稱 >':\<錯誤訊息 >
...
1. 檢查引用的錯誤訊息，並參考主題[Al.exe](../../../framework/tools/al-exe-assembly-linker.md)。 如需進一步說明和建議。  
