...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 編譯器呼叫組件連結器 \(Al.exe，也稱為 Alink\) 使用資訊清單產生組件，連結器在建立組件的發出階段回報錯誤。  
...
6.  在 [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)] 中，加入您剛建立之檔案的 .NET Assembly 參考。  
