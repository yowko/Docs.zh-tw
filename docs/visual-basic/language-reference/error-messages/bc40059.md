...
---
# <a name="a-reference-was-created-to-embedded-interop-assembly-assembly1-because-of-an-indirect-reference-to-that-assembly-from-assembly-assembly2"></a>已建立內嵌 interop 元件 ' @no__t 0assembly1 > ' 的參考，因為該元件的間接參考來自元件 ' \<assembly2 > '
