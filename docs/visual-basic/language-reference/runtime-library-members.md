...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="bd608-102">Visual Basic 執行階段程式庫成員</span><span class="sxs-lookup"><span data-stu-id="bd608-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="bd608-103">`Microsoft.VisualBasic`命名空間包含類別、 模組、 常數和列舉型別構成 Visual Basic 執行階段程式庫。</span><span class="sxs-lookup"><span data-stu-id="bd608-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="bd608-104">這些程式庫成員提供程序、 屬性和您可以使用您的程式碼中的常數值。</span><span class="sxs-lookup"><span data-stu-id="bd608-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="bd608-105">每個模組和類別代表與特定類別的功能。</span><span class="sxs-lookup"><span data-stu-id="bd608-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="bd608-106">Microsoft.VisualBasic.Collection 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="bd608-107">Microsoft.VisualBasic.ComClassAttribute 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="bd608-108">Microsoft.VisualBasic.ControlChars Class</span><span class="sxs-lookup"><span data-stu-id="bd608-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="bd608-109">Microsoft.VisualBasic.Constants Class</span><span class="sxs-lookup"><span data-stu-id="bd608-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="bd608-110">Microsoft.VisualBasic.Conversion Module</span><span class="sxs-lookup"><span data-stu-id="bd608-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="bd608-111">Microsoft.VisualBasic.DateAndTime Module</span><span class="sxs-lookup"><span data-stu-id="bd608-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="bd608-112">Microsoft.VisualBasic.ErrObject 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="bd608-113">Microsoft.VisualBasic.FileSystem Module</span><span class="sxs-lookup"><span data-stu-id="bd608-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="bd608-114">Microsoft.VisualBasic.Financial 模組</span><span class="sxs-lookup"><span data-stu-id="bd608-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="bd608-115">Microsoft.VisualBasic.Globals Module</span><span class="sxs-lookup"><span data-stu-id="bd608-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="bd608-116">Microsoft.VisualBasic.HideModuleNameAttribute 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="bd608-117">Microsoft.VisualBasic.Information 模組</span><span class="sxs-lookup"><span data-stu-id="bd608-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="bd608-118">Microsoft.VisualBasic.Interaction 模組</span><span class="sxs-lookup"><span data-stu-id="bd608-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="bd608-119">Microsoft.VisualBasic.MyGroupCollectionAttribute 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="bd608-120">Microsoft.VisualBasic.Strings Module</span><span class="sxs-lookup"><span data-stu-id="bd608-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="bd608-121">Microsoft.VisualBasic.VBFixedArrayAttribute 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="bd608-122">Microsoft.VisualBasic.VBFixedStringAttribute 類別</span><span class="sxs-lookup"><span data-stu-id="bd608-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="bd608-123">Microsoft.VisualBasic.VbMath 模組</span><span class="sxs-lookup"><span data-stu-id="bd608-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="bd608-124">Microsoft.VisualBasic 常數和列舉類型</span><span class="sxs-lookup"><span data-stu-id="bd608-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="bd608-125">`Microsoft.VisualBasic`命名空間提供的 Visual Basic 執行階段程式庫一部分的常數和列舉型別。</span><span class="sxs-lookup"><span data-stu-id="bd608-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="bd608-126">您可以在程式碼中使用這些常數的值。</span><span class="sxs-lookup"><span data-stu-id="bd608-126">You can use these constant values in your code.</span></span> <span data-ttu-id="bd608-127">每個列舉，代表與特定類別的功能。</span><span class="sxs-lookup"><span data-stu-id="bd608-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="bd608-128">如需詳細資訊，請參閱 <<c0> [ 常數和列舉型別](../../visual-basic/language-reference/constants-and-enumerations.md)。</span><span class="sxs-lookup"><span data-stu-id="bd608-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="bd608-129">另請參閱</span><span class="sxs-lookup"><span data-stu-id="bd608-129">See also</span></span>

- [<span data-ttu-id="bd608-130">常數和列舉</span><span class="sxs-lookup"><span data-stu-id="bd608-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="bd608-131">關鍵字</span><span class="sxs-lookup"><span data-stu-id="bd608-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
