...
## <a name="in-this-section"></a>本節內容  
 ...
 文件的宣告和可執行陳述式可以在 Visual Basic 中使用。  
  
 [XML 註解標記](../../visual-basic/language-reference/xmldoc/index.md)  
 描述 IntelliSense 會提供在 Visual Basic 程式碼編輯器中的文件註解。  
 ...
 提供的清單，Visual Basic 編譯器和執行階段錯誤訊息以及說明如何處理它們。  
  
## <a name="related-sections"></a>相關章節  
 [Visual Basic](../../visual-basic/index.md)  
 在 Visual Basic 語言中的所有區域中提供完整的說明。  
  
 [Visual Basic 命令列編譯器](../../visual-basic/reference/command-line-compiler/index.md)  
 描述如何使用命令列編譯器作為從 Visual Studio 整合式的開發環境 (IDE) 內編譯程式的替代方案。
