...
## <a name="in-this-section"></a>本節內容  
 ...
 摘要說明關鍵字、 預留位置和語言的其他項目在 Visual Basic 文件中格式化的方式。  
 ...
 文件的宣告和可執行檔陳述式可以在 Visual Basic 中使用。  
