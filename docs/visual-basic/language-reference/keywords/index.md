...
|[AndAlso](../operators/andalso-operator.md)|[As](../statements/as-clause.md)|[布林值](../data-types/boolean-data-type.md)|[ByRef](../modifiers/byref.md)|  
...
|[Each](../statements/for-each-next-statement.md)|[Else](../statements/else-statement.md)|[ElseIf](../statements/if-then-else-statement.md)|[End 陳述式](../statements/end-statement.md)|  
|[End \<關鍵字>](../statements/end-keyword-statement.md)|`EndIf`|[Enum](../statements/enum-statement.md)|[Erase](../statements/erase-statement.md)|  
|[錯誤](../statements/on-error-statement.md)|[Event](../statements/event-statement.md)|[結束](../statements/exit-statement.md)|[False](../data-types/boolean-data-type.md)|  
|[Finally](../statements/try-catch-finally-statement.md)|[For (在 For…Next 中)](../statements/for-next-statement.md)|[For Each…Next](../statements/for-each-next-statement.md)|[Friend](../modifiers/friend.md)|  
...
|[If](../statements/if-then-else-statement.md)|[If()](../operators/if-operator.md)|[Sub New](../statements/implements-clause.md)|[Implements 陳述式](../statements/implements-statement.md)|  
...
|[New 條件約束](../statements/type-list.md)|[New 運算子](../operators/new-operator.md)|[下一步](../statements/for-next-statement.md)|[Next (在 Resume 中)](../statements/resume-statement.md)|  
...
|[物件](../data-types/object-data-type.md)|[Of](../statements/of-clause.md)|[On](../../../visual-basic/misc/on.md)|[Operator](../statements/operator-statement.md)|  
|[選項](../statements/option-keyword-statement.md)|[Optional](../modifiers/optional.md)|[Or](../operators/or-operator.md)|[OrElse](../operators/orelse-operator.md)|  
|[Out (泛型修飾詞)](../modifiers/out-generic-modifier.md)|[多載](../modifiers/overloads.md)|[Overridable](../modifiers/overridable.md)|[Overrides](../modifiers/overrides.md)|  
...
|[Return](../statements/return-statement.md)|[SByte](../data-types/sbyte-data-type.md)|[選取](../statements/select-case-statement.md)|[Set](../statements/set-statement.md)|  
...
|[結構條件約束](../statements/type-list.md)|[Structure 陳述式](../statements/structure-statement.md)|[Sub](../statements/sub-statement.md)|[SyncLock](../statements/synclock-statement.md)|  
...
|[>> 運算子](../operators/right-shift-operator.md)|[>>= 運算子](../operators/right-shift-assignment-operator.md)|[<<](../operators/left-shift-operator.md)|[<\<=](../operators/left-shift-assignment-operator.md)|  
  
> [!NOTE]
> `EndIf`、`GoSub`、`Variant`和 `Wend` 會保留為保留的關鍵字，但不會再用於 Visual Basic 中。 `Let` 關鍵字的意義已變更。 `Let` 現在用於 LINQ 查詢中。 如需詳細資訊，請參閱 [Let 子句](../queries/let-clause.md)。  
...
|[自訂](../statements/event-statement.md)|[Distinct](../queries/distinct-clause.md)|[Equals](../queries/equals-clause.md)|[Explicit](../statements/option-explicit-statement.md)|  
...
|標題|描述|  
|-----------|-----------------|  
|[陣列摘要](arrays-summary.md)|列出語言項目，可用來建立、定義以及使用陣列。|  
|[集合物件摘要](collection-object-summary.md)|列出用於集合的語言項目。|  
|[控制流程摘要](control-flow-summary.md)|列出陳述式，以用於迴圈和控制程序流程。|  
|[轉換摘要](conversion-summary.md)|列出函式，可用來轉換數字、日期、時間和字串。|  
|[資料類型摘要](data-types-summary.md)|列出資料類型。 也會列出函式，可用來轉換不同資料類型與確認資料類型。|  
|[日期和時間摘要](dates-and-times-summary.md)|列出語言項目，以用於日期和時間。|  
|[宣告和常數摘要](declarations-and-constants-summary.md)|列出陳述式，可用來宣告變數、常數、類別、模組和其他程式設計項目。 也會列出語言項目，可用來取得物件資訊、處理事件，以及實作繼承。|  
|[目錄和檔案摘要](directories-and-files-summary.md)|列出函式，可用來控制檔案系統以及處理檔案。|  
|[錯誤摘要](errors-summary.md)|列出語言項目，可用來攔截並傳回執行階段錯誤值。|  
|[財務摘要](financial-summary.md)|列出函式，可用來執行財務計算。|  
|[輸入和輸出摘要](input-and-output-summary.md)|列出函式，可用來讀取和寫入檔案、管理檔案，以及列印輸出。|  
|[資訊和互動摘要](information-and-interaction-summary.md)|列出函式，可用來執行其他程式、取得命令列引數、操作 COM 物件、擷取色彩資訊，以及使用控制對話方塊。|  
|[數學摘要](math-summary.md)|列出函式，可用來執行三角和其他數學計算。|  
|[My 參考](my-reference.md)|列出 `My` 中所包含的物件，此功能可存取應用程式執行所在電腦、目前應用程式、應用程式資源、應用程式設定等的常用方法、屬性和事件。|  
|[運算子摘要](operators-summary.md)|列出指派和比較運算式以及其他運算子。|  
|[登錄摘要](registry-summary.md)|列出函式，可用來讀取、儲存和刪除程式設定。|  
|[字串操作摘要](string-manipulation-summary.md)|列出用來操作字串的函式。|  
