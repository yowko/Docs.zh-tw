---
title: "運算子摘要 (Visual Basic) |Microsoft 文件"
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
|其他作業|[AddressOf](../../../visual-basic/language-reference/operators/addressof-operator.md)， [Await](../../../visual-basic/language-reference/operators/await-operator.md)， [GetType](../../../visual-basic/language-reference/operators/gettype-operator.md)|  
