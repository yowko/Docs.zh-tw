...
|動作|語言項目|  
|------------|----------------------|  
|指派值。|[取得](../../../visual-basic/language-reference/statements/get-statement.md)，[屬性](../../../visual-basic/language-reference/statements/property-statement.md)|  
...
|需要明確宣告變數。|[Option Explicit](../../../visual-basic/language-reference/statements/option-explicit-statement.md)，[嚴格的選項](../../../visual-basic/language-reference/statements/option-strict-statement.md)|  
