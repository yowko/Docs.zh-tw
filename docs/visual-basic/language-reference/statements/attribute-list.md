...
Specifies the attributes to be applied to a declared programming element. 以逗號分隔多個屬性。 Following is the syntax for one attribute.  
...
|`attributearguments`|選擇項。 List of positional arguments for this attribute. Multiple arguments are separated by commas.|
|`attributeinitializer`|選擇項。 List of variable or property initializers for this attribute. Multiple initializers are separated by commas.|
