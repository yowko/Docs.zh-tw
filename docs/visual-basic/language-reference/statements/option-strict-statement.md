...
###  <span data-ttu-id="a230c-199"><a name="conditions"></a>若要在 IDE 中設定警告組態</span><span class="sxs-lookup"><span data-stu-id="a230c-199"><a name="conditions"></a> To set warning configurations in the IDE</span></span>  
