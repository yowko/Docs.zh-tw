...
您可以在這裡取得完整連結 shortener 存放庫與指示:[無伺服器 URL shortener](https://github.com/jeremylikness/serverless-url-shortener)。 您可以在這裡閱讀簡化版本的相關資訊:[幾分鐘內就能 Azure 儲存體無伺服器 .net 應用程式](https://blogs.msdn.microsoft.com/webdev/2018/01/25/azure-storage-for-serverless-net-apps-in-minutes/)。
...
* [幾分鐘內無伺服器 .NET 應用程式的 Azure 儲存體](https://blogs.msdn.microsoft.com/webdev/2018/01/25/azure-storage-for-serverless-net-apps-in-minutes/)
