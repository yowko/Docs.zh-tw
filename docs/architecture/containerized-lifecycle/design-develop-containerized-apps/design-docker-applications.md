...
**更多資訊**要深入瞭解企業應用程式和微服務體系結構，請閱讀[指南 NET 微服務：容器化 .NET 應用程式的體系結構](../../microservices/index.md)，您也可以從<https://aka.ms/MicroservicesEbook>下載。

不過，在開始探討應用程式生命週期和 DevOps 之前，請務必了解您要如何設計及建構應用程式，以及您有哪些設計選擇。

>[!div class="step-by-step"]
>[上一個](index.md)
>[下一個](common-container-design-principles.md)
