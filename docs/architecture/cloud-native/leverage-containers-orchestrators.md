...
除了本機開發之外， [Azure Dev Spaces](https://docs.microsoft.com/azure/dev-spaces/) 也提供便利的方法，讓多個開發人員在 Azure 中使用自己的 Kubernetes 設定。 如圖3-7 中所示，您也可以在 Azure Dev Spaces 中執行應用程式。
